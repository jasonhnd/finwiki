...
aliases:
  ...
  - "Japan non-life big three cat matrix"
  - "Tokio Marine MSAD Sompo reinsurance overlay"
  - "Japan P&C big three cat overlay"
  - "Japan non-life cat reinsurance comparison"
  - "日本 損保 big three 再保険 比較"
  - "Japan non-life big three combined ratio matrix"
...
- **Earthquake (commercial / shintaku property)** — Distinct from the household earthquake insurance pool ([[insurance/earthquake-insurance-public-private-scheme|earthquake insurance public-private scheme]]). Cat XL is the primary reinsurance protection. The biggest single-event scenarios drive the reinsurance-program retention sizing.
...
See [[insurance/global-solvency-framework-comparison-matrix|the global solvency framework comparison matrix]] for the regime-level decomposition and [[insurance/esr-economic-value-solvency|the ESR explainer]] for the metric definition.
...
- **Remediation context affects messaging.** Public-disclosure remediation arcs (notably the recent Sompo arc) affect mid-term-plan messaging, regulatory dialogue, and capital-policy guidance. Read alongside [[insurance/insurance-agency-and-brokerage-japan|the agency / brokerage Japan landscape]].
...
- **IAIG / ICS reporting.** Group-level ICS reporting applies in parallel with domestic ESR for designated IAIGs — see [[insurance/japan-iaig-ics-mapping|Japan IAIG / ICS mapping]] and [[insurance/global-solvency-framework-comparison-matrix|the global solvency framework comparison matrix]].
