...
株式会社トマト銀行は、金融庁の銀行免許一覧に掲載される岡山県本店の第二地方銀行。岡山県内では [[chugoku-bank]] の local second-regional-bank peer として扱う。

## 1. License / group boundary

| Item | Notes |
|---|---|
| Legal name | 株式会社トマト銀行 |
...
- Closes the FSA exact-name page for トマト銀行.
- Adds a separate Okayama second-regional-bank route.
- Prevents the bank from being swallowed by [[chugin-okayama]] / 中国銀行 coverage.
