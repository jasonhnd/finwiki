---
title: "Shinkin Network Services (信金ネットワークサービス)"
aliases:
...
confidence: likely
tags: [JapanFG, shinkin, cooperative-banking, infrastructure, atm, system-shared, operating-company]
status: active
sources:
  - "https://www.shinkin.org/"
  - "https://www.shinkin-central-bank.jp/"
  - "https://www.shinkin.co.jp/network/"
  - "https://www.fsa.go.jp/menkyo/menkyoj/shinkin.xlsx"
  - "https://www.shinkin.org/zenshinkyo/about/"
---

# Shinkin Network Services (信金ネットワークサービス)

## Wiki route

This entry sits under [[JapanFG/INDEX|JapanFG index]]. Read it against [[JapanFG/shinkin-central|信金中央金庫]] for the operational central-bank counterpart that anchors the shinkin system, against [[JapanFG/zenshin-kyo|全国信用金庫協会]] for the industry-body / policy layer, and against [[banking/shinkin-bank-registry-japan|Japan shinkin bank registry]] for the full member-population route. The cooperative-system comparison anchor sits at [[banking/japan-cooperative-banking-unified-federation-matrix|Japan cooperative-banking unified federation matrix]].
...
| Item | Notes |
|---|---|
| Legal name | 信金ネットワークサービス株式会社（株式会社、信金中央金庫系列） |
| Group route | 信金中央金庫グループ系列の IT 共同インフラ会社 |
| Member base | 全国信用金庫 254 行（FSA 2025-11-06 時点）+ 信金中央金庫 |
| Wiki role | 信用金庫業界の **共同 IT インフラ運営会社** の anchor entry |
| Counterpart at federation layer | [[JapanFG/zenshin-kyo|全国信用金庫協会]]（policy / industry body） |
| Counterpart at central-bank layer | [[JapanFG/shinkin-central|信金中央金庫]]（central liquidity / clearing） |
...
2. **信用金庫共同センター（勘定系共同利用）**
   ...
   - 大手信用金庫（[[JapanFG/kyoto-chuo-shinkin|京都中央信用金庫]]・[[JapanFG/osaka-shinkin|大阪信用金庫]] など）は独自勘定系を持つケースもあるが、多くの中堅・中小金庫は共同センターに依存。
...
## 3. 戦略的位置付け（Why this entity matters）
...
### [[JapanFG/shinkin-central|信金中金]] との分業
...
- [[JapanFG/osaka-shinkin|大阪信用金庫]]
- [[JapanFG/jonan-shinkin|城南信用金庫]]
- [[JapanFG/yokohama-shinkin|横浜信用金庫]]
