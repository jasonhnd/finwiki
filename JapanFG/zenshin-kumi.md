...
status: active
sources:
  - "Wikipedia: 全国信用協同組合連合会 (2026-05-19 抽出)"
...
日本の **信用組合 (信組) 業界の中央機関**。1954-04 設立、全国 **145 信用組合** (2024 時点) を会員とする協同組織金融機関。信金中央金庫 [[shinkin-central]] と並ぶ「中央 2 連」の一翼だが、規模は約 1/10。会員信組向け資金運用・余資運用・決済代行・システム共同センター・ATM 連携が四本柱。**信用組合 = 中小企業組合員 + 地域組合員 向け融資特化、信用金庫より会員制が厳格**で、その中央銀行に当たる。地域金融セーフティネット機能を持つ。^[extracted]
...
**上場**: 非上場 (会員 = 信用組合 145 組合による出資)
**本部**: 東京都千代田区一番町 10
**会員数**: **145 信用組合** (2024 年度時点) ^[extracted]
...
| **全信組連** | **信用組合** | **145 信組** | **小規模 (信金中央金庫の約 1/10)** |
...
| 2010 年代 | 業界再編一段落、145 前後で安定推移 |
| 2010 年代後半 | フィンテック / 共同センター高度化 |
| **2024** | **会員 145 信組** + 中計策定 ^[extracted] |
...
- **「信用組合の中央銀行」機能維持**: 信組業界 145 組合の余資運用 + 流動性供給
...
- 信用組合数の中長期見通し (現 145 → 2030 年代の予測値)?
...
- 全信組連 公式サイト・ディスクロージャー誌 (2024 年度版)
- 金融庁: 協同組織金融機関一覧 (2024 年度)
- 信用組合業界統計 (2024)

---

> [!info] 校核状态
> confidence: **likely** (公开情報ベース、Wikipedia + 公式ディスクロージャー由来)。会員信組数 (145) は 2024 時点、組合再編により年次変動あり。詳細財務指標は要 IR 直接確認。信金中金との対比規模は業界相対的概算。
