...
This entry sits under [[JapanFG/INDEX|JapanFG index]] as the **operating-company anchor** for [[mobility/softbank-corp|ソフトバンク株式会社]]（東証 PRIME 9434、コア通信事業）グループの **決済代行・金融サービス子会社 SB ペイメントサービス（SBPS）**. Read it against [[JapanFG/paypay-fg|PayPay 金融グループ]] for the sister SoftBank-affiliated payment / fintech cluster, [[JapanFG/au-fh|au フィナンシャル HD]] for the telco-captive financial group peer, [[JapanFG/ndfg|NTT ドコモ FG]] for the telco-financial-group ピア, [[payments/INDEX|payments index]] for the PSP / 加盟店決済サービス context, and [[payments/cashless-jp-landscape|キャッシュレス日本ランドスケープ]] for system-level positioning.

## TL;DR

[[mobility/softbank-corp|ソフトバンク株式会社]]（通信事業の SoftBank Corp、東証 PRIME 9434）グループの **決済代行サービス（PSP = Payment Service Provider）子会社**。2004 設立、ソフトバンクの完全子会社。**EC 加盟店向けにクレジットカード・コンビニ決済・電子マネー・QR コード決済（[[payments/paypay|PayPay]] 含む）・キャリア決済（ソフトバンクまとめて支払い）等のマルチペイメント決済処理プラットフォーム** を提供。日本国内 EC ペイメント市場で **PSP 大手 3 強の一角**（[[JapanFG/gmo-pg|GMO ペイメントゲートウェイ]]・[[JapanFG/digital-garage|デジタルガレージ／VeriTrans]]・SBPS）を構成。直接の B2C 金融機能は [[JapanFG/paypay-fg|PayPay 金融グループ]] が担い、SBPS は **B2B / B2B2C の加盟店向け決済処理インフラ** に特化。^[likely]
...
| 親会社 | [[mobility/softbank-corp|ソフトバンク株式会社]]（東証 PRIME 9434、100% 子会社）|
...
| **電子マネー** | [[transit/suica|Suica]]・PASMO・楽天 Edy・WAON 等の主要交通 IC / 流通系 |
...
- **国内 EC 加盟店 数十万店規模** との業界観測 ^[ambiguous]
- 通信事業者親会社のチャネル力 + 大手 EC プラットフォーム連携（[[corporate/yahoo-japan|Yahoo! ショッピング]] / [[corporate/lohaco|LOHACO]] 等）
...
ソフトバンクグループ株式会社（東証 PRIME 9984）
  ...
  └── ソフトバンク株式会社（東証 PRIME 9434、コア通信事業）
        ...
        ├── ヤフー / LINE 統合事業（[[corporate/ly-corporation|LY Corporation]] 子会社化）
...
### SBPS vs [[JapanFG/paypay-fg|PayPay 金融グループ]] の棲み分け
...
| 指標 | 規模感 |
|---|---|
| **加盟店数** | 数十万店規模（PSP 大手 3 強の一角）|
| **取扱決済額** | 兆円規模（PayPay 決済額の B2B 処理分を含む）^[likely] |
| 従業員数 | 数百〜千名規模 ^[ambiguous] |
| 親会社ソフトバンク内位置 | エンタープライズ事業セグメント内の決済子会社 |
| PSP 市場シェア | 国内 PSP 大手 3 強の一角（[[JapanFG/gmo-pg|GMO ペイメントゲートウェイ]]・[[JapanFG/digital-garage|デジタルガレージ／VeriTrans]] と並ぶ）|
...
国内 PSP 市場の競合構造:
- **[[JapanFG/gmo-pg|GMO ペイメントゲートウェイ]]**（東証 PRIME 3769、PSP 専業最大手）
- **[[JapanFG/digital-garage|デジタルガレージ／VeriTrans]]**（東証 PRIME 4819、メディア + PSP 兼業）
...
- [[corporate/yahoo-japan|Yahoo! ショッピング]]・[[corporate/lohaco|LOHACO]]・Z Holdings 系 EC プラットフォーム
- [[corporate/zozotown|ZOZOTOWN]]（Z Holdings 系）
...
| 上場 | 非上場（親会社 [[mobility/softbank-corp|ソフトバンク]] が東証 PRIME 9434）|

## Counterpoints

- 「PSP 大手 3 強の一角」: [[JapanFG/gmo-pg|GMO ペイメントゲートウェイ]] の単独企業としての規模感が圧倒的、SBPS は親会社グループ依存度高い ^[ambiguous]
- 「PayPay 連携優位」: PayPay は他 PSP（[[JapanFG/gmo-pg|GMO ペイメントゲートウェイ]] 等）経由でも加盟店接続可能、SBPS 独占ではない ^[inferred]
...
- 「[[JapanFG/paypay-fg|PayPay 金融グループ]] との統合」: 別法人として並立する現状の合理性は要検証、長期的には統合シナリオも残る ^[ambiguous]

## Open questions

- 加盟店数の精緻数値（[[JapanFG/gmo-pg|GMO ペイメントゲートウェイ]] との単純比較）?
- 取扱決済額（PayPay 経由分の按分処理含む）?
- 親会社ソフトバンク連結内での収益貢献度?
- [[JapanFG/paypay-fg|PayPay 金融グループ]] との **将来的な統合・再編** シナリオ?
- BNPL・サブスク決済・電子チケッティング等の **新領域シェア** 状況?
- PSP マージン低下圧力に対する戦略（決済以外の付加価値サービス展開）?

## Related

- [[mobility/softbank-corp]] — 親会社（東証 PRIME 9434）
- [[JapanFG/paypay-fg]] — グループ兄弟（B2C 金融グループ）
- [[JapanFG/paypay]] — QR 決済（加盟店連携先）
- [[JapanFG/paypay-bank]] — グループ銀行
- [[JapanFG/paypay-card]] — グループカード
- [[JapanFG/gmo-pg]] — PSP 大手競合（[[JapanFG/INDEX]] 内）
