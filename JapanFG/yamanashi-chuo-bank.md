...
株式会社山梨中央銀行は、金融庁の銀行免許一覧に掲載される山梨県本店の地方銀行。山梨県の main regional bank として、wiki では standalone operating-company anchor として扱う。

## 1. License / group boundary

| Item | Notes |
|---|---|
| Legal name | 株式会社山梨中央銀行 |
...
- Closes the exact-name page for 山梨中央銀行 in the FSA regional-bank list.
