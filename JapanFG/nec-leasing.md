...
confidence: likely
tags: [JapanFG, leasing, finance, nec-group, captive-lease, it-finance]
status: active
sources:
...
This entry sits under [[JapanFG/INDEX|JapanFG index]]. Read it against [[JapanFG/ricoh-leasing|リコーリース]] for peer / contrast context (both are事業会社 captive lease) and [[banking/INDEX|banking index]] for the broader system / regulatory boundary. Read it together with [[JapanFG/fuyo-lease|芙蓉総合リース]] for the準大手 leasing peer set.
...
リコーリース ([[JapanFG/ricoh-leasing|リコーリース]]) との対比は事業会社系 captive lease の典型的 peer set：
...
- 事業会社系 captive リースの代表例 ([[JapanFG/ricoh-leasing|リコーリース]] / [[JapanFG/toyota-finance|トヨタファイナンス]] と並ぶ peer set)
...
> [!info] 校核状态
> confidence: **likely** (公開情報ベース 2026-05-24)。NEC 本体の事業構造変化 (ハード → IT ソリューション) との連動による親子会社戦略は変動要素。自治体 PFI 案件の収益貢献度の詳細は IR 資料の最新版で要参照。
