...
status: active
sources:
  - "https://www.westernunion.com/jp/en/register-and-send-money.html"
  - "https://www.westernunion.com/content/dam/wu/APAC/other/pdf/WU-terms-conditions-Japan-jp.pdf"
...
ウエスタンユニオンジャパン株式会社は Western Union の日本 funds-transfer operator。FSA 登録一覧では関東財務局長第00039号として掲載され、cash pickup / agent network 型 remittance の代表例になる。

## 1. 法人・ライセンス境界

| Item | Reading |
|---|---|
| Legal entity | ウエスタンユニオンジャパン株式会社 |
| Group | Western Union group |
| Main lanes | International money transfer, agent network, cash receipt / payout |
| FSA registry route | FSA funds-transfer list: 関東財務局長 第00039号, ウエスタンユニオンジャパン株式会社. |
