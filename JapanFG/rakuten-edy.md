...
confidence: likely
tags: [JapanFG, payments, prepaid, electronic-money, funds-transfer, rakuten]
status: active
sources:
  - "https://edy.rakuten.co.jp/company/company.html?l-id=lid_top_footer_company"
  - "https://edy.rakuten.co.jp/company/?l-id=footer_company"
...
楽天Edy株式会社は [[JapanFG/rakuten-fg|Rakuten financial ecosystem]] の prepaid electronic-money / Rakuten Cash operating company。公式会社概要は「楽天Edy」「楽天キャッシュ」事業の企画・運営、利用店舗開拓、ブランド管理を示している。

## 1. 法人・ライセンス境界

| Item | Reading |
|---|---|
| Legal entity | 楽天Edy株式会社 |
| Group | [[JapanFG/rakuten-fg|Rakuten]] / Rakuten Payment subsidiary |
| Main lanes | Prepaid electronic money, Rakuten Cash, merchant acceptance, stored-value management |
| FSA registry route | FSA funds-transfer list: 関東財務局長 第00067号, 楽天Edy株式会社. |
...
楽天カード, 楽天ペイ, 楽天Edy, and 楽天キャッシュ are adjacent but legally different surfaces. This page keeps the prepaid / funds-transfer layer visible.
