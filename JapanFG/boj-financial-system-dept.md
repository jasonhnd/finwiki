...
aliases:
  - "JapanFG/boj-financial-system-dept"
  - "boj-financial-system-dept"
  - "BoJ Financial System and Bank Examination Department"
...
confidence: likely
tags: [JapanFG, central-bank, internal-bureau, BoJ, prudential, macroprudential, bank-examination]
status: active
sources:
  - "https://www.boj.or.jp/en/about/organization/index.htm"
  - "https://www.boj.or.jp/en/finsys/exam_monit/index.htm"
  - "https://www.boj.or.jp/en/finsys/fsr/index.htm"
...
## Wiki route
This entry sits under [[JapanFG/INDEX|JapanFG index]]. Read it against [[JapanFG/boj-financial-markets-dept|金融市場局]] for the BoJ market-operations counterpart and [[JapanFG/fsa-supervision-bureau|FSA 監督局]] for the regulatory-perimeter contrast. For the broader prudential system, anchor through [[JapanFG/boj-monetary-policy|BoJ monetary policy]] and [[banking/INDEX|banking landscape]].
...
- Input into the Policy Board on financial-stability matters that may interact with monetary policy (the financial-stability remit complements but does not replace [[JapanFG/boj-monetary-policy|monetary policy]] decisions).
...
- **Examined institutions**: banks, shinkin banks, foreign-bank branches, securities firms, and other entities holding BoJ current accounts. This includes most of the JapanFG bank universe — see [[JapanFG/smfg|SMFG]], [[JapanFG/mufg-mums|MUFG / MUMS]], regional banks such as [[JapanFG/chiba-bank|Chiba Bank]] and [[JapanFG/77-bank|77 Bank]], and the shinkin segment captured in [[banking/shinkin-bank-registry-japan|shinkin bank registry]].
- **Other regulators**: the FSA (particularly [[JapanFG/fsa-supervision-bureau|監督局]]), the Deposit Insurance Corporation of Japan, and foreign supervisors for cross-border banking groups.
- **Internal BoJ**: shared work with [[JapanFG/boj-financial-markets-dept|金融市場局]] on counterparty-credit aspects of market operations, with [[JapanFG/boj-payment-settlement-dept|決済機構局]] on settlement-risk surveillance, and with [[JapanFG/boj-international-dept|国際局]] on cross-border prudential issues including BIS Basel coordination.
