...
aliases:
  ...
  - "BoJ Payment and Settlement Systems Department"
...
confidence: likely
tags: [JapanFG, central-bank, internal-bureau, BoJ, payment, settlement, BOJ-NET, FMI]
status: active
sources:
  - "https://www.boj.or.jp/en/about/organization/index.htm"
  - "https://www.boj.or.jp/en/paym/bojnet/index.htm"
  - "https://www.boj.or.jp/en/paym/outline/index.htm"
  - "https://www.boj.or.jp/en/paym/release/index.htm"
...
## Wiki route
This entry sits under [[JapanFG/INDEX|JapanFG index]]. Read it against [[JapanFG/boj-financial-markets-dept|金融市場局]] for the BoJ market-operations counterpart and [[JapanFG/boj-financial-system-dept|金融機構局]] for the prudential-side bureau. For the broader settlement system, anchor through [[banking/INDEX|banking landscape]] and [[JapanFG/boj-monetary-policy|BoJ monetary policy]].
...
- Cross-border settlement coordination with major central banks on issues such as PvP, CLS, and FX settlement risk; this overlaps with [[JapanFG/boj-international-dept|国際局]] on BIS-CPMI work.

Internal coordination is dense: the bureau supplies the operational layer that lets [[JapanFG/boj-financial-markets-dept|金融市場局]] execute open-market operations, and supports the settlement-risk monitoring done by [[JapanFG/boj-financial-system-dept|金融機構局]].

## 2. Counterparty / interaction

Counterparties cluster in three layers:

- **BOJ-NET participants**: banks, securities firms, tanshi firms, and other current-account holders who settle through the system. This includes most of the JapanFG bank / securities universe and the tanshi pages [[JapanFG/tokyo-tanshi|Tokyo Tanshi]], [[JapanFG/central-tanshi|Central Tanshi]], [[JapanFG/ueda-yagi-tanshi|Ueda Yagi Tanshi]].
- **Domestic FMI operators**: Zengin-Net, JSCC, JASDEC, the Tokyo Financial Exchange, and related clearing / settlement utilities. The bureau's oversight role here is policy-level rather than statutory supervision (statutory supervision sits with the FSA — see [[JapanFG/fsa-supervision-bureau|監督局]]).
