...
status: active
sources:
  - "Wikipedia: 株式会社ローソン銀行 (2026-05-19 抽出)"
  - "Wikipedia: 株式会社ローソン (2026-05-19 抽出)"
...
| セグメント | 主力プロダクト | 特徴 |
|---|---|---|
| **ATM 業務（コア）** | 全国ローソン店舗 ATM 約 13,000 台 ^[ambiguous] | コンビニ ATM 手数料収入が収益源（[[seven-bank]] モデル踏襲）|
| 個人預金 | ローソン銀行口座（普通預金・定期）| ローソンアプリ + Ponta ポイント連携 ^[inferred] |
...
- **Lawson Bank** — ATM 約 13,000 台、後発で追随戦略 ^[ambiguous]
- **E-net（イーオン・ファミマ系列）** — 旧 イーネット、ファミリーマート系列の ATM 運営会社 ^[inferred]

セブン銀行モデル（ATM 手数料 × 大量設置 × 軽資本リテール）を後発 2 行が踏襲する産業構造。^[inferred]

### KDDI au 経済圏統合可能性

2024-09 の親会社 ローソン JV 化（三菱商事 + KDDI 50:50）以降の戦略軸：

- **ローソンアプリ + au PAY 連携深化**：通信会社 KDDI の決済プラットフォームと小売の融合 ^[inferred]
- **三菱商事系列の金融サブ機能**：三菱商事の小売・流通インフラ（ローソン）と銀行ライセンスを束ねた「小売金融」の試行 ^[inferred]
- **MUFG との関係**：1990 年代の旧 三菱東京 UFJ 銀行 ATM 委託歴史 + 三菱商事筆頭株主の三菱グループ系列性で、[[mufg]] との間接連携余地 ^[ambiguous]
...
| 設立 | 2001-04 | 2017-11 |
| 開業 | 2001-05 | 2018-10 |
| ATM 設置数 | 約 27,000 台超 ^[ambiguous] | 約 13,000 台 ^[ambiguous] |
...
- **主管**：金融庁（FSA）
- **業態**：普通銀行（コンビニ ATM 特化）
- **資金決済法**：ATM 業務・送金業務関連 ^[inferred]
- **直近政策論点**：
  - 親会社 ローソン の **三菱商事 + KDDI 50:50 JV 化**（2024-09）に伴う **大株主変更届出・銀行法上の主要株主認可** ^[inferred]
  - 通信・小売・金融の業界横断的所有構造に対する規制当局の関心 ^[ambiguous]
  - 日銀政策金利正常化（2024〜）→ ATM 手数料収益への影響は限定的（金利マージン依存度低い）^[inferred]
