...
| Listing | Tokyo Stock Exchange listed leasing company |
| Strategic shareholders | Mizuho Financial Group and Marubeni are key strategic shareholders |
| Business | Leasing, installment sales, financing, real-estate / aircraft / overseas and vendor-finance related businesses |
| Peer set | [[JapanFG/smfl|SMFL]], [[JapanFG/mitsubishi-hc-capital|Mitsubishi HC Capital]], [[JapanFG/orix-corp|ORIX]], [[JapanFG/tokyo-century|Tokyo Century]] |

## Business Map

| Lane | Role |
|---|---|
| Corporate leasing | Equipment, IT, industrial and vendor finance for corporate clients |
| Real estate / environment | Asset ownership and project-linked finance |
...
Mizuho Leasing is useful because it shows how a megabank group can use a listed leasing company as a flexible balance-sheet satellite:

- bank loans finance borrower balance sheets;
- leasing finances assets and can preserve residual-value control;
- trading-company partners add asset sourcing, project knowledge, and overseas origination;
- listed-company status gives minority-shareholder and market-discipline considerations.

## Competitive Context

| Peer | Contrast |
|---|---|
| [[JapanFG/orix-corp|ORIX]] | More diversified and independent investment / asset-management model |
| [[JapanFG/smfl|SMFL]] | SMFG + Sumitomo Corporation joint platform, stronger Sumitomo group pairing |
| [[JapanFG/mitsubishi-hc-capital|Mitsubishi HC Capital]] | Larger Mitsubishi / MUFG group leasing platform |
| [[JapanFG/ntt-tc-lease|NTT TC Leasing]] | NTT asset base + Tokyo Century lease expertise, more telecom-asset anchored |

## Risk Notes

- Leasing earnings are sensitive to corporate capex cycles, asset residual values, rates, and overseas risk.
...
- [[JapanFG/ntt-tc-lease|NTT TC Leasing]]
