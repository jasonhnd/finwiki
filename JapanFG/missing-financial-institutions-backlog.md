...
| Foreign bank branches | 57 | FSA bank license Excel | Add only material Japan branches first; keep long-tail branches in an index. |
...
| Financial instruments business operators | 1,945 | FSA FIEA operator Excel | Registry route completed via [[securities/financial-instruments-business-operators-japan-index]]; standalone pages only for brokers, AMs, PTS, derivatives, and listed/publicly material operators. |
...
| Non-life insurers | 57 | FSA non-life insurer Excel | Add major operating insurers, direct insurers, reinsurers, and insurance HD gaps. |
| Insurance holding companies | 15 | FSA insurance holding company Excel | Add missing HD pages where group strategy matters. |
| Trust companies | 38 | FSA trust company Excel | Registry route completed via [[JapanFG/trust-companies-japan-index]]; add standalone pages only for material independent / group trust companies. |
| Funds transfer service providers | 83 | FSA funds transfer Excel / JPSA member list | Add major wallet, remittance, PSP, and stablecoin-adjacent operators. |
...
| Credit purchase / card operators | 240+ registered operators | METI Installment Sales Act lists | Standalone pages for card issuers, acquirers, PSPs, and BNPL/consumer-credit operators. |
...
| Status | Target page | Institution | Why it matters |
|---|---|---|---|
...
| [ ] | Consumer finance / installment E2 | 新生フィナンシャル, Toyota Finance page split from [[JapanFG/toyota-financial|Toyota Financial Services]] |
...
| [ ] | PSP / acquiring / gateway E2 | ネットスターズ, リクルートMUFGビジネス, JALペイメント・ポート |
...
| [x] | P2 | Other branches | [[JapanFG/foreign-bank-branches-japan-index]] created as the 57-row FSA registry route; promote registry-only rows only when standalone analysis is strategically needed. |
...
|---|---:|---:|---:|---|---|
| Banks: city / trust / other | 2026-04-01 | 35 | 32 | Mostly covered after B1; remaining exact-name gaps are specialty trust / custody-adjacent names. | Review SBI Shinsei Trust, JSF Trust, and BNY Mellon Trust before deciding standalone vs parent/context pages. |
| Foreign bank branches | 2026-05-13 | 57 | 57 | Registry/index route completed via [[JapanFG/foreign-bank-branches-japan-index]]; 36 rows have standalone / umbrella wiki routes and 21 rows remain registry-only. | Refresh the registry index when FSA `ginkou.xlsx` changes; standalone P2 pages only for strategically material exceptions. |
...
| Bank holding companies | 2026-05-01 | 31 | 30 | Near complete. | Verify CCI Group / Kyushu parent boundary before adding or marking registry-only. |
...
| Financial instruments business operators | 2026-04-30 | 1,945 | 1,945 | Registry route completed via [[securities/financial-instruments-business-operators-japan-index]]; material brokers, AMs, PTS, FX, and listed/publicly material operators have route anchors. | Refresh when FSA `kinyushohin.xlsx` changes; standalone pages only for strategic exceptions. |
...
| Non-life insurers | 2026-04-01 | 57 | 22 | Major, direct / digital, specialty, and reinsurance D3-D5 pages completed; long-tail non-life insurers remain registry-only unless strategically material. | Execute insurance holding company gaps next. |
| Insurance holding companies | 2026-04-01 | 15 | 14 | D6 completed for Anicom HD, NTT docomo non-life HD, Rakuten Insurance HD, and Dai-ichi Life Group name update. | Remaining HD gaps should be checked only when group strategy needs standalone coverage. |
| Trust companies | 2026-03-31 | 38 | 38 | Registry route completed via [[JapanFG/trust-companies-japan-index]]; 6 rows have existing group wiki routes and 32 rows remain registry-only. | Promote standalone pages only for material trust-company exceptions. |
| Funds transfer service providers | 2026-04-30 | 83 | 9 | Exact match is low because many are platform/group pages; Batch E is still a large gap. | Prioritize PayPay, Merpay, au PAY, Rakuten Edy, Kyash, SBI Remit, Wise, Revolut, PayPal, Western Union, Airwallex. |
...
5. Batch C: securities and asset-management operators.
6. Batch E: payment / card / funds-transfer operators.
7. Batch D: insurance operating companies. D1-D7 completed; FSA 41 life-insurer surface closed at standalone / intentional group-anchor level. Continue with other batches rather than duplicating life-insurer pages.
...
9. Batch G + H + I: foreign branches, cooperative-system gaps, and policy-finance adjacency. Batch G foreign-bank branch surface is closed at registry-index level via [[JapanFG/foreign-bank-branches-japan-index]], Batch H cooperative-system gaps are routed via [[banking/ja-bank-system-japan]] and [[banking/jf-marine-bank-system-japan]], and Batch I public-credit adjacency is routed via [[policy-finance/japan-housing-finance-agency]], [[policy-finance/japan-credit-guarantee-system]], [[policy-finance/national-federation-credit-guarantee-corporations]], [[policy-finance/agriculture-credit-guarantee-system]], and [[policy-finance/fisheries-credit-guarantee-system]]. Future foreign-bank standalone pages should come only from strategic exceptions, not from raw list completion.
