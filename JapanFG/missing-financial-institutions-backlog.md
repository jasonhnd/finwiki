...
| [x] | P3 remaining rows | Other branches | [[JapanFG/foreign-bank-branches-japan-index]] remains the 57-row FSA registry route; promote remaining 6 registry-only rows only when standalone analysis is strategically needed. |
...
| Foreign bank branches | 2026-05-13 | 57 | 57 | Registry/index route completed via [[JapanFG/foreign-bank-branches-japan-index]]; 51 rows have standalone / umbrella wiki routes and 6 rows remain registry-only after P2 strategic exceptions and P3 corridor promotions. | Refresh the registry index when FSA `ginkou.xlsx` changes; standalone pages only for strategic exceptions, not raw list completion. |
...
| Non-life insurers | 2026-04-01 | 57 | 26 | Major, direct / digital, specialty, reinsurance, pet-insurance, outdoor/platform, and telco-linked D3-D5/D8 pages completed; long-tail non-life insurers remain registry-only unless strategically material. | Refresh when FSA `songai.xlsx` changes; standalone pages only for strategic specialty exceptions. |
...
7. Batch D: insurance operating companies. D1-D8 completed for life-insurers, major / direct / specialty non-life insurers, pet / outdoor / telco-linked specialty insurers, and insurance holding-company anchors; FSA 41 life-insurer surface closed at standalone / intentional group-anchor level. Continue with other batches rather than duplicating life-insurer pages.
