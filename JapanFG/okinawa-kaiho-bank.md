...
4. **再編圧力**: 全国的に第二地銀は再編・統合進行中（北日本 FG・きらやか・[[fidea-hd]]・[[jimoto-hd]] 等の事例）→ 沖縄県では海邦銀行は独立維持 ^[inferred]
...
- 「**再編シナリオの蓋然性**」: 県内 3 行 → 2 行への統合（[[okinawa-fg]] が海邦銀行を吸収）は理論上ありうるが、第二地銀協会・沖縄県・米軍基地経済への影響を考えると政治的ハードルが高い ^[speculative]
...
- 沖銀（[[okinawa-fg]]）との将来的経営統合シナリオは存在するか? あるいは独立維持戦略を継続する経営方針か?
