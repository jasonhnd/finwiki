...
> 従業員数・主要株主は最新有価証券報告書 (2025-06 提出予定) 要参照 ^[ambiguous]
...
> [!info] 校核状态
> confidence: **confirmed**（v2.0 公式決算短信ベース 2026-05-19）。FY2024 通期実績・FY2025 通期見通しは公式短信値で確定。**重要訂正 2 件**: ①社名は 2025-10-01 付で「コンコルディア FG」→「横浜フィナンシャルグループ」に変更（証券コード 7186 不変）。②横浜銀行は **TSUBASA アライアンス非加盟**（旧版誤記）。広域連携は千葉銀との「千葉・横浜パートナーシップ」（2019〜）が主軸。従業員数・主要株主の最新値は 2025-06 提出予定の有価証券報告書で要再校核 ^[ambiguous]。
