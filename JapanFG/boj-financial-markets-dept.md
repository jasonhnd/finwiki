...
confidence: likely
tags: [JapanFG, central-bank, internal-bureau, BoJ, money-market, market-operations]
status: active
sources:
...
## Wiki route
This entry sits under [[JapanFG/INDEX|JapanFG index]]. Read it against [[JapanFG/boj-payment-settlement-dept|決済機構局]] for peer-bureau context inside the Bank of Japan, and against [[JapanFG/boj-monetary-policy|BoJ monetary policy]] for the policy-to-operations boundary. For market-mechanics anchoring, route through [[money-market/japan-money-market|Japan money market]] and [[money-market/boj-open-market-operations|BoJ open market operations]].
...
Day-to-day interaction is with eligible counterparties for each operation. The BoJ's own framework recognises tanshi (money-market brokerage) firms as central to short-end intermediation, which is why FMD activity directly conditions the revenue base of [[JapanFG/tokyo-tanshi|Tokyo Tanshi]], [[JapanFG/central-tanshi|Central Tanshi]], and [[JapanFG/ueda-yagi-tanshi|Ueda Yagi Tanshi]].

Other counterparty layers include:

- JGB primary dealers and major securities firms for outright JGB / T-Bill operations.
- Banks and other depository institutions holding BoJ current accounts (see [[JapanFG/boj-payment-settlement-dept|決済機構局]] for the account-infrastructure side).
- Foreign central banks for FX-related funds-supplying operations (cross-border coordination is shared with [[JapanFG/boj-international-dept|国際局]]).
- Internal liaison with the Monetary Affairs Department for policy framing and with the Financial System and Bank Examination Department on counterparty-credit issues, via [[JapanFG/boj-financial-system-dept|金融機構局]].
...
- It distinguishes execution (this bureau) from policy direction ([[JapanFG/boj-monetary-policy|MPM guideline]]), which is a routinely confused boundary in commentary.
