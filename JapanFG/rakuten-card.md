...
aliases: ["Rakuten Card", "楽天カード", "楽天カード株式会社"]
domain: JapanFG
created: 2026-05-21
...
楽天カードは [[JapanFG/rakuten-fg|楽天グループ金融]] のカード issuer / payment touchpoint。楽天市場、楽天ポイント、楽天ペイ、楽天銀行、楽天証券との接続で、カード単体よりも ecosystem finance の中核として読む必要がある。
...
Rakuten Card should not be collapsed into a generic "Rakuten finance" page. It is the consumer-facing credit product that makes the broader group finance loop measurable.
