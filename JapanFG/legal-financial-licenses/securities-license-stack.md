...
aliases:
  ...
  - "Japan FIEA license stack"
  - "Type I Type II FIBO boundary"
  - "金融商品取引業 license stack"
domain: "JapanFG"
...
Use this page with [[JapanFG/legal-financial-licenses/INDEX|JapanFG legal / financial licenses]], [[securities/INDEX|securities domain]], [[securities/financial-instruments-business-operators-japan-index|FIEA operator registry index]], and [[JapanFG/jsda|JSDA]] when a company page needs to say what kind of regulated securities role it is actually playing.
...
| Self-regulation | [[JapanFG/jsda|JSDA]] member lists and rules | Whether the firm is in the dealer self-regulatory route and which conduct / underwriting / solicitation rules may be relevant. | Statutory licensing by itself. |
...
| Investment management | Investment management business | Core route for asset managers such as [[JapanFG/nomura-asset-management|Nomura Asset Management]], [[JapanFG/asset-management-one|Asset Management One]], and [[JapanFG/mufg-asset-management|MUFG Asset Management]]. |
...
| Securities finance | Securities finance company | Relevant to [[JapanFG/japan-securities-finance|Japan Securities Finance]] and margin / lending plumbing. |
...
- [[JapanFG/sbi-securities|SBI Securities]] and [[JapanFG/rakuten-securities|Rakuten Securities]] use online brokerage, NISA acquisition, points / ecosystem linkage, and SOR / PTS execution policies as competitive levers.
- [[JapanFG/mizuho-securities|Mizuho Securities]], [[JapanFG/mufg-mums|MUMSS]], and [[JapanFG/smbc-nikko|SMBC Nikko]] sit inside megabank groups, so entity analysis separate bank balance-sheet activity from securities subsidiary activity.
- [[JapanFG/paypay-securities|PayPay Securities]] and app-embedded brokers require extra attention to whether the app is the broker, an intermediary, or a distribution surface connected to a broker.
- [[JapanFG/monex-group|Monex Group]], [[JapanFG/gmo-click-securities|GMO Click Securities]], and [[JapanFG/dmm-com-securities|DMM.com Securities]] often sit near crypto, FX, CFD, and derivatives boundaries. Check whether the product is spot securities, derivatives, crypto asset, or another regulated category.
- [[JapanFG/jsda|JSDA]] is the self-regulatory layer behind solicitation, underwriting, advertising, customer administration, and off-exchange practice.
