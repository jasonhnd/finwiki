---
title: LBank Exchange — 日本向け海外無登録暗号資産交換業者
aliases:
  - LBank
  - LBank Exchange
  - エルバンク
...
sources:
  ...
  - https://www.fsa.go.jp/policy/virtual_currency02/LBank_keikokushiryo.pdf
  - https://www.fsa.go.jp/policy/virtual_currency/angoushisan_mutouroku.xlsx
  - https://www.lbank.com/
  - https://nextmoney.jp/?p=66527
  - https://nextmoney.jp/?p=59575
---

# LBank Exchange — 日本向け海外無登録暗号資産交換業者 overview
...
- **日本 FSA 警告履歴**:
  - **2024-06-14（令和6年6月14日）— 第 1 回（計 1 回）警告書発出**。金融庁事務ガイドライン（暗号資産交換業者関係 Ⅲ-1-6(2)②）に基づき、無登録で暗号資産交換業を日本国居住者を相手方として行ったとして警告。金融庁公表上、代表者・所在地ともに「不明」として記載。警告書 PDF: `LBank_keikokushiryo.pdf`
...
- **コピートレード**: Copy Trading 機能を提供（リードトレーダー 1,350 人以上、2026-05 時点）
...
- **User Agreement（利用規約）**: 2025-12-18 改訂。違法活動への利用禁止等を規定。運営主体名として「LBK Exchange」が明記されている
...
- [[exchanges/jp-foreign-exchange-mexc]] — MEXC Global（同様の FSA 警告受領済み海外取引所）
...
- [金融庁 暗号資産・電子決済手段関係](https://www.fsa.go.jp/policy/virtual_currency02/index.html)（取得 2026-05-19）
- [LBank Exchangeに対する警告書の発出について（PDF）](https://www.fsa.go.jp/policy/virtual_currency02/LBank_keikokushiryo.pdf)（FSA 公表 2024-06-14、取得 2026-05-19）
- [無登録で暗号資産交換業を行う者の名称等について（Excel）](https://www.fsa.go.jp/policy/virtual_currency/angoushisan_mutouroku.xlsx)（FSA 公表、取得 2026-05-19）
- [LBank 公式サイト](https://www.lbank.com/)（取得 2026-05-19）
- [LBank、無認可業務で日本金融庁から厳しい監視を受ける — NEXTMONEY](https://nextmoney.jp/?p=66527)（公表 2024-06-17、取得 2026-05-19）
- [LBank Labs が 1,000 万ドルの MEME 特別基金を設立 — NEXTMONEY](https://nextmoney.jp/?p=59575)（公表 2023-07-05、取得 2026-05-19）
- [LBank、アルゼンチン代表チームとスポンサー契約を締結 — NEXTMONEY](https://nextmoney.jp/?p=78390)（公表 2025-09-29、取得 2026-05-19）
