---
title: Bithumb（빗썸）— 韓国 KRW spot CEX
aliases:
  - Bithumb
  - 빗썸
  - Bithumb Korea
...
- 商号：주식회사 빗썸코리아（Bithumb Korea Co., Ltd.）
- 設立：2014-01
- 本店所在地：서울특별시 강남구
- 親会社構造：Bithumb Holdings（持株会社）→ Bithumb Korea（事業会社）の 2 層構造
...
- **가상자산사업자 (VASP)** 등록：금융정보분석원（FIU）登録済（2021-09-24 한국 VASP 登録制度初日同日付クラス）
- **ISMS / ISMS-P 認証**：KISA 認証保有（강화 ISMS-P を含む）
- **실명확인 입출금 계정**（実名口座）：**NH 농협은행** との契約（2018 年以降継続）
- 韓国の VASP 登録 2 要件（ISMS + 実名口座）を満たし KRW spot 市場を提供できる **5 社のうちの 1 社**
...
- 一部 USDT pair（限定的）
- 派生・margin 取引：**韓国 VASP 規制下では非提供**（韓国 VASP は spot only に制限）
- staking / lending：限定的サービス（規制制約あり）
- 法定通貨入金チャネル：NH 농협은행 実名口座経由のみ
...
- [[fintech/japan-financial-regulation]] — 日本制度対比
- [[exchanges/fsa-vasp-registration-system]] — 日本 VASP 登録制度対比
