...
- **LINE → LINE Xenesis (BITMAX)** — LINK → Finschia → KAIA token 連携で出発したが、2026-06 サービス全面終了予定。LY Corp 戦略撤退の象徴。[[exchanges/jp-exchange-line-xenesis]]
...
来源: 公開情報整理 (各 CEX/ポイント発行体 IR・利用規約、JVCEA 自主規制公表、楽天/SBI/PayPay/メルカリ各社プレスリリース)
