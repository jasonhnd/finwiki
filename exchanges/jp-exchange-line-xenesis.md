...
- 銘柄数・機能の限定性から、業界内でのポジションはリテール・初心者向けのニッチプレイヤーと位置付けられる。bitFlyer・Coincheck・GMOコインら大手との差別化軸は「LINE エコシステム内での手軽さ」であった
- サービス終了発表後、競合他社（Coincheck 等）がユーザー取り込みを目的とした移行キャンペーンを展開した
