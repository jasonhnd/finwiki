...
- **Bitstamp UK** — 2022 認可
- **Gemini UK** — 認可
- **Binance UK** — 2024 撤退 (FCA 警告・consumer redress 不足後)
- **eToro UK** — 認可
- **総数 ~50 社** (2026-05 時点 · 公開 FCA register · cryptoasset firms list)

## 4. 2024 Financial Promotion Regulation

2023-10 施行・2024 enforcement 強化。暗号資産マーケティング・広告は (a) FCA 認可業者 (b) s21 FSMA exemption 経由 (c) 認可業者による approval のいずれか経由のみ可能。リスク警告義務 + **cooling-off period 24 時間** (新規顧客は申込後 24h 待機必須) + appropriateness assessment 義務。**2024-04 違反業者多発** → FCA enforcement notice 発出強化、海外無登録業者への警告も増加。

## 5. 戦略的位置づけ

Brexit 後の独自路線で EU MiCA より柔軟 (AML 中心の軽い枠組み) だが包括規制範囲は狭い。米国 FinCEN MSB 登録に近い構造 (連邦 AML のみ + 州別ライセンス未整備に相当)。2027 完全規制移行で EU MiCA との互換性向上見込み (passporting 復活の議論あり)。機関投資家 hub としてロンドンの地位回復を狙い、stablecoin 規制と custody 規制を先行整備する戦略。
