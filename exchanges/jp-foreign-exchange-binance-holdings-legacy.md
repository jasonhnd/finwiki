...
以下は金融庁の無登録業者警告一覧と JVCEA の現行会員一覧に基づく、日本での規制上の区別である。Binance Holdings Limited のグローバル法人所在地やグループ内資本関係をこの表から推定しない。 ^[Sources: https://www.fsa.go.jp/policy/virtual_currency02/index.html; https://jvcea.or.jp/member/.]

| 項目 | Binance Holdings Limited（本エントリ） | Binance Japan 株式会社 |
|------|----------------------------------------|------------------------|
| 日本での対象法人 | 金融庁警告書に記載された海外法人 | JVCEA 現行会員一覧に掲載される日本法人 |
| FSA 対応 | 2018年3月23日と2021年6月25日に無登録業者として警告 | 暗号資産交換業 関東財務局長 第00031号 |
| 本稿での扱い | 歴史的な無登録警告の記録 | 現役法人は別エントリ [[exchanges/jp-exchange-binance-japan]] |
...
金融庁の警告資料は Binance Holdings Limited が警告日時点で日本居住者を相手方として無登録で暗号資産交換業を行っていたと記載する。本稿では同資料から銘柄数や日本向けの商品範囲を推定しない。

## 4. 業務範囲（日本居住者向け・無登録期間中）

金融庁の警告資料は商品・入出金機能を列挙する資料ではない。本稿では警告日時点の無登録営業という規制事実に範囲を限定し、当時の商品一覧を固定しない。

## 5. 市占・存在感（無登録期間中）

金融庁の警告資料には、日本居住者の利用者数・取引高・市場シェアを同業他社と比較できる数値が含まれない。警告回数を市場規模の代理指標にせず、グローバル順位も推定しない。
...
- **2018〜2020年**: 本項では金融庁が確認した警告事実を中心に扱い、日本居住者の利用規模やマーケティング状況は推定しない
...
上記の米国当局による制裁・和解は、グローバル Binance Holdings Limited を対象としたものであり、Binance Japan 株式会社の金融庁登録とは法人・手続を区別する。

## 7. 歴史的意義・位置付け

日本で確認できる規制上の節目は、Binance Holdings Limited に対する 2018年・2021年の警告と、別法人である Binance Japan 株式会社の登録である。本稿では警告が法人化の動機になったか、他社と比べて唯一の事例かを推定しない。
