...
- **SBI グループ内の法人関係**：SBI 証券（金商 第44号、JVCEA #1041）・SBI FXトレード（金商 第2635号、JVCEA #1026）は同グループ傘下の金融商品取引業者である。法人関係だけからサービス連携や統合を推定しない。SBI ホールディングスは Ripple Labs（XRP 関連）への出資・提携関係を持つ。
