...
aliases:
  ...
  - "Japan crypto exchange overview"
  - "日本暗号資産交換業 overview"
domain: "exchanges"
created: 2026-05-19
...
confidence: likely
tags: [exchanges, Japan, VASP, FSA, JVCEA]
status: active
sources:
...
日本の暗号資産交換業は、金融庁・財務局の登録制と [[exchanges/jvcea-self-regulatory-overview|JVCEA]] 自主規制の二層で成り立つ。2017-04-01 に暗号資産交換業登録制が始まり、2023-06-01 には電子決済手段等取引業も制度化された。2026-02-28 時点の金融庁英語版登録一覧では暗号資産交換業者は 27 業者。国内市場は「登録 VASP + JVCEA 会員 + FSA 監督 + 税務報告/CARF」まで含めて見る必要がある。
...
| 金融グループ系 | [[exchanges/jp-exchange-sbi-vc-trade|SBI VC Trade]], [[exchanges/jp-exchange-gmo-coin|GMO Coin]], [[exchanges/jp-exchange-rakuten-wallet|Rakuten Wallet]] | 証券・FX・銀行グループ接続 |
| 海外系日本法人 | [[exchanges/jp-exchange-binance-japan|Binance Japan]], [[exchanges/jp-exchange-okcoin-japan|OKJ]], [[exchanges/jp-exchange-osl-japan|OSL Japan]] | 日本法人化・登録取得が entry gate |
...
| 機関向け・特殊 | [[exchanges/jp-exchange-crypto-garage|Crypto Garage]], [[exchanges/jp-exchange-digital-asset-markets|Digital Asset Markets]], [[exchanges/jp-exchange-jpyc|JPYC]] | custody, RWA, EPI-adjacent |

JVCEA 会員ページでは、第一種会員数と業務種別（暗号資産交換業、暗号資産デリバティブ取引業、電子決済手段等取引業）が確認できる。金融庁登録一覧は「登録番号・業者名・所在地・取扱暗号資産」を見る一次ソース。

## 3. Strategic reading

- **登録制が moat**: 日本居住者向けサービスは登録が前提。海外大手は無登録状態で警告を受けるか、日本法人を買収・設立して登録を取るかの二択になる。
- **銘柄数と安全性の trade-off**: JVCEA 銘柄審査は国内上場銘柄を制限し、海外 CEX より商品数を抑える一方、投資者保護と市場健全性を優先する。
- **販売所 economics**: 国内個人市場では販売所スプレッドが収益源になりやすく、取引所板の厚み・手数料競争とは別に見る必要がある。
- **金融グループ接続**: SBI、GMO、楽天、Monex、メルカリ等は、証券・FX・銀行・ポイント・EC との cross-sell が強み。
- **stablecoin / EPI adjacency**: 2023-06-01 以降は電子決済手段制度が別レイヤーとして立ち、暗号資産交換業と stablecoin 仲介の境界が重要になる。
...
- 登録制は投資者保護に有効だが、銘柄上場速度とプロダクト多様性では海外市場に劣りやすい。
- JVCEA 会員数と金融庁登録業者数は一致しない。現物、デリバティブ、電子決済手段等取引業の区分を混同しない。
- 登録業者でも流動性・セキュリティ・親会社信用・停止/廃業リスクは個別に異なる。

## Open questions

- 金商法移行・申告分離課税の議論は、現物 VASP の収益構造をどう変えるか。
- 国内 CEX は EPI / stablecoin / deposit token とどのように接続するか。
- 海外系日本法人は、登録取得後にグローバル流動性をどこまで日本市場に持ち込めるか。
...
- FinWiki P3 graph repair inbound: [[JapanFG/ssnb]]

---

> [!info] 校核状态
> confidence: **likely**。登録業者数・制度時点は変動しやすいため、次回更新時は金融庁 PDF と JVCEA 会員ページを再確認する。
