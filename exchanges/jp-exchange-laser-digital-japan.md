---
title: Laser Digital Japan — 日本暗号資産交換業者
aliases:
  - Laser Digital Japan
  - レーザーデジタルジャパン
  - LDJ
...
sources:
  ...
  - https://coinpost.jp/?p=655580
  - https://coinpost.jp/?p=685975
...
| 2026-01-22 | Bitcoin Diversified Yield Fund SP（BDYF）開始（Adoption Fund からアップグレード）。 |
| 2026-01-27 | 米国で National Trust Bank（LDNTB）設立に向けた OCC への de novo 申請を発表。 |
| 2026-01-30 | 野村 HD FY3Q 決算で、レーザー・デジタルの digital asset 関連事業で損失計上。「中長期育成」方針は堅持と説明。 |
...
- **野村グループ digital asset 戦略の中核**: Crypto Garage（野村 × MUFG × エスビーアイ JV 系）とは異なり、Laser Digital は野村 HD が 100% 直接設立・保有するグローバルデジタル資産専業子会社。グループ全体として機関向けトレード・AM・カストディの生態系構築を推進。
- **Komainu との役割分担**: Komainu（2018 年設立、野村 × CoinShares × Ledger の JV）はカストディ・インフラ担当。Laser Digital は取引・資産運用担当。Komainu Board に Laser Digital の Steve Ashley・Jez Mohideen（CEO）が参画し、両社の密接な連携体制を示す。
...
- **Hideaki Kudo（工藤英明）**: Laser Digital Japan 代表取締役（Representative Director）。2026-02 の AML PoC 発表コメントで名前が公表。
- **Jez Mohideen**: Laser Digital（グループ）CEO。Komainu Board にも参画。
- **Steve Ashley**: Laser Digital Board Member。Komainu Board にも参画。
- **野村ホールディングス森内博之 CFO**: 2026-01-30 決算 Q&A でレーザー・デジタルの損失・リスク管理方針について説明。

## Related

- [[exchanges/jp-exchange-crypto-garage]] — 同じ野村 HD グループ系の暗号資産関連 entity（Crypto Garage）
...
- [[exchanges/jp-custody-komainu]] — Komainu institutional custody（連携）
- [[exchanges/jvcea-type2-associate-membership-system]] — JVCEA Type 2 associate membership 制度
- [[exchanges/global-cex-prime-brokerage-layer]] — グローバル CEX プライムブローカレッジレイヤー
...
- [Komainu About Us — 設立・Board 情報](https://komainu.com/about/)（取得 2026-05-18）
