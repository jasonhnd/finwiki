---
title: Orca Whirlpools — Solana 系集中流動性 AMM
aliases:
  - Orca
  - Orca Whirlpools
  - ORCA token
...
sources:
  ...
  - 公開情報整理 (DefiLlama Orca TVL/Volume データ, 2024-2026)
  - 公開情報整理 (Solana Foundation エコシステム発表)
  - 公開情報整理 (Orca foundation governance forum 発信)
---

# Orca Whirlpools — Solana 系集中流動性 AMM overview
...
> 2021-02 ローンチ · ORCA token · concentrated liquidity AMM (Whirlpools, Uniswap v3 類似) · retail UX 重視
...
| token 経済 | ORCA staking fee share | RAY buy-back |
...
- [[exchanges/solana-ecosystem-dex-comparison]] — Solana DEX 群比較（最重要 cross-link）
