---
title: マネックス株式会社 — 日本暗号資産デリバティブ取引業者
aliases:
  - MONEX Inc.
  - マネックス証券
  - Monex Securities
...
> FSA 登録番号 関東財務局長（金商）第165号 · JVCEA 会員 #1024 · 暗号資産デリバティブ取引のみ（spot 取引は子会社 Coincheck が担当）
...
- [[exchanges/jp-exchange-coincheck]]（子会社）：**spot 暗号資産交換業**（FSA 登録番号 00014、JVCEA #1017）
- Monex, Inc.（米国子会社）：米国証券業

マネックス株式会社は暗号資産交換業者（spot 取引）ではなく、暗号資産 CFD（差金決済）を金融商品取引業として提供する。当社自身のサイトにも「当社は、暗号資産交換業者ではなく、暗号資産取引を提供していません。」と明示されている。

## 2. 牌照・登録状況

- **金融商品取引業**: 関東財務局長（金商）第165号
- **JVCEA 会員種類**: 第一種会員 #1024（**暗号資産デリバティブ取引のみ**）
- **暗号資産交換業**: なし（spot 交換業の登録なし）
...
- spot 取引・現物保管・ウォレット・ステーキング等は提供なし
...
- **2019年**: コインチェック株式会社（2018 年 NEM 流出事件後）を買収。マネックスグループ傘下に組み込み、暗号資産 spot 事業はコインチェックが担う体制に
...
- [[exchanges/jp-exchange-coincheck]] — グループ内 spot 暗号資産交換業子会社（JVCEA #1017）
...
- [[securities-firms/monex-group]] — マネックスグループ親会社プロファイル
