...
- 機関・主権国家向け **cold custody + offline signing** 専業
...
### 株式会社 Ginco (国内独立系)
- 2017 設立 · 創業者 森川夢佑斗 · 2026-04 代表交代 → 坂根遼 [[exchanges/jp-custody-ginco]]
- **Ginco Enterprise Wallet (MPC)** + Ginco Node 提供
...
|---|---|---|---|
| 技術 | Cold + offline signing | MPC SaaS + ノード提供 | MPC + policy + workflow |
| 主顧客 | 機関・主権国家 | 国内 VASP / 金融機関 | 数千機関規模 (グローバル) |
| 課金 | 月額 / AUM ベース | ライセンス / per-tx | Subscription |
| 親会社 | 野村 HD 系 (海外法人) | 国内独立系 | 海外 vendor (米 NY) |

## 規制位置づけ

三社いずれも **FSA 暗号資産交換業登録なし** (B2B インフラのため不要) · [[exchanges/fsa-vasp-registration-system|JVCEA 非加盟]] · 顧客側 VASP のライセンスに依存する vendor 層として機能する。

## 競合層 (海外比較)

Anchorage / Coinbase Custody / BitGo / Fidelity Digital Assets — いずれも国内未進出、または提携経由 (例: BitGo × Mitsui)。機関向け純カストディは依然として [[exchanges/jp-exchange-crypto-garage]] のような Daiwa / SBI 系 Securities Token 接続事業との重複領域でも展開している。

---
来源: 各社公式コーポレートサイト · 日経 / ITmedia · 各社 IR 報道
