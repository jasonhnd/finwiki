...
- GitHub Release 的 title 只使用日文；body 必须日文在前、中文在后，并写清楚发布范围、主要变更、验证结果、已知注意事项和下一步。
...
- GitHub Release の title は日本語のみとします。body は必ず日本語を先に置き、その後に中国語を置き、公開範囲、主要変更、検証結果、既知の注意点、次の作業を明記します。
