...
このため、FinWiki では `bny-mellon-trust-bank` を独立ページとして量産せず、本ページを [[foreign-financial-institutions/foreign-bank-branches-japan-index|foreign-bank branch registry]] と [[trust-banks/trust-companies-japan-index|trust-company registry]] の umbrella route として扱う。必要な場合だけ、本節から [[trust-banks/master-trust-bank|日本マスタートラスト信託銀行]] や [[trust-banks/custody-bank|日本カストディ銀行]] との custody / trust-bank 比較に進む。
