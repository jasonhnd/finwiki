...
This entry sits under [[JapanFG/INDEX|JapanFG index]]. Read it against [[card-issuers/jcb|JCB]] for peer / contrast context (両者とも 3-party 系・プレミアム志向) and [[payments/japan-card-issuer-acquirer-processor-split|Japan card issuer / acquirer / processor split]] for the broader system / regulatory boundary.
...
| Group boundary | [[trust-banks/sumitomo-mitsui-trust|三井住友トラスト・グループ]] 系列 — 歴史的にシティバンクからの日本事業移管経緯 |
...
- [[card-issuers/jcb|JCB]] (相互利用提携・プレミアム競合)
- [[payment-firms/american-express-international-japan|American Express International Japan]] (3-party 同類・最大の直接競合)
...
- [[card-issuers/smbc-card]] (グループ内別ブランド issuer・Vパスワード Olive 主軸)
