...
- **メルカリ売上 → メルペイ残高 → メルコイン購入 / メルカード決済**: 単一ウォレットで EC・決済・暗号資産・与信が完結する垂直統合（決済・後払いの規制実行主体は資金移動業者 [[payment-firms/merpay|メルペイ (Merpay)]]）
