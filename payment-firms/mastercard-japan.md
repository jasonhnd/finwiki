...
国内に **直接の card issuance license** や **acquirer license** を持たない (=割賦販売法上の登録カード発行業者ではない) ため、METI Installment Sales Act 登録業者リストには載らない — これが [[card-issuers/jcb|JCB]] や Amex とは異なるレギュレーション境界。
