...
| License route | 資金移動業者（funds-transfer, 資金決済法）; FSA 関東財務局長 第00039号（2015-08 登録） |
| Parent / group | Western Union group（foreign parent） |
| Main lanes | 国際送金、エージェント網、cash receipt / payout |
| Home | 東京・港区虎ノ門 |
| Wiki role | Western Union の日本 funds-transfer 実体ページ |
