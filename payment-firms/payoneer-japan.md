...
| License route | 第二種資金移動業者（funds-transfer, 資金決済法）; FSA 関東財務局長 第00045号 |
| Parent / group | Payoneer Global Inc.（米、foreign parent） |
| Established | 2015 年 |
| Main lanes | Marketplace payouts、business payments、収納代行、cross-border funds management |
| Wiki role | Payoneer の日本 funds-transfer 実体ページ |
...
Payoneer はグローバル・プラットフォームとして語られがちだが、日本のコンプライアンスとプロダクト分析は **登録された日本実体（第二種資金移動業者）** を参照すべき。foreign parent の日本 subsidiary が funds-transfer license で operating する典型例を固定する。
