...
2. **Shinkin joint center (shared core-banking use)**
   ...
   - Large shinkin banks such as [[JapanFG/kyoto-chuo-shinkin|京都中央信用金庫]] and [[JapanFG/osaka-shinkin|大阪信用金庫]] may have independent core systems, but many mid-sized and smaller shinkin banks depend on the joint center.
...
### Division of roles with [[JapanFG/shinkin-central|信金中金]]
...
### Division of roles with [[JapanFG/zenshin-kyo|全信協]]
