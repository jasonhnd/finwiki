...
fidelity: ok
title: "au Payment"
translated_at: 2026-05-31T11:13:44.880Z
---
...
au payment is[[JapanFG/au-fh|auフィナンシャルHD]]payment operating company. The official company profile shows funds transfer business, prepaid payment instrument issuing business, au PAY, financial product intermediary, bank agency, insurance intermediary/agent, etc., and is a corporation that connects prepaid derived from WebMoney and au PAY wallet.

## 1.Corporation/License Boundary

| Item | Reading |
|---|---|
| Legal entity | au Payment Co., Ltd. |
| Group |[[JapanFG/au-fh|au Financial Holdings]] |
| Main lanes | au PAY, prepaid / WebMoney heritage, funds transfer, financial-product intermediation |
| FSA registry route | FSA funds-transfer list: Kanto Local Finance Bureau第00053号, au Payment Co., Ltd. |
...
- Officially announced merger planning with au Financial Service for2026-07-01, so the boundary is a watch item.
