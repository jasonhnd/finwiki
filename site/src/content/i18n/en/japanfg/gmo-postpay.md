...
| Group | GMO Internet Group; sibling / affiliated relationship with [[JapanFG/gmo-payment-gateway|GMO Payment Gateway]] |
...
The [[JapanFG/gmo-payment-gateway|GMO Payment Gateway]] page focuses on card-payment PSP functions. Keeping deferred payment on a separate operating-entity page for [[JapanFG/gmo-postpay|GMO Payment Service]] makes the PSP, post-payment, and convenience-store collection boundaries explicit.
