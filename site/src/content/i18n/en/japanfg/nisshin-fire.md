...
status: machine
fidelity: ok
title: "Nisshin Fire & Marine Insurance"
...
| Item | Notes |
|---|---|
| Legal name | Nisshin Fire & Marine Insurance Co., Ltd. |
...
| Group boundary | Tokio Marine group adjacency |
| Wiki role | Specialty / group non-life operating company |

## 2. Operating Model

Nisshin Fire has an operating surface different from Tokio Marine group's main non-life brand and direct brand. A standalone page is needed when reading SME / regional / agency channels, niche products, and group-brand segmentation.
...
- Nisshin Fire official company information.
