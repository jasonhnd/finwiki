...
- **atone** is a month-end BNPL wallet based on consumer accounts, allowing "next-month convenience-store payment" across merchants (UX close to [[JapanFG/paidy|Paidy]], but with an independent brand and ecosystem). ^[extracted]
