...
SoftBank Group Corp. (TSE PRIME 9984)
  ...
  +-- SoftBank Corp. (TSE PRIME 9434; core telecom business)
        ...
        +-- PayPay Financial Group ([[JapanFG/paypay-fg]])
        |     +-- [[JapanFG/paypay|PayPay Corp.]] -- QR-code payments
        |     +-- [[JapanFG/paypay-bank|PayPay Bank]] -- internet bank
        |     +-- [[JapanFG/paypay-card|PayPay Card]] -- card issuer
        |     +-- [[JapanFG/paypay-securities|PayPay Securities]] -- securities
        +-- **SB Payment Service** (this page; PSP)
        +-- Other financial subsidiaries, including finance and leasing
```

### Division of roles: SBPS vs [[JapanFG/paypay-fg|PayPay Financial Group]]
...
| PSP market share | One of the major domestic PSP operators, alongside [[JapanFG/gmo-payment-gateway|GMO Payment Gateway]] and [[JapanFG/digital-garage|Digital Garage / VeriTrans]] |
...
- **[[JapanFG/gmo-payment-gateway|GMO Payment Gateway]]** (TSE PRIME 3769; largest dedicated PSP)
- **[[JapanFG/digital-garage|Digital Garage / VeriTrans]]** (TSE PRIME 4819; media + PSP operator)
...
- [[JapanFG/paypay-fg]] ? group sibling and B2C financial group
- [[JapanFG/paypay]] ? QR-payment merchant linkage
- [[JapanFG/paypay-bank]] ? group bank
- [[JapanFG/paypay-card]] ? group card issuer
- [[JapanFG/gmo-payment-gateway]] ? major PSP competitor within [[JapanFG/INDEX]]
- [[JapanFG/digital-garage]] ? major PSP competitor
- [[JapanFG/au-fh]] ? telecom financial-group peer
- [[JapanFG/ndfg]] ? telecom financial-group peer
