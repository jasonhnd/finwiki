...
status: machine
fidelity: ok
title: "Aflac Life Insurance (Aflac Japan)"
translated_at: 2026-05-31T07:28:06.130Z
---

# Aflac Life Insurance (Aflac Japan)

## Wiki route

This entry sits under [[life-insurers/INDEX|life-insurers INDEX]]. Read it against [[life-insurers/prudential-japan|Prudential Gibraltar Financial (Prudential Japan)]] for peer / contrast context and [[insurance/INDEX|insurance index]] for the broader system / regulatory boundary.
...
**Official name**: Aflac Life Insurance Co., Ltd. ^[extracted]  
**English name**: Aflac Life Insurance Japan Ltd.  
**Parent company**: Aflac Incorporated (NYSE: AFL, headquartered in Columbus, Georgia, USA; Fortune 500 company and S&P 500  constituent) ^[extracted]  
...
### Aflac group overall (FY2024 , based on parent-company 10-K) ^[extracted]

| Item | Amount (USD) |
|---|---|
| Revenue (Total revenues) | about 192 億 |
| Net earnings | about 56 億 |
| Total assets | about 1,200 億 |
| Japan-segment premium income | More than 6  tenths of group revenue (Japan is the core market) |

> The Japan segment (Aflac Japan) is the main pillar of Aflac Incorporated's earnings and premiums. The U.S. segment (Aflac U.S.) centers on supplemental insurance sold through the workplace, forming a two-pillar structure. ^[extracted]
...
Aflac Incorporated (US holding company, NYSE: AFL)
  ...
  ├── American Family Life Assurance Company of Columbus (Aflac U.S.) ── US workplace distribution
  ├── American Family Life Assurance Company of New York
  └── Indirectly held under the holding structure: investment subsidiaries and reinsurance subsidiaries (Cayman, etc.)
```
...
|---|---|
| **Cancer insurance** | Core products originating in Japan's first cancer insurance (launched 1974-11 ). Includes the "Cancer Insurance for Living" series, whole-life cancer insurance, cancer insurance for younger customers, products for women, etc. |
| **Medical insurance** | "Medical Insurance EVER That Truly Responds," income-support / disability-style products, etc. In the third sector, cross-selling of cancer + medical products is central. |
| **Nursing-care insurance** | "Aflac Nursing-Care Insurance" (linked to the public long-term-care insurance system) |
| **Life / whole-life products** | "WAYS, the insurance where your future self decides" and "Aflac whole-life insurance for anyone" (no-medical-disclosure type), etc. |
| **Educational / savings** | Savings-oriented products such as "Aflac Dreaming Children's Education Insurance" |

### Historical timeline ^[extracted]
...
- **Digital direct sales**: strengthening "Aflac Direct" (fully online model) to capture younger customers and second policies
- **Agency platform**: tablets for agents, electronic-contract infrastructure
- **Contact-center AI**: AI-powered inquiry handling and contract-lookup automation
- **US-parent digital investment**: Aflac Incorporated as a whole has been expanding AI / cloud budgets (10-K disclosure)
...
- **Primary regulator**: Financial Services Agency (FSA) — registration and supervision under Japan's Insurance Business Act
- **US parent company**: SEC / NAIC / Georgia Office of Insurance
...
- **Tokio Marine & Nichido Anshin Life** ([[non-life-insurers/tokio-marine|tokio-marine-hd]] group)
...
- **Dai-ichi Life HD press release**: "Regarding the strategic business and capital alliance with Aflac Incorporated" (2018-07-12)

---

> [!info] Review status
> confidence: **likely** (constructed only from public information in Wikipedia, the US parent 10-K, Dai-ichi Life HD press releases, and Aflac Japan's official history, with 2026-05-19 review). Detailed standalone financials for the Japanese subsidiary are disclosed via the Japan segment of Aflac Incorporated, so yen-denominated company-specific figures may change over time. Dai-ichi Life's approximately 7% voting-rights basis reflects the plan at the time of 2018-07-12 disclosure; the current holding ratio should be verified separately.
