...
| Layer | Entity | Role |
|---|---|---|
| **External-facing bank (main bank)** | [[megabanks/sumitomo-mitsui-banking-corp|SMBC]] (within [[megabanks/smfg|SMFG]]) | Commercial banking / external financial services |
| **External-facing trust** | [[trust-banks/smtb|SMTB]] (Sumitomo Mitsui Trust) | Trust / fiduciary / pension |
| **External-facing leasing (JV)** | [[leasing-firms/smfl|SMFL]] | SMFG + Sumitomo Corporation JV; equipment / environment / overseas / real estate / aircraft |
...
| Segment | Content |
|---|---|
| **CMS (cash management service)** | Settlement concentration / cash pooling for Sumitomo Corporation group companies |
...
|---|---|---|
| Sumitomo Corporation | **Sumitomo Corp FM (this page)** | [[leasing-firms/smfl|SMFL]] (SMFG JV) |
...
| Itochu | [[trading-company-finance/itochu-finance|伊藤忠ファイナンス]] | [[leasing-firms/tokyo-century|東京センチュリー]] (Mizuho JV, listed) |
...
- **Supervisor**: FSA (money-lending / FX-business related)
- **Regulatory points**:
  - **Transfer pricing** on intra-group financial transactions
...
- **Recent policy points**:
  - 2024 to [[financial-regulators/boj-monetary-policy|日銀政策金利正常化]] → reassessment of intra-group interest charging
  - Strengthening of AML/CFT on overseas remittance / cross-border fund movement

## Related

- [[leasing-firms/smfl|SMFL]] (external-facing leasing, SMFG JV)
- [[megabanks/smfg|SMFG]] (main-bank group)
...
- Sumitomo Corporation official IR / integrated report (list of group companies)
...
> confidence: **tentative** (based on public information, 2026-05-24). Sumitomo Corp FM is an unlisted subsidiary with limited external disclosure. The latest scope of business / list of subsidiaries should be checked against the affiliated-companies list in Sumitomo Corporation's securities report. Because its internal integration with SMFG / SMFL runs deep, its presence as an independent subsidiary may be relatively thinner than that of other trading houses. **The parent trading-house page `sumitomo-corp.md` has not been created → planned to be added to the backlog in the future**.
