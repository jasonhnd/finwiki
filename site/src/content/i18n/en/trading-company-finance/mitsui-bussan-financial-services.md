...
| Layer | Entity | Role |
|---|---|---|
| **Outward-facing bank (main bank)** | [[megabanks/sumitomo-mitsui-banking-corp|SMBC]] (within [[megabanks/smfg|SMFG]]) | Commercial banking / external financial services |
| **Outward-facing trust** | [[trust-banks/smtb|三井住友信託銀行 (SMTB)]] | Trust / fiduciary / pension |
| **Outward-facing leasing** | [[cooperative-banks/ja-mitsui-leasing|JA三井リース]] | JV of Mitsui & Co. + Norinchukin + Sumitomo Mitsui Trust, agriculture + general leasing |
...
| Segment | Content |
|---|---|
| **CMS (cash management service)** | Settlement concentration / cash pooling / intra-group transfers for Mitsui & Co. group companies |
| **Bulk factoring** | Purchase of trade receivables / payment agency for group companies |
| **Group finance** | Short-term / mid-term loans to intra-group companies |
| **FX / interest-rate risk-hedge intermediation** | Derivatives intermediation for group companies |
| **Overseas remittance services** | Overseas remittance / collection for group companies |
| **Commodity-trading-attached finance** | Credit / hedge intermediation tied to Mitsui & Co.'s own commodity trading in iron ore, crude oil, LNG, copper, etc. |
...
|---|---|---|
| Mitsui & Co. | **Mitsui & Co. FS (this page)** | [[cooperative-banks/ja-mitsui-leasing|JA三井リース]] (Mitsui + Norinchukin) |
...
| Toyota Tsusho | [[trading-company-finance/toyota-tsusho-finance|豊田通商フィナンス]] | Intra-group captive |
| Sojitz | [[trading-company-finance/sojitz-finance|双日フィナンス]] | No dedicated arm |

## 4. Regulation / policy

- **Supervisor**: Financial Services Agency (moneylending / FX-business related)
- **Regulatory issues**:
  - **Transfer-pricing taxation** of intra-group financial transactions (transaction pricing with overseas subsidiaries)
  - Boundary clarification of group factoring against the **Installment Sales Act / Money Lending Business Act**
  - **Intra-group transaction elimination** in consolidated accounting
...
- [[cooperative-banks/ja-mitsui-leasing|JA三井リース]] (outward-facing leasing, same Mitsui & Co. group)
- [[megabanks/sumitomo-mitsui-banking-corp|SMBC]] (main bank)
...
- Mitsui & Co. official IR / integrated report (list of group companies)
...
> confidence: **tentative** (public-information based 2026-05-24). Mitsui & Co. FS is an unlisted 100% subsidiary with limited external disclosure. The latest scope of business / subsidiary list should be checked against the affiliated-companies list in Mitsui & Co.'s Securities Report. Its positioning as a typical trading-company group-treasury arm is certain. **The parent trading-company pages `mitsui-co.md` / `mitsui-bussan-corp.md` have not been created → planned to be added as backlog in the future**.
