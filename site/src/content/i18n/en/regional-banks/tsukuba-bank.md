...
This entry sits under [[regional-banks/INDEX|regional-banks INDEX]] (its domain route). Read it against [[regional-banks/joyo-bank|常陽銀行]] for the same-prefecture peer / contrast (Ibaraki lead regional bank vs second channel), and against [[financial-regulators/fsa|the FSA]] plus [[banking/INDEX|banking]] for the supervisory / system boundary.
...
| Item | Notes |
|---|---|
| Legal name | 株式会社筑波銀行 / Tsukuba Bank, Ltd. |
| License route | bank license under the Banking Act (regional bank / first-tier regional bank); FSA bank license list |
| Group boundary | Independent regional bank; for the SBI alliance context, read together with [[megabanks/sbi-regional-bank-hd|SBI 地銀ホールディングス]] |
| Formed | 2010-03-01（Kanto Tsukuba Bank absorbed Ibaraki Bank by merger） |
| Home market | Ibaraki / Tsuchiura（土浦市本店・つくば本部） |
| Wiki role | Ibaraki regional-bank operating-company page |

## 2. Operating model

Tsukuba Bank is a regional bank that, centered on Ibaraki Prefecture, handles retail deposits, SME finance, local business support, and regional-consulting services. It faces the same Ibaraki market as [[regional-banks/joyo-bank|常陽銀行]], but Tsukuba Bank is organized as a standalone bank-license entity. For regional-bank consolidation trends in northern Kanto, see [[regional-banks/mebuki-fg|めぶきフィナンシャルグループ]] and [[banking/regional-bank-consolidation-pattern|地域銀行統合パターン]].

## 3. Why this page matters

- Pins down the legal-name exact page in the FSA bank license list (Banking Act) (previously referenced only via regional-bank / SBI-alliance context).
- Becomes a useful peer for [[regional-banks/joyo-bank|常陽銀行]] and northern-Kanto regional-bank consolidation notes.
- Separates the FSA licensed bank from group strategy pages (such as [[regional-banks/mebuki-fg|めぶきFG]]).
...
- Tsukuba Bank official company profile.
- 筑波銀行 (Wikipedia): formed 2010-03-01 (Kanto Tsukuba Bank absorbed Ibaraki Bank); HQ Tsuchiura, head-office functions in Tsukuba.
