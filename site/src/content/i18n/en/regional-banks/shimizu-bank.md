...
This entry sits under [[regional-banks/INDEX|regional-banks INDEX]]. Read it against [[regional-banks/shizuoka-bank|静岡銀行]] for peer / contrast context and [[banking/INDEX|banking index]] for the broader system / regulatory boundary.
...
- Corrects prior wiki references that routed Shimizu Bank through the wrong group boundary.
- Closes the FSA exact-name page for Shimizu Bank.
