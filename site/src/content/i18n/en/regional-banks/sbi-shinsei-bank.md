...
This entry sits under [[regional-banks/INDEX|regional-banks INDEX]]. Read it against [[regional-banks/aozora-bank|あおぞら銀行 (Aozora Bank)]] for peer / contrast context and [[banking/INDEX|banking index]] for the broader system / regulatory boundary.

## TL;DR

An ordinary bank that went through the sequence of the **former Long-Term Credit Bank of Japan (LTCB) → 1998-10  management collapse → temporary nationalization → 2000  sale to the Ripplewood consortium → renaming to "Shinsei Bank" and rehabilitation**, and then, with **the completion of SBI HD [[megabanks/sbi-hd]]'s TOB in 2023-09  making it a wholly-owned subsidiary and delisting it, changed its trade name to "SBI Shinsei Bank" in 2023-12 **. It is the banking core of the "**4 th megabank concept**" advocated by SBI HD. The biggest management issue is the **unrepaid public funds from the nationalization of the former LTCB (on the order of 3500 億円)**. A 3 -axis business of retail (Shinsei + Aplus Financial) + corporate lending + real-estate / structured finance. ^[extracted]

## 1. Company profile

**Legal name**: SBI Shinsei Bank, Limited ^[extracted]
**English name**: SBI Shinsei Bank, Limited
**Securities code**: former TSE PRIME 8303 (relisted 2004-02  → **delisted 2023-09 **) ^[extracted]
**Established**: 1952-12 (as the Long-Term Credit Bank of Japan) ^[extracted]
**Current-entity history**: renamed "Shinsei Bank" 2000-06  → trade name changed to "SBI Shinsei Bank" 2023-12  ^[extracted]
**Parent company**: SBI Holdings [[megabanks/sbi-hd]] (consolidated subsidiary; effectively 100%) ^[extracted]

### Specificity of its business type ^[extracted]
...
- Sibling lineage: [[regional-banks/aozora-bank]] (the former Nippon Credit Bank, likewise nationalized → private rehabilitation group)
- The "3 行 long-term credit banks": former IBJ (→ Mizuho Corporate / [[megabanks/mizuho-fg]]) / former LTCB (→ Shinsei) / former NCB (→ Aozora) — of which 2 行 collapsed and were nationalized
...
| **2021-09** | **SBI HD [[megabanks/sbi-hd]] launched a TOB** (led by Yoshitaka Kitao, positioning it as the core bank of the "4 th megabank concept") |
| **2022-04** | As a result of the TOB, SBI HD's holding reached **approx. 47%** (effectively acquiring management control) |
| **2023-09** | **Made a wholly-owned subsidiary (SBI HD 100%) → delisted** ^[extracted] |
| **2023-12** | **Trade name changed to "SBI Shinsei Bank"** ^[extracted] |

### The unrepaid public funds issue ^[extracted]
...
| Group collaboration | SBI Securities / SBI Life / SBI Sumishin Net Bank, etc. | Cross-selling via SBI HD [[megabanks/sbi-hd]] |

### The "4 th megabank concept"

- A concept led by SBI HD's Yoshitaka Kitao: aiming to be a 4 th pole following the megabanks 3 行 ([[megabanks/mufg]] / [[megabanks/smfg]] / [[megabanks/mizuho-fg]]) + [[megabanks/ndfg]]
- **Core bank = SBI Shinsei Bank**, with a satellite network of investments in regional banks (minority stakes in Shimane Bank, Fukushima Bank, Chikuho Bank, Shimizu Bank, etc.) ^[extracted]
...
- [[regional-banks/aozora-bank]]: in the same "former long-term credit bank → nationalization → private rehabilitation" group, with the most closely resembling business type. MUFG [[megabanks/mufg]] held a strategic stake for a time
- [[megabanks/mizuho-fg]]: the only surviving long-term-credit-bank-lineage megabank carrying on the lineage of the former IBJ
...
- **Regulation**: Banking Act (ordinary bank). The special-bank framework under the Long-Term Credit Bank Act was exited in the 2000 年s upon conversion to an ordinary bank ^[extracted]
