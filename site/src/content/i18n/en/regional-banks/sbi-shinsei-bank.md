...
SBI Holdings [[sbi-hd]] (listed 8473)
  └── SBI Shinsei Bank (100%, former 8303; delisted 2023-09 )
        ...
        ├── Shinsei Trust & Banking ── trust function
        └── Showa Leasing ── leasing and finance
```

### Important Timeline (excerpt) ^[extracted]

| Date | Event |
|---|---|
| 1952-12 | **Long-Term Credit Bank of Japan (LTCB) established** (postwar long-term credit institution, special bank under the Long-Term Credit Bank Act) |
| 1970 年s-80 s | Core infrastructure finance during the high-growth period through long-term equipment funding and bank debenture issuance ("Ricky" bonds) |
| 1985 | Listed on the TSE First Section |
| Early 1990 年s | After the bubble collapse, nonperforming loans to real estate and nonbanks expanded sharply |
| **1998-10** | **Failure → temporary nationalization under the Financial Revitalization Act** (special public management) |
| 2000-03 | Sold to the **US Ripplewood Holdings consortium** (including J.C. Flowers) → private-sector rehabilitation |
...
### Unrepaid Public Funds Issue ^[extracted]

- Remaining public capital injection from the former LTCB nationalization is about **3500 億円** in scale (originating from Deposit Insurance Corporation-held shares, and still an issue after SBI's full subsidiary conversion).

## 2. Business Segment Map

| Segment | Main operator | Characteristics |
|---|---|---|
| Retail bank | SBI Shinsei Bank parent bank | Urban middle-class and affluent customers, linkage with SBI Securities |
| Consumer credit / cards | APLUS Financial | Auto loans, installment credit, card loans |
| Consumer finance | Shinsei Financial (Lake ALSA) | Unsecured loans from the former GE Capital line |
...
- Customer referral and account linkage with SBI Securities
...
- **Regulation**: Banking Act (commercial bank). The special-bank framework under the Long-Term Credit Bank Act was exited through conversion to a commercial bank in the 2000 年s ^[extracted].
- **Deposit Insurance Corporation**: counterparty for the former LTCB unrepaid public funds
- **G-SIB designation**: none (below scale threshold)
- **Recent policy issues**:
  - Public-fund repayment scheme (negotiations with SBI HD; no market route after delisting)
  - Consistency of the "4 th megabank concept" regional-bank network investments with the FSA's regional-bank reorganization policy
  - Contribution from improved interest margins in the Bank of Japan policy-rate normalization phase from 2024 onward
...
- SBI HD full-subsidiary-conversion releases (2023-09) and trade-name-change releases (2023-12)

---

> [!info] Verification status
> confidence: **likely** (checked against Wikipedia + SBI HD official releases 2026-05-19). Key dates (1998-10  nationalization, 2000-03  sale to Ripplewood, 2023-09  full subsidiary conversion, 2023-12  trade-name change) match across multiple public sources. The exact amount and repayment progress for unrepaid public funds are time-sensitive; latest SBI HD IR and Deposit Insurance Corporation publications should be consulted. After the full subsidiary conversion, disclosure density for financial results declined, and quantitative data is embedded in SBI HD consolidated reporting.
