...
This entry sits under [[regional-banks/INDEX|regional-banks INDEX]] (its domain route). Read it against [[regional-banks/fukushima-bank|福島銀行]] for the same-prefecture second-regional peer / contrast, and against [[financial-regulators/fsa|the FSA]] plus [[banking/INDEX|banking]] for the supervisory / system boundary. The Fukushima first-regional anchor is [[regional-banks/toho-bank|東邦銀行]].
...
| Item | Notes |
|---|---|
| Legal name | 株式会社大東銀行 / The Daito Bank, Ltd. |
| License route | Bank license under the Banking Act (second regional bank / 第二地銀); FSA bank license list |
| Group boundary | Independent second-regional bank (independent / not under an FG) |
| Home market | Fukushima / Koriyama (head office in Koriyama City, Fukushima Prefecture) |
| Wiki role | Fukushima second-regional-bank operating-company page |

## 2. Operating model

The Daito Bank is a second regional bank that, centered on the Naka-dori area of Fukushima Prefecture, handles retail, SME lending, local deposits, cards / credit-adjacent group services, and community finance. The official company outline confirms its head office in Naka-machi, Koriyama City, and its history of conversion into an ordinary bank. Fukushima carries a heavy context of post-earthquake / post-nuclear-accident reconstruction finance, business succession, and population decline, so the layered structure of regional finance must be viewed together with the Toho Bank and the Fukushima Bank.

## 3. Regulatory & system positioning

- **Supervision**: Under the Banking Act, the FSA ([[financial-regulators/fsa|FSA]]) and the Tohoku Local Finance Bureau supervise. Soundness is disciplined through capital-adequacy-ratio regulation (domestic standard) and the like.
- **Industry body**: A second regional bank in the Second Association of Regional Banks (Daini Chigin Kyo) lineage. It participates in the Zengin System (the nationwide bank funds-transfer settlement network) and, as an industry body, is connected to the framework of [[financial-regulators/zenginkyo|全国銀行協会（全銀協）]].
- **Depositor protection**: Deposits are covered by the Deposit Insurance Corporation of Japan (DIC).
- **Consolidation context**: For the general context of second-regional-bank realignment in Tohoku / Fukushima (including SBI-affiliated alliance trends), see [[banking/regional-bank-consolidation-pattern|regional-bank consolidation pattern]].
...
- The Daito Bank official company outline (会社概要), `https://www.daitobank.co.jp/investor/outline/outline03.html`.
