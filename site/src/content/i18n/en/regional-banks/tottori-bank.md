...
This entry sits under [[regional-banks/INDEX|regional-banks INDEX]] (its domain route). Read it against [[regional-banks/san-in-godo-bank|山陰合同銀行]] for the same-region peer / contrast (the larger 山陰 regional bank) and [[regional-banks/tomato-bank|トマト銀行]] for a neighbouring second-regional bank, and against [[financial-regulators/fsa|the FSA]] plus [[banking/INDEX|banking]] for the supervisory / system boundary.
...
| Item | Notes |
|---|---|
| Legal name | 株式会社鳥取銀行 / The Tottori Bank, Ltd. |
| License route | Bank license under the Banking Act (regional bank / first regional bank); FSA bank license list |
| Group boundary | Independent regional bank（独立系；鳥取県唯一の地方銀行） |
| Established | 1949-10（鳥取信用組合の営業譲受で設立） |
| Home market | Tottori / Tottori City（鳥取市本店） |
| Wiki role | Tottori regional-bank operating-company page |

## 2. Operating model

The Tottori Bank is a regional bank that, centered on Tottori Prefecture, handles retail deposits, SME finance, tourism / agriculture support, and local relationship banking. In the San'in region [[regional-banks/san-in-godo-bank|山陰合同銀行]] is the larger peer (it is also Tottori Prefecture's designated agent financial institution), and the Tottori Bank is organized as a Tottori-specific local-bank anchor. In the neighbouring Chugoku region it forms a peer set with [[regional-banks/chugoku-bank|中国銀行]] and [[regional-banks/hiroshima-bank|広島銀行]]. For the Chugoku regional-bank consolidation context, see [[banking/regional-bank-consolidation-pattern|地域銀行統合パターン]].

## 3. Why this page matters

- Establishes the exact-name page on the FSA's bank license list (Banking Act).
- Sets up the prefecture-level finance anchor for Tottori Prefecture.
- Provides the peer route to [[regional-banks/san-in-godo-bank|山陰合同銀行]] and the Chugoku consolidation note.

## Related

- [[regional-banks/san-in-godo-bank|山陰合同銀行]]
- [[regional-banks/chugoku-bank|中国銀行]]
- [[regional-banks/hiroshima-bank|広島銀行]]
...
- Tottori Bank official company profile / history (established 1949-10; HQ Tottori City; Tottori's only regional bank).
