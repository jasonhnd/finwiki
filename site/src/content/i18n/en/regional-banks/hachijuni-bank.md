...
**Former official name**: Hachijuni Bank, Ltd.
...
- 1877  **63rd National Bank** (established as 第 63 号 under the Meiji National Bank Ordinance)
- 1878  **The 19th National Bank** (founded with 第 19 号)
- In the pre-war period, the 19th Bank and the 63rd Bank were established in Nagano Prefecture, and both developed as leading regional banks in the prefecture.
- **1931-08-01 82nd Bank Launched**: 19th Bank + 63rd Bank merged, company name derived from the sum of numbers of both predecessor banks (** 19  + 63  = 82 **) — Typical example of naming derived from national bank numbers
...
| Month | Event |
|---|---|
| 1877  | **Establishment of the 63rd National Bank** (under the Meiji National Bank Ordinance) |
| 1878  | **Establishment of the 19th National Bank** (same) |
| ** 1931-08-01 ** | **Establishment of the 82nd Bank** (19th + 63rd merger, 19  + 63  = 82) |
| 1949  | Listed on TSE |
| 1950 ~ 80  | No. 1  in the prefecture Established regional bank position, became main bank for manufacturing industry (electronics/precision machinery) |
| 1990 ~ 2000 年 generation | Existing alongside the same industry in the prefecture (former Nagano Sogo Bank → 1989  Nagano Bank) |
| 2022 - 04  | TSE market classification review → TSE PRIME 8359 (migrated from former TSE First Section) |
...
|---|---|---|
| Ground core | Hachijuni Bank main body | Nagano prefecture ground No. 1, overwhelming share in the prefecture |
...
- **Banking industry regulations**: Banking Act (bank holding company regulations are not applicable as it is a single bank)
- **Current policy issues**:
- 2024 ~ Bank of Japan policy rate normalization → Regional bank margin improvement (benefits are relatively greater than for mega)
- 2025 ~ Acceleration of regional bank reorganization (population decline + digital investment burden) → Next strategic phase after completion of absorption of Nagano Bank
- Deciding whether to remain a stand-alone bank or convert to a holding company (FG)
- Responding as the main bank to structural changes in the prefecture's electronics industry (Seiko Epson, etc.) (decrease in demand for printers, shift to semiconductors)
...
- **Wikipedia: Hachijuni Bank** (https://ja.wikipedia.org/wiki/Hachijuni Bank, 2026-05-19 extract)
- **Wikipedia: Nagano Bank** (https://ja.wikipedia.org/wiki/Nagano Bank, 2026-05-19 extract)
