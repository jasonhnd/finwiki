...
Nagasaki Bank is treated here as a Nagasaki-based second regional bank in the Nishi-Nippon Financial Holdings group. The page scope is banking license boundary, group-bank mapping, and comparison with neighboring Kyushu regional banks. This translation keeps to the public-source boundary of the original entry and does not add new factual claims beyond the protected source material.

## Boundary map

| Item | Reading |
|---|---|
| Entity | Nagasaki Bank |
| Functional role | a Nagasaki-based second regional bank in the Nishi-Nippon Financial Holdings group |
