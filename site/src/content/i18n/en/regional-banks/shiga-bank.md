...
translated_at: 2026-06-01T00:41:50.481Z
---
# The Shiga Bank, Ltd.
...
**Ticker**: TSE PRIME 8366 (moved from the former TSE First Section in 2022-04 )
...
| Metric | Value (consolidated / non-consolidated) |
|---|---|
...
| Offices | 133  locations, including branches, sub-branches, and agencies |

> Source: Shiga Bank 138th securities report, with Wikipedia "Shiga Bank" summary checked as of 2025-03-31.
...
The Shiga Bank (independent listed bank 8366)
  ...
  ├── Shigagin Credit Guarantee -- credit guarantees including housing loans
  ├── Shigagin JCB -- JCB-affiliated credit cards
  ├── Shigagin Economic and Cultural Center -- think tank and regional economic research
  ├── Shigagin Business Service -- administrative outsourcing and peripheral operations
```

### Merger History and Predecessors

- **1879  Sixty-Fourth National Bank established** in Hikone under the Meiji-period national bank ordinance, with 第 64 号 as the basis; this is the oldest root of Shiga Bank and the Hikone origin of Shigagin.
...
| Date | Event |
|---|---|
| 1879  | **Sixty-Fourth National Bank established** in Hikone under the Meiji national bank ordinance; Shigagin's root |
...
|---|---|---|
| Local core | The Shiga Bank itself | No. 1 position in Shiga Prefecture, with strong prefectural share |
| Prefectural retail | The Shiga Bank | Shiga Prefecture population about 140 万 and a thick individual deposit base |
| Manufacturing finance | The Shiga Bank | Main-bank position for Shiga's domestic manufacturing clusters, including auto parts, electronics, and materials |
| Kansai / Tokai area expansion | The Shiga Bank | Shiga base + northern Kyoto + northern Osaka + Nagoya region = regional-bank position across 4  prefectural border areas in Kansai and Tokai |
| Group finance | Shigagin Lease / Credit Guarantee / JCB / Economic and Cultural Center | Complementary functions around the bank |
| Out-of-prefecture corporates | The Shiga Bank, with offices in Kyoto, Osaka, Nagoya, Tokyo, etc. | Follows Shiga-headquartered companies' out-of-prefecture business |
| Digital | Shigagin app and TSUBASA system commonization | As an independent bank, captures scale benefits through TSUBASA |
| ESG | The Shiga Bank / UN PRB | **First regional-bank adopter of UN PRB** 2019; early mover in ESG disclosure and climate-related financial information (TCFD) |

### ESG Leader Strategy *
- **Adopted the UN Principles for Responsible Banking (UN PRB)** in 2019 as the first regional bank; this established a regional-bank leader frame in ESG disclosure, sustainability target-setting, and climate-related financial information (TCFD).
...
- **Shiga Prefecture = major domestic manufacturing prefecture**: clusters of mid-sized manufacturers in auto parts, electronics, and materials create main-bank opportunities.
- **Specificity around Lake Biwa**: Lake Biwa is the water source for about 1400 万 people in Keihanshin, making environmental finance and ESG finance a theme that can be projected outside the prefecture.
- **Northern Kyoto, northern Osaka, and Nagoya region**: because Shiga alone has limited volume, the bank strengthens expansion into eastern / northern Kyoto, Takatsuki and Ibaraki in Osaka, and the Nagoya region via Maibara.
- **High prefectural share**, but Shiga has a dual profile: bedroom-town growth in the Keihanshin orbit in the south, including Otsu, Kusatsu, and Ritto, and population decline in the north around Hikone, Nagahama, and Maibara.
...
- **Maintains an independent path as Shiga Prefecture's standalone regional-bank leader**, distant from megabank alliances and SBI's 4 th megabank concept.
- **TSUBASA + UN PRB** are two pillars that reinforce the independent-maintenance strategy.
- The ESG-leader frame may contribute to negotiating power during future reorganization.

## 4. Regulation and Policy
- **Primary regulator**: Financial Services Agency (FSA) / Kinki Local Finance Bureau.
- **Banking regulation**: Banking Act. Because it is an independent bank, bank-holding-company regulation is outside the direct perimeter.
- **Participation in international frameworks**: **adopted the UN Principles for Responsible Banking (UN PRB)** in 2019 as the first regional bank; climate-related financial disclosure aligned with TCFD recommendations.
- **Current policy issues**:
  - From 2024: Bank of Japan policy-rate normalization -> regional-bank margin improvement, with a relatively larger benefit than megabanks.
  - From 2025: acceleration of regional-bank reorganization, population decline, and heavier digital-investment burden; decisions on cooperation or reorganization with Kansai regional banks.
  - Whether to remain an independent bank or move to a holding-company / FG structure.
  - More advanced ESG / sustainability disclosure, including global initiatives such as GFANZ and NZBA.
  - Policy positioning for Lake Biwa environmental finance, including environmental bonds and cooperation with Shiga Prefecture.
...
- **Wikipedia: The Shiga Bank**: https://ja.wikipedia.org/wiki/滋賀銀行, extracted 2026-05-19 / FY2024  figures checked 2026-05-29
- Shiga Bank 138th securities report (FY2024, as of 2025-03-31): total assets, deposits, loans, employees, and office count
- Shiga Bank official history and IR disclosure materials 2025
