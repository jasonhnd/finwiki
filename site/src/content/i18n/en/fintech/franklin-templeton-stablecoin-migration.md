...
status: machine
fidelity: ok
title: "Franklin Templeton FOBXX (BENJI) · From Stellar Single-Chain to Multi-Chain RWA · \"Tokenized Fund ≠ Stablecoin\" Paradigm"
translated_at: 2026-05-31T06:16:15.695Z
---

# Franklin Templeton FOBXX (BENJI) · From Stellar Single-Chain to Multi-Chain RWA · "Tokenized Fund ≠ Stablecoin" Paradigm

## TL;DR

**Franklin OnChain US Government Money Fund** (ticker FOBXX, on-chain share class **BENJI**) is the **first SEC-registered 1940  Act money market fund in the US to fully on-chain its shares** (launched 2021-04 ). It operated **solely on Stellar for approximately 3  years**, then completed **multi-chain expansion** from 2024-2025 : Polygon (2023-04  added) + Arbitrum (2024-04) + Base (2024-09) + Avalanche (2024-10) + Aptos (2024-11) + Solana (2025-02) + Sui (2025-Q4) + select EVM private chains. BENJI AUM **~$650M+** as of 2026-05 , tokenized MMF rank 2 位 (first place is [[fintech/blackrock-buidl-tokenized-mmf-overview|BlackRock BUIDL]] at $2.5B+). **FOBXX's core strategic value**: the product that **earliest proved in the industry that the "tokenized fund ≠ stablecoin" paradigm works** — SEC-registered security, yield-bearing, daily NAV computed on-chain, transfer agent on-chained, belonging to a compliance classification entirely distinct from USDC/USDT.
