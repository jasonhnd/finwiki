...
status: machine
fidelity: ok
title: "Singapore MAS Payment Services Act + SCS Framework Overview"
translated_at: 2026-05-31T07:28:06.145Z
---
...
- PS Act 2019: legal foundation for 6  kinds of payment service ^[extracted]
- SCS Framework 2023-08: Asia's first complete SC sub-framework (2  years ahead of HKMA) ^[extracted]
- DTSP Regime 2024-04: closes the gray zone of "Singapore entities serving global customers" ^[extracted]
- Major DPT license holders (2026-05): DBS Vickers / Independent Reserve / HashKey / Coinbase Singapore / Crypto.com / Sygnum Singapore / Anchorage Digital Singapore / StraitsX (Xfers) ^[extracted]
- SCS license holders: StraitsX XSGD (2023-12) / Paxos USDP (offshore subsidiary application pending) ^[extracted]
- 2026-03: Singapore-US MRA concluded → first Asian inclusion wave under §501(d) ^[extracted]
- Capital / circulation threshold: S$5M (far below HKMA's HKD 100M) → friendlier to mid-sized issuers ^[extracted]
- Tax: capital gains 0% (individual) ^[extracted]
