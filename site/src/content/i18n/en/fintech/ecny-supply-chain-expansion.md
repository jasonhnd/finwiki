...
|---|---|---|
| Two-tier (PBoC → 10 operators → user) | Same two-tier model from domestic e-CNY extended to HK / mBridge | Preserve commercial-bank role; consistent with 4  dual-tier; political stability for the 4 state commercial banks |
