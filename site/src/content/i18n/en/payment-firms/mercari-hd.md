...
- **Mercari sales proceeds → Merpay balance → Mercoin purchase / Mercard payment**: vertical integration in which e-commerce, payments, crypto assets, and credit are completed within a single wallet (the regulatory executing entity for payments / deferred payment is the funds-transfer operator [[payment-firms/merpay|メルペイ (Merpay)]])
...
| Code payment | [[megabanks/paypay-fg]] (PayPay), Rakuten Pay, d Payment, au PAY |
...
| Credit card | JCB-affiliated, Sumitomo Mitsui [[megabanks/smfg]], Rakuten Card |
