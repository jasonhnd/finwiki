...
This entry sits under [[JapanFG/INDEX|JapanFG index]]. Read it against [[payment-firms/western-union-japan|ウエスタンユニオンジャパン (Western Union Japan)]] for peer / contrast context and [[payments/INDEX|payments index]] for the broader system / regulatory boundary.

## TL;DR

Wise Payments Japan is Wise group's Japanese entity. Its official corporate page states its registration numbers as both a Type I and Type II funds-transfer service provider. It is a representative operator when analyzing Japan's cross-border remittance / multi-currency account competition.
...
| FSA registry route | FSA funds-transfer list: Kanto Local Finance Bureau Director 第00040号, Wise Payments Japan. |
