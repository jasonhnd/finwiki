...
**Formal name**: Mizuho Financial Group, Inc. ^[extracted]
**English name**: Mizuho Financial Group, Inc.
**Securities code**: TSE PRIME 8411 (listed 2003-03 ) / NYSE: MFG (listed 2006-11-08) ^[extracted]
**Established**: 2003-01-08 (by share transfer from under Mizuho Holdings, Inc.) ^[extracted]
**Current structure launched**: 2013-07-01 (Mizuho Corporate Bank + Mizuho Bank merger; the new "Mizuho Bank" born) ^[extracted]
**Headquarters**: Otemachi 1-5-5, Chiyoda-ku, Tokyo (Otemachi Tower) ^[extracted]
**Governance design**: company with nominating committee, etc. (transitioned 2014-06 ) ^[extracted]
**Origin of the name "Mizuho"**: "Land of Mizuho" (a land where abundant rice ears ripen = Japan) — an elegant appellation derived from the Kojiki ^[extracted]

### 2025-03  financial results (consolidated) ^[extracted]
...
- **2000-09-29** Mizuho Holdings established (3 行 became wholly-owned subsidiaries via share transfer) ^[extracted]
- **2002-04-01** Mizuho Bank + Mizuho Corporate Bank launched (functional split of individual / SME vs large-corporate / international) ^[extracted]
- **2003-01-08** Mizuho FG launched (pure-holding-company structure above HD) ^[extracted]
- **2013-07-01** Mizuho Bank + Mizuho Corporate Bank → new "Mizuho Bank" **re-integrated** (functional split revisited after 11  years) ^[extracted]
...
| **2024-05** | **New medium-term management plan 2024-2026  announced** (cumulative net income of 1 兆円 over 5  years targeted, ROE over 8%) ★ ^[extracted] |
...
| **2025-09** | **Announced formation of a PE / investment fund for Japanese companies jointly with US Bain Capital** (on a scale of several hundred billion yen) ^[extracted] |
...
- **MINORI** (Mizuho's next-generation core system): fully operational 2019 年, an ultra-large-scale system overhaul with investment over 4500 億円. But it also became the epicenter of the 2021 年 recurring failures ^[extracted]
...
- **Rakuten Securities capital and business alliance** (2022-10〜) ★: Mizuho Securities acquired Rakuten Securities shares approx. 49% (just under approx. 50% after later capital increases), approx. 800 億円 scale. **The first deep investment by a megabank in an external net broker.** Commonizing retail customer channels and product platforms ^[extracted]
- **US Greenhill acquisition** (completed 2023-09 , approx. 770 億円 / 5.5 億 dollars): bringing an independent global M&A advisory under its umbrella, the first acquisition of an independent investment bank by a Japanese bank ^[extracted]
...
- **Formation of a PE fund with Bain Capital** (announced 2025-09 ) ^[extracted]
...
- **Corporate color**: Mizuho Blue (trust / intellect) + a rice-ear-motif logo ^[extracted]
...
- **Business-improvement orders**: **received multiple business-improvement orders for the large-scale system failures of 2002 / 2011 / 2021  and 3  times**. The 2021-11  order was the 2 th banking business-improvement order in history (including the past) ^[extracted]
