...
2002-12   Holding company [[megabanks/smfg|SMFG]] established → SMBC becomes a wholly owned subsidiary of SMFG
```
...
| 1895 | Sumitomo Bank established |
| 1990 | Mitsui Bank + Taiyo Kobe Bank → Sakura Bank |
| **2001-04-01** | **Sakura Bank + Sumitomo Bank → Sumitomo Mitsui Banking Corporation founded** |
| **2002-12-02** | **SMFG (Sumitomo Mitsui Financial Group) established** (shift to holding-company structure) |
| 2003 | Sumitomo Mitsui VISA Card (later [[card-issuers/smbc-card|三井住友カード]]) rollout |
| 2009-10 | Promise (later [[consumer-finance/smbc-consumer-finance|SMBC コンシューマーファイナンス]]) made a consolidated subsidiary |
| 2009-10 | Nikko Cordial Securities (later [[securities-firms/smbc-nikko|SMBC 日興証券]]) acquisition |
| 2013 | Acquisition of Société Générale Private Banking Japan → [[trust-banks/smbc-trust-bank|SMBC 信託銀行]] structure development |
| 2018 | Restructuring of [[trust-banks/smbc-trust-bank|SMBC 信託銀行]] and SMBC Leasing |
...
SMFG ([[megabanks/smfg|8316]], holding company)
  ├── **SMBC (株式会社三井住友銀行, 100%) = this entry**
  │     ├── retail / for individuals
  │     ├── wholesale (mid-tier / large corporate)
  │     ├── international business (overseas offices)
  │     └── investment banking (part of DCM / ECM)
  ├── [[securities-firms/smbc-nikko|SMBC 日興証券]] (securities)
  ├── [[trust-banks/smbc-trust-bank|SMBC 信託銀行]] (trust / PB)
  ├── [[card-issuers/smbc-card|三井住友カード]] (credit cards)
  ├── [[consumer-finance/smbc-consumer-finance|SMBC コンシューマーファイナンス（プロミス）]] (consumer finance)
  ├── Sumitomo Mitsui Finance & Leasing (leasing, SMFL)
  ├── The Japan Research Institute (IT / think tank)
...
|---|---|
| **Retail** | Individual deposits + home loans + investment-trust sales + asset management for individuals |
| **Wholesale** | Lending for mid-tier / large corporates + syndicated loans + DCM/ECM + M&A advisory |
| **International business** | Local lending / transaction banking through offices in North America, Europe, Asia, and Latin America |
...
- **Emphasis on capital efficiency**: thorough ROE / RORA management
- **GX / sustainable finance**: strengthening SLB / green loans
- **Deepening into the US market**: strengthening US IB · leveraged finance with the strategic capital and business alliance with 2023 Jefferies (Jefferies) as the axis
- **Asia / emerging markets**: for individuals (Vietnam, Indonesia) + wholesale (Thailand, India)

## 5. Supervision / regulation

- **Supervisor**: [[financial-regulators/fsa|金融庁]] (the Banking Act)
- **Macroprudential**: [[financial-regulators/boj|日本銀行]] examinations · Financial System and Bank Examination Department monitoring
- **Capital regulation**: Basel III + G-SIB (global systemically important bank) buffer
- **G-SIB designation**: SMFG is designated in G-SIB bucket 1  (2024)
