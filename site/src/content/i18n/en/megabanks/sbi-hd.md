...
translated_at: 2026-06-01T00:41:50.479Z
---
# SBI Holdings (SBI HD)
...
**Legal name**: SBI Holdings, Inc. ^[extracted]
**English name**: SBI Holdings, Inc.
**Ticker**: TSE PRIME 8473  ^[extracted]
**Established**: 1999-07-08 (former SoftBank Investment Corporation) ^[extracted]
**Head office**: Izumi Garden Tower, Roppongi 1-6-1, Minato-ku, Tokyo ^[extracted]
**Representative**: **Yoshitaka Kitao** (chairman, president, CEO, founder) ^[extracted]
**Name origin**: SBI = Strategic Business Innovator, retaining the initials of the former SoftBank Investment while redefining them after independence ^[extracted]
**Capital**: 1829.25 億円 ^[extracted]
**Shares issued**: 303,056,907  shares ^[extracted]

### Consolidated Financial KPIs (FY2024/3  = 2025-03  period) ^[extracted]

| Indicator | Amount |
|---|---|
| Revenue | **1兆4437億円** (¥1,443.73 bn) |
| Ordinary profit | **2823億円** (¥282.29 bn) |
| Net income attributable to owners of parent | **1621億円** (¥162.12 bn) |
| Net assets | **1兆2614億円** (¥1,261.41 bn) |
| Total assets | **32兆1134億円** (¥32,113.43 bn) |
| Employees (consolidated) | **19,156 名** |

### Major Shareholders (as of 2025-07-17) ^[extracted]
...
```
SBI Holdings（listed holding company 8473）
  ├── SBI Securities（100%）── Japan's largest online brokerage, accounts over 1500 万 (2025-11) ^[extracted]
  │     │ FY2024/3  results: operating revenue 2388.67 億円 / operating profit 766.25 億円 / net income 478.65 億円 / total assets 7.125 兆円 ^[extracted]
  │     ├── SBI Neomobile Securities → absorbed into SBI Securities in 2024 
  │     ├── SBI Liquidity Market 100% ── FX liquidity provider
  │     └── Overseas: SBI Royal Securities (Cambodia), etc.
  ├── SBI Shinsei Bank（former Shinsei Bank, 100%, wholly owned in 2023-09 , delisted → renamed in 2023-12 ）
  │     ├── Outstanding public funds issue of 3500 億円 (continuing)
  ...
  ├── SBI Graduate School ── MBA program
  ├── SBI Global Asset Management（listed subsidiary）── AM intermediate holding company
  └── SBI Liquidity Market ── FX market maker

Strategic alliance / regional-bank partners（over 10 行, 4 th megabank concept）
...
★ SMBC-SBI Alliance（from 2022）
  ...
  └── Olive Consulting JV（established 2025-09-05, 5 社 joint venture）
        ...
        └── Asset-management service for Olive Infinite planned from spring 2026 
```
...
| Date | Event |
|---|---|
| **1999-07-08** | **SoftBank Investment Corporation established** as SoftBank Group's investment subsidiary; Yoshitaka Kitao moved from SoftBank vice president to found it |
| 2000-12  | SBI Securities (former E*TRADE Securities) established |
| 2005-07  | Renamed SBI Holdings, effectively separated from the SoftBank Group line |
| 2007  | SBI Insurance opened |
| 2008-04  | Listed on TSE First Section |
...
|---|---|---|
| Online brokerage | SBI Securities | Japan's largest, accounts **over 1500 万** (2025-11), one of the industry 2  leaders with Rakuten Securities |
| Online bank (consolidated subsidiary) | SBI Shinsei Bank | Former Shinsei Bank, 3500 億円 public funds outstanding, 2025-07  re-listing application |
| Online bank (former JV) | SBI Sumishin Net Bank former 50% → transfer to NTT Docomo completed 2025-10  | SBI exit completed |
| Crypto assets | SBI VC Trade | Domestic Tier 2  scale, strong institutional custody service |
| Online non-life insurance | SBI Insurance | Direct auto insurance model |
| Life insurance | SBI Life | Acquired former PCA Life |
| Small-amount short-term insurance | SBI Ikiiki SSI | Medical and funeral insurance for seniors |
| Regional-bank alliance | Chikuho / Shimizu / Daito / Fukushima / Sendai and others, over 10 行 | 4 th megabank concept |
| Real estate | SBI Estate Management | Asset management and private funds |
| FX | SBI Liquidity Market | Market maker |
| Overseas | SBI Bank (Russia business being wound down) / SBI Royal Securities (Cambodia), etc. | Emerging Asia focus |
| Education | SBI Graduate School | MBA |
| ★ SMBC linkage | Olive Consulting JV (established 2025-09 ) | Integrated SBI Securities + SMBC Nikko Securities + Olive asset management |
...
- **SBI Shinsei Bank wholly owned (2023-09)** secured the commercial banking license as the core for regional-bank alliances

### SBI Shinsei Bank Integration Effects (Reflected in FY2024/3 )

- Since full ownership (2023-09), SBI HD's balance sheet has shifted significantly toward a commercial-bank model (from securities-business base to banking-business base)
- **2025-07  re-listing application**: formal presentation of public-funds 3500 億円 repayment plan, aiming to secure market float while maintaining SBI ownership ^[extracted]
...
### Crypto Assets and New Areas

- **SBI VC Trade**: domestic Tier 2  scale, strong institutional custody services
- **SBI Ripple Asia**: Ripple (XRP) Japan rollout joint venture
- **Web3  / stablecoins**: Chairman Kitao supports crypto assets and is active in industry lobbying

### Overseas Strategy

- **Russia business being wound down**: exit from SBI Bank (former OWB) is progressing ^[needs-verification]
- **Southeast Asia**: emerging-market securities business such as SBI Royal Securities (Cambodia)
- **United States / Europe**: limited (no IB function, retail focus)

## 4. Regulation and Policy

- **Primary authority**: Financial Services Agency (FSA)
- **SBI Shinsei Bank public funds 3500 億円 outstanding**: remaining public capital injection from the former Long-Term Credit Bank failure, continuing issue after SBI's full ownership
  - **2025-07  re-listing application** (path to public-funds repayment) → milestone in repayment strategy ^[extracted]
- **Relationship with FSA**:
  - From 2021, FSA reviewed SBI's governance capability during the Shinsei Bank TOB process
  - After approval of full ownership in 2022 , negotiations with FSA continue
...
- **Wikipedia: SBI Holdings**（https://ja.wikipedia.org/wiki/SBIホールディングス, 2026-05-19 extracted, FY2024/3 consolidated KPIs + major shareholders 2025-07-17）
- **Wikipedia: SBI Securities**（https://ja.wikipedia.org/wiki/SBI証券, 2026-05-19 extracted, account count 1500 万 2025-11 + FY2024/3  results）
- **Wikipedia: Sumitomo Mitsui Financial Group**（https://ja.wikipedia.org/wiki/三井住友フィナンシャルグループ, 2026-05-18 extracted, SMBC-SBI Alliance and Olive Consulting cross-ref）
- **To supplement**:
  - SBI HD annual securities report (FY2024/3 ) primary-source segment revenue and profit
  - SBI Shinsei Bank official IR / re-listing prospectus for public-funds repayment plan
  - Official PR on SBI Sumishin Net Bank transfer to NTT Docomo, transfer consideration, and capital gain
  - SBI VC Trade volume / share primary sources
  - Latest individual investment ratios in regional-bank partners
  - FY2025/3  period (2026-03  period) full-year forecast and 1Q earnings release

---

> [!info] Validation Status
> confidence: **likely** (v1.1  Wikipedia + SBI Securities Wikipedia + SMFG Wikipedia cross-ref check 2026-05-19). FY2024/3  period (2025-03  period) consolidated KPIs (revenue 1.44 兆円 / net income 1621 億円 / total assets 32.11 兆円 / net assets 1.26 兆円 / employees 19,156), SBI Securities account count 1500 万 (2025-11), and major shareholders 5 位 (SMFG 8.91% / NTT 8.18%) have high confidence as values transcribed in Wikipedia. SBI Shinsei Bank integration effects are clearly reflected in the consolidated balance sheet (total assets in the 32 兆円 range). **FY2025/3  period (2026-03  period) full-year results and structural changes after SBI Shinsei Bank re-listing need supplementation** — checking SBI HD official IR primary sources (annual securities report / earnings releases) is the next validation step.
