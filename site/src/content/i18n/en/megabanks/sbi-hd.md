...
**Official name**: SBI ホールディングス株式会社 ^[extracted]
**English name**: SBI Holdings, Inc.
**Securities code**: TSE PRIME 8473 ^[extracted]
**Establishment**: 1999-07-08 (former SoftBank Investment Co., Ltd.) ^[extracted]
**Head office**: 1-6-1 Roppongi, Minato-ku, Tokyo (Izumi Garden Tower) ^[extracted]
**Representative**: **Yoshitaka Kitao** (Chairman and President / CEO / founder) ^[extracted]
**Origin of name**: SBI = Strategic Business Innovator (inheriting the initials of the former SoftBank Investment while being redefined after independence) ^[extracted]
**Capital**: 1829.25 億円 ^[extracted]
**Shares issued**: 303,056,907  shares ^[extracted]

### Consolidated financial KPI (FY2024/3  = the 2025-03  period) ^[extracted]
...
| 2020-09 | sequentially announced capital and business alliances with [[regional-banks/shimane-bank|島根銀行]] / Chikuho Bank / Shimizu Bank, etc. |
...
| **2022 (〜2022-06  reporting)** | **concluded the "SMBC-SBI Alliance" (comprehensive capital and business alliance) with [[megabanks/smfg]]** ★ |
...
- **2025-07  relisting application**: formal presentation of a plan for full repayment of public funds 3500 億円, securing market float while maintaining SBI's shareholding ratio ^[extracted]

### Alliance / acquisition strategy

- **★ SMBC-SBI Alliance** (2022〜): [[megabanks/smfg]] holds an SBI HD stake of 8.91%
...
- **Transfer of SBI Sumishin to NTT docomo** (2025-10-01) ★: SBI HD transferred all shares of SBI Sumishin Net Bank to NTT docomo → completed the online-bank exit 9  months before establishing [[megabanks/ndfg]]
...
- **SBI Shinsei Bank public funds 3500 億円 unrepaid**: the residual public-capital-injection debt from the failure of the former Long-Term Credit Bank, an ongoing issue even after SBI's full consolidation
  - **2025-07  relisting application** (public-funds full repayment in sight) → a milestone in the repayment strategy ^[extracted]
...
- **Recent policy points**:
  ...
  - 2025〜 antitrust response for regional-bank consolidation (unlike [[megabanks/mufg]] / [[megabanks/smfg]], SBI is a distributed-network type rather than a concentration type)
