...
Use this comparison after the listed-J-REIT routing pages: [[real-estate-finance/j-reit-market-overview|J-REIT market overview]], [[real-estate-finance/j-reit-vs-us-reit-governance-comparison|US/JP governance comparison]], [[real-estate-finance/j-reit-sponsor-structure-conflict|sponsor structure and conflict of interest]], and [[real-estate-finance/top-10-j-reit-overview-matrix|top 10 J-REIT overview matrix]]. From here, route to [[insurance/INDEX|insurance domain]] for life-insurer allocation context, to [[banking/INDEX|banking domain]] for the financing layer, and to [[finance/INDEX|finance domain]] for listed-developer sponsor context. A GK-TK structure may be used in a private real-estate transaction, subject to the applicable transaction documents; for that route, follow the GK-TK SPV cluster planned in [[real-estate-finance/INDEX|real-estate-finance index]].

## 1. Side-by-side comparison

Table evidence (reviewed 2026-07-29): [FSA's investment-corporation regulatory overview](https://www.fsa.go.jp/en/refer/legislation/20130416/02.pdf), [JPX's listed-REIT directory](https://www.jpx.co.jp/english/equities/products/reits/issues/index.html), and [ARES's January 2026 private-fund survey](https://www.ares.or.jp/news/uploads/private_fund_survey202601.pdf). Private-fund terms vary by product documents.
...
Table evidence (reviewed 2026-07-29): [ARES's private-fund survey](https://www.ares.or.jp/news/uploads/private_fund_survey202601.pdf) establishes the market segment, while actual fees come from each fund's offering and management documents. Rows below describe possible fee categories, not universal terms.
...
Table evidence (reviewed 2026-07-29): [ARES's January 2026 private-fund survey](https://www.ares.or.jp/news/uploads/private_fund_survey202601.pdf). Investor-use rows are analytical use cases; they do not claim that every named investor type holds every private REIT.
...
| Life insurers ([[insurance/INDEX\|insurance domain]]) | Test capital treatment, valuation, ALM, concentration, liquidity and look-through requirements |
| Regional banks ([[banking/INDEX\|banking domain]]) | Test capital treatment, CRE concentration, liquidity, governance and look-through exposure |
...
- Sponsor strategy: where a sponsor manages both listed and private vehicles, verify the current entities, eligible assets, allocation policy and each actual transaction before applying the [[real-estate-finance/j-reit-sponsor-structure-conflict|sponsor conflict]] framework.
