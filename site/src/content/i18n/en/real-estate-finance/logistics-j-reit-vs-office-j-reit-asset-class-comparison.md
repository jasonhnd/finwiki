...
source_hash: a770d057cd798d6b
lang: en
status: machine
fidelity: ok
title: "Logistics J-REIT vs office J-REIT asset class comparison"
...
Row evidence (reviewed 2026-07-29): each REIT name links to its official IR portal; codes and current names are cross-checked against the [JPX listed-REIT directory](https://www.jpx.co.jp/english/equities/products/reits/issues/index.html).

| REIT | Code | Sponsor / sponsor type | Asset focus |
|---|---|---|---|
| [Industrial & Infrastructure Fund Investment Corporation (IIF)](https://www.iif-reit.com/en/) | TSE J-REIT **3249** | KKR-linked asset-management platform | Logistics + industrial infrastructure |
| [GLP J-REIT](https://www.glpjreit.com/en/) | TSE J-REIT **3281** | GLP Japan within the Ares sponsor group | Modern logistics facilities |
| [Nippon Prologis REIT](https://www.prologis-reit.co.jp/en/) | TSE J-REIT **3283** | Prologis | Modern logistics facilities |
| [LaSalle Logiport REIT](https://www.lasalle-logiport.com/en/) | TSE J-REIT **3466** | LaSalle | Modern logistics facilities |
| [Mitsui Fudosan Logistics Park REIT](https://www.mflp-reit.co.jp/en/) | TSE J-REIT **3471** | [[real-estate-finance/mitsui-fudosan-financing-model\|Mitsui Fudosan]] | MFLP-branded logistics |
| [Mitsubishi Estate Logistics REIT](https://mel-reit.co.jp/en/) | TSE J-REIT **3481** | [[real-estate-finance/mitsubishi-estate-financing-model\|Mitsubishi Estate]] | Logistics-focused portfolio |
...
|---|---|---|---|
| [Nippon Building Fund (NBF)](https://www.nbf-m.com/nbf_e/) | TSE J-REIT **8951** | [[real-estate-finance/mitsui-fudosan-financing-model\|Mitsui Fudosan]]-related asset manager | Office-focused |
| [Japan Real Estate Investment Corporation (JRE)](https://www.j-re.co.jp/en_cms/) | TSE J-REIT **8952** | [[real-estate-finance/mitsubishi-estate-financing-model\|Mitsubishi Estate]]-related asset manager | Office-focused |
| [Daiwa Office Investment Corporation](https://www.daiwa-office.co.jp/en/) | TSE J-REIT **8976** | Daiwa Securities Group-related asset manager | Office-focused |
| [ORIX JREIT](https://www.orixjreit.com/en/) | TSE J-REIT **8954** | ORIX-related asset manager | Diversified |
| [HEIWA REAL ESTATE REIT](https://www.heiwa-re.co.jp/en/) | TSE J-REIT **8966** | Heiwa Real Estate-related asset manager | Office / residential |
| [MORI TRUST REIT](https://www.mt-reit.jp/en/) | TSE J-REIT **8961** | Mori Trust-related asset manager | Diversified, including office |
...
Table evidence (reviewed 2026-07-29): [JREI's 54th Japanese Real Estate Investor Survey](https://www.reinet.or.jp/pdf/REIS/published-document_main_the-japanese-real-estate-investor-survey_202604.pdf) for dated expected-cap-rate medians, plus the official issuer links in the two tables above for portfolio, lease, occupancy, and tenant data. Qualitative rows are diligence fields and must be populated from the compared issuers rather than read as sector-wide facts.
...
## Sponsor relationships in the selected logistics sample
...
|---|---|
| Prologis | [Nippon Prologis REIT (3283)](https://www.prologis-reit.co.jp/en/) |
| GLP Japan within the Ares sponsor group | [GLP J-REIT (3281)](https://www.glpjreit.com/en/) |
| LaSalle | [LaSalle Logiport REIT (3466)](https://www.lasalle-logiport.com/en/) |
| KKR-linked asset-management platform | [Industrial & Infrastructure Fund (3249)](https://www.iif-reit.com/en/) |
...
Table evidence (reviewed 2026-07-29): portfolio and tenant disclosures from [GLP J-REIT](https://www.glpjreit.com/en/), [Nippon Prologis REIT](https://www.prologis-reit.co.jp/en/), [Nippon Building Fund](https://www.nbf-m.com/nbf_e/), and [Japan Real Estate](https://www.j-re.co.jp/en_cms/). The table is a comparison lens; tenant counts and lease terms must be refreshed issuer by issuer.
...
See [[real-estate-finance/real-estate-cap-rate-compression-2026|cap-rate compression 2026]] for the cycle dimension.

## Sponsor-conflict comparison

Both segments operate under the [[real-estate-finance/j-reit-sponsor-structure-conflict|J-REIT sponsor structure]] framework. Sponsor affiliation, related-party protocols and appraisal use are issuer- and transaction-specific; an appraisal is a valuation benchmark rather than the mechanism that sets a transfer price. The asset-class-specific notes:
...
Financing must be separated into (a) debt issued or borrowed by a listed J-REIT and (b) property-level or developer financing outside the J-REIT. Asset class alone does not determine recourse, tenor, pricing, or covenants. See [[real-estate-finance/bank-commercial-real-estate-lending-japan|bank CRE lending Japan]] for the broader context.
...
Table evidence (reviewed 2026-07-29): [ARES June 2026 monthly report](https://www.ares.or.jp/action/monthly/pdf/ares_monthly_report_202606.pdf) and [JPX investor-type statistics](https://www.jpx.co.jp/english/markets/statistics-equities/investor-type/index.html).

| Investor question | Publicly reproducible reading |
|---|---|---|
| Aggregate holder categories | Use the dated ARES unitholder survey; it does not split logistics and office |
| Weekly investor-type trading | Use JPX J-REIT flow statistics; trading flow is not beneficial ownership |
| Issuer / sponsor holdings | Use each REIT's current major-unit-holder disclosure |
| Fund or ETF exposure | Use the fund's own holdings disclosure; do not infer from sponsor nationality |

JPX aggregate flow statistics alone cannot identify a logistics-versus-office rotation. A sector-rotation claim requires contemporaneous issuer-level price / volume data or disclosed fund holdings; see [[real-estate-finance/j-reit-foreign-investor-ownership|J-REIT foreign-investor ownership]].
