...
source_hash: 9d81a8ce08b98a14
lang: en
status: machine
fidelity: ok
title: "J-REIT sponsor structure and conflict of interest"
...
A [[real-estate-finance/j-reit-market-overview|J-REIT]] can look like a single entity from the outside but operates through an investment corporation and an external asset-management company. Many, but not all, J-REITs also have a sponsor that owns or influences the asset manager, may supply acquisition opportunities, and may hold investment units. The exact ownership, support agreement, pipeline rights, and sponsor stake must be verified in each issuer's current disclosure. This structure creates related-party-transaction risk addressed by the Investment Trust Act, FSA supervision, and issuer-level conflict controls.

Use this page after [[real-estate-finance/j-reit-vs-us-reit-governance-comparison|US/JP governance comparison]] for the Japan-specific conflict-of-interest detail and the named-sponsor mapping. For the listed-name-by-listed-name picture, use [[real-estate-finance/top-10-j-reit-overview-matrix|top 10 J-REIT overview matrix]].

## Wiki route

Anchor in [[real-estate-finance/INDEX|real-estate-finance domain]] and follow this entry after [[real-estate-finance/j-reit-market-overview|J-REIT market overview]] and [[real-estate-finance/j-reit-vs-us-reit-governance-comparison|US/JP governance comparison]]. For trustee plumbing under the structure see [[banking/trust-bank-custody-operating-comparison|trust bank custody operating comparison]]. For the listed-developer side (the sponsor side) cross-link to [[finance/INDEX|finance domain]] and [[finance/japan-listed-financial-groups-investable-universe|Japan listed financial groups investable universe]]; for retail / mall sponsors specifically cross-link to [[retail/aeon-group|AEON Group]] and [[retail/seven-and-i-hd|Seven & i HD]].

## 1. The three-party structure

Table evidence (reviewed 2026-07-29): [FSA's J-REIT regulatory overview](https://www.fsa.go.jp/en/refer/legislation/20130416/02.pdf) and the [JPX J-REIT Guidebook (May 2026)](https://www.jpx.co.jp/english/equities/products/reits/guidebook/b5b4pj000003984r-att/REIT.pdf).
...
Table evidence (reviewed 2026-07-29): the [FSA regulatory overview](https://www.fsa.go.jp/en/refer/legislation/20130416/02.pdf) establishes the external-manager framework; the presence and wording of each support arrangement must be checked in the relevant issuer's securities report and IR materials.
...
|---|---|---|---|
| Mitsui Fudosan | Developer | [Nippon Building Fund (8951)](https://www.nbf-m.com/nbf_e/) | Office-focused example. |
| Mitsubishi Estate | Developer | [Japan Real Estate (8952)](https://www.j-re.co.jp/en_cms/) | Office-focused example; one of the first two J-REIT listings. |
| Mori Building | Developer | [Mori Hills REIT (3234)](https://www.morihills-reit.co.jp/en/) | Urban office / mixed-use example. |
| Mori Trust | Developer | [MORI TRUST REIT (8961)](https://www.mt-reit.jp/en/) | Separate sponsor group from Mori Building. |
| Nomura Real Estate | Developer | [Nomura Real Estate Master Fund (3462)](https://www.nre-mf.co.jp/en/) | Diversified example; no Nomura Holdings parent relationship should be inferred. |
| Daiwa House | Developer | [Daiwa House REIT (8984)](https://www.daiwa-house-reit.co.jp/en/) | Diversified example. |
| Daiwa Securities Group | Financial group | [Daiwa Office Investment (8976)](https://www.daiwa-office.co.jp/en/) | Office-focused example. |
| ORIX | Financial group | [ORIX JREIT (8954)](https://www.orixjreit.com/en/) | Diversified example. |
| Kenedix | Asset manager | [KDX Realty Investment Corporation (8972)](https://www.kdx-reit.com/eng/) | Current consolidated KDX listed vehicle. |
| Hulic | Developer | [Hulic Reit (3295)](https://www.hulic-reit.co.jp/en/) | Office / commercial example. |
| AEON | Retail group | [AEON REIT (3292)](https://www.aeon-jreit.co.jp/en/) | Retail example linked to [[retail/aeon-group\|AEON Group]]. |
| GLP Japan / Ares Management | Logistics / global asset-management group | [GLP J-REIT (3281)](https://www.glpjreit.com/en/) | GLP Japan is the sponsor and has been part of Ares Management since 2025-03-01; the issuer describes Ares as the broader sponsor group. |
| Prologis | Logistics platform | [Nippon Prologis REIT (3283)](https://www.prologis-reit.co.jp/en/) | Logistics example. |
...
Table evidence (reviewed 2026-07-29): [FSA's regulatory overview](https://www.fsa.go.jp/en/refer/legislation/20130416/02.pdf). The table describes risk channels and common control surfaces; the operative approvals and thresholds are those in each asset manager's current related-party policy.
...
Table evidence (reviewed 2026-07-29): [FSA's regulatory overview](https://www.fsa.go.jp/en/refer/legislation/20130416/02.pdf) and the [JPX J-REIT Guidebook](https://www.jpx.co.jp/english/equities/products/reits/guidebook/b5b4pj000003984r-att/REIT.pdf).
