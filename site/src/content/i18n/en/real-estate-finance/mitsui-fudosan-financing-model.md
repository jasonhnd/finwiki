...
Table evidence (reviewed 2026-07-29): [Mitsui Fudosan investor guide](https://www.mitsuifudosan.co.jp/english/corporate/ir/investors_guide/) and [bond / rating disclosure](https://www.mitsuifudosan.co.jp/english/corporate/ir/shareholder/bond/). Ratings shown are the issuer's published snapshot dated 2026-05-13.
...
See [[real-estate-finance/bank-commercial-real-estate-lending-japan|bank CRE lending Japan]] for the broader lender-side architecture; that context is not evidence for a Mitsui Fudosan facility.

### 3. Related listed REIT vehicles and transaction testing
...
Row evidence (reviewed 2026-07-29): each vehicle links to its official IR portal; current names and codes are cross-checked against the [JPX listed-REIT directory](https://www.jpx.co.jp/english/equities/products/reits/issues/index.html).

| Sponsor J-REIT | Asset focus | Listing | Role in Mitsui Fudosan stack |
|---|---|---|---|
| [Nippon Building Fund (NBF)](https://www.nbf-m.com/nbf_e/) | Office | TSE J-REIT **8951** | Office-focused listed vehicle |
| [Mitsui Fudosan Retail Fund Investment Corporation](https://www.frontier-reit.co.jp/en/) (formerly Frontier Real Estate Investment Corporation) | Retail | TSE J-REIT **8964** | Retail-focused listed vehicle |
| [Mitsui Fudosan Logistics Park Inc.](https://www.mflp-reit.co.jp/en/) | Logistics | TSE J-REIT **3471** | Logistics-focused listed vehicle |
...
|---|---|---|
| CBD concentration | Measure current district exposure across Nihonbashi, Roppongi, Toyosu, Kashiwa-no-ha, Hibiya, Osaka and other disclosed areas | Measure current Marunouchi and other district exposure |
| Sponsor J-REIT (office) | Nippon Building Fund (NBF, 8951) | Japan Real Estate Investment Corp. (JRE, 8952) |
| Sponsor J-REIT (retail) | Mitsui Fudosan Retail Fund Investment Corporation (8964) | n/a (no dedicated retail J-REIT) |
| Sponsor J-REIT (logistics) | MFLP-REIT (3471) | Mitsubishi Estate Logistics REIT (3481) |
| Overseas exposure | Compare dated segment assets, revenue and earnings by geography | Compare dated segment assets, revenue and earnings by geography |
| Brand portfolio | Park Mansion / Park Court / Park Homes, LaLaport / MITSUI OUTLET PARK, MFLP, Mitsui Garden Hotels | Marunouchi office, The Parkhouse / The Parkhabio, Premium Outlets, Royal Park Hotels |
| Strategy emphasis | Use current plan, capex, transfers and segment disclosures | Use current plan, capex, transfers and segment disclosures |

Both have listed-developer, sponsor-J-REIT and asset-management relationships. Compare asset-class and district concentration from same-date data rather than assuming the same template or a fixed breadth ranking. See [[real-estate-finance/mitsubishi-estate-financing-model|Mitsubishi Estate financing model]] for the contrast detail.

## J-REIT sponsor relationships — governance frame

The sponsor relationship is regulated under the **Investment Trust Act** and applicable related-party rules, with [[real-estate-finance/j-reit-sponsor-structure-conflict|sponsor structure and conflict]] documenting the analytical frame. For NBF, Mitsui Fudosan Retail Fund and MFLP-REIT, use the current issuer and asset-manager documents:
...
The existence of these controls does not by itself establish alignment or investor acceptance. Assess ownership, approvals, appraisals, price, fees, votes and post-transaction performance from the applicable documents. See [[real-estate-finance/j-reit-sponsor-structure-conflict|sponsor structure and conflict]] for the in-depth treatment.
...
- **Currency-risk management** — instrument, notional, currency, maturity, hedge designation and hedged item; do not assume a swap-back structure (see [[derivatives/yen-basis-swap-market|JPY-USD basis swap]]).
...
- Mitsui Fudosan Retail Fund Investment Corporation (8964; formerly Frontier Real Estate Investment Corporation) IR portal — https://www.frontier-reit.co.jp/en/
