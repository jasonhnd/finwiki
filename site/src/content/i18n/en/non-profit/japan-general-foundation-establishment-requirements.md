...
> [!info] TL;DR
> It is easily confused with a "public-interest incorporated foundation" or an "NPO corporation," but the **general incorporated foundation** holds its own distinct position as a neutral corporate form. A form suited to research / advocacy-type organizations.
...
When dealing with financial / policy research, use the systems of [[policy-finance/INDEX|policy-finance INDEX]] and [[finance/INDEX|finance INDEX]] as the primary reference, and refer to [[business/INDEX|business INDEX]] for cross-industry operator mapping.

## 関連 wiki

- [[fintech/japan-financial-regulation|japan-financial-regulation]] (adjacent legal systems in the financial domain)
- [[non-profit/japan-research-grant-map-2026|日本 研究助成金 map（2026 年度）]] (a list of grants that can be sought after establishing a foundation)
- [[non-profit/INDEX|non-profit INDEX]] (reference to real-world examples of financial groups)
