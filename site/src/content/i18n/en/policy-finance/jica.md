...
The following table is scoped to public primary sources (jica.go.jp, mofa.go.jp). It restates licence / structure / product boundaries from those materials and does not invent market share, ranking, or unstated numerical claims. ^[source:jica.go.jp; mofa.go.jp]
