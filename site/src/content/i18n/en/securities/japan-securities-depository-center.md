...
status: machine
fidelity: ok
title: "Japan Securities Depository Center (JASDEC)"
...
JASDEC is Japan's central securities depository for most dematerialized securities other than JGBs. Its official site describes it as the only domestic company providing comprehensive securities settlement infrastructure except government bonds, designated as a book-entry transfer institution by the Financial Services Agency and Ministry of Justice.

For FinWiki, JASDEC is the settlement / book-entry rail behind listed shares, corporate bonds, municipal bonds, commercial paper, investment trusts, matching, and DVP settlement.
...
| Japanese name | 株式会社証券保管振替機構 |
| Founded | 2002-01-04 |
| Capital | 4.25 billion yen |
| Main role | Book-entry transfer and securities settlement infrastructure. |
...
| Service | Role |
|---|---|
| Shares book-entry transfer | Dematerialized listed-share settlement rail. |
| Commercial paper | Book-entry transfer for CP. |
| Corporate bonds | Book-entry transfer for corporate bonds. |
| Investment trusts | Book-entry transfer for investment trusts. |
| DVP settlement | Delivery-versus-payment settlement services. |
| Pre-settlement matching | Matching infrastructure before settlement. |
| Foreign stock certificates | Custody-related services for foreign securities. |
...
- [[fintech/japan-third-party-allotment-5-step-flow]]
- [[fintech/japan-listed-company-disclosure-monitoring]]

## Sources

- JASDEC: About JASDEC.
- JASDEC: Company Outline.
