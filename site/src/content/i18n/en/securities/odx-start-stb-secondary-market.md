...
For [[securities/japan-asset-manager-landscape-matrix|asset managers]] and institutional allocators, this means ST exposure typically requires either direct ST PTS access through a participant, or wrapping inside a publicly offered investment trust / privately placed investment trust structure that itself holds ST instruments.
