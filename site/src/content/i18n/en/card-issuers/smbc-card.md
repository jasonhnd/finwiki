...
status: machine
fidelity: ok
title: "Sumitomo Mitsui Card (SMCC)"
...
This entry sits under [[JapanFG/INDEX|JapanFG index]]. Read it against [[card-issuers/mufg-nicos|三菱UFJニコス (Mitsubishi UFJ NICOS)]] for peer / contrast context and [[payments/INDEX|payments index]] for the broader system / regulatory boundary.

## TL;DR

Sumitomo Mitsui Card is the core operator for [[megabanks/smfg|SMFG]]'s card, consumer-credit, and transaction businesses. It is separated as the representative [[payments/card-acquiring-japan-stack|card acquiring stack]] page because it covers not only card issuing, but also merchant payments, transaction services, and the cashless contact points around Olive / V Point.

## 1. Legal-Entity / License Boundary

| Item | Reading |
|---|---|
| Legal entity | Sumitomo Mitsui Card Company, Limited |
