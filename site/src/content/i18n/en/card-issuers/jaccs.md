---
source: japanfg/jaccs
source_hash: c9d92dbb9d4c35f0
lang: en
status: machine
fidelity: ok
title: "Jaccs Co., Ltd. (Jaccs)"
...
This entry sits under [[JapanFG/INDEX|JapanFG index]]. Read it against [[card-issuers/orico|株式会社オリエントコーポレーション (Orico)]] for peer / contrast context and [[banking/INDEX|banking index]] for the broader system / regulatory boundary.
...
**Formal name**: Jaccs Co., Ltd.
**Securities code**: TSE PRIME **8584**
**Established**: **1954-07** (formerly Hokkaido Shinyo Hanbai Co., Ltd.; originated in Hakodate)
...
```
1954-07  Hokkaido Shinyo Hanbai (Hakodate)
   ↓ 1968  company-name change
Jaccs
...
| Segment | Main businesses | Characteristics |
|---|---|---|
| **Individual installment credit (shopping credit)** | Auto loans / education loans / home renovation loans | **Core 3  large-loan axis**, strong in sales finance through merchants |
| **Credit cards** | Jaccs Card (VISA / Mastercard / JCB partnerships) | Developed as a consumer contact point |
| **Card loans** | Unsecured personal loans | Own channels and bank guarantee partnerships |
| **Collection agency services** | Account-transfer collection for utilities and recurring charges | BtoB recurring revenue |
| **Rent guarantees** | Guarantee services for rental housing | Linked with the real estate industry |
| **Corporate finance** | Corporate leasing and installment transactions | Complementary business |
| **Overseas** (ASEAN) | Consumer finance in Vietnam, Cambodia, and Indonesia | Focused on motorcycle loans and durable-goods loans |
...
- **Vietnam**: Full-scale entry from around 2014 年, with motorcycle and home-appliance loans
...
| Year | Event |
|---|---|
| **1954-07** | **Hokkaido Shinyo Hanbai Co., Ltd. established in Hakodate** |
...
| 2024〜 | Medium-term management plan (public version) launched |
...
### Medium-Term Strategy (Public Direction)

- **Deepening 3  large loans (auto, education, home renovation)**
...
- **Lead regulator**: Financial Services Agency (FSA)
- **Registration**: Registered operator under the Installment Sales Act and Money Lending Business Act
- **Industry association**: Member of the Japan Consumer Credit Association (JCA)
- **Major regulations**:
  - Installment Sales Act: comprehensive credit purchase intermediaries and individual credit purchase intermediaries
  - Money Lending Business Act: subject to total-volume controls (annual income 1/3  rule)
  - Act on the Protection of Personal Information and amended Payment Services Act (crypto-asset matters are outside scope)
- **Recent policy issues**:
  - 2024〜 introduction of AI / machine learning into credit models
  - Cashless-payment policy (card fees and merchant regulation)
  - 2025〜 amended Installment Sales Act and more advanced identity verification
...
> confidence: **likely** (constructed only from public information, 2026-05-19). Establishment year, listing year, parent-company relationship, and business-category classification are within the range verifiable from Wikipedia + Jaccs official IR. Details on overseas bases and medium-term plans are limited to public materials. No internal or non-public information is included.
