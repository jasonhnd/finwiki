...
| **Disclosure obligation** | Installment Sales Act annual quality rate, franchise store performance, security guideline (J-CSC) | Money Lending Business Act Article 13  Document Delivery, Article 17  Contract Document | Installment Sales Act annual quality rate, franchise store indication, individual contract | METI 后払い FAQ guidance + Consumer Contract Law | Installment Sales Act Actual annual rate + dealership disclosure | Important matters statement + bank-side disclosure | Bank-side disclosure + JFC product disclosure | Money Lending Business Law Article 13/17  | METI + Consumer Contracts Act + wallet T&C |
...
| **Bank-adjacency** | Megabank-FG aligned: [[JapanFG/smbc-card\|SMBC Card]] (SMFG), [[JapanFG/mufg-nicos\|MUFG NICOS]] (MUFG), [[JapanFG/jcb\|JCB]] (multi-bank), [[JapanFG/rakuten-card\|Rakuten Card]] (Rakuten FG), [[JapanFG/paypay-card\|PayPay Card]] (PayPay FG) | Mixed: [[JapanFG/smbc-consumer-finance\|SMBC Consumer Finance / Promise]] (SMFG 100%), [[JapanFG/acom\|ACOM]] (MUFG 39.6% equity-method), [[JapanFG/aiful\|AIFUL]] (independent) | Bank-FG aligned: [[JapanFG/jaccs\|JACCS]] (MUFG equity-method), [[JapanFG/orico\|Orico]] (Mizuho + Itochu), [[JapanFG/aplus\|APLUS]] (SBI Shinsei), Credit Saison (independent / Mizuho-adjacent) | Mostly non-bank: Paidy (PayPal), Atone (Net Protections), NP後払い (Net Protections) — but bank-FG card issuers also extend BNPL-like products | OEM-captive: Toyota Finance (Toyota), Honda Finance, Nissan Financial Services — non-bank captive, sometimes bank-partnered | Bank-fronted (private): all megabanks + regional banks; JHF is policy-finance non-bank | Bank-fronted (民間 education loan); JFC is policy-finance non-bank | Often non-bank social-finance + money lending small ops | Bank-FG aligned if parent PSP is bank-adjacent |
