...
|---|---|---|
| SoftBank / LY wallet | [[payment-firms/paypay|PayPay]] and [[megabanks/paypay-fg|PayPay FG]] | Largest consumer-wallet gravity, merchant acceptance, points / campaigns, bank / card / securities cross-sell. |
| Rakuten ecosystem | [[payment-firms/rakuten-fg|Rakuten FG]], [[card-issuers/rakuten-card|Rakuten Card]], [[payment-firms/rakuten-edy|Rakuten Edy]] | E-commerce, card, points, bank / securities adjacency; app and card economics interact. |
| Telecom wallet | [[payment-firms/au-payment|au PAY]] and [[megabanks/au-fh|au Financial Holdings]] | KDDI distribution, telecom billing, bank / card / securities / insurance bundle. |
| NTT docomo route | [[megabanks/ndfg|NTT docomo FG]] | d払い / dカード / bank-facing strategy be tracked through NDFG as structure stabilizes. |
| Marketplace wallet | [[payment-firms/merpay|Merpay]] and [[payment-firms/mercari-hd|Mercari HD]] | Marketplace balance, BNPL / credit, identity, and bank-license ambition. |
| Bank-linked wallet | [[payment-firms/recruit-mufg-business|Recruit MUFG Business]] | COIN+ / Air Wallet route; account-linked payment and Recruit merchant / consumer surfaces. |
| Travel wallet | [[payment-firms/jal-payment-port|JAL Payment Port]] | Loyalty / travel embedded finance, prepaid, transfer, bank agency. |
| QR gateway / PSP | [[payment-firms/netstars|Netstars]], [[payment-firms/sb-payment-service|SBPS]], [[payment-firms/gmo-payment-gateway|GMO-PG]] | Merchant-side aggregation, onboarding, settlement, and risk controls. |
...
| Question | Route |
|---|---|
| Is this a wallet or a merchant PSP? | Compare [[payment-firms/paypay|PayPay]] with [[payment-firms/netstars|Netstars]] and [[payments/psp-merchant-settlement-risk]]. |
