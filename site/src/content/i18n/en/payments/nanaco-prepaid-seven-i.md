...
**nanaco** is the Seven & i Holdings group's **convenience-store-anchored prepaid e-money**, launched in 2007-04 alongside Aeon's WAON. It is issued by [[JapanFG/seven-card-service|Seven Card Service Co., Ltd.]], an FSA-registered third-party prepaid payment instrument issuer (corporate number 4010001088278, registered 2007-02-22). nanaco runs on **FeliCa** contactless IC and is the dominant prepaid e-money at the **20,000-plus 7-Eleven Japan store network**, as well as Ito-Yokado supermarkets, Sogo & Seibu department stores, Akachan Honpo, Denny's Japan, and a broad external merchant footprint. Settlement runs through [[JapanFG/seven-payment-service|Seven Payment Service]] under the [[banking/INDEX|Seven & i financial-services platform]], alongside [[JapanFG/seven-bank|Seven Bank]] as the group bank rail and ATM-charge route, and Seven Card Plus as the co-branded credit card for auto-charge. nanaco Points convert 1:1 into spendable balance, paralleling the WAON POINT model.
...
| FSA prepaid issuer of record | [[JapanFG/seven-card-service\|Seven Card Service Co., Ltd.]] |
| Corporate number | 4010001088278 |
| FSA registration date | 2007-02-22 |
| Settlement / payment services | [[JapanFG/seven-payment-service\|Seven Payment Service Co., Ltd.]] |
| Group bank rail | [[JapanFG/seven-bank\|Seven Bank, Ltd.]] (ATM charge, auto-charge) |
...
- [[JapanFG/seven-card-service|Seven Card Service]] is registered with the FSA through the Kanto Local Finance Bureau and appears in [[payments/prepaid-payment-instrument-issuers-japan-index|`daisan.xlsx`]].
