...
status: machine
fidelity: ok
title: "CoinDCX — India's largest CEX / FIU-IND PMLA registered overview"
translated_at: 2026-05-31T03:19:56.377Z
---
...
- **India spot market share**: one corner of the duopoly alongside [[exchanges/cex-wazirx-india|WazirX]]; effectively the largest domestic player since the 2024-07  WazirX Liminal hack
...
| 2024-07 | [[exchanges/cex-wazirx-india|WazirX]] Liminal hack $235M; CoinDCX becomes effectively the largest domestic player |
...
- **Trust benefit after the WazirX hack**: since the 2024-07  [[exchanges/cex-wazirx-india|WazirX]] $235M Liminal hack, it has strengthened proof-of-reserves disclosure and foregrounded its insurance / guarantee framework to consolidate the domestic #1  position
...
- **1% TDS handling**: implemented automatic calculation / reporting systems for India's unique withholding framework, countering customer outflow to overseas CEXs (the offshore arms of [[exchanges/jp-foreign-exchange-bybit|Bybit]] / [[exchanges/jp-foreign-exchange-bitget|Bitget]], etc.)
...
CoinDCX, as one of the **largest CEXs of 1 ** in India's crypto market, leads the Indian industry on the 3  fronts of FIU-IND registration + institutional-investor funding + Unicorn valuation. Globally it does not reach [[exchanges/global-cex-top10-comparison|top 10]], but in the India / South Asia region it holds an effectively dominant position.

The structural features of the India market are **(a) trading-volume contraction from 1% TDS**, **(b) the impossibility of loss-offset on 30% capital gains**, **(c) domestic KYC/AML control from FIU-IND PMLA registration**, and **(d) the instability of UPI bank access** — these largely determine the earnings volatility of domestic CEXs such as [[exchanges/cex-wazirx-india|WazirX]] / CoinDCX / ZebPay.

## Related

- [[exchanges/cex-wazirx-india]] — India #2  / Liminal hack victim (most important cross-link)
- [[exchanges/global-cex-top10-comparison]] — Global CEX top 10
- [[exchanges/global-vasp-regulatory-comparison-matrix]] — Global VASP regulation comparison
- [[exchanges/INDEX]] — Exchange domain index
- [[exchanges/global-crypto-forensics-vendor-layer]] — Custody/forensics layer such as Liminal
- [[exchanges/jp-foreign-exchange-bybit]] — Comparison of offshore outflow destinations for India residents
- [[exchanges/cex-bithumb-korea]] — Asia-region CEX comparison
