...
- **Securities cross-sell** — SBI VC Trade reaches into the SBI Securities account base (Japan's #1 online broker) as a cross-promotion lane, with the SBI Common ID linking accounts across group brands
...
- **Remittance** — [[JapanFG/sbi-remit|SBI Remit]] runs the group's outbound remittance / funds-transfer service surface
...
- **BNPL** — [[JapanFG/gmo-postpay|GMO Postpay]] runs the group's BNPL / deferred-payment line
...
- **Internal sister entity**: [[exchanges/jp-exchange-custodiem|Custodiem]] (formerly FTX Japan, acquired 2024) sits inside bitFlyer Holdings for institutional / segregated-asset business
...
- **Crypto derivatives** — Monex, Inc. (separate license holder) runs crypto derivatives under FIEA Type 1, complementing Coincheck's spot-only license
...
- **Wallet / payments** — Merpay (group wallet, holds a funds-transfer service license) provides the in-group JPY rail and is the primary entry point for Mercoin's BTC purchases via Mercari points / Mercari sales proceeds
...
- **No bank in group** — Mercari does not run a bank; JPY rails route through Merpay's funds-transfer service license + partner banks
- **Points cross-link** — Mercari Points can be exchanged for BTC inside Mercoin, which is the distinguishing cross-link
...
- **License** — Laser Digital Japan holds FIEA Type 2 (derivatives-focused) rather than the standard crypto-asset exchange operator registration, reflecting the institutional / derivatives focus rather than retail spot
...
### Crypto Garage — Daiwa Securities Group (8601) + DG / Nomura connection

**Parent FG**: [[JapanFG/daiwa-sg|Daiwa Securities Group]] (TSE Prime 8601), with DG Holdings (Digital Garage 4819), Tokyo Tanshi, and other strategic investors on cap table. **Group services contributed**:
...
**Adjacency intensity**: high (institutional / experimental) — Crypto Garage sits at the intersection of Daiwa institutional surface and JPX-adjacent experimentation, with sibling-entity [[exchanges/jp-exchange-digital-asset-markets|Digital Asset Markets]] in the same JPX / Mitsui & Co. / Monex consortium for institutional spot. Detail: [[exchanges/jp-exchange-crypto-garage|jp-exchange-crypto-garage]].
...
**Parent FG**: KDDI (TSE Prime 9433) via au Jibun Bank / au PAY / au Financial cluster. **Group services contributed**:
- **Telco** — KDDI (au) is one of the 3 MNOs
- **Bank** — au Jibun Bank (joint venture with MUFG) is the in-group internet bank
- **Wallet** — au PAY (QR / code payment) and au PAY Card sit inside the FG
- **Securities** — au Kabucom Securities (joint venture with MUFG, formerly kabu.com Securities) provides FIEA broker surface
...
|---|---|---|---|---|---|---|---|---|---|---|
| **SBI VC Trade** | [[JapanFG/sbi-hd\|SBI HD]] | 8473 | [[JapanFG/sbi-shinsei-bank\|SBI Shinsei Bank]] + regional-bank-HD | [[JapanFG/sbi-securities\|SBI Securities]] (JP #1 online) | [[JapanFG/sbi-remit\|SBI Remit]] | SBI Common ID | [[JapanFG/sbi-life\|SBI Life]] + [[JapanFG/sbi-insurance\|SBI Insurance]] | (limited) | very high | Yes — superstore model |
...
| **Mercoin** | [[JapanFG/mercari-hd\|Mercari HD]] | 4385 | (none) | (none) | Merpay (funds-transfer service) | Mercari Points | (none) | Mercari (largest JP C2C) | very high | Yes — captive marketplace on-ramp |
...
| **Crypto Garage** | [[JapanFG/daiwa-sg\|Daiwa SG]] + DG + Tokyo Tanshi + Nomura | 8601 (Daiwa) | [[JapanFG/daiwa-next-bank\|Daiwa Next Bank]] | Daiwa Securities (JP #2 wealth) | (none) | (none) | (Daiwa Life) | (none) | high (institutional) | Yes — institutional + JPX-adjacent |
...
| **au-related** | KDDI | 9433 | au Jibun Bank (with MUFG) | au Kabucom Securities (with MUFG) | au PAY | Ponta-adjacent | (au Insurance) | au Market | low (no own VASP) | (no crypto entity) |
...
3. **Mercoin** (Mercari HD) — captive C2C-marketplace on-ramp + Merpay funds-transfer wallet integration
...
7. **Crypto Garage** (Daiwa SG + DG + Tokyo Tanshi + Nomura) — institutional + JPX-adjacent experimental surface
...
- **Bank-deposit rail** — in-group bank account that customer can use for instant JPY in/out (SBI Shinsei, Rakuten Bank, GMO Aozora Net, Daiwa Next Bank, au Jibun Bank, PayPay Bank). Without an in-group bank, the VASP must route through partner-megabank rails with corresponding settlement-time and fee disadvantages.
- **Securities-brokerage account base** — the parent's existing FIEA brokerage customers as a cross-sell pool (SBI Securities, Rakuten Securities, Nomura Securities, Daiwa Securities, Monex Securities, GMO Click Securities, au Kabucom Securities, PayPay Securities). Cross-sell from a brokerage account is the lowest-CAC channel for a JP VASP.
- **Wallet / funds-transfer service** — Merpay, PayPay, au PAY, Rakuten Pay, Rakuten Edy, SBI Remit (outbound remit). The funds-transfer service license is structurally complementary to crypto-asset exchange operator registration since it handles JPY-side movement that the VASP's exchange license does not cover.
...
- **Medium funding cost**: Coincheck (Monex Group, no in-group bank but listed parent with capital-market access), Mercoin (Mercari HD, Merpay funds-transfer service covers JPY-side but no actual bank)
...
- FSA registered crypto-asset exchange operators list: https://www.fsa.go.jp/menkyo/menkyoj/kasoutuka.xlsx
