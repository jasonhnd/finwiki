...
Japan PE research starts with the exact GP, fund, acquisition vehicle, target, financing, governance rights, and exit documents. Global and domestic managers may use GP-LP arrangements, fees/carry, acquisition SPCs, portfolio-company governance, value-creation plans, and several exit routes, but none of those terms or routes should be inferred from the manager category. Use [[finance/japan-acquisition-finance|acquisition finance]] for a disclosed debt stack and [[finance/japan-tender-offer-process|tender offer process]] when a public-target transaction falls within that route.
...
For a carve-out, [[finance/japan-mbo-and-squeeze-out-process|MBO]], or take-private, identify bidder, financing sources, lenders, and advisers from the named filings. Attribute [[securities-firms/nomura-hd|Nomura]], [[securities-firms/daiwa-sg|Daiwa]], [[securities-firms/smbc-nikko|SMBC Nikko]], [[securities-firms/mizuho-securities]], [[securities-firms/morgan-stanley-japan|Morgan Stanley Japan]], or [[securities-firms/goldman-sachs-japan|Goldman Sachs Japan]] only under a defined [[finance/japan-ib-league-table|league-table]] category, period, and crediting rule or a deal filing.
...
| Squeeze-out | Companies Act cash-out, share consolidation | EDINET, JPX TDnet, see [[finance/japan-mbo-and-squeeze-out-process|MBO and squeeze-out]] |
| Delisting | JPX delisting notice | JPX listing-status update |

For a listed target, determine whether FIEA tender-offer rules apply. METI Fair M&A materials are guidance relevant to their stated scope, not a substitute for law or proof that every PE deal follows one process. See [[finance/japan-tender-offer-process|Japan tender offer process]].
...
An IPO exit routes through the [[securities/japan-ipo-listing-disclosure-route|Japan IPO listing disclosure route]] and applicable [[securities/japan-underwriting-market-structure|underwriting market structure]]. Verify offered shares, selling holders, retained stake, lock-up, board rights, and later sell-down from the named offering.
...
| Underwriter | Lead bookrunner + co-managers (see [[finance/japan-ib-league-table|league table]]) |
...
Identify acquisition-debt arrangers, lenders, borrowers, tranches, and commitments from the named financing disclosure. See [[finance/japan-acquisition-finance|Japan acquisition finance]] for the full-stack checklist.
...
| Lender | Role |
|---|---|
| [[megabanks/mufg|MUFG]] | Verify legal entity, arranger/lender role, tranche, commitment, and date |
| [[megabanks/smfg|SMFG]] | Verify legal entity, arranger/lender role, tranche, commitment, and date |
| [[megabanks/mizuho-fg|Mizuho FG]] | Verify legal entity, arranger/lender role, tranche, commitment, and date |
| [[financial-regulators/dbj|DBJ]] | Verify instrument, ranking, policy rationale if stated, amount, and role |
| Mezzanine providers | Identify each legal entity, instrument, ranking, commitment, and intercreditor terms |

If a [[finance/japan-ib-league-table|league table]] publishes a relevant loan/LBO category, record its period and crediting rule; otherwise use deal documents.

## JIC Capital specific case

[[financial-regulators/dbj|DBJ]] and JIC Capital are distinct entities. Use JIC/JIC Capital's current official materials to identify ownership, mandate, fund, instrument, target, and stated policy rationale; do not infer a “private capital insufficiency” test or assume the public disclosure set is complete.

## Regulatory and disclosure surfaces

Table source note: Each row is tied to the responsible public authority; transaction-specific applicability still depends on the target, investor, sector, thresholds, and current rules. ^[Sources are embedded row by row.]

| Surface | Relevance |
|---|---|
| FIEA tender offer rules | Public-target acquisition disclosure (see [[finance/japan-tender-offer-process|tender offer process]]) ^[Source: https://www.fsa.go.jp/en/laws_regulations/faq_on_fiea/section04.html.] |
...
| FSA large shareholding disclosure | Block ownership reporting (see [[finance/japan-large-shareholding-disclosure|large shareholding disclosure]]) ^[Source: https://www.fsa.go.jp/en/laws_regulations/faq_on_fiea/section03.html.] |
