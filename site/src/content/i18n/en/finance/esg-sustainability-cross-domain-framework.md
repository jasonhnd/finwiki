...
This page sits under [[finance/INDEX|finance domain]] as a cross-domain ESG / sustainability reference. Use [[finance/dcf-vs-multiples-vs-nav-cross-domain-valuation-framework|DCF / multiples / NAV framework]], [[finance/cost-of-capital-japan-2026-reference|cost of capital Japan 2026 reference]], [[finance/real-options-valuation-japan-applications|real options valuation]], [[finance/japan-cross-shareholding-unwinding-economics|cross-shareholding unwinding economics]], [[real-estate-finance/cap-rate-noi-irr-real-estate-valuation-framework|cap-rate / NOI / IRR real-estate framework]], [[structured-finance/japan-green-securitization|Japan green securitization]], [[finance/cross-border-m-a-japan|cross-border M&A Japan]], and [[finance/japan-mbo-and-squeeze-out-process|MBO / squeeze-out process]] as contextual routes only. None proves that ESG changed pricing, WACC, appraisal, diligence scope, or a fairness analysis in a named case.
...
Table source note: Provider rows are sourced individually to the provider's methodology surface as of 2026-07-29. Scales are not interchangeable, and the table does not rank providers or carry forward a score without its methodology date. ^[Sources are embedded row by row.]
...
The [[securities/tokyo-stock-exchange|TSE]] Corporate Governance Code and related disclosure rules create the following review points for Prime Market companies:
...
| Cost of capital and price-to-book | Identify the applicable [[finance/cost-of-capital-japan-2026-reference|TSE programme]] and issuer response; do not infer a valuation effect |
...
Do not attribute foreign-institutional demand or mandate eligibility to a GRESB score without a named mandate and dated holdings/flow evidence. [[real-estate-finance/j-reit-market-overview|J-REIT market overview]] and [[real-estate-finance/j-reit-foreign-investor-ownership|J-REIT foreign investor ownership]] are contextual routes, not causal evidence.

## M&A Due Diligence Implications

An M&A scope may include ESG-related workstreams where target, sector, jurisdictions, disclosures, financing, or risk assessment warrant them. [[finance/cross-border-m-a-japan|cross-border M&A Japan]] and [[finance/japan-m-a-deal-process-comparison-matrix|M&A deal process comparison matrix]] do not establish a universal standard scope.
...
For a named deal, verify whether any representation, warranty, insurance policy, escrow, indemnity, price adjustment, covenant, or closing condition addresses an ESG finding. Separately, cite the applicable rating methodology and rating report before saying an ESG factor drove a rating. [[structured-finance/credit-rating-methodology-jcr-r-and-i|JCR / R&I methodology]] is a research route, not proof of impact.
