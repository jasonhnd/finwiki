...
- **Legacy kanpo block** — the pre-privatization Postal Insurance policies are accounted for under a separate management framework (managed under contract with the Management Organization for Postal Savings and Postal Life Insurance, and overlay the new post-2007 Kampo block.

The dual structure — legacy Kampo + new Kampo — is the key feature that distinguishes Kampo's balance sheet from the private big-four. Asset- allocationclass and ALM are reported on a consolidated basis but the underlying liability structure has two distinct vintages.
...
The 2019 improper-sales scandal is the defining recent governance event:
...
- Analyzing the postal-channel distribution model versus tied / bancassurance / agency models.
