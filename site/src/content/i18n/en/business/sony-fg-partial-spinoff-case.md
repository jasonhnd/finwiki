...
status: machine
fidelity: ok
title: "Sony Financial Group partial spinoff case — 株式分配方式 (in-kind share distribution method) + parent retention below 20% + tax deferral"
translated_at: 2026-05-30T16:08:36.707Z
---

# Sony Financial Group partial spinoff case — 株式分配方式 (in-kind share distribution method) + parent retention below 20% + tax deferral
...
Without all five, the transaction would default to non-qualified treatment with deemed-dividend tax for shareholders and capital-gains tax for the parent. See [[corporate-strategy/spinoff-decision-tree-japan|spinoff decision tree Japan]] for the broader option set.
...
| Toshiba | Toshiba Tec / Toshiba Capital | Different path — see [[business/toshiba-tob-squeeze-out-2023-2024-case|Toshiba TOB squeeze-out 2023-2024]] |
...
> [!info] 校核状态
> confidence: **likely**. Transaction announced and METI-certified; re-listing date is forecast. Final parent retained stake, distribution ratio, and TSE listing date will be confirmed at IPO closing.
