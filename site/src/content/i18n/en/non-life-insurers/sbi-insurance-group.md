...
**Formal name**: SBI Insurance Group Co., Ltd. ^[extracted]
...
```
SBI HD (holding company, listed 8473)
  └── SBI Insurance Group (intermediate holding company, 100%)
        ├── SBI Insurance (100%) -- direct online auto insurance mainly, opened in 2008 
        │     └── Fire insurance, cancer insurance, liability insurance, etc.
        ├── SBI Life Insurance (100%) -- former PCA Life, became SBI in 2015-04 
        │     └── Term death insurance, medical insurance, disability income insurance
        ├── SBI Ikiiki SSI (100%) -- former Airio Life lineage, for seniors
        │     └── Medical and funeral insurance for seniors
        ├── SBI Resta SSI (100%) -- specialist earthquake-expense insurance
```
...
| Year / month | Event |
|---|---|
| 2006-06 | Preparation to establish a direct online auto-insurance subsidiary (SBI Holdings 100% investment) |
| **2008-01** | **SBI Insurance started operations** (direct online auto insurance) |
| 2008 | Airio Life Small-Amount Short-Term Insurance established -> later renamed SBI Ikiiki SSI |
| 2014-02 | SBI HD signed acquisition agreement for PCA Life Insurance (Japan entity of UK Prudential lineage) |
| **2015-04** | **PCA Life -> renamed SBI Life Insurance** (SBI subsidiary conversion completed) |
| 2016 | Resta Small-Amount Short-Term Insurance (earthquake-expense specialist) joined SBI group |
| **2017-04-03** | **SBI Insurance Group established** (intermediate holding company for insurance business) |
| 2017-09-27 | Listed on TSE Mothers |
| 2022 | Medium-term management plan formulated (strengthening cross-sell / expanding earnings base) |
| **2023-08** | **SBI HD announced TOB aimed at full subsidiary conversion** (shareholder returns + securing management agility) |
| **2023-09-29** | **Delisted from TSE Growth -> became SBI HD 100% wholly owned subsidiary** (squeeze-out completed) |
| 2024 onward | Under the medium-term plan, integrated operation of insurance companies and faster customer-base sharing with SBI Securities / SBI Shinsei Bank |

## 2. Business segment map

| Subsidiary | Business type | Main products | Features |
|---|---|---|---|
| SBI Insurance | Non-life | Auto insurance | Direct online sales, mileage-based rates, young to mid-career customers |
| SBI Life Insurance | Life | Term death + medical + disability income | Former PCA, focused on simple protection |
| SBI Ikiiki SSI | Small-amount short-term | Senior medical / funeral | Specialized for seniors |
| SBI Resta SSI | Small-amount short-term | Earthquake-expense insurance | Niche, earthquake-disaster focused |
...
- **Regulatory law**: Insurance Business Act (non-life and life subsidiaries) + Insurance Business Act Article 272  (small-amount short-term insurance providers)
- **Soundness**: Solvency margin ratio (consolidated + individual)
- **Policy issues from 2024 onward**:
  - Personal information protection (high dependence on data because of direct online sales)
  - Cybersecurity (strengthened FSA monitoring)
...
- **Wikipedia: SBI Insurance Group** (https://ja.wikipedia.org/wiki/SBIインシュアランスグループ, extracted 2026-05-19)
...
> confidence: **likely** (v1.0  Wikipedia + SBI HD IR checked 2026-05-19, listing status rechecked 2026-05-29). The company discloses its insurance business segment as a consolidated subsidiary of SBI HD (voting rights 59.67% as of 2025-03-31), but **full subsidiary conversion and delisting have not occurred, and the company remains listed on the TSE Growth Market (7326)** (confirmed through 2026-05-29 IR and Wikipedia). Subsidiary-level KPIs (number of policies in force, premium income, combined ratio) vary by date, and the latest values require reference to SBI HD quarterly reports. Specific locations and scale of overseas insurance businesses are limited to public information.
