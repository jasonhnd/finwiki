...
status: machine
fidelity: ok
title: "Deloitte Touche Tohmatsu LLC (Deloitte Touche Tohmatsu)"
...
This entry sits under [[financial-regulators/INDEX|financial-regulators INDEX]]. Read it alongside [[financial-regulators/ey-shinnihon|EY 新日本]] and [[financial-regulators/pwc-aarata|PwC あらた]] for peer Big 4  audit context, and [[financial-licenses/INDEX|金融ライセンス INDEX]] for the regulatory boundary of the Certified Public Accountants Act / audit quality control. The CPAAOB supervisory context falls under the jurisdiction of [[financial-regulators/fsa-supervision-bureau|金融庁 監督局]] and [[financial-regulators/fsa-strategy-bureau|金融庁 総合政策局]].

## 1. Firm overview

- **Official name**: Deloitte Touche Tohmatsu LLC ^[extracted]
- **English name**: Deloitte Touche Tohmatsu LLC ^[extracted]
- **Legal form**: limited-liability audit corporation ^[extracted]
- **Headquarters**: Marunouchi, Chiyoda-ku, Tokyo ^[extracted]
- **Member network**: **Deloitte Touche Tohmatsu Limited (DTTL)** (London head office) ^[extracted]
- **Group entities**:
  ...
  - Deloitte Tohmatsu Risk Advisory LLC (risk / cyber) ^[extracted]

## 2. History

| Year/Month | Event |
|---|---|
| **1968** | **Tohmatsu Awoki & Co. established** (the direct predecessor of Tohmatsu; "Tohmatsu" is short for Tomatsu-Aoki) ^[extracted] |
| 1975 | Touche Ross international affiliation ^[extracted] |
| **1989** | **Touche Ross + Deloitte Haskins & Sells global merger → formation of Deloitte Touche Tohmatsu** (a Japanese-affiliated presence in that "Tohmatsu" was incorporated into the firm name) ^[extracted] |
| **2008-07** | **Conversion into a limited-liability audit corporation under the amendment of the Certified Public Accountants Act** ^[extracted] |
...
| Around 2020 〜 | **Early entry into digital-asset audit / Travel Rule consulting** ^[extracted] |

### Banking / insurance / securities ^[extracted]
...
- As referenced in **[[exchanges/japan-crypto-audit-firm-landscape|国内クリプト監査ランドスケープ]]**, a front-runner in the **financial-statement audit + segregated-management audit** of FSA-registered VASPs
- Involved in the formulation of the **JICPA Industry Committee Practical Guideline 第 61 号 (audit of crypto-asset-related businesses)** ^[extracted]
- Major domestic crypto-asset exchanges (public, related cases including the [[exchanges/jp-exchange-bitflyer|bitFlyer]] group)

### Travel Rule / AML consulting ^[extracted]

- Consulting relating to [[exchanges/jp-vasp-aml-travel-rule-implementation|JVCEA Travel Rule 実装]]
- AML / sanctions-screening advice
- Coordination with the risk-advisory division (Risk Advisory LLC)

### M&A / FAS (separated from audit) ^[extracted]
...
- **Major VASPs** — audit track record related to the [[exchanges/jp-exchange-bitflyer|bitFlyer]] group, etc. (public-basis references exist) ^[extracted]
...
- **Supervision**: **the FSA's Certified Public Accountants and Auditing Oversight Board (CPAAOB)** conducts quality-control reviews / inspections ^[extracted]
- **CPAAOB inspection results**: an outline of the inspection results of major audit firms is published in the annual "Activities of the Certified Public Accountants and Auditing Oversight Board" report ^[extracted]

### Past disciplinary history ^[extracted]
...
- [[securities-firms/nomura-hd]] (a major client domain in the securities sector)
...
> confidence: **likely** (based on v1.0  public sources, 2026-05-24). The legal form, history, Big 4  affiliation, and crypto-asset front-runner status are of high reliability on a public basis. The auditor for individual clients should be confirmed each time in EDINET primary sources.
