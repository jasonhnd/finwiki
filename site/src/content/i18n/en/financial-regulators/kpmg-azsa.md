...
This entry sits under [[financial-regulators/INDEX|financial-regulators INDEX]]. Read it alongside [[financial-regulators/ey-shinnihon|EY 新日本]] and [[financial-regulators/deloitte-touche-tohmatsu|トーマツ]] for peer Big 4  audit context, and [[financial-licenses/INDEX|金融ライセンス INDEX]] for the regulatory boundary of the Certified Public Accountants Act / audit-quality control. The CPAAOB supervision context falls under [[financial-regulators/fsa-supervision-bureau|金融庁 監督局]] and [[financial-regulators/fsa-strategy-bureau|金融庁 総合政策局]].

## 1. Firm overview

- **Legal name**: KPMG AZSA LLC (有限責任 あずさ監査法人) ^[extracted]
- **English name**: KPMG AZSA LLC ^[extracted]
- **Legal form**: limited-liability audit corporation ^[extracted]
- **Head office**: Tsukudo-cho, Shinjuku-ku, Tokyo (Tokyo KPMG Tower) ^[extracted]
- **Member network**: **KPMG International Cooperative** (head office in Amsterdam) ^[extracted]
...
| Date | Event |
|---|---|
| **2003-12** | **AZSA & Co. established** (merger of the Asahi + Ota Showa lineages) ^[extracted] |
| **2010-07** | **Transitioned to KPMG AZSA LLC under the revised Certified Public Accountants Act** ^[extracted] |
| 2020s | KPMG Japan brand integration / new sustainability entity established ^[extracted] |

### Financial-institution audit (greatest strength) ^[extracted]
...
- Advisory from [[exchanges/jp-crypto-bank-credit-facilities|銀行系クリプト与信検討]] (business expertise on both financial institutions and crypto assets)
- As noted in [[exchanges/japan-crypto-audit-firm-landscape]], strength in advising megabank-affiliated / regional-bank-affiliated crypto-asset-related companies
...
- **Registration**: the Japanese Institute of Certified Public Accountants (JICPA) ^[extracted]
...
- [[financial-regulators/taiyo-grant-thornton]] (second-tier major peer)
- [[megabanks/smfg]] (megabank-affiliated major client domain)
...
> confidence: **likely** (based on v1.0  public sources, 2026-05-24). The legal form, historical mergers, and Big 4  affiliation are highly reliable on a public basis. The auditor of each specific client should be confirmed each time against EDINET primary sources.
