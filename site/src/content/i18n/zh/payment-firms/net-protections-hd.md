...
| 业务线 | 公开来源解读 |
|---|---|
| NP 后払い | 面向 EC 的商户结账 BNPL。产品页面将其描述为消费者收货后付款，以及面向商户的授信筛查、发票、回收和费率计划组合服务。 |
| atone | 以消费者账户为基础的 BNPL，可让用户跨参与商户汇总购买并延后付款；应读作集团内偏消费者钱包的业务线。 |
| NP 掛け払い | BtoB 发票付款外包。公开页面描述其提供授信 / 应收保证、发票开具、回收、入金管理、催收和咨询处理。 |
| AFTEE | 日本以外市场的海外 BNPL 品牌；除非来源明确把本地牌照与日本实体相连，否则应与日本监管页分开阅读。 |
| 上市控股公司视角 | IR 页面和东证 Prime 上市使 Net Protections 适合用来阅读公开 BNPL 经济性：GMV、加盟店基础、信用损失指标可以从披露材料核对，而不必从私有市场同行推断。 |
