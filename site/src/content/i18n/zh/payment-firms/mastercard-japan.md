...
本条目位于 [[JapanFG/INDEX|JapanFG index]] 之下。可对照 [[card-issuers/jcb|JCB]] 理解同业 / 对比背景（4-party global scheme vs JCB 的 3-party hybrid），并参照 [[payments/japan-interchange-and-merchant-fee-stack|Japan interchange and merchant fee stack]] 理解更广泛的系统 / 监管边界。
