...
|---|---|---|
| 母公司生态 | 商务、支付、电信、证券、信托银行、区域银行或独立集团 | 解释获客与交叉销售成本。 |
| 账户规模 | 带日期戳的账户数或客户基础 | 仅在带日期时有用；账户数可能快速变动。 |
| 存款特许经营 | 存款余额、工资账户、结算账户或促销余额 | 决定资金稳定性与主银行转化。 |
| 放贷构成 | 住房贷款、卡贷、个人贷款、企业贷款、证券质押，或无实质性贷款账簿 | 驱动 ROA、信用风险及资本使用。 |
| BaaS / API 深度 | 合作分行、API 服务、白标账户、法人 API | 区分消费 app 银行与平台基础设施银行。 |
| 证券 / 支付邻接性 | 经纪、钱包、卡、QR 支付、快速入金、外汇 | 解释日常频次及净息差以外的收入。 |
| 监管栈 | 银行牌照、银行代理、电子结算代行业、资金移动、预付、FIEA | 防止把 UX 误认为法律职能。 |

## Model Notes

### Ecosystem Retail

[[banking/rakuten-bank|Rakuten Bank]]、[[banking/paypay-bank|PayPay Bank]] 与 [[banking/au-jibun-bank|au Jibun Bank]] 是生态系统银行。其公开分销面包括商务、电信、卡、钱包、积分、证券及日常支付行为。主账户转化字段包括工资入账、定期付款、住房贷款、卡及高频转账。
...
1. 账户数指标及来源日期。
2. 母集团、仅银行、仅账户，或活跃客户的数据类别。
3. 在分别披露时的 BaaS 账户与主零售银行账户。
4. 存款规模与放贷盈利能力。
5. 与 [[banking/japan-baas-operating-models|BaaS operating models]] 及 [[payments/japan-bank-api-payment-agency-route|bank API payment agency route]] 相关联的 API / 银行代理类别。
6. 与 [[securities/INDEX|securities index]] 及快速入金路线相关联的证券流动。
...
- FSA：持牌银行名单。
- Rakuten Group / Rakuten Bank 公开发布与银行披露。
- PayPay Bank 公司简介及与 PayPay 所有权相关的发布。
- au Jibun Bank 业绩 / 披露页面。
- SSNB 公司 / NEOBANK 页面。
- GMO Aozora Net Bank 公司页面。
- Sony Bank 简介 / 披露页面。
- UI Bank 公司信息。
