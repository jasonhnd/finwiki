...
GMO あおぞらネット銀行 (GMO Aozora Net Bank, Ltd.) 是日本网络银行版图中的**法人 / 中小企业 / 金融科技 API 银行**支柱 —— 区别于 [[banking/rakuten-bank|Rakuten Bank]] / [[banking/paypay-bank|PayPay Bank]] / [[banking/au-jibun-bank|au Jibun Bank]] 的消费者生态圈取向,以及 [[JapanFG/ssnb|SSNB / NEOBANK]] 的 BaaS 合作渠道架构。该银行是合资企业:据官方公司概要,[[JapanFG/aozora-bank|あおぞら銀行]] 持有 50% 的股权(及 85.12% 的表决权),而 GMO 一方([[JapanFG/gmo-financial-hd|GMO Internet Group]] 25% + GMO Financial Holdings 25%)持有 50% 的股权但仅有 7.43% + 7.43% 的表决权 —— 即青空保留表决控制权,而 GMO 主导运营。该银行于 **2018** 由其原 あおぞら信託銀行(成立于 2004-04)形态更名而来,此前 GMO 取得运营控制权(青空保留 50% 股权 / 85.12% 表决权)。其旗舰产品为 **あんしんワイド**(一款无抵押的中小企业 / 自由职业者商业贷款产品,采用基于 GMO Payment Gateway 交易数据的 AI 驱动核保)及 **「銀行 API for Developers」**(一套涵盖余额查询、转账、开户及会计 SaaS 集成的综合公开 API 栈)。战略合作伙伴包括 [[fintech/japan-stablecoin-regulatory-landscape|fintech-adjacent operators]]、freee、マネーフォワード、Square、Stripe 及 Wise。该银行瞄准传统大型银行企业银行业务与消费者主导网络银行业务之间的空白 —— 为 SaaS / 中小企业 / 自由职业经济提供嵌入式金融。
