...
status: machine
fidelity: ok
title: "乐天银行 (Rakuten Bank)"
translated_at: 2026-05-31T03:19:56.434Z
---
...
乐天银行是乐天集团内部的互联网银行，以与乐天市场、乐天证券、乐天 Pay 等使用导流相结合的「生活账户」化为核心。据官方发布，截至 2026-03 末时点，非合并账户数 1,807 万、存款余额 12.9 兆円，作为单独的网络银行在国内具有最大级别的规模。
...
乐天银行的强项不在于银行单体的利率竞争，而在于利用乐天经济圈内的接触频率进行账户获取。与乐天证券的 sweep / preferential-rate 导流，作为把工资、生活费、投资余力汇集到同一金融圈的装置而发挥作用。

另一方面，存款余额和账户数的增长强烈依赖于乐天集团整体的品牌与积分设计。一旦发生包括乐天移动在内的集团信用问题、积分改订、证券客户流入放缓，也会波及到银行单体的增长率。
