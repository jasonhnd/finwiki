...
| NEOBANK / 白标银行 | 在合作伙伴命题下开设银行账户 | 更完整的嵌入式银行体验 | [[JapanFG/ssnb|SSNB]] / NEOBANK 型模型 |
| 法人 API 银行 | 商业账户、支付、转账、会计集成 | 中小企业 / SaaS / 平台运营 | [[JapanFG/gmo-aozora-net|GMO Aozora Net Bank]] 邻接领域 |
