...
本页将码支付分析归入 [[payments/INDEX|支付领域]]，并把 [[JapanFG/INDEX|JapanFG]] 中的消费者钱包运营商与 [[JapanFG/netstars|Netstars]]、[[payments/psp-merchant-settlement-risk|商户结算风险]] 等 PSP / 网关基础设施连接起来。

## 竞争路线

| 路线 | 核心路径 | 战略解读 |
|---|---|---|
| SoftBank / LY 钱包 | [[JapanFG/paypay|PayPay]] 与 [[JapanFG/paypay-fg|PayPay FG]] | 最大的消费者钱包引力、商户受理、积分 / 活动，以及银行 / 卡 / 证券交叉销售。 |
...
| 电信钱包 | [[JapanFG/au-payment|au PAY]] 与 [[JapanFG/au-fh|au Financial Holdings]] | KDDI 分发、电信计费、银行 / 卡 / 证券 / 保险组合。 |
| NTT docomo 路线 | [[JapanFG/ndfg|NTT docomo FG]] | d Pay / d Card / 面向银行的战略应随着结构稳定通过 NDFG 跟踪。 |
| 市场平台钱包 | [[JapanFG/merpay|Merpay]] 与 [[JapanFG/mercari-hd|Mercari HD]] | 市场余额、BNPL / 信贷、身份，以及银行牌照抱负。 |
