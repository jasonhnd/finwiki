...
将此页面与 [[payments/card-acquiring-japan-stack|Japan card acquiring stack]]、[[payments/japan-card-security-authentication-controls|card security and authentication controls]]、[[payments/credit-purchase-card-operators-japan-index|credit purchase and card operator registry]]、[[payments/psp-merchant-settlement-risk|PSP settlement risk]]、[[payments/cashless-jp-landscape|cashless landscape]]、[[JapanFG/jcb|JCB]]、[[JapanFG/smbc-card|SMBC Card]] 和 [[JapanFG/mufg-nicos|MUFG NICOS]] 一起使用。

## 角色地图

|角色 |它控制什么 |典型的日本FG主播|
|---|---|---|
|发行人 |持卡人筛选、信用额度、计费、循环/分期应收账款、欺诈监控。 | [[JapanFG/smbc-card|SMBC Card]]、[[JapanFG/rakuten-card|Rakuten Card]]、[[JapanFG/paypay-card|PayPay Card]]、[[JapanFG/aeon-financial-service|AEON Financial Service]] |
|品牌/方案|网络规则、品牌接受度、国际路由、卡产品规则。 | [[JapanFG/jcb|JCB]]，Visa / Mastercard / AMEX / Diners 合作伙伴。 |
|收单机构 |商户承保、商户合同、结算、退款/争议处理。 | [[JapanFG/jcb|JCB]]、[[JapanFG/mufg-nicos|MUFG NICOS]]、[[JapanFG/smbc-card|SMBC Card]]、[[JapanFG/gmo-payment-gateway|GMO Payment Gateway]] |
| PSP/网关|技术验收、标记化、支付页面、欺诈过滤器、对帐文件。 | [[JapanFG/gmo-payment-gateway|GMO Payment Gateway]]、[[JapanFG/sb-payment-service|SB Payment Service]]、[[JapanFG/gmo-epsilon|GMO Epsilon]]、[[JapanFG/dg-financial-technology|DGFT]] |
