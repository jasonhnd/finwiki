...
它位于 [[payments/INDEX|payments index]] 下，作为跨类别消费者信用参考。读取时用 [[payments/japan-bnpl-credit-purchase-boundary|Japan BNPL and credit-purchase boundary]] 为 BNPL/信贩行，[[payments/japan-card-issuer-acquirer-processor-split|card issuer / acquirer / processor split]] 为卡端角色分离，[[payments/japan-payment-scheme-economics-matrix|Japan payment scheme economics matrix]] 为跨方案比较本条目刻意补充，[[payments/credit-purchase-card-operators-japan-index|credit-purchase / card operator registry]] 为 METI 注册表行级源，[[JapanFG/legal-financial-licenses/payment-license-stack|Japan payment license stack]] 为监管类别映射，[[policy-finance/japan-housing-finance-agency|Japan Housing Finance Agency]] 为房贷邻接的政策金融面。实体锚的示例为 [[JapanFG/acom|ACOM]]、[[JapanFG/aiful|AIFUL]]、[[JapanFG/smbc-consumer-finance|SMBC Consumer Finance]]、[[JapanFG/aplus|APLUS]]、[[JapanFG/jaccs|JACCS]] 和 [[JapanFG/orico|Orico]]。
...
每行都是一个独立的许可证堆栈。持有超过一项的运营商**不**自动成为控股公司——它更常见的是多牌照的销售金融/消费信贷运营商（例如，[[JapanFG/orico|Orico]]同时持有综合信用购买中介、个人信用购买中介和放贷业务；[[JapanFG/aiful|AIFUL]]通过生命卡持有放贷+综合信用购买中介业务；[[JapanFG/jaccs|JACCS]]持有全部三项业务，再加上综合信用购买中介+个人信贷购买调解）。
...
| **银行毗邻** | Megabank-FG 一致：[[JapanFG/smbc-card\|SMBC Card]] (SMFG)、[[JapanFG/mufg-nicos\|MUFG NICOS]] (MUFG)、[[JapanFG/jcb\|JCB]]（多银行）、[[JapanFG/rakuten-card\|Rakuten Card]] (Rakuten FG)、[[JapanFG/paypay-card\|PayPay Card]] (PayPay FG) | 混合：[[JapanFG/smbc-consumer-finance\|SMBC Consumer Finance / Promise]]（SMFG 100%）、[[JapanFG/acom\|ACOM]]（MUFG 39.6% 权益法）、[[JapanFG/aiful\|AIFUL]]（独立） | 银行-FG 一致：[[JapanFG/jaccs\|JACCS]]（MUFG 权益法）、[[JapanFG/orico\|Orico]]（瑞穗 + 伊藤忠）、[[JapanFG/aplus\|APLUS]]（SBI Shinsei）、Credit Saison（独立/瑞穗相邻） | 主要是非银行：Paidy (PayPal)、Atone (Net Protections)、NP 后払い (Net Protections) — 但银行 FG 发卡机构也扩展了类似 BNPL 的产品 | OEM自保：丰田金融（丰田）、本田金融、日产金融服务——非银行自保，有时与银行合作 | 银行主导（私人）：所有大型银行+区域银行； JHF是政策性金融非银行 | 银行贷款（民间教育贷款）； JFC 是政策性金融非银行机构 | 通常是非银行社会金融+放贷小型业务 | 如果父 PSP 与银行相邻，则银行-FG 对齐 |
...
锚定：[[JapanFG/paidy|Paidy]]（由 PayPal 2021-09  收购，价格约为 2.7 bn 美元），Atone / NP Postpaid（净保护）。 [[payments/japan-bnpl-credit-purchase-boundary|BNPL boundary]] 页面逐步完成每个产品的分类测试。消费者事务局 (CAA) 对 BNPL（稍后付款）的**现金兑换滥用**以及使延期付款感觉像现金一样的用户体验模式保持着主动警告渠道 — 请参阅 CAA 的支付问题警告页面。

### 5。汽车金融/自动自保（汽车贷款/汽车信贷）

汽车金融有两种结构形式：（a）通过分期销售法通过经销加盟店网络预订的新盘汽车贷款（例如，[[JapanFG/orico|Orico]]是国内#1 in汽车贷款，[[JapanFG/jaccs|JACCS]]是#2-3），以及（b）**OEM auto-captive**——丰田金融（丰田）、本田金融、日产金融服务、三菱日联租赁和金融（现为三菱 HC Capital）等——主要是为了承保母公司 OEM 的汽车销售。
...
教育贷款账簿通常不会被证券化为独立的教育贷款资产支持证券——银行方风险敞口位于更广泛的无担保消费贷款账簿中。 Shinpan 运营商（例如 [[JapanFG/jaccs|JACCS]]）还根据《分期付款销售法》个人途径提供教育机构渠道，这是继银行-私人和 JFC-公共之后的第三条教育信贷途径。
...
此类别的存在是因为 Mercari/Merpay（其中 Pay Later 功能跨越资金转账 + PayPay 线路）、PayPay（其中 Pay Later 使用 [[JapanFG/paypay-card|PayPay Card]] 作为信用预订）以及 EC 市场的平台端信用实体扩展等运营商。 [[payments/japan-bnpl-credit-purchase-boundary|BNPL boundary]] 页面和 [[JapanFG/legal-financial-licenses/payment-license-stack|payment license stack]] 页面给出了每个产品的分类测试。
...
| FG | 发卡机构 | 消费金融 | 新盘 | 笔记 |
|---|---|---|---|---|
| [[JapanFG/mufg|MUFG]] | [[JapanFG/mufg-nicos|MUFG NICOS]] (100%) | [[JapanFG/acom|ACOM]]（39.6%权益法） | [[JapanFG/jaccs|JACCS]]（权益法） | 3 一个 FG 内的消费信贷足迹 |
| [[JapanFG/smfg|SMFG]] | [[JapanFG/smbc-card|SMBC Card]] (100%) | [[JapanFG/smbc-consumer-finance|SMBC Consumer Finance / Promise]] (100%) | （内部没有主要的 Shinpan；与 Credit Saison 等合作） | 2系列，与shinpan作为合伙而非所有权 |
| [[JapanFG/mizuho-fg|Mizuho FG]] | （UC 卡遗产；合作伙伴关系） | （没有主要的独立） | [[JapanFG/orico|Orico]]（权益法+伊藤忠商事） | Shinpan重，卡片轻 |
| [[JapanFG/sbi-shinsei-bank|SBI Shinsei]] | （新生金融卡产品） | 新生金融 / Lake ALSA（原 GE） | [[JapanFG/aplus|APLUS]]（集团公司） | 通过遗留的 GE / Lake / APLUS 书籍获得重度消费信贷 FG |
| 独立/非银行-FG | [[JapanFG/rakuten-card|Rakuten Card]]、[[JapanFG/paypay-card|PayPay Card]]、[[JapanFG/aeon-financial-service|AEON Financial Service]] | [[JapanFG/aiful|AIFUL]]（创始人家族） | Credit Saison（独立），[[JapanFG/aplus|APLUS]]（SBI 方） | 银行-FG 所有权不存在或部分所有权的情况 |
...
| 2008-04  | 金融服务管理局 | 针对 [[JapanFG/aiful|AIFUL]] 的业务改进令（催收-实践问题）、全部业务暂停令 |
| 2008-10-22 | 三菱日联金融集团TOB | MUFG 收购 [[JapanFG/acom|ACOM]] 的 ~ 40%，权益法合并 |
...
- 每个运营商的IR /公司披露（公开分）：[[JapanFG/acom|ACOM]]（TSE STD 8572），[[JapanFG/aiful|AIFUL]]（TSE PRIME 8515），[[JapanFG/jaccs|JACCS]]（TSE PRIME 8584），[[JapanFG/orico|Orico]]（TSE PRIME） 8585）、[[JapanFG/aplus|APLUS]]（SBI集团公司网站）、[[JapanFG/smbc-consumer-finance|SMBC Consumer Finance / Promise]]（SMFG合并）
