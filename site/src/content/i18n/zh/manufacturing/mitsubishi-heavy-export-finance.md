...
| 项目 | 内容 |
|---|---|
| 正式名 | 三菱重工业株式会社 / Mitsubishi Heavy Industries, Ltd. |
| 设立 | 1950-01-11（前身 1884  三菱造船所，1934  三菱重工业成立，战后 3  分割 → 1964  再整合） |
| 总部 | 东京都千代田区丸之内 3-2-3  |
| 上市 | 东证 PRIME 7011  |
| 合并营收 | 约 4.7 兆円（FY2024） |
| 合并事业利润 | 约 2,800 億円 规模（FY2024） |
...
三菱重工业（7011,  母公司）
  ...
  ├── Aircraft, Defense & Space（防务、航空、宇宙）
  │     ├── F-X（GCAP/GIGO 日英意共同开发）
  │     ├── H-IIA / H3  火箭
  │     └── 面向美军 / 自卫队的装备
  ├── Plants & Infrastructure Systems（化学装置、物流、交通）
  ├── Logistics, Thermal & Drive Systems（叉车、空调、涡轮）
  └── 公司财务（Treasury & Project Finance）
        ├── 出口案件的银团组建（JBIC + 大型银行 + 欧美 ECA）
        ├── NEXI 贸易保险的承保设计
        ├── 项目金融（IPP、火力、海上风电）
        └── 供应链金融、应收账款 ABL
```

MHI 并非「持有银行 / 保险型 captive」，而是作为「**按出口案件设计政策金融 + 商业银行 + ECA 银团型的 finance arm**」运作。
...
- **GCAP/GIGO（Global Combat Air Programme / GCAP International Government Organisation）**：日英意下一代战斗机共同开发。位于旧三菱重工 X-2「心神」的技术延长线上，作为 F-X 构成日本下一代主力战斗机。GCAP International Government Organisation 于 2023 年 末在英国总部成立，由日英意 3  国组建共同合资事业公司。MHI 为日本侧总承包（prime）。商业金融介入有限，以防务预算为基础。
- **「Sapphire（蓝宝石）」防务装备倡议**：以 MHI 名义的防务装备海外拓展倡议，将 Anti-Air / 舰艇、导弹防御系的出口案件面向欧洲、东南亚推进。在装备品出口 3  原则的运用修订后正逐步商业案件化，但 NEXI 覆盖的活用设计是论点。
- **AP1000  系 / 三菱重工 PWR 海外案件**：面向土耳其、东欧、中东的大型核能出口案件。是 JBIC + 政府担保 + 当地政府支援组合的典型情形。
- **H3  火箭商业化**：将与 JAXA 合作的 H3  火箭拓展至商业发射市场，需要卫星运营商合同 + 保险组建。

## 3. KPI（FY2024  合并）

| 指标 | 值 | 出处 |
|---|---|---|
| 合并营收 | 约 4.7 兆円 | MHI 决算短信 |
| 合并事业利润 | 约 2,800 億円 规模 | 同上 |
| 合并净利润 | 约 2,200 億円 规模 | 同上 |
| 合并总资产 | 约 6.5 兆円 规模 | 同上 |
| Aircraft, Defense & Space 营收 | 约 9,000 億円 规模 | 分部信息 |
| Energy Systems 营收 | 约 1.7 兆円 规模 | 同上 |
| Plants & Infrastructure 营收 | 约 6,000 億円 规模 | 同上 |
| 在手订单（合并） | 约 6 兆円 规模（FY2024  末） | Integrated Report |
| 防务、宇宙相关订单 | 数千亿日元〜万亿日元规模 | 分部信息 |
| 海外营收占比 | 超过 50% | 同上 |

> KPI 以 MHI「Integrated Report」「决算短信」「EDINET 有价证券报告书」为基准。防务案件保密性高，分部披露的粒度有限制。
...
- 防务、宇宙、核能、出口管制（外汇法、METI 安全保障贸易管理）的重多重监管。
- 防务装备出口受 2014  防务装备转移 3  原则、2023  运用指针修订的影响，可出口领域逐步扩大。GCAP/GIGO 等国际共同开发案件是新运用的象征。
- 核能出口需要 IAEA 保障措施、出口对象国的核能监管当局审查、政府间核能协定（123  协定 / 日本的双边核能协定）。
- 绿色领域中，METI GX 推进法、JBIC GX 额度的活用余地正在扩大。
...
- [[manufacturing/hitachi-industrial-finance-platform|Hitachi 産業金融]] · [[manufacturing/panasonic-captive-finance|Panasonic 顧客金融]] · [[manufacturing/sony-group-finance-arm|Sony FG]] · [[manufacturing/toyota-financial-services|Toyota Financial Services]]
...
> [!info] 校正状态
> confidence: **likely**。以 MHI IR / 决算短信 / EDINET / JBIC / NEXI 官方信息为基准，由公开信息构成。防务、宇宙相关数值保密性高，以概数记载。GCAP/GIGO・Sapphire 的最终金融组建在 2024-2026  时点进行中，需依 IR 与政府发布随时更新。
