...
| ???? | 254 + Shinkin Central Bank | FSA shinkin license Excel | ?? [[cooperative-banks/shinkin-central|Shinkin Central Bank]] ??????????? [[banking/shinkin-bank-registry-japan]] ??? |
| ???? | 143 + central federation | FSA credit cooperative Excel | ?? [[cooperative-banks/zenshin-kumi|Zenshin-kumi]] ??????????? [[banking/credit-cooperative-registry-japan]] ??? |
| ???? | 13 + Rokinren | FSA rokin license Excel | ?? [[cooperative-banks/rokin-renraku|Rokinren]] ??????????? [[banking/rokin-bank-registry-japan]] ??? |
...
| 信托公司 | 38 | FSA trust company Excel | Registry route completed via [[trust-banks/trust-companies-japan-index]]; priority A / B / C standalone pages completed, and all 38 rows now have standalone or existing group wiki routes. |
...
公司页面层现在由六个控制页支撑：[[financial-licenses/securities-license-stack|日本证券牌照栈]]、[[securities/japan-online-brokerage-competition|日本线上券商竞争]]、[[securities/japan-best-execution-sor-pts|日本最佳执行、SOR 与 PTS]]、[[securities/japan-pts-liquidity-data-guide|日本 PTS 流动性数据指南]]、[[securities/japan-underwriting-market-structure|日本承销市场结构]] 和 [[securities/japan-market-infrastructure-map|日本市场基础设施地图]]。
...
| [x] | Consumer finance / installment E2 | [[consumer-finance/shinsei-financial|新生フィナンシャル]], [[card-issuers/toyota-finance|Toyota Finance]] page split from [[leasing-firms/toyota-financial|Toyota Financial Services]] |
...
| 登记册 | FSA 截止日期 | 官方数量 | 机器匹配下限 | 覆盖决策 | 下一步 |
|---|---:|---:|---:|---|---|
