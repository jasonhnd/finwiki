...
au じぶん銀行 以存款余额与账户数计，跻身日本最大数字银行之列，与 **[[banking/rakuten-bank|楽天銀行]]**、**PayPay 銀行**、**住信SBI ネット銀行**、**ソニー銀行** 并列 ——「ネット銀行」同类组。与 au PAY、au PAY Card 及 Pontaポイント 累积的整合，使其成为忠诚度生态的结构性组成部分，而非独立的数字银行产品。
