...
| **3. QR / 条形码钱包** | au PAY | 无现金钱包、低客单高频支付界面 | [[JapanFG/au-payment|au Payment]]（KDDI 子公司） |
...
| **6. 金融子公司** | au じぶん銀行 + au PAY 損保 + auアセットマネジメント +（auカブコム承继方） | 银行、保险、资产管理产品分销 | [[JapanFG/au-fh|au Financial Holdings]] |
...
| 项目 | au PAY |
|---|---|
| 运营方 | [[JapanFG/au-payment|au Payment]]（KDDI 子公司，[[JapanFG/au-fh|au FH]]合并范围内） |
...
2026-05-12 KDDI 关于 **au Financial Holdings 准备在东京证券交易所上市**的公告，将 au じぶん銀行（在 au FH 合并范围内）纳入 IPO 范围 —— 这是日本以电信为锚的金融控股公司中首个此类 IPO 候选。结构细节见 [[JapanFG/au-fh|au Financial Holdings]]。
...
| 控股公司上市 | **2026-05-12：KDDI 適時開示 [[JapanFG/au-fh|au FH]] IPO 準備開始** | LY（旧 Z HD）已上市；PayPay 銀行 已上市（4689） | 即将到来的 NDFG（约 2026-07 公布的合并）；上市策略待定 |
...
3. **控股公司上市时点**：KDDI 的 2026-05-12 [[JapanFG/au-fh|au FH]] IPO 公告是首个电信金控 IPO 候选。PayPay 的生态已通过 LY / PayPay 銀行 部分上市。NTT docomo 的 [[JapanFG/ndfg|NDFG]] 合并即将到来（约 2026-07），但尚未公布 IPO。
