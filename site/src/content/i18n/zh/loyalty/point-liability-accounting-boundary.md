...
| 已购 / 已充值价值 | 客户支付现金以充值余额 | 预付负债；可能成为受监管的预付式支付手段 | [[financial-licenses/payment-license-stack|FSA prepaid issuer registry]] / 资金结算法 |
...
- 所收资金是预付负债，而非忠诚度负债。
- 运营方须向 FSA 注册为预付发行人（前払式支払手段発行者）—— 登记边界见 [[financial-licenses/payment-license-stack|payment-license stack]]。
