...
|---|---|---|---|---|
| **d Point** | NTT docomo 电信订户 | Lawson、麦当劳、松本清、ENEOS 等 | d払い（d-barai QR）、d Card 信用卡、d Card Prepaid | NTT Docomo 金融部门 → [[JapanFG/ndfg|NDFG]]（含 SMBC 信托路径的计划性合并） |
| **au PAY ポイント（旧 Ponta）** | KDDI / au 电信订户 + Recruit Holdings 共锚联盟 | Lawson、GEO、Shell SS（出光昭和シェル）、Recruit 集团服务（じゃらん、Hot Pepper 等） | au PAY（QR）、au PAY カード、au PAY プリペイドカード | [[JapanFG/au-fh|au FH (KDDI 金融持株)]] + [[JapanFG/au-payment|au Payment]] |
| **V Point** | SMBC 集团金融订户 + CCC 数据库 | T-Card 遗留网络（CCC）、SMBC 卡持卡人、Olive 账户 | Olive一体型、SMBC 卡、V NEAR PAY | [[JapanFG/smfg|SMFG]] / SMBC 卡 |
...
| 银行 | （计划性 NDFG 合并；当前为合作银行） | au じぶん銀行（[[JapanFG/au-fh|au FH]] 子公司） | SMBC + Olive |
| 证券 | （经 SMBC 联盟向 NTT 路径的计划性路线） | au カブコム証券（au FH 子公司） | SMBC日興証券 |
| 保险 | （NTT docomo 保险分销 + 计划性 NDFG 整合） | [[JapanFG/au-insurance|au 損害保険]] + au アセットマネジメント | 合作保险路线 |
...
d Point 计划是 NTT docomo 向**金融控股集团**结构更广推进的面向消费者层 —— 正在组建的合并结构见 [[JapanFG/ndfg|NDFG (NTT docomo financial group)]]。战略脉络：
...
NTT 公开材料所暗示的终局是一个**以电信为锚的金融超级集团**，在整合的积分-支付-金融服务捆绑上与 [[JapanFG/rakuten-fg|Rakuten FG]] 和 [[JapanFG/paypay-fg|PayPay FG]] 抗衡，并以**电信订阅现金流作为底层锚点**。

## KDDI —— au FH 内的 au Point

KDDI 的并行结构在金融一侧比 NTT 更为**已经整合**。[[JapanFG/au-fh|au FH (au Financial Holdings)]] 已拥有：

- au じぶん銀行（au Jibun Bank —— 互联网银行，MUFG 遗留联盟）
- au カブコム証券（au Kabu.com Securities）
- au 損害保険 / [[JapanFG/au-insurance|au 損害保険]]
- au アセットマネジメント
- [[JapanFG/au-payment|au Payment]]（au PAY 运营方）
- au Pay Card
...
| 金融集团终局是什么？ | 以电信为锚的金融控股（[[JapanFG/ndfg|NDFG]]、[[JapanFG/au-fh|au FH]]） | 银行主导集团（[[JapanFG/smfg|SMFG]] / Olive） |
...
- **d Point / au PAY ポイント 的较量是一场跨越数十年的角逐**，因为两个锚点都具备全国足迹，都拥有整合的金融控股，且都无结构性成本劣势。PayPay 的生态（[[JapanFG/paypay-fg|PayPay FG]]）从不同起点（LY / SoftBank / Yahoo 数据资产，而非移动线路锚点）运作，并在第三条轴上竞争。
