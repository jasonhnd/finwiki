...
status: machine
fidelity: ok
title: "比特币现货 ETF 美国获批对国内 CEX 的影响 (2024-01〜)"
translated_at: 2026-05-31T03:19:56.468Z
---

# 比特币现货 ETF 美国获批对国内 CEX 的影响 (2024-01〜)
...
2024-01-10,美国 SEC 一并批准了 BTC 现货 ETF 11 件 (BlackRock IBIT、Fidelity FBTC、Ark 21Shares ARKB、Bitwise BITB、Grayscale GBTC、Invesco/Galaxy BTCO、VanEck HODL、Valkyrie BRRR、Franklin EZBC、WisdomTree BTCW、Hashdex DEFI)。由此,全球机构投资者资金流通过正规渠道向加密资产现货市场释放,对冲基金、养老金、RIA(注册投资顾问)获得了低成本敞口。对日本国内 CEX 的影响,可从 **(a) 现货价格上涨带来的成交量增加** **(b) 国内机构账户加速** **(c) 国内 BTC ETF 解禁讨论正式化** 的 3 条路径观察到。
...
- **税制不公平**:加密资产为杂项所得(累进最高 55%) · ETF 为申报分离课税(20.315%)——同一原始资产存在 35pp 税率差
- **需修改金商法 + 投信法**:在投资信托的"投资对象资产"中加入加密资产。现行投信法 2 条未列举"特定资产",属政令修改级别
- **监管机构分担**:FSA 监督指针 + 行业应对成本 · 需完善保管、估值、流动性规则
- **2026 修订案**:讨论推进中 · ETH/BTC 依次解禁的分阶段论占优
...
- [[exchanges/global-institutional-custody-five-pillars]] — 全球机构托管 5 大支柱
...
来源: 公开信息整理 (SEC press、BlackRock IBIT prospectus、Coinbase Custody IR、FSA 公布、日经/ITmedia 报道、Bloomberg ETF flow data)
