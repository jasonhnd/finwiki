...
被定位为继 3 大megabank（[[megabanks/mufg]] / [[megabanks/smfg]] / [[megabanks/mizuho-fg]]）之后的「**第 4 家megabank**」。作为 **拥有信托职能的商业银行 G**，是不分拆信托银行、以银行兼业方式运营的 **日本首个真正意义上的「商业银行＋信托」模式**。拥有 2003-05  注入公共资金 **1 兆 9600 億円**（实质国有化）→ 2015-06  偿清的重生史。地盘为 **首都圈（埼玉）+ 关西**。随着 2021-04  关西未来 FG 完全子公司化 → **2024-04  吸收合并 KMFG、关西未来银行＋港银行的直接子公司化**，关西整合阶段宣告完成。FY2024（2025-03 期）净利润 **2,133 億円** / 总资产 **77.4 兆円**。^[extracted]
...
> [!info] 验证状况
> confidence: **likely**（基于 v1.1 日文版 Wikipedia + 官方 IR，于 2026-05-19 更新）。重要史实（公共资金 1.96 兆円・2003-05 注入・2015-06 偿清・2021-04 关西未来完全子公司化・2024-04 吸收合并 KMFG）经由 Wikipedia 为公开信息基础。FY2024 决算（2025-03 期）合并数值已经 IR 确认。下次复核将在 FY2025（2026-03 期）决算发表之后。
