...
This entry sits under [[fintech/INDEX|fintech index]]. Read it alongside [[fintech/japan-stablecoin-regulatory-landscape|日本 SC 法制度の三層構造]] for the regulatory frame, [[fintech/japan-epi-three-types-overview|EPI 三類型概要]] for taxonomy, and [[fintech/japan-epi-four-camps-comparison|EPI 四陣営比較]] for competitive landscape. 主要发行方与流通方请参见 [[payment-firms/jpyc|JPYC株式会社]]、[[payment-firms/progmat|株式会社Progmat]]、[[exchanges/jp-exchange-sbi-vc-trade|SBI VC Trade]]。
...
**定位**：Progmat（见 [[payment-firms/progmat|株式会社Progmat]]）是由大型信托银行（MUTB 49% + SMBC 15% + Mizuho 15%）以及 NTT Data、JPX 出资的数字资产平台。发行主体是信托银行，Progmat 是平台提供方。
