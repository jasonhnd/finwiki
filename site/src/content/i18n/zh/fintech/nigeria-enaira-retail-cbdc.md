...
|层|在分销中的作用|力量|弱点|
|---|---|---|---|
|**CBN（尼日利亚中央银行）**|发行人和计划运营商|直接法律授权|与公众没有直接零售关系|
|**DMB**|面向既有银行客户的钱包开通入口|现有客户群|DMB 将 eNaira 视为蚕食手续费收入；推广动力偏弱|
|**移动货币运营商（MMO）**|面向无银行账户人群的钱包获客 / 开户入口|覆盖无银行账户细分市场|MMO 激励错位（eNaira 与自身电子货币业务竞争）|
|**代理银行网络**|现金存入 / 现金取出（cash-in/cash-out）|最大的物理覆盖范围|与零费用的 eNaira 相比，代理更偏好可赚取佣金的代理银行交易|
|**商户**|商户受理|对零售闭环至关重要|缺少大型零售商承诺；非正规商户更偏好现金或 POS|
...
|发行人|CBN（尼日利亚中央银行）|巴哈马中央银行|牙买加银行|中国人民银行|
