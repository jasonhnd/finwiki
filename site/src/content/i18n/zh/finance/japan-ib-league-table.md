...
| 表类型 | 典型指标 | 重要性 |
|---|---|---|
| 并购财务顾问 | 宣布/完成交易金额及交易数量 | 关系资源、跨境顾问能力、董事会信任度 |
| ECM/股票主承销商 | IPO、PO、CB、可交换债券交易金额及发行数量 | 资本市场分销能力及发行人资源 |
| DCM/债券主承销商 | 债券发行金额及发行数量 | 企业、金融机构及公共部门债务资源 |
| IPO主承销商 | TSE/JPX上市程序中的角色、保荐人函、承销角色 | 初创/成长型企业资源及零售/机构分销能力 |

## 阅读规则

1. **记录数据供应商**：LSEG、Dealogic、Bloomberg、Mergermarket及公司自行发布的联赛表可能对交易进行不同分类。
...
- 谁掌握日本发行人资源；
- 银行是否擅长并购顾问或仅擅长承销；
- 某一排名是否反映单笔大型交易或广泛的业务深度；
- 对于跨境交易，国内银行还是外资银行定位更优；
- 如何比较综合性证券公司与在线券商。
