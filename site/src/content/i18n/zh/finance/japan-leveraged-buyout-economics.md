...
日本 LBO 是由发起人主导、以分层债务和股权结构融资的收购交易。核心结构要素包括：SPC 载体、发起人股权、大型银行 LBO 贷款、夹层债（可选）、过桥融资（可选）、担保包、财务契约、篮子条款、EBITDA 调整项、再融资窗口及股息资本化潜力。与美国 / 欧洲相比，日本 LBO 的杠杆水平通常更为保守，契约包更紧，股息资本化操作也不那么激进。大型银行贷款机构（[[megabanks/mufg|MUFG]]、[[megabanks/smfg|SMFG]]、[[megabanks/mizuho-fg|Mizuho FG]]）主导高级债务市场。
...
| 政策投资银行档 | [[financial-regulators/dbj|Development Bank of Japan]] | 战略性 / 政策导向的高级参与 |
...
| 银行 | 典型 LBO 角色 |
|---|---|
| [[megabanks/mufg|MUFG]] / 三菱 UFJ 银行 | 高级 MLA、代理行、对冲交易对手 |
| [[megabanks/smfg|SMFG]] / 三井住友银行 | 高级 MLA、代理行、对冲交易对手 |
| [[megabanks/mizuho-fg|Mizuho FG]] / 瑞穗银行 | 高级 MLA、代理行、对冲交易对手 |
| [[financial-regulators/dbj|DBJ]] | 高级或战略参与，偶尔参与夹层 |
