...
本条目位于 [[card-issuers/INDEX|card-issuers INDEX]] 之下。可与 [[payments/INDEX|payments index]] 一起阅读以获得相邻语境，并与 [[payments/funds-transfer-vs-prepaid-boundary|Funds transfer vs prepaid boundary in Japan]] 对读以把握更广的系统边界。
