...
本条目位于 [[regional-banks/INDEX|regional-banks INDEX]] 之下。可与 [[regional-banks/aozora-bank|あおぞら銀行 (Aozora Bank)]] 对照阅读同业 / 对比语境，并与 [[banking/INDEX|banking index]] 阅读更广泛的系统 / 监管边界。
...
| 年月 | 事项 |
|---|---|
| 1952-12 | **日本长期信用银行（LTCB）设立**（战后复兴期的长期信用机构，依据长期信用银行法的特殊银行） |
| 1970 年年代〜80 年代 | 通过长期设备资金供给和金融债（Ricky 债）发行，成为高度成长期基础设施融资核心 |
| 1985 | 东证一部上市 |
| 1990 年年代前半 | 泡沫破裂后，面向不动产和 nonbank 的不良债权急剧扩大 |
| **1998-10** | **经营破产 → 依据金融再生法临时国有化**（特别公的管理） |
| 2000-03 | 出售给 **美国 Ripplewood Holdings 联合体**（J.C. Flowers 等参与）→ 民间重整 |
| 2000-06 | **改称“新生银行”** |
...
- 原 LTCB 国有化时注入公共资金余额 **约 3500 億円**规模（源自存款保险机构持有股份，SBI 完全子公司化后仍为持续论点）。

## 2. 业务分部地图

| 分部 | 主要业务者 | 特征 |
|---|---|---|
| 零售银行 | SBI 新生银行本体 | 都市中产 / 富裕层，与 SBI 证券联动 |
| 信贩 / 卡 | APLUS Financial | 汽车贷款、分期付款、卡贷款 |
| 消费金融 | 新生 Financial（Lake ALSA） | 原 GE Capital 系无担保贷款 |
...
- 与 SBI 证券进行客户导流和账户联动
- 通过 APLUS / 新生 Financial 扩充零售金融产品线
...
- **主管**: 金融厅（FSA）
- **监管**: 银行法（普通银行）。长期信用银行法下的特殊银行框架在 2000 年年代通过转为普通银行而退出 ^[extracted]
- **存款保险机构**: 原 LTCB 未偿还公共资金的对手方
- **G-SIB 指定**: 无（规模未达）
- **近期政策论点**:
  - 公共资金偿还方案（与 SBI HD 协商，退市后缺乏市场路径）
  - “第 4 家 megabank 构想”的地银网络出资与金融厅地银重组政策的一致性
  - 2024〜 日本银行政策利率正常化局面下利差改善的贡献
...
- **Wikipedia: SBI 新生银行**（https://ja.wikipedia.org/wiki/SBI新生銀行, 2026-05-19 抽出）
- **Wikipedia: 日本长期信用银行**（https://ja.wikipedia.org/wiki/日本長期信用銀行, 2026-05-19 抽出）
- SBI HD 完全子公司化 release（2023-09）・商号变更 release（2023-12）

---

> [!info] 校核状态
> confidence: **likely**（Wikipedia + SBI HD 官方 release 校核 2026-05-19）。重要日期（1998-10 国有化、2000-03 出售给 Ripplewood、2023-09 完全子公司化、2023-12 商号变更）在多个公开来源一致。公共资金未偿还金额的精确值和偿还进展会随时点变化，最新情况需参照 SBI HD IR 和存款保险机构公布。完全子公司化后，决算信息披露密度下降，定量数据嵌入 SBI HD 合并披露中。
