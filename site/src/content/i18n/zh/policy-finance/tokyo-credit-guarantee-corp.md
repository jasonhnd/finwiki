...
东京信用保证株式会社是日本51法人地方信用保证体系的东京都成员。从担保余额、合格借款人数量和政策计划规模来看，它始终是联盟中最大的单一公司，因为东京都的中小企业数量是所有县中最多的，而且东京都政府的紧急计划（流行病、能源危机、灾难）都通过该协会进行。

使用 [[policy-finance/INDEX|policy-finance index]] 下的此页面作为 [[policy-finance/japan-credit-guarantee-system|Japan credit guarantee system]] 和 [[policy-finance/national-federation-credit-guarantee-corporations|Japan Federation of Credit Guarantee Corporations]] 系统锚点的规范本地公司示例。
...
|功能|为什么这很重要 |
|---|---|
|中小企业银行贷款信用担保|允许银行、[[banking/shinkin-bank-registry-japan|shinkin banks]] 和信用合作社向缺乏抵押品或交易历史的东京中小企业提供信贷。 |
|东京都政府的政策计划|管理都市政府紧急信贷计划（流行病救助、能源价格冲击缓解、地区振兴）。 |
|代位追偿和追偿|当有担保的借款人违约时，向贷款金融机构偿还贷款，然后向借款人追偿。 |
|责任共担管理|在标准体系下，在企业和贷款金融机构之间分割剩余风险；在特定紧急计划下具有 100% 风险。 |
|公私中小企业咨询 |提供信用咨询、业务改进指导以及向东京中小企业支持机构的转介。 |

## 3。为什么这很重要

东京 CGC 是当地信用担保体系中最大的单一节点，原因有以下三个结构性因素：
...
- 住房融资担保（[[policy-finance/japan-housing-finance-agency|JHF]]）。
- 海外贸易保险（[[policy-finance/nexi|NEXI]]）。
- 项目融资国家支持（[[policy-finance/japan-project-finance-stack-diagram|project-finance stack]]）。
