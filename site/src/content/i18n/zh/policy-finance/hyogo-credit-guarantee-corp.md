...
该条目属于 [[policy-finance/INDEX|policy-finance index]]，是日本信用担保系统的 51  都道府县/市级成员之一。请与 [[policy-finance/japan-credit-guarantee-system|Japan credit guarantee system]] 的系统概述和 [[policy-finance/national-federation-credit-guarantee-corporations|Japan Federation of Credit Guarantee Corporations]] 的协调机构一起阅读。与邻近的[[policy-finance/osaka-credit-guarantee-corp|Osaka CGC]]（相同的关西工业带经济，但兵库县的账簿更重工业/港口锚定）、[[policy-finance/tokyo-credit-guarantee-corp|Tokyo CGC]]（更大的城市服务主导）和[[policy-finance/aichi-credit-guarantee-corp|Aichi CGC]]（不同的供应链锚定）进行同行比较。
...
| 项目 | 内容 |
|---|---|
|成立| 1948年（信用担保协会法1953年施行后重组） |
|管辖范围 |中小企业厅/兵库县|
|法律|信用担保协会法（1953）|
|总部| | 神户市中央区（兵库县神户市） | 神户市中央区
...
- **一般担保**——责任共担制下的标准中小企业银行贷款担保。
- **Marukyo** — 小企业管理改进贷款担保。
- **安全网保证** - 行业困境指定事件保证（例如，钢铁周期倒转、造船订单冲击、港口交通下降）。
- **危机相关担保** — 危机相关担保（国家紧急框架、100% 担保）。
- **启动保证** — 启动/新业务保证。
- **企业继承保证** — 企业继承保证，在阪神/播州制造业-中小企业继承浪潮中大量使用。
- **管理创新保障** — 管理创新/业务转型保障。
- **再融资担保** — 再融资/合并担保。
- **地震恢复相关保证** — 植根于1995 大阪神地震恢复的长尾历史产品框架，该框架建立了兵库县CGC的救灾作战准则。

## 3。与县产业结构的关系

兵库县的中小企业经济至少分布在五个结构不同的集群中，兵库县 CGC 的担保书反映了所有这些集群：

1。 **阪神工业带和重工业** — 神户-尼崎-西宫集中了日本历史悠久的重工业核心：神户制钢所 (Kobelco)、[[JapanFG/kawasaki-shipyard]]（川崎重工造船和机车车辆）、三菱重工神户工厂、住友橡胶、住友电工，以及制造、机械加工、铸造、电气设备领域的 2/3 SME 供应商基地，和工业化学品。
2。 **神户港物流** — 神户港是日本最大的集装箱和滚装港口之一，尽管其市场份额长期输给横滨/东京。中小企业生态系统（货运代理、报关、仓储、船舶供应、集装箱堆场运营、卡车运输）利用担保信贷。
3。 **精密机械** — 姬路/明石/加古川走廊集中了印刷机制造商（历史上的小森、利优比）、摩托车和小型发动机供应商（川崎明石工厂）以及精密加工中小企业尾部。
4。 **播州/但马当地产业** — 播州纺织品、龙野皮革制品、姬路火柴笔产业以及但马乡村农业/清酒/但马牛肉集群构成了独特的当地工业中小企业部门。
5。 **旅游和服务** — 神户城市旅游、淡路岛度假旅游、有马/城崎温泉小镇和姬路城国际旅游支撑着大量的旅游中小企业尾部。
1995 阪神大地震（阪神·淡路大震灾）永久性地塑造了兵库县CGC的制度原则——其震灾复兴关连保证框架是日本战后第一个大规模的都道府县救灾保障计划，并为后来的2011 东北地震应对和 COVID-19  特别保障计划提供了操作模板。
...
## 6。危机时代的应对
在COVID-19 emergency（2020–2021）期间，兵库CGC是国家実质无利子·无安全（ゼロゼロ融资/零零贷款）特别担保计划的重要参与者。冲击遍及所有五个主要中小企业集群：重工业供应商面临2020 订单崩溃，港口物流中小企业面临全球货运放缓，神户/淡路/有马/城崎的旅游中小企业基地因国内旅行暂停而遭受重创，而播州/田岛当地工业中小企业面临复杂的批发需求崩溃。兵库县政府借鉴 1995 时代的救灾操作模板，通过兵库县 CGC 制定了分层的县级次应急计划。

随着 2020 老式 ZeroZero 本金偿还宽限期的结束，通过 2023-2025  实现的后疫情正常化产生了预期的代位浪潮。兵库县的损失状况与联邦平均水平大致一致——在大公司中既不是最好也不是最差。针对能源价格冲击，危机关连保证框架被重新启动（2022-2023），这对兵库县能源密集型重工业供应商基础的打击尤其严重。通过2024–2025 ，兵库县CGC帐簿正朝着一般保证/借换保证/事业承継保证的平衡方向正常化，随着阪神/播州制造业中小企业创始人一代继续退休，后者加速发展。
...
|尺寸|兵库CGC | [[policy-finance/osaka-credit-guarantee-corp|Osaka CGC]]| [[policy-finance/kanagawa-credit-guarantee-corp|Kanagawa CGC]] |
|---|---|---|---|
|主导产业结构 |重工业+港口+精密机械+本土产业尾巴|制造/批发/建筑(东大阪) | 家企业重工业+港口+汽车+通勤服务|
...
- 兵库県信用保证协会，官方首页（https://www.hosho.or.jp/）。
