...
status: machine
fidelity: ok
title: "Japannext 证券 (Japannext)"
translated_at: 2026-06-01T04:15:40.158Z
---

# Japannext 证券 (Japannext)
...
Japannext Securities 运营 Japannext PTS，这是面向日本股票的专有交易系统。其官方网站称，该公司是注册金融工具业务运营商和 PTS 运营商，并且是日本证券业协会会员。

在 FinWiki 中，Japannext 是与 [[securities/tokyo-stock-exchange|TSE]] 现金股票执行相对应的主要私营交易场所。

## System Map

| 层级 | 阅读 |
|---|---|
| 法定名称 | Japannext 证券株式会社 |
| 注册 | 关东财务局金融商品交易业者 No.45 |
| 协会 | 日本证券业协会 |
| 交易场所 | Japannext PTS |
| 起源 | 于 2006 以 SBI Japannext 名义成立；PTS 牌照于 2007获批。 |
...
|---|---|
| 日间 PTS | 上市股票的替代执行场所。 |
| 夜间交易时段 | 在普通交易所交易时段之外提供交易时间。 |
| 最佳执行 | 对 SOR 和券商订单路由分析很重要。 |
| HFT / 机构订单流 | 私营交易场所设计会产生不同的流动性和时延激励。 |
