...
| 所有权脉络 | 由 [[JapanFG/sbi-hd|SBI HD]] 作为主要 anchor、[[JapanFG/nomura-hd|Nomura HD]]、Sumitomo Mitsui Trust Holdings / SBI Sumishin 合作脉络共同创立。当前股权结构需通过 ODX 公司页面确认。 |
| 自律监管 | [[JapanFG/jsda|JSDA]] 成员；FSA 2022  Market System Working Group 输出后制定的非上市 PTS 规则覆盖证券代币板块。 |
...
| Anchor | 战略利益 |
|---|---|
| [[JapanFG/sbi-hd|SBI HD]]（及 SBI group entities） | PTS / 数字资产 / 在线券商业务延伸；SBI Securities 零售分销；Progmat / 数字资产平台 thesis。 |
| [[JapanFG/nomura-hd|Nomura HD]] | 证券业领导地位；BOOSTRY（Nomura 主导的 ST 发行平台）发行侧协同；机构 STO 分销。 |
...
| 资产类型 | 示例结构 | 发行平台 |
|---|---|---|
| 代币化房地产受益权 | 持有房地产的信托中的信托受益权，代币化用于 DLT 记录维护 | [[JapanFG/progmat|Progmat]]、BOOSTRY、ibet for FIN |
| 代币化债券 | 作为电子记录权发行的数字债券 | BOOSTRY（Nomura group）、[[JapanFG/progmat|Progmat]] |
