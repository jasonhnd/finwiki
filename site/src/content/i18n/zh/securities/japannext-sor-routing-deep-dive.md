...
| 自律邻接 | [[JapanFG/jsda|JSDA]] 会员；PTS Information Network 于 2025年7月结束后，PTS 统计由 JSDA 汇总。 |
...
- **股东关系。** Japannext 的历史 SBI 谱系意味着 [[JapanFG/sbi-securities|SBI Securities]] 订单流在结构上有理由将 Japannext 视为其执行菜单的一部分。披露问题在于路由偏好是否记录在券商最佳执行政策中。
