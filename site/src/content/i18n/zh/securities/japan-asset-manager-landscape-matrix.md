...
以下四条赛道是竞争分段，而非法律类别。它们会重叠：保险公司持有的 AM 也可能是大型银行系（AM-One），独立 AM 也可能是 sub-advisory 接收方。
...
| AM | 母公司 | 日本角色 |
|---|---|---|
| BlackRock Japan | BlackRock | iShares ETF 日本上市、投資一任、機関投資家 mandates；跨领域链接至 [[fintech/blackrock-buidl-tokenized-mmf-overview|BUIDL tokenized MMF]]。 |
| JPMorgan Asset Management Japan | JPMorgan | 通过日本银行和券商分发的全球主动股票 / 收益基金。 |
| Fidelity Investments Japan | Fidelity | 长期日本零售 / 機関投資家 presence；强主动股票品牌。 |
| Pictet Asset Management Japan | Pictet | 通过银行渠道分发的主题 / 全球股票基金。 |
| Schroders Japan | Schroders | 全球主动 / multi-asset / sustainability mandate。 |
| T. Rowe Price Japan | T. Rowe Price | 全球成长股票 mandate；偏机构。 |
| Vanguard Japan | Vanguard | 注：Vanguard 已重组 / 退出日本直接零售 presence；在视为活跃本地 AM 前，应对照 FSA 登记确认当前实体状态。 |
| Goldman Sachs Asset Management Japan、Morgan Stanley Investment Management Japan 等 | 美国投行 | 机构 / alternative 倾向，常作为国内 AM 的 sub-advisor。 |

赛道 4 要点：外资 AM 运营全球产品工厂，日本主要作为分发目的地和 機関投資家 mandate 来源。它们很少主导 公募投信 零售资金流排名，因为缺少银行或在线券商漏斗；相反，它们在国内 AM 基金的 sub-advisory mandate 中出现比例较高。

## 跨赛道比较矩阵

| 维度 | 大型银行系 | 保险系 | 独立 / 在线 | 外资系 |
|---|---|---|---|---|
| AUM 类别（粗略） | 大手（≥¥30trn）常见 | 中堅（¥5-30trn）常见 | 中堅至中小 | 中堅至中小（日本 AUM） |
| 分发渠道 | 大型银行柜台、集团证券部门、IFA | 银行柜台、IFA、保险代理网络、养老金顾问 | 在线券商（NISA 主导）、直接 | 银行 / 券商分发、機関投資家 RFP |
| 产品组合倾斜 | 平衡：主动 + 被动 + DC + 公募 + 私募 | ALM-aware 固定收益 + DC + 投資一任 | 低成本被动 + boutique active + theme | 全球主动 + multi-asset + sustainability |
| NISA / iDeCo 份额 | 高且增长（后 2024） | 中等（DC 重点） | 对指数基金领导者非常高（eMAXIS Slim、SBI V、楽天） | 低（无 captive retail channel） |
| ETF / ETN 发行 | 强 — Nomura、AM-One、MUFG AM、Nikko AM、Daiwa AM 主导 | 有限 | 小众 / 选择性 | iShares（BlackRock）领先外资发行 ETF |
| ESG / sustainable AM | 集团层面 TCFD / stewardship reports | ESG 与保险负债一致 | 主题基金 + ESG 被动 | 强全球 ESG 产品货架 |
| Inhouse vs sub-advisory | 多数 inhouse，选择性 sub-advisory | 混合 — 保险投资子公司 + 外部 sub-advisors | 常为 sub-advised（精品全球接入） | 经常向国内 AM 提供 sub-advice |
...
经 [[securities/nisa-2024-flow|NISA 2024 flow]] 路由的 2024 New NISA reset，是日本零售 AM 一代人中最大的需求侧变化：

- **Tsumitate investment 增长** 奖励低 TER 指数基金 — 集中于 MUFG AM（eMAXIS Slim）、SBI AM（SBI V series）和 楽天投信投資顧問（楽天 series）。
- **Growth investment** 扩大主动股票和主题基金的货架接入 — 被 NAM、Nikko AM、AM-One 以及通过银行渠道分发的外资 AM 更高比例使用。
- **iDeCo / 確定拠出年金** 资金流比 NISA 流动更慢，但会在数十年内复利。大型银行系 AM 和保险系 AM 主导 DC mandate，因为 plan administration 被捆绑进银行 / 信托银行关系；统计由 MHLW 维护。

注意：MHLW、JITA 和 FSA 发布的 NISA / iDeCo 汇总数字使用不同分母。未调和基数前，不要串联百分比。

## ETF 与 ETN 发行视角

日本 ETF AUM 高度集中。日本银行 ETF 购买（目前处于维护状态）通过 Nomura AM、AM-One、MUFG AM、Nikko AM 和 Daiwa AM 锚定 TOPIX / Nikkei 225 ETF 发行。iShares（BlackRock Japan）是在本地上市的最大外资 ETF 系列。ETN 发行是一个独立、更小且萎缩的市场，发行人名单不同（主要为银行 / 证券公司结构化产品部门，而不是 AM）。关于 ETF 流的交易所 / 清算路径，使用 [[securities/japan-market-infrastructure-map|Japan market infrastructure map]]。

## Inhouse 与 sub-advisory 边界

日本 公募投信 AUM 的相当一部分是 sub-advised，即国内 AM 为基金贴牌和分发，但实际投资组合管理人是外资或 boutique AM。这以两种方式出现：

- **外资 AM 作为 sub-advisor**：由 JPMorgan AM、BlackRock、Fidelity 或 T. Rowe Price 子公司管理的国内大型银行系 AM 品牌全球股票基金。
- **精品 AM 作为 sub-advisor**：由独立 / boutique AM（国内或外资）管理的大型银行系 AM 品牌 smart-beta 或主题基金。

这个边界很重要，因为：

1. 品牌 AM 保留分发经济；sub-advisor 保留投资管理经济。
2. 业绩归因属于 sub-advisor。
3. Stewardship 和 proxy voting 往往跟随 sub-advisor。

在把一只基金的表现解读为品牌 AM 的能力之前，务必检查 目論見書 / 運用報告書 中的 sub-advisor 披露。

## 公募投信 vs 私募投信 ratio

| 类别 | 受众 | 披露 | 典型 AM |
|---|---|---|---|
| 公募投信 | 零售 / 家庭 | 目論見書、EDINET、運用報告書 | 大型银行系 AM、独立 / 在线 AM、外资 AM |
| 私募投信 | 適格機関投資家 / 专业投资者 | 有限公开披露 | 保险系 AM、大型银行系 AM、外资 AM |
| 投資一任（DIM） | 个人或机构 mandate | 合同层面 | 保险系 AM、外资 AM、boutique AM |

金融媒体通常报道的零售 AM 排名只覆盖 公募投信。若要正确观察机构和保险赛道，需要纳入 私募投信 和 投資一任 残高。
...
| 比较 | 日本现实 |
|---|---|
| 规模 vs BlackRock | 日本最大 AM 的规模比 BlackRock 全球 AUM 小一个数量级；即使合并，日本前 5  大 AM 也无法接近 BlackRock 规模。 |
| 规模 vs Vanguard | Vanguard 的 mutual ownership / 超低 TER 模式与日本银行绑定型 AM 模式在结构上不同；SBI AM 和 MUFG AM（eMAXIS Slim）是日本最接近的定价类比，但不是结构类比。 |
| 主动管理份额 | 日本按 AUM 计的主动 公募投信 份额仍高于美国，尽管自 2024 NISA 以来指数份额大幅增长。 |
| ETF 集中度 | 高度偏向日本银行购买过的 TOPIX / Nikkei 225 ETFs，使行业 / 主题 ETF 深度浅于美国。 |
| Alternatives / private credit | 规模小于美国 / 欧洲同业，流动性也较弱；正通过信托银行和 機関投資家 渠道增长。 |

底线：日本 AM 是**分发驱动，而非规模驱动**。竞争问题不是“谁能匹配 BlackRock 的全球产品工厂”，而是“谁控制客户的主要 投信 购买决策，以及 DC / iDeCo 计划管理”。
...
| 投資顧問業協会 successor / JIAA | 投资顾问和 discretionary-investment-management 行业自律组织。 | 用于 投資一任 / 投資助言 规则背景和历史统计。 |

注意：投資信託協会 发布行业总量，而不是详细 AM 级别排名。AM 级别数字来自各 AM 的 統合報告書 / 月次運用実績 以及 vendor 汇编。
...
- 投資信託協会（JITA），行业统计和会员名录。
- 日本証券業協会（JSDA），自律规则页面和会员名单。
- FSA，“金融商品取引業者登録一覧”，`kinyushohin.xlsx`。
- MHLW，確定拠出年金 统计和计划级数据。
- Nomura Asset Management，公司概要。
- Asset Management One，公司概要 / ごあいさつ。
- Mitsubishi UFJ Asset Management，公司概要。
- Sumitomo Mitsui DS Asset Management，公司概要。
- Daiwa Asset Management，公司概要。
- Nikko Asset Management，corporate profile。
- SBI Asset Management，公司概要。
