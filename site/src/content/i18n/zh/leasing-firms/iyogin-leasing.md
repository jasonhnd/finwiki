...
translated_at: 2026-06-19T06:09:18.187Z
---
...
株式会社いよぎんリース（Iyogin Leasing）是 [[regional-banks/iyogin-hd|いよぎん HD (東証 PRIME 5830)]] 集团旗下的地方银行系租赁公司。依托其核心子公司 [[regional-banks/iyo-bank|伊予銀行]]（设立为 1878 第二十九国立银行，爱媛县市占 No.1）的中坚企业 main bank 客户基础，在 **爱媛县 + 四国全域 + 大阪、东京、广岛等本州据点** 提供设备租赁、融资租赁、经营租赁、自治体租赁、医疗租赁、**海事集群（今治造船 + 海运）设备租赁**、农业机械租赁、汽车租赁等业务。作为四国 4 县的地银系租赁中规模最大级别者，在 [[regional-banks/iyogin-hd]] 2022-10-03 控股公司化之后，被重新配置为集团并列子公司中的一员。^[extracted]
...
> [!info] 验证状况
> confidence: **likely**（FG leasing-subsidiary anchor created 2026-05-25）。[[regional-banks/iyogin-hd]] page = 处理持股公司 holding strategy（2022-10 HD 化），本页处理 leasing-subsidiary operating boundary。设立年（1974-09-26，旧称 伊豫銀総合リース）、资本金（8,000 万円）、いよぎん HD 直接出资子公司化（2022-10-03）已在 いよぎんリース 官方公司概要 / 沿革中确认（出处见下）。海事集群经办额比率为单体未披露（无公开值），故正文仅作定性记述。
