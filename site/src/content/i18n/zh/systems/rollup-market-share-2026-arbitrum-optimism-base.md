...
- ?? 7 ??? Ethereum L2 rollup?? 2026-Q2 ??? **TVL ? ???? ? ???? ? sequencer ?? ? gas ?? ? DEX ?? ? ???? ? RWA ? ????? ? ????? ? DA ??** ? 11 ??????
- **TVL ?? 2026-Q2 ??**?**Base ~$18B**??? ? ?????? **Arbitrum ~$13B**????? **Optimism ~$5B** ? **zkSync Era ~$2.0B** ? **Linea ~$1.2B** ? **Polygon zkEVM ~$800M** ? **Scroll ~$700M**
- **日活地址排名**：Base ~3-5M · Arbitrum ~1-2M · Optimism ~600k-1M · zkSync ~400-700k · Linea ~300-500k · Polygon zkEVM ~150-300k · Scroll ~100-200k
- **Base ????**?Coinbase ????? + Stripe / Shopify / Apple Pay ?? + meme coin / consumer dApp ?????2024-2026 ??? TVL ???????? L2
- **Arbitrum ????**??????Nitro ? Stylus ? Orbit????????????? DeFi-heavy????????
- **Optimism Superchain ??**??? OP Stack ???? 30 ?????Base ? Mode ? Worldcoin ? Lyra ? Polynomial ? Zora ?????Superchain ? TVL ????? Arbitrum
...
- ???[[systems/INDEX|????]] ? [[systems/zk-evm-rollup-maturity-comparison-matrix-2026|ZK-EVM rollup ????? 2026]] ? [[systems/eip-4844-blob-economics-impact-2026|EIP-4844 blob ?? 2026]] ????

## Wiki 路径

????? [[systems/INDEX|????]] ???? [[systems/zk-evm-rollup-maturity-comparison-matrix-2026|ZK-EVM rollup ????? 2026]] ??????????????????????????????????? [[systems/eip-4844-blob-economics-impact-2026|EIP-4844 blob ??? 2026 ????]] ?????????? rollup ????? DA / blob ???

## 为什么这个矩阵重要

L2 rollup ? 2023-2024 ?????????????? + TVL ??????? 2024-2026 ??????????????**Base ??????? ? Arbitrum ?? DeFi-native ?? ? Optimism Superchain ????? ? ZK rollup ??????**?

**为什么对照 7 个 L2 ，而不是更多**：
- Base · Arbitrum · Optimism · zkSync Era · Linea · Polygon zkEVM · Scroll = 2026-Q2 TVL > $500M 的全部 L2
- ???Blast?TVL > $500M ??????????? meme / yield farming?? Mantle??? EigenDA??? L1 DA??????? Taiko?TVL < $500M?????????????????? [[systems/zk-evm-rollup-maturity-comparison-matrix-2026|ZK ??]]?? Manta Pacific / Eclipse?alt-DA ??????????
...
- ???? + finality??? [[systems/cross-chain-bridge-security-insurance-matrix-2026|?????]]?
- Meme coin / consumer dApp 活动

**Consumer dApp 选择 L2 时的判断轴**：
- Account Abstraction??? [[systems/erc-4337-overview|ERC-4337 ??]] ? [[systems/erc-7702-overview|ERC-7702 ??]]?
- Gas sponsorship 工具
