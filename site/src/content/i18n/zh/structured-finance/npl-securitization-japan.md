...
[[financial-regulators/rcc|RCC (Resolution and Collection Corporation)]] 被设立为公共资产管理公司，负责：
- 接收失败金融机构的 NPL
...
日本政府的政策应对（包括 [[policy-finance/INDEX|policy-finance]]工具，来自 [[financial-regulators/jbic|JBIC]] 和 JFC，以及延长商业银行贷款宽限）防止了其他司法辖区出现的那种即时 NPL 激增。然而：
- 通过 2022–2024
积累了一批表现较弱的 SME 贷款存量
- 地方银行已开始选择性处置问题贷款
...
- **“不良债权买家以公共成本榨取了超额价值”** — [[financial-regulators/rcc|RCC]]资产池出售的定价在当时存在争议；一些批评者认为公共部门定价有利于外国买家，更多价值本应留在日本账簿中
...
- [[financial-regulators/boj|BOJ]]利率正常化是否会加速 SME 贷款违约并产生更实质的新 NPL 周期
- [[financial-regulators/rcc|RCC]]在下一个周期中的作用，即它是否会作为主要处置渠道重新启用，还是继续处于看护模式
