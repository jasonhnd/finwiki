...
fidelity: ok
title: "日本医疗保险附加险产品矩阵"
translated_at: 2026-05-31T07:28:06.117Z
---
# 日本医疗保险附加险产品矩阵
...
理解一个日本家庭的医疗保障选择，意味着要在至少三种都被统称为“医疗保险（医療保険）”的产品架构之间做判断：

1. **癌症专属险（がん保険）** —— 独立产品线，拥有独立核保、独立等待期和独立保费曲线。Aflac 在 1970 年代建立了现代日本癌症保险市场，并在该细分市场中数十年来一直保持约 70% 的新单份额。
2. **一般医疗险（医療保険）** —— 住院日额给付 + 手术一次金 + 附加险菜单（先進医療、三大疾病、住院一次金）。这里的竞争最为激烈。
3. **附着于终身寿险或定期保障的附加险（医療特約 / 入院特約）** —— 由寿险大4 相互会社以及运行保障捆绑计划的外资系公司（Sony Life lifeplanner、Prudential、Manulife）附着在主险之上销售。

下方矩阵将这些维度逐一拆开。具体产品名称、保费水平、渠道佣金和核保限额都与日期有关，应结合各公司产品小册子、FSA 招揽规则披露以及年报 / 披露资料确认。
...
下表列出区分日本医疗 / 癌症险主要承保公司的关键维度。具体市场份额、保费和产品名称都会随时间变化，应结合各公司当前披露核对。
...
|---|---|---|---|---|---|---|---|
| 独立癌症险（がん保険） | 主导 | 显著 | 显著 | 显著 | 显著 | 有限 | 可提供，但更偏好附加险捆绑 |
| 独立医疗险（医療保険） | 显著 | 显著 | 显著 | 显著 | 显著 | 有限 | 可提供，但更偏好附加险捆绑 |
| 终身寿险医疗附加险 | 可提供 | 显著 | 显著 | 显著 | 显著 | 显著 | 主导路径 |
| 三大疾病附加险 | 可提供 | 可提供 | 可提供 | 可提供 | 可提供 | 可提供 | 可提供 |
| 介护附加险 | 选择性 | 可提供 | 可提供 | 可提供 | 可提供 | 可提供 | 可提供 |
| 先進医療附加险 | 标准配置且上限高 | 标准 | 标准 | 标准 | 标准 | 标准 | 标准 |
| 入院一次金 | 标准 | 标准 | 标准 | 标准 | 标准 | 有限 | 可提供 |
| 通院 / 日间手术给付 | 强（偏癌症导向） | 标准 | 标准 | 标准 | 标准 | 有限 | 可提供 |
| 女性疾病医疗 | 可提供 | 可提供 | 可提供 | 可提供 | 可提供 | 有限 | 可提供 |
| 外币医疗险 | 选择性 | 选择性 | 选择性 | 选择性 | 选择性 | 显著 | 选择性 |
...
| Manulife / Prudential | 保障捆绑下标准化 | Standard | Available |
| Life big-4  mutuals | 终身主险为标准，附加险跟随主险 | 终身主险可做标准短期缴 | 可提供定期缴 |
| Kampo Life | 在产品审批限制内为标准 | Standard | Available |

### 按产品划分的给付类型

| Benefit type | Aflac | AIA | Tokio Marine Anshin lineage | Sompo Himawari | MS Aioi | Manulife / Prudential | Life big-4  mutuals |
|---|---|---|---|---|---|---|---|
| 住院日额（入院日額） | 医疗险标准配置 | 医疗险标准配置 | 医疗险标准配置 | 医疗险标准配置 | 医疗险标准配置 | 选择性 | 医疗附加险标准配置 |
| 手术一次金 | 标准 | 标准 | 标准 | 标准 | 标准 | 选择性 | 标准 |
| 癌症诊断一次金 | 标准（Aflac 核心特征） | 标准 | 标准 | 标准 | 标准 | 有限 | 可提供 |
| 持续癌症治疗一次金 | 标准 | 标准 | 标准 | 标准 | 标准 | 有限 | 可提供 |
| 实损填补 | 选择性 | 选择性 | 选择性 | 选择性 | 选择性 | 有限 | 选择性 |
| 先進医療实费 | 标准且上限高 | 标准 | 标准 | 标准 | 标准 | 标准 | 标准 |
| 三大疾病一次金 | 标准附加险 | 标准附加险 | 标准附加险 | 标准附加险 | 标准附加险 | 标准附加险 | 标准附加险 |
| 生活给付 / 收入保障 | 有限 | 可提供 | 可提供 | 可提供 | 可提供 | 显著 | 可提供 |
| 介护一次金或年金 | 有限 | 可提供 | 可提供 | 可提供 | 可提供 | 可提供 | 可提供 |
...
|---|---|---|---|---|---|---|---|---|
| 专属销售队伍 / FA | 显著 | 显著 | 选择性 | 选择性 | 选择性 | 主导（lifeplanner） | 主导（综合职） | n/a |
| 独立代理店 | 显著 | 显著 | 显著（依托财险母体网络） | 显著（依托财险母体网络） | 显著（MSI + ADI 网络） | 选择性 | 选择性 | n/a |
...
| Axis | Aflac | AIA | Tokio Marine Anshin lineage | Sompo Himawari | MS Aioi | Manulife / Prudential | Life big-4  mutuals |
|---|---|---|---|---|---|---|---|
| 标准核保产品 | Yes | Yes | Yes | Yes | Yes | Yes | Yes |
| 核保放宽产品（引受基準緩和） | Yes | Yes | Yes | Yes | Yes | Yes | Yes |
| 无核保产品（無選択型） | 选择性 | 选择性 | 选择性 | 选择性 | 选择性 | 选择性 | 选择性 |
| 按性别差异定价 | 标准 | 标准 | 标准 | 标准 | 标准 | 标准 | 标准 |
| 吸烟 / 非吸烟差异定价 | 部分产品可用 | 选择性 | 选择性 | 选择性 | 选择性 | 选择性 | 选择性 |
| 非体检限额 | 因产品而异 | 因产品而异 | 因产品而异 | 因产品而异 | 因产品而异 | 因产品而异 | 因产品而异 |
| 等待期（癌症险） | 90  天标准 | 90  天标准 | 90  天标准 | 90  天标准 | 90  天标准 | 90  天标准 | 90  天标准 |

### 解约返还金设计

| Carrier set | Surrender-value design tilt | Notes |
|---|---|---|
| Aflac 癌症 / 医疗专业线 | 现代菜单为纯保障型（无明显解约返还金） | 通过短期低解约返还金设计压低返还金，以稳定保费曲线 |
| AIA 医疗 / 癌症 | 现代菜单为纯保障型 | 同样设计原则 |
| Tokio Marine Anshin lineage | 现代医疗菜单为纯保障型 | 同上 |
| Sompo Himawari | 现代医疗菜单为纯保障型 | 同上 |
| MS Aioi | 现代医疗菜单为纯保障型 | 同上 |
| Manulife / Prudential 终身主险 | 终身主险有解约返还金；医疗附加险没有 | 捆绑式产品设计 |
| Life big-4  终身主险 | 终身主险有解约返还金；医疗附加险没有 | 同上 |
| 外币终身寿险 | 以外币计价的解约返还金 | 汇率风险转移给投保人 |
| 线上直销（日元定期） | 纯保障型 | 按设计无解约返还金 |
...
| Life big-4  mutuals | Standard | High cap | 附着于终身主险 |
| 外币医疗险 | Standard | 以外币计价的上限 | 从外币保单角度理解 |
| 线上直销（日元定期） | Standard rider | 日元上限 | 作为核心卖点宣传 |

### 外币医疗 / 年金叠加

| Carrier set | Foreign-currency medical / cancer product presence | Notes |
|---|---|---|
| Aflac | Limited | 主要为日元计价 |
| AIA | Selective | 可提供附医疗附加险的美元终身寿险 |
| Tokio Marine Anshin lineage | Selective | 可提供附附加险的外币终身寿险 |
...
|---|---|---|
| 新癌症保险市场 | Aflac（历史上约 70%） | Sompo Himawari、AIA、MS Aioi、Tokio Marine Anshin lineage |
...
当前日本医疗保险结构反映了数十年的产品和监管演化：

- **1974  Aflac 进入癌症保险市场**，把专业化癌症保险引入日本并建立了该细分市场。Aflac 的分销结合了企业 / 雇主团体销售与代理店。
- **1995  《保险业法》修订**，使牌照制度现代化，并为外资系在保障 / 医疗专业领域的扩张奠定基础。
- **1996–2001  第三分野自由化**，使外资系与财险集团旗下寿险子公司都能在医疗 / 癌症 / 介护领域公平竞争。第三分野（第三分野）是介于寿险（第一分野）与财险（第二分野）之间的医疗 / 癌症 / 介护监管分类。
...
在横向比较日本医疗保险竞争格局，而不是与整个寿险行业对比时，应使用本矩阵。实际问题包括：

- **癌症专属险 vs 医疗捆绑险。** Aflac 主导独立癌症险，而医疗险有多家公司竞争。购买癌症专属保障的家庭，与购买一般医疗险的家庭，所面对的竞争集合并不相同。
...
- **数字是概念性的。** 市场份额（尤其是 Aflac 约 70% 的癌症份额）、保费、给付上限和附加险可得性，会随每个产品周期和披露期变化。来源包括 FSA、生命保险行业资料、各承保公司的产品手册与综合 / 披露报告，以及 MHLW 关于公保的资料。
- **Aflac 癌症份额。** 约 70% 的数字长期被行业作为新癌症险市场份额的简称。更近期的具体口径应结合 Aflac 披露与 Seiho 行业数据确认。
...
- **Kampo Life 产品菜单。** 受到特别法审批约束。请单独阅读 [[insurance/kampo-japan-post-insurance|the Kampo entry]]。
