...
status: machine
fidelity: ok
title: "日本非寿险三大再保险和巨灾叠加矩阵"
translated_at: 2026-05-31T11:13:44.925Z
---
...
仅从财务报表摘要中解读日本非寿险三大巨头（保费、综合比率、ESR）并不能揭示真正推动资产负债表波动的因素。下面存在三个结构性问题：
...
2。 **海外业务如何与国内承保波动相互作用？** 每个集团都建立了不同的海外组合：Tokio Marine 拥有最大的美国专业和伦敦市场业务； MS&AD 拥有美国、亚洲和劳合社辛迪加航线； Sompo 拥有美国/欧洲专业业务和亚洲业务。
...
下面的覆盖矩阵将这些轴记录为路由而不是最新数字。具体巨额损失数字、ESR 比率、再保险自留额和股票投资组合规模每个财政年度都会发生变化，应来自每个集团的综合/年度报告和 FSA 材料。
...
资本回报是股息加上根据 ESR 校准的定期回购。交叉持股逐步减少正在进行中，并且是一个反复出现的资本政策话题。
...
资本回报是股息加上根据 ESR 校准的机会性回购。交叉持股清盘正在进行中。近几年来，补救措施一直是影响资本政策信息的公开披露话题。

## 猫险、再保险和海外覆盖

所有三个团体都在日本方面运行共同的再保险架构和共同的猫险组合，但每一层的规模和形状有所不同：

- **地震（商业/shintaku财产）** — 与家庭地震保险池（[[insurance/earthquake-insurance-public-private-scheme|earthquake insurance public-private scheme]]）不同。 Cat XL 是主要的再保险保护。最大的单一事件情景决定了再保险计划保留规模。
- **台风/风** — 高频损耗驱动器。近年来（Faxai 2019, Hagibis 2019, 及后续事件）重置了整个计划的再保险定价。年度巨灾预算假设提供了综合比率指导。
- **洪水** — 次要灾害，气候造成的损失频率不断增加。 Cat XL 和再保险恢复条款是主要的缓解措施。
...
综合比率（损失+费用/赚取保费）是主要承保盈利能力指标。对于三巨头来说，它按类别（自愿汽车、火灾（住宅和商业）、伤亡、海事、事故和其他商业）和地区（国内与海外）进行分解。巨灾损失在报告时显示为损失率的一行补充，并在中期计划中披露了单独的“巨灾预算”假设。

三巨头的 ESR 敏感性由以下因素驱动：

- **国内利率冲击** - 小于寿险公司的冲击，但由于准备金贴现和债券投资组合按市价计价，仍然存在。
- **股市冲击** — 由于交叉持股投资组合而有意义；随着逐渐结束，这种敏感性会机械性地下降。
- **外汇冲击*​​ - 由于海外收入、以外币计价的储备和以外币计价的再保险可收回金额而产生重大影响。
- **信用利差扩大** — 债券投资组合按市价计价和再保险交易对手风险。
- **巨灾冲击** — 根据 FSA 经济价值标准直接对 Cat 模块进行收费；通过受交易对手质量影响的再保险可收回金额来缓解。

有关制度级别的分解，请参阅[[insurance/global-solvency-framework-comparison-matrix|the global solvency framework comparison matrix]]，有关度量定义，请参阅[[insurance/esr-economic-value-solvency|the ESR explainer]]。

## 大比较矩阵表

下面的矩阵列出了区分三大巨头的轴。具体数字（巨灾预算、综合比率、ESR、股票投资组合规模）是特定日期的，应根据每个集团当前的综合/年度报告和 FSA 材料进行确认。
...
|家猫预算重置| Faxai / Hagibis (2019) 及后续事件后重置 | Faxai / Hagibis (2019) 及后续事件后重置 | Faxai / Hagibis (2019) 及后续事件后重置 |

### 再保险计划的形式

|轴|东京海上 | MS&AD |颂波 |
|---|---|---|---|
|集团内转分 |是的——海外子公司猫复古成集团|是的 — MSI / ADI 和海外子公司之间 |是的——Sompo Japan 和海外潜艇之间 |
|比例条约（非 Cat 线）|用于选定的行 |用于选定的行 |用于选定的行 |
...
|轴|东京海上 | MS&AD |颂波 |
|---|---|---|---|
|海外盈利份额|三者中最大的 |材料;小于东京海上|材料;小于东京海上|
|美国特产| Philadelphia / Pure / HCC 平台（通过并购获得）|美国专业平台|耐力/Sompo国际传承|
|伦敦市场存在|是的——有意义的劳合社/伦敦市场存在|是的 — 劳埃德集团通过 MS Amlin 遗产路线 |精选伦敦/欧洲特产|
|亚洲增长|亚洲非寿险和再保险足迹|亚洲非生命足迹（Aioi / Nichido 遗产）|亚洲非生命足迹|
|劳合社互动 |劳合社市场参与|劳合社财团参与 |劳合社的选择性参与|
|再保险实体 | Tokio Marine Re / 专业子公司 |团体再保险 | Sompo International / 耐力传承 |
|外国再保险公司日本前景|参见[[insurance/foreign-reinsurer-japan-landscape|foreign-reinsurer Japan landscape]] |相同 |相同 |

### 股权持有和交叉持股投资组合

|轴|东京海上 | MS&AD |颂波 |
|---|---|---|---|
|交叉持股传承 |大型战后 keiretsu / 客户手册 |大型战后 keiretsu / 客户手册 |大型战后 keiretsu / 客户手册 |
|结束计划|年度披露的多年削减计划|年度披露的多年削减计划|年度披露的多年削减计划|
| ESR 股权风险资本影响 |随着放松的进行，机械性地坠落 |随着放松的进行，机械性地坠落 |随着放松的进行，机械性地坠落 |
|已实现收益管道 |定期处置所实现的收益|定期处置所实现的收益|定期处置所实现的收益|
|关系约束|根据客户/合作伙伴关系考虑因素对处置进行排序 |相同的约束 |相同的约束 |

### 资本回报政策和ESR

|轴|东京海上 | MS&AD |颂波 |
|---|---|---|---|
|标题资本指标 | ESR（FSA 经济价值制度）| ESR（FSA 经济价值制度）| ESR（FSA 经济价值制度）|
| ESR目标|与资本配置政策相关的披露范围|与资本配置政策相关的披露范围|与资本配置政策相关的披露范围|
|股利政策|累进股息|累进股息|累进股息|
|回购政策|根据 ESR 进行机会性回购；历史上三者中最活跃的根据 ESR 进行定期回购 |根据 ESR 进行定期回购 |
|附属资本|用于控股层面 |用于控股层面 |用于控股层面 |
| IAIG / ICS 叠加 |参见[[insurance/japan-iaig-ics-mapping|Japan IAIG / ICS mapping]]|相同的路由|相同的路由|

### 组合比率分解（概念）

|线路|东京海上 | MS&AD |颂波 |
|---|---|---|---|
|自愿汽车 |按保费计算最大的单线；周期敏感 |最大单线； ADI 移动生态系统 |按溢价计算的最大单线 |
|火灾（住宅和商业）| Cat-波动性驱动； reinsurance recoverables material |相同 |相同 |
|伤亡（包括责任）|商业/企业书籍|商业/企业书籍|商业/企业书籍|
| Marine | See [[insurance/marine-insurance-and-pi-cover-market|marine / P&I cover market]] | Same | Same |
|意外/个人线路 |稳定、波动性较低 |稳定、波动性较低 |稳定、波动性较低 |
|海外综合比率|单独报告；反映美国特色/伦敦周期|单独报道|单独报道|

### 概念层面的 ESR 敏感性

|灵敏度 |东京海上 | MS&AD |颂波 |
|---|---|---|---|
|国内利率震荡|比实际情况小，但通过储备贴现/债券 MTM 呈现 |相同 |相同 |
|股市震荡|随着交叉持股逐渐减少，股价下跌随着交叉持股逐渐减少，股价下跌随着交叉持股逐渐减少，股价下跌
|外汇冲击|三者中规模最大的原因是海外盈利组合 |材质 |材质 |
|信用利差扩大|债券 MTM 加上再保险交易对手风险 |相同 |相同 |
|猫震| FSA经济价值标准下的直接猫模块收费|相同 |相同 |
|再保险交易对手风险|分布在全球再保险交易对手集中|相同 |相同 |

### 最近的并购和战略交易（概念性）

|轴|东京海上 | MS&AD |颂波 |
|---|---|---|---|
|美国特产并购历史|费城、Pure、HCC 平台 |美国专业平台|耐力赛/Sompo International |
|伦敦/劳合社并购历史|窑炉/专业平台| MS Amlin（劳埃德辛迪加遗产）|精选特色优惠|
|亚洲/欧洲、中东和非洲交易 |重复|重复|重复|
|处置/重组|持续优化投资组合|持续优化投资组合|持续的投资组合优化加上修复弧披露|
|移动性/数字邻接|远程信息处理/数字财产险投资 |丰田/移动生态系统|数字化财产险投资|

### 专业线路测绘

|专业线|东京海上 | MS&AD |颂波 |
|---|---|---|---|
|海洋与能源|主要参与者；参见[[insurance/marine-insurance-and-pi-cover-market|marine / P&I cover market]] |主要参与者|主要参与者|
|网络|成长之书；再保险市场敏感|成长之书|成长之书|
|航空 |选择性|选择性|选择性|
|贸易信贷/政治风险|选择性专业暴露|选择性专业暴露|选择性专业暴露|
|建筑/工程|国内外|国内外|国内外|
|担保|选择性|选择性|选择性|
|人身意外|稳定的书 |稳定的书 |稳定的书 |
|农业（JA相关）|选择性|选择性（ADI传承）|选择性|
|专业替代品| [[insurance/lloyds-japan-syndicate-operating-model|Lloyd's Japan syndicate model]]、[[insurance/captive-insurance-japan-market|captive insurance market]] |相同 |相同 |
...
- **交叉持股逐步减少。** 这三个公司多年来都在运行长尾股权减持计划，对ESR市场风险资本、股息收入线和回购能力产生影响。

## 阅读披露内容

每个小组都以类似但不相同的披露格式发布相关数据：

|披露面|东京海洋高清 | MS&AD 高清 |搜宝高清 |
|---|---|---|---|
|综合报告（年度）|是的 |是的 |是的 |
|中期经营计划|是（有资本配置政策）|是（有资本配置政策）|是（在资本配置政策和整治背景下）|
| ESR披露|在综合报告和IR材料中|在综合报告和IR材料中|在综合报告和IR材料中|
| Cat 预算披露 |中期计划|中期计划|中期计划|
|再保险计划披露 |综合报告的高层结构；专门再保险披露的详细信息|相同 |相同 |
|交叉持股清盘计划|披露计划及年度目标|披露计划及年度目标|披露计划及年度目标|
|海外关联公司披露 |地理/品牌细分（美国、欧洲、亚洲）|地理/品牌细分|地理/品牌细分（Sompo International）|
|季度财务补充|标准上市公司格式|标准上市公司格式|标准上市公司格式|
| ALM/敏感性披露|在综合报告中|在综合报告中|在综合报告中|

仔细匹配行项目命名：“自愿汽车”与“强制汽车责任 (CALI)”、“火灾”细分为住宅/商业、“伤亡”与一般/责任/E&O 细分，以及按地区细分的“海外”，这三者的标签和细节有所不同。

## 决策使用

在阅读非寿险三巨头相互对比而不是与大盘对比时，请使用此叠加。该矩阵提出了几个实际的分析问题：

- **标题-ESR单独比较具有误导性。** 具有相同ESR但不同猫保留层和不同海外收益份额的两组具有不同的波动性。拉动每个群体的 ESR 敏感性披露，而不是依赖标题。
- **巨灾预算解释需要再保险计划。** 低巨灾预算与高再保险保留率在结构上不同于低巨灾预算与低保留率。
- **海外综合比率是一个单独的周期。** 美国特种软/硬市场和伦敦伤亡周期的变化独立于日本方面的情况。不区分国内外的阅读群综合比例具有误导性。
- **交叉持股缩减具有双重信号。** 减少股本会降低ESR市场风险资本（正）并降低股息收入贡献（混合）。步伐和买方都很重要。
- **补救背景影响信息传递。** 公开披露的补救弧线（特别是最近的 Sompo 弧线）影响中期计划的信息传递、监管对话和资本政策指导。与[[insurance/insurance-agency-and-brokerage-japan|the agency / brokerage Japan landscape]]一起阅读。
- **MS&AD 双运营公司模式。** 集团级数字汇总 MSI 和 ADI；与 Tokio Marine & Nichido Fire 或 Sompo Japan 的单一运营公司比较需要分段级别的读取。
- **IAIG / ICS 报告。** 集团级 ICS 报告与指定 IAIG 的国内 ESR 并行适用 — 请参阅[[insurance/japan-iaig-ics-mapping|Japan IAIG / ICS mapping]] 和[[insurance/global-solvency-framework-comparison-matrix|the global solvency framework comparison matrix]]。
...
- 日本普通保险协会：行业概述。
- 东京海洋控股公司：综合/年度报告。
- MS&AD Insurance Group Holdings：综合报告和披露库。
- Sompo Holdings：综合/年度报告。
