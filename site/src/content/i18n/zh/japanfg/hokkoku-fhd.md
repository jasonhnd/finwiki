...
本条目属于 [[JapanFG/INDEX|JapanFG index]]。可结合 [[JapanFG/fukuoka-fg|Fukuoka Financial Group (FFG)]] 进行同业对照，并结合 [[banking/INDEX|banking index]] 了解更广泛的银行与监管背景。

当前名称路径：[[JapanFG/cci-group|CCI Group]]。本页保留为历史上的 Hokkoku FHD 桥接页，用于承接较早研究笔记与反向链接。

## 概览

Hokkoku Financial Holdings 是一家以石川县为基础的地区银行控股公司，曾以代码 7381 在东京证券交易所 Prime Market 上市。该公司于 2021-10-01 由 Hokkoku Bank 通过单独股份转移设立，并于 2025-10-01 将商号变更为 [[JapanFG/cci-group|CCI Group]]。虽然其资产规模处于中型地区银行梯队，但该集团在日本地区银行中长期被视为较为例外的数字化领先者。

其战略画像由一套较早启动的技术计划塑造：2008 年采用 Microsoft Azure，2010 年将核心银行系统迁移至开放式 Windows Server 和 .NET 架构，2017 年以 Surface 设备替代营业网点柜面终端。2023 年，集团设立 ICT 咨询子公司 Digital Value，并推出 Tonari BaaS 平台，将自身定位为由地区银行发展而来的数字平台提供方。与 [[fukuoka-fg|Fukuoka Financial Group 的 Minna Bank]] 一样，Hokkoku FHD 是日本地区银行数字化转型的参考案例之一。
...
最接近的数字化转型参照对象是 [[fukuoka-fg|Fukuoka Financial Group]]，其通过 Minna Bank 运营云原生数字银行。对比点很重要：FFG 创建了一个新的全国性数字品牌，而 Hokkoku FHD 则是把既有地区银行的运营底座数字化，并尝试将该底座出售给同业机构。因此，两者的收入模型和转型路径存在实质差异。
...
- Hokkoku FHD 会继续保持独立，还是会参与 SBI“第四大超级银行”概念或邻近 [[hokuhoku-fg|Hokuhoku Financial Group]] 相关的地区银行整合？
- 与 Microsoft 的合作会在生成式 AI 与 Copilot 相关落地上深化到什么程度？

## 8. Related

- [[fukuoka-fg|Fukuoka Financial Group]] -- 另一条通过 Minna Bank 展开的主要地区银行 DX 参考案例。
- [[hokuhoku-fg|Hokuhoku Financial Group]] -- 邻近的北陆地区银行集团。
- [[shizuoka-fg|Shizuoka Financial Group]] · [[concordia-fg|Concordia Financial Group]] · [[mebuki-fg|Mebuki Financial Group]] -- 中型至大型地区银行集团。
- [[mufg|MUFG]] · [[smfg|SMFG]] · [[mizuho-fg|Mizuho Financial Group]] -- 超级银行参照。
- [[sbi-hd|SBI Holdings]] -- “第四大超级银行”概念下的地区银行联盟战略。
