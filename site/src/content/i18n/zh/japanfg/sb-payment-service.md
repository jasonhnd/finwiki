...
本条目位于 [[JapanFG/INDEX|JapanFG index]] 之下。可与 [[JapanFG/gmo-epsilon|GMOイプシロン (GMO Epsilon)]] 对照阅读同业 / 对比语境，并与 [[payments/INDEX|payments index]] 阅读更广泛的系统 / 监管边界。
...
- 提供 PayPay consumer wallet 之外面向商户的支付基础设施。
- 连接 card acceptance、online checkout、安全和 merchant management。
- 是与 [[JapanFG/gmo-payment-gateway|GMO Payment Gateway]]、[[JapanFG/gmo-epsilon|GMO Epsilon]]、[[JapanFG/dg-financial-technology|DGFT]] 对比的有用参照。
