...
该条目位于[[JapanFG/INDEX|JapanFG index]]下。对照[[JapanFG/fsa|金融庁]]（监管对应方）、[[JapanFG/dic|預金保険機構]]（安全网对等方）以及[[JapanFG/boj-monetary-policy|BoJ 金融政策]] / [[JapanFG/boj-financial-markets-dept|BoJ 金融市場局]]（内脏器官）来阅读。
...
**监督**：财政部（人事/预算）+[[JapanFG/fsa|金融庁]]（协调）
...
### 3）银行的银行（→ [[JapanFG/boj-financial-system-dept|金融機構局]]）

- 在私人银行开设**日本银行往来账户**
- **[[systems/bojnet|BoJ-NET]]**（即时毛额支付系统）操作
- 最后贷款人
- 金融机构检查/监控（分工/与[[JapanFG/fsa|金融庁]]合作）
...
│   = 政策委员会 9 名（金融政策决定）
│
├── [[JapanFG/boj-monetary-policy|企画局]] ── 金融政策企画・MPC 事务局
├── [[JapanFG/boj-financial-markets-dept|金融市場局]] ─ 市场运作/国债买卖
├── [[JapanFG/boj-financial-system-dept|金融機構局]] ── 金融机构检查/监控
├── [[JapanFG/boj-payment-settlement-dept|決済機構局]] ── BoJ-NET / 支付系统
├── [[JapanFG/boj-international-dept|国際局]] ── 国际运营/G7/G20 央行合作
├── 研究统计局── 经济统计、短观、物价分析
├── 票务局── 纸币的制造及发行管理
├── 商务局── 国库事务局
