...
**法定名称**：株式会社西日本 Financial Holdings ^[extracted]  
**英文名称**：Nishi-Nippon Financial Holdings, Inc. ^[extracted]  
**证券代码**：东证 PRIME 7189，于 2016-10-03 上市，并同时在福冈证券交易所上市 ^[extracted]  
**设立**：2016-10-03，通过西日本 City 银行的单独股份转移转为控股公司 ^[extracted]  
**总部**：福冈县福冈市博多区博多站前 3-1-1，位于西日本 City 银行总行大楼内 ^[extracted]
...
西日本 FHD（上市控股公司 7189）
  ...
  ├── NCB Capital（100%）：风险投资、事业承继和 PE
  ├── NCB Lease & Capital（100%）：租赁和分期销售
  ├── 西日本 Card（100%）：信用卡
  └── 西日本 City Business Service、西日本 City Credit Guarantee 等
```
...
- **事业承继 / PE**：通过 NCB Capital，强化对缺乏明确继任者的区域企业的 PE 投资和 MBO 支持。

### 面向亚洲的国际业务

- **福冈机场 / 博多港的区位优势**：接近韩国、中国和东南亚，支持区域中型企业的跨境贸易和投资。
...
。
- **近期政策议题**：
  - 2024：日本银行政策利率正常化可改善国内贷款利差，对地方银行普遍构成利好。
  - 2025：削减营业网点、重组地方分支机构并改善 OHR。
  - 地方创生和人口减少应对金融；在地方银行市场中，福冈市属于少数人口增长区域之一。
...
- **Wikipedia：西日本 Financial Holdings**（https://ja.wikipedia.org/wiki/西日本フィナンシャルホールディングス，2026-05-19 抽取）
- **Wikipedia：西日本 City 银行**（https://ja.wikipedia.org/wiki/西日本シティ銀行，2026-05-19 抽取）
- 西日本 FHD 官方 IR，2025-03  期间决算材料部分。

---

> [!info] 验证状态
> confidence: **likely**。基于截至 1.0  / 2026-05-19 的 Wikipedia 公开信息。沿革、主要子公司结构和「福冈 2  大地方银行」框架可信度较高。详细财务和最新分部业绩应参见西日本 FHD 官方 IR 季度材料。
