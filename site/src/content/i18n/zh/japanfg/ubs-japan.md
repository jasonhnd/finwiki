...
该条目位于 [[JapanFG/INDEX|JapanFG index]] 下。针对同行/对比上下文阅读 [[JapanFG/citigroup-japan|シティグループ・ジャパン (Citigroup Japan)]]，针对更广泛的系统/监管边界阅读 [[banking/INDEX|banking index]]。
...
**母公司**：UBS Group AG（总部位于瑞士苏黎世，六号：UBSG / 纽约证券交易所：UBS）^[extracted]
**日本主要企业**：

|公司|业务类型|股票持有|
|---|---|---|
|瑞银证券日本有限公司|企业 IB 市场 |瑞银 100% |
|瑞银集团东京分行|日本分行|瑞银 100% |
|瑞银资产管理有限公司|投资信托和管理|瑞银 100% |
|原瑞信证券有限公司|前CS日本IB | 2024 集成完成|
...
- **亚太基地**：3  位于香港、新加坡和东京的大型枢纽，与汇丰银行/瑞士宝盛/瑞士信贷银行（合并前）在亚洲PB竞争中并列
- **前CS整合效应**：规模扩张与风险资产整合的两阶段方法（非核心和遗留部门的分离）
...
- **所在管辖区**：FINMA（瑞士金融市场监管局）+ SNB（瑞士国家银行）
- **受日本监管**：金融厅（FSA）、关东地方财政局（外国证券公司和银行分行的注册）
- **当前政策问题**：
  - 2023 ~ 前CS AT1  债券贬值诉讼/国际仲裁
  - 2024 ~ 瑞士 TBTF（太大而不能倒）监管收紧辩论（仅瑞银集团在银行资产占 GDP 的百分比方面脱颖而出）
  - 2024 ~ 2026  日本基地前CS整合进度成本重组

## 6。对位法

> 主观战略评估/问题（PB 与 IB 份额视角、前 CS 整合的战略意义、瑞士 TBTF 风险）分为“.opinions/JapanFG/ubs-japan.md”。

## 7。开放式问题

- 原CS日本基地的整合何时能完全完成？最终成本重组规模（人员裁减/部门重组）是多少？
- UBS SuMi TRUST WM JV的长期战略是什么（追加投资、解散JV、成为全资子公司）？
- 原CS AT1 债券一文不值的国际仲裁/诉讼进展如何？
- 原CS整合后，瑞银证券在日本IB市场（DCM/ECM/M&A）的地位如何？与摩根士丹利和高盛的竞争结构
- 瑞士收紧的 TBTF 法规 (2025~) 对瑞银整体及其日本基地有何影响？
...
- **维基百科：UBS / UBS Group AG**（https://ja.wikipedia.org/wiki/UBS，2026-05-19 摘录）
- **维基百科：瑞士信贷**（2023-06 紧急采购相关，2026-05-19提取）
- 瑞银集团年度报告2024（已发布/2025-03 已发布）

---

> [!info] 验证状态
> 信心：**有可能**（v1.0 公开信息+维基百科校核2026-05-19）。 UBS SuMi TRUST WM 的持股比例（51% / 49%）是根据公开报告估算的，最新数值请参阅两家公司的新闻报道。原CS的整合进度和人员数量不断变化，请每季度查看UBS IR。
