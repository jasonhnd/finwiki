...
本条目位于 [[JapanFG/INDEX|JapanFG index]] 之下。可与 [[banking/INDEX|banking index]] 一起阅读以理解相邻语境，也可与 [[JapanFG/legal-financial-licenses/INDEX|JapanFG index]] 一起阅读以把握更大的系统边界。

## TL;DR

株式会社大光银行是总部位于新潟县长冈市、列入金融厅银行牌照名单的第二地方银行。在 FSA workbook 中，它属于关东财务局管内 second-regional-bank list；在本 wiki 中，它作为 Niigata / Kanto-adjacent second-regional-bank operating-company page 处理。
...
- 补齐 FSA second-regional-bank 对大光银行精确名称的覆盖缺口。
- 将该银行与其他同名“大光”公司区分开。
- 为 Niigata / Kanto-adjacent regional-bank coverage 提供银行层面的锚点。
