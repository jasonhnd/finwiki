...
本条目位于 [[JapanFG/INDEX|JapanFG index]] 之下。可与 [[JapanFG/shinkin-central|信金中央金庫]] 对照阅读，以理解支撑信用金库系统的 operational central-bank counterpart；可与 [[JapanFG/zenshin-kyo|全国信用金庫協会]] 一起阅读，以理解行业团体 / 政策层；也可与 [[banking/shinkin-bank-registry-japan|Japan shinkin bank registry]] 一起阅读，以把握完整会员群体路径。协同组织系统比较锚点位于 [[banking/japan-cooperative-banking-unified-federation-matrix|Japan cooperative-banking unified federation matrix]]。
...
| Federation 层 counterpart | [[JapanFG/zenshin-kyo|全国信用金庫協会]]（policy / industry body） |
| Central-bank 层 counterpart | [[JapanFG/shinkin-central|信金中央金庫]]（central liquidity / clearing） |
...
2. **信用金库共同中心（勘定系共同使用）**
   ...
   - 大型信用金库（如 [[JapanFG/kyoto-chuo-shinkin|京都中央信用金庫]]、[[JapanFG/osaka-shinkin|大阪信用金庫]] 等）也有持有独自勘定系的情况，但许多中坚 / 中小金库依赖共同中心。
...
### 与 [[JapanFG/shinkin-central|信金中金]] 的分工
