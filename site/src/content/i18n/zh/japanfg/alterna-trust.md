...
该页面之所以重要，是因为它是进入日本 security-token 基础设施的直接信托公司路径。它连接 [[JapanFG/smtb|SMTB]]、[[JapanFG/progmat|Progmat]] 以及 ALTERNA 数字证券分销界面。
...
本页不应暗示 Alterna Trust 本身就是交易所、券商或代币平台。市场场所路径请用 [[securities/osaka-digital-exchange|ODX]]，平台背景请用 [[JapanFG/progmat|Progmat]]。
...
4. 在分析面向投资者的分销时链接到 [[JapanFG/legal-financial-licenses/securities-license-stack|securities license stack]]。
