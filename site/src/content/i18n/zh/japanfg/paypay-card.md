...
PayPay 卡是 [[JapanFG/paypay-fg|PayPay金融グループ]] 的信用卡 / PayPay Credit operator。由于它把 credit line 嵌入 PayPay wallet 的支付体验，需要将 wallet 与 card issuer 分开管理。
...
| 集团 | [[JapanFG/paypay-fg|PayPay FG]] / SoftBank-LY payment ecosystem |
