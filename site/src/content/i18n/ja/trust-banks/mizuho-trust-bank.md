...
この項目は [[trust-banks/INDEX|trust-banks INDEX]]（そのドメイン経路）の下に位置する。ピア / 対比（他のメガバンクグループ系信託銀行）として [[trust-banks/mitsubishi-ufj-trust-bank|三菱UFJ信託銀行 (MUTB)]] および [[trust-banks/smtb|三井住友信託銀行 (SMTB)]] と、監督 / システム境界として [[financial-regulators/fsa|the FSA]] および [[banking/INDEX|banking]] と併せて読むとよい。同一グループ内の商業銀行の姉妹会社は [[megabanks/mizuho-bank|みずほ銀行]]。
...
| 項目 | 備考 |
|---|---|
| 法人名 | みずほ信託銀行株式会社 / Mizuho Trust & Banking Co., Ltd. |
| ライセンス経路 | 銀行法の銀行免許 + 兼営法に基づく信託業務の兼営認可（信託兼営金融機関） |
| FSA 区分 | 信託銀行 |
| 銀行コード | 0289 |
