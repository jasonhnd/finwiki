...
|---|---|
| 正式名 | 大和リビング信託株式会社 |
| ライセンス類型 | FSA 登録上の管理型信託会社 |
| 公開上の焦点 | 不動産管理信託 |
| 資産レーン | 賃貸住宅・不動産 |
| 登録ルート | FSA 信託会社一覧 |

これはフルラインの信託銀行や住宅ローン貸出機関と同じ面ではない。受託者・管理、賃貸不動産運営、融資の役割は分けて扱う。

## 事業役割マップ

| 機能 | FinWiki 上の意味 |
|---|---|
| 不動産管理信託 | 賃貸住宅と賃貸人の承継論点を接続する。 |
| 家族・資産承継 | 公開上の位置づけは、資産を守り家族へ引き継ぐ点を強調する。 |
...
2. 会社の位置づけと不動産信託の仕組みは公開サイトで確認する。
3. 受託者、プロパティマネージャー、建設会社、貸出機関の機能を分ける。
4. 資金調達の仕組みに出典がある場合に限り、住宅金融ページへリンクする。
