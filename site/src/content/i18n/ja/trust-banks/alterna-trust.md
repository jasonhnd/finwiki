...
このページが重要なのは、日本のセキュリティトークン・インフラへ直接つながる信託会社ルートだからである。[[trust-banks/smtb|SMTB]]、[[payment-firms/progmat|Progmat]]、ALTERNA のデジタル証券販売面を接続する。
...
4. 投資家向け販売を分析する場合は [[financial-licenses/securities-license-stack|securities license stack]] にリンクする。
