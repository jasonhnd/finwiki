...
|---|---|
| 法人名 | 日証金信託銀行株式会社 |
| 英名 | JSF Trust and Banking Co., Ltd. |
| 親会社 | [[financial-regulators/japan-securities-finance|Japan Securities Finance]] 100% |
| 設立 | 1998-11-17 |
| 資本金 | 14.0 億円 |
| 銀行 / 店番号 | 公式会社概要における 0321 / 001  |
| コアルート | 証券 / 金融事業者の信託ニーズに対応する専門信託銀行 |

これはフルサービス信託銀行における相続 / 資産承継チャネルのようなリテール信託銀行のストーリーではない。より適切な読み方は「市場参加者向けの規制された信託層」である。

## 業務ライン・マップ

| 信託機能 | 公的な関連性 |
|---|---|
| 顧客資産保護信託 | 金融商品取引業者が顧客資産を分別管理することを支援する。 |
| 有価証券信託 | 信託銀行構造を有価証券の保有・管理に結び付ける。 |
| FX / CFD 証拠金信託 | 顧客証拠金保護を信託ラッパーの内側に置く。 |
| 債務引受 / 担保信託 | 構造化された債務とリスク移転の仕組みを支える。 |
...
1。顧客が証券会社・FX / デリバティブ事業者・暗号資産事業者・クラウドファンディング事業者・セキュリティ・トークン・プラットフォームのいずれであるかを特定する。
2。信託銀行の受託者 / 管理者としての役割を、投資判断と切り分ける。
3。信用取引と証券金融については、[[securities/japan-margin-trading-and-securities-finance|margin trading / securities finance]] と [[financial-regulators/japan-securities-finance|JSF]] にリンクする。
4。セキュリティ・トークン・スキームについては、[[securities/osaka-digital-exchange|ODX]] と [[financial-licenses/securities-license-stack|securities license stack]] にリンクする。
5。暗号資産関連の信託については、取引所登録を推測しないこと。信託銀行の役割は暗号資産取引所の運営とは異なる。

## 留意点

- 公開された会社沿革は商品カテゴリーを挙げているが、特定の顧客スキームについては依然として案件レベルの出典確認が必要である。
- 信託構造は分別 / 管理リスクを低減し得るが、市場・オペレーショナル・カウンターパーティの各リスクを排除するものではない。
...
- 日証金信託銀行: 会社概要 / 沿革・経営理念ページ。
- 日本証券金融: 公式会社概要およびグループ文脈。
- 金融庁: 信託業務を営む金融機関一覧。
