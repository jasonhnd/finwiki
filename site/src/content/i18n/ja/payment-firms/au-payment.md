...
- au 金融エコシステムに対し、決済とストアドバリューのレイヤーを提供する。
- 通信アカウントの流通、ウォレット残高、前払式手段、ポイント投資、金融商品チャネルをつなぐ。
- [[payment-firms/paypay|PayPay]] と同じ通信主導のコード決済 / ウォレットの区分に位置し、独自のライセンススタックよりもポイント経済のリーチで競争する。
- au Financial Service との合併計画を 2026-07-01 に向けて公式に発表しており、この境界は watch item。

## 3. なぜこの独立ページが重要か

au PAY はサービス名であり、auペイメントは規制対象の operating company である。本ページは、通信流通、前払い価値、資金移動ライセンスが混同されるのを防ぐ。
