...
本項は [[payment-firms/INDEX|payment-firms INDEX]]（そのドメインルート）の下に置かれる。ピア／対比（もう一つの P2P ウォレット資金移動業者）として [[payment-firms/kyash|Kyash]] と、監督・システムの境界として [[financial-regulators/fsa|the FSA]] および [[payments/funds-transfer-vs-prepaid-boundary|the 資金移動 vs 前払式 boundary]] と照らし合わせて読むこと。
...
|---|---|
| 法人名 | 株式会社pring |
| ライセンス区分 | 資金移動業者（資金移動, 資金決済法）; FSA 関東財務局長第00050号 |
...
| Wiki 上の役割 | Google が買収した日本資金移動事業者 のページ |
...
- Google が保有した数少ない日本資金移動事業者 を 実体名アンカー として固定する。
