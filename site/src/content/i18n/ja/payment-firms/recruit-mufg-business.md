...
RMB は [[megabanks/mufg|MUFG]]、消費者向けアプリ、加盟店、給与支払フロー、口座間決済の間に位置する。そのため、[[payment-firms/paypay|PayPay]]、[[payment-firms/merpay|Merpay]]、[[payment-firms/au-payment|au PAY]]、および [[payment-firms/gmo-payment-gateway|GMO-PG]] のようなカード主導の PSP との有用な比較対象になる。
