...
[[payment-firms/bnpl-landscape|Japan BNPL landscape]] および [[payment-firms/paidy|Paidy]] / [[payment-firms/atone|atone]] / [[payment-firms/net-protections-hd|Net Protections HD]] のページから直接参照される **物流系 BNPL のアンカー**として、独立ページが必要。ヤマト HD 本体は物流コングロマリットであり、金融サブセグメント単独で取り出すのが整理上自然。
