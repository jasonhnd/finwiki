...
PayPalはグローバルなブランド主導のサービスだが、日本で分析するには法人格とアカウント種別の境界を分ける必要がある。 個人アカウントとビジネスアカウントの扱いは同一ではない。 比較対象として [[payment-firms/wise-payments-japan|Wise]], [[payment-firms/payoneer-japan|Payoneer]], and [[payment-firms/airwallex-japan|Airwallex]] 資金移動業の比較対象を、また [[payment-firms/paypay|PayPay]] 国内ウォレット隣接領域を確認する。.
