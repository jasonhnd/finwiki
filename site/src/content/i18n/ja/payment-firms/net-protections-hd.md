...
| レーン | 公開情報からの読み方 |
|---|---|
| NP 後払い | EC 向けの加盟店 checkout BNPL。製品サイトは、購入者にとっての商品確認後支払い、加盟店にとっての与信審査、請求、回収、料金プランを組み合わせたサービスとして説明している。 |
| atone | 消費者アカウントを基点に、加盟店をまたいだ購入を後払い体験へまとめる BNPL。グループ内の消費者ウォレット型レーンとして読む。 |
| NP 掛け払い | BtoB の請求書払いアウトソーシング。公開サイトは与信 / 債権保証、請求書発行、代金回収、入金管理、督促、問い合わせ対応を説明している。 |
| AFTEE | 日本国外市場向けの海外 BNPL ブランド。ローカルライセンスを日本法人に結びつける公開情報がない限り、日本規制ページとは分けて読む。 |
| 上場持株会社レンズ | IR サイトと東証 Prime 上場により、Net Protections は公開 BNPL 経済性を読むうえで有用である。GMV、加盟店基盤、与信損失指標は、非公開 peer から推測せず開示資料で確認できる。 |
...
- NP Kakebarai 製品サイト: https://np-kakebarai.com/
