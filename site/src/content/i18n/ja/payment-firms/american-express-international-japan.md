...
この項目は [[payment-firms/INDEX|payment-firms INDEX]] の下に位置する。ピア／対比の文脈（JCB と Amex は両方 3-party scheme + 提携歴あり）としては [[card-issuers/jcb|JCB]] と、より広範なシステム／規制の境界としては [[payments/japan-card-issuer-acquirer-processor-split|Japan card issuer / acquirer / processor split]] と併せて読むこと。
