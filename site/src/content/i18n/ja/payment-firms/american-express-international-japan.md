...
| Brand role | 3-party scheme 事業者 + direct card 発行会社 + アクワイアラ (国内では混合型) |
...
- **国内加盟店契約**: 自社で加盟店契約 (アクワイアリング) を行う伝統 — ただし国内では決済代行業者経由のケースも増加。
- **提携カード発行 (4-party 的)**: [[card-issuers/mufg-nicos|三菱UFJニコス]]・セゾン・ANA・JAL 等との Amex ブランド提携カード — 発行会社 は提携先、ブランドは Amex。
...
- [[card-issuers/mufg-nicos]] / [[card-issuers/aplus]] (Amex 提携カード発行発行会社)
