...
本項目は [[exchanges/INDEX|exchanges index]] 配下に位置づける。Solana エコシステム文脈は [[exchanges/solana-ecosystem-dex-comparison|Solana エコシステム DEX 群比較]]、隣接する DEX 同業文脈は [[exchanges/dex-raydium-solana|Raydium]] / [[exchanges/dex-orca-solana|Orca]]、より広い制度・メカニズム境界は [[exchanges/amm-design-evolution|AMM 設計進化系譜]] と併読する。
