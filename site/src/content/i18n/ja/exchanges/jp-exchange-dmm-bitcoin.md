...
status: machine
fidelity: ok
title: "株式会社DMM Bitcoin — 日本暗号資産交換業者（former VASP）overview"
translated_at: 2026-06-02T12:19:04.222Z
---
...
> **former VASP / 2024-12 サービス停止発表 · 2025-03-08 全面終了**
> 旧 FSA 登録番号 関東財務局長 第00010号（登録抹消済） · 旧 JVCEA 第一種会員（退会済） · 暗号資産交換業登録日 2018年1月

## 1. 法人・株主

- **商号**: 株式会社DMM Bitcoin
- **設立**: 2016年11月7日（株式会社東京ビットコイン取引所として設立）
- **本店所在地**: 東京都中央区日本橋2-7-1 東京日本橋タワー10階
- **資本金**: 1億円（最終期）
- **親会社**: 株式会社DMM FX ホールディングス（DMM.com グループ）
- **上場**: 非上場
- **代表取締役**: 松田昇樹（廃業時点）
- **法人番号**: 5010401128129
...
- **暗号資産交換業（FSA）**: 旧 関東財務局長 第00010号 — **登録抹消済**（2025年廃業に伴い）
- **第1種金融商品取引業**: 旧 関東財務局長（金商）第3189号 — **登録抹消済**（2020年5月取得）
- **JVCEA 会員**: 旧 第一種会員 — **退会済**（2026-05-18現在 JVCEA 会員一覧に非掲載で確認）
- 電子決済手段等取引業・資金移動業の登録実績：公表なし

## 3. 取扱通貨

2023年時点で現物取引対応18銘柄（主要銘柄）：

BTC · ETH · XRP · LTC · BCH · XLM · MATIC · LINK · MKR · AVAX · CHZ · TRX · ZPG · ETC · BAT · ENJ · OMG · MONA

レバレッジ取引（差金決済）にも対応し、BTC・ETH 等の主要銘柄を提供していた。取扱銘柄はビットコインを中心とした中型ラインナップで、アルトコインは限定的。

## 4. 業務範囲

- 現物取引：販売所（OTC）
- レバレッジ取引（差金決済 / 第1種金融商品取引業として提供）
- 法定通貨入金チャネル：銀行振込・クイック入金
- ステーキング・レンディング：公式案内なし
- NFT：対応実績なし
- 法人サービス：一般的な口座開設対応（詳細公表なし）
...
| 年月 | 事項 |
|------|------|
| 2016-11 | 株式会社東京ビットコイン取引所として設立 |
| 2017-03 | 仮想通貨取引所「東京ビットコイン取引所」開設 |
| 2017-09 | 関東財務局へ仮想通貨交換業者登録申請 |
...
- 2025-03-08 サービス終了。DMMグループとしての暗号資産交換業からの完全撤退。

## 8. 関連人物

- **松田昇樹**：代表取締役（廃業時点）— 詳細な経歴は公表なし
- **株式会社DMM FX ホールディングス**：100%親会社（廃業時点）
- DMM.com Securities Co.,Ltd.（DMM.com証券）はグループ内の別法人として JVCEA 第一種会員（会員番号1043・暗号資産デリバティブ取引）を継続しており、株式会社DMM Bitcoinとは別個の事業体

## 関連項目

- [[exchanges/jp-exchange-sbi-vc-trade]] — SBI VCトレード（顧客資産移管引受先）
...
- [DMM Bitcoin 公式サイト（サービス終了告知）](https://bitcoin.dmm.com/)（取得 2026-05-18）
- [SBI VCトレード DMM Bitcoin 移管 特設サイト](https://www.sbivc.co.jp/dmm_vct)（取得 2026-05-18）
- [JVCEA 会員一覧](https://jvcea.or.jp/member/)（取得 2026-05-18 · DMM Bitcoin 非掲載を確認）
- [FSA 暗号資産・電子決済手段関係ページ](https://www.fsa.go.jp/policy/virtual_currency02/)（取得 2026-05-18）
