...
status: machine
fidelity: ok
title: "SBI VCトレード株式会社 — 日本暗号資産交換業者 概要"
translated_at: 2026-06-02T12:19:04.229Z
---

# SBI VCトレード株式会社 — 日本暗号資産交換業者 概要
...
同社は現時点で日本唯一の「3種牌照同時保有業者」であり、暗号資産交換業・金融商品取引業（暗号資産デリバティブ）・電子決済手段等取引業を単独で持つ。

| 業種 | 登録番号 | 備考 |
|------|---------|------|
| 暗号資産交換業 | 関東財務局長 第00011号 | 登録 2017-12-01 |
| 第一種金融商品取引業（暗号資産デリバティブ） | 関東財務局長（金商）第3247号 | OTC 派生対応 |
| 電子決済手段等取引業 | 関東財務局長 第00001号 | 2025-03-04 登録完了、USDC 取扱用 |
...
関連するステーブルコイン経路: [[fintech/japan-ecisb-license]], [[fintech/japan-stablecoin-regulatory-landscape]], [[fintech/stablecoin-channel-japan-sbi-jpyc-ring]], [[JapanFG/jpyc]], [[JapanFG/progmat]].

## 3. 取扱通貨

2026年5月時点で現物取引対象は約40銘柄。主要銘柄：BTC・ETH・XRP・LTC・BCH・SOL・ADA・DOGE・DOT・LINK・XLM・AVAX・MATIC・SHIB・TON・SUI など。加えて電子決済手段（EP 手段）として **USDC** および JPY 安定性資産（ZPG・DAI）を取扱う。

特色：
- **USDC**（ユーエスディーシー）を 2025年3月25日に国内一般向け取引開始。電子決済手段等取引業登録（第00001号）を生かした日本円⇔USDC スポット交換および **USDCレンディングサービス**（2026年3月18日開始・国内初）を提供。
...
| USDC レンディング | 国内初（2026-03-18 開始）、雑所得扱い |
...
公開指標：
- **自己資本規制比率** 354.0%（固定化されていない自己資本 76億9,800万円）※2026年3月末時点・同社 IR 開示
- 口座数・月間取引高の公開数値は確認できず（公表なし）

ポジション：3種牌照保有・DMM Bitcoin 顧客資産移管（推定数十万口座規模）・SBI グループ百%子会社という点から、国内大手 5–6 社に位置すると見られるが、取引高・口座数の公的比較ランキングに同社独自の数字は公表されていない。顧客層は個人リテール中心に大口・法人向け Prime サービスを併設。

## 6. 沿革・重大事件

| 時期 | 事項 |
|------|------|
| 2017-05-26 | SBI VCトレード株式会社 設立 |
| 2017-12-01 | 暗号資産交換業 関東財務局長 第00011号 登録 |
| 2020-10 | TaoTao 株式会社（旧 Z Holdings 系）の発行済全株式を SBIリクイディティ・マーケットが取得し SBI グループ入り |
| 2021-09-01 | SBI VCトレードと TaoTao 株式会社の合併決議発表（存続会社：TaoTao、消滅会社：SBI VCトレード；その後商号変更により現在の SBI VCトレード株式会社として継続） |
| 2021-12-01 | TaoTao × SBI VCトレード 合併効力発生（予定日）。ブランド名 VCTRADE に統合 |
| 2022 | 第一種金融商品取引業（金商 第3247号）取得（暗号資産デリバティブ対応） |
| 2024-05 | DMMビットコイン、約482億円相当の BTC 不正流出被害（同社は無関係だが後に移管先に選定） |
| 2024-12-02 | DMM Bitcoin との口座・預かり資産移管に向けた**基本合意**締結 |
| 2025-03-04 | **電子決済手段等取引業者**として関東財務局長 第00001号 登録完了（国内初） |
| 2025-03-08 | DMM Bitcoin の口座・預かり資産を SBI VCトレードへ**移管完了**（全顧客対象） |
| 2025-03-25 | USDC 一般向け取引開始（日本円で USDC 売買が可能な国内唯一の取引所） |
| 2026-01-30 | SBI VCトレードと株式会社ビットポイントジャパンの合併決議発表（SBI VCトレードが存続会社、効力発生日 2026年4月1日予定） |
| 2026-04-01 | ビットポイントジャパン吸収合併効力発生（両ブランド当面並行維持） |
| 2026-03-18 | USDC レンディングサービス開始（国内初） |

## 7. 戦略動向

- **3 種牌照構造の戦略的意義**：暗号資産交換業（現物）・金融商品取引業（デリバティブ）・電子決済手段等取引業（ステーブルコイン）を単一法人に集約するのは国内唯一。特に電子決済手段等取引業（USDC 取扱）は 2025-03 に登録完了し、Circle 社 USDC の日本円建スポット交換・レンディングを展開中。
- **SBI グループ内シナジー**：SBI 証券（金商 第44号、JVCEA #1041）・BI FXTRADE（金商 第2635号、JVCEA #1026）など同グループ傘下の金融商品取引業者との連携が可能な体制。SBI ホールディングスは Ripple Labs（XRP 関連）への出資・提携関係を持つ。
...
- **代表取締役会長**：尾崎 文紀（2026年5月時点）
- **代表取締役社長**：近藤 智彦（2026年5月時点）
- **取締役**：北尾 吉孝（SBI ホールディングス代表取締役 CEO）、日下部 聡恵、久場 健太郎、小川 裕之
- **監査役**：北原 勝美
...
- [[exchanges/jp-exchange-binance-japan]] — 同業他社 概要（Binance Japan）
- [[exchanges/jp-exchange-gmo-coin]] — 同業他社 概要（GMO コイン）
