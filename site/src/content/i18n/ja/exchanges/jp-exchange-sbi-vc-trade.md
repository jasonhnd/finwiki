...
## 2. 牌照・登録状況同社は現時点で日本唯一の「3種牌照同時保有業者」であり、暗号資産交換業・金融商品取引業（暗号資産デリバティブ）・電子決済手段等取引業を単独で持つ。

| 業種 | 登録番号 | 備考 |
|------|---------|------|
| 暗号資産交換業 | 関東財務局長第00011号 | 登録 2017-12-01 |
| 第一種金融商品取引業（暗号資産デリバティブ） | 関東財務局長（金商）第3247号 | OTC 派生対応 |
| 電子決済手段等取引業 | 関東財務局長第00001号 | 2025-03-04 登録完了、USDC 取扱用 |

- **JVCEA 会員種類**：第一種（会員番号 1011）
- **加入協会**：日本暗号資産等取引業協会（JVCEA）、日本暗号資産ビジネス協会（JCBA）、日本デジタル経済連盟、日本デジタル分散型金融協会、JPCrypto-ISAC

### 電子決済手段 / USDC 相互参照金融庁の電子決済手段等取引業者登録一覧では、SBI VCトレードが関東財務局長第00001号の登録業者として記載され、取扱電子決済手段は USDC とされている。したがって同社は単なる暗号資産交換業者ではなく、日本の電子決済手段 / stablecoin 実装を読む際の primary route でもある。
...
| 2021-12-01 | TaoTao × SBI VCトレード合併効力発生（予定日）。ブランド名 VCTRADE に統合 |
| 2022 | 第一種金融商品取引業（金商第3247号）取得（暗号資産デリバティブ対応） |
| 2024-05 | DMMビットコイン、約482億円相当の BTC 不正流出被害（同社は無関係だが後に移管先に選定） |
| 2024-12-02 | DMM Bitcoin との口座・預かり資産移管に向けた**基本合意**締結 |
| 2025-03-04 | **電子決済手段等取引業者**として関東財務局長第00001号登録完了（国内初） |
...
- **SBI グループ内シナジー**：SBI 証券（金商第44号、JVCEA #1041）・BI FXTRADE（金商第2635号、JVCEA #1026）など同グループ傘下の金融商品取引業者との連携が可能な体制。SBI ホールディングスは Ripple Labs（XRP 関連）への出資・提携関係を持つ。
