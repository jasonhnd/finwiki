...
本項目は [[exchanges/INDEX|exchanges index]] 配下に位置する。同業比較・対照の文脈では [[exchanges/jcba-japan-crypto-business-association|JCBA — 日本暗号資産ビジネス協会]]、より広いシステム・規制境界では [[exchanges/fsa-vasp-registration-system|FSA 暗号資産交換業登録制度]] と併読する。
...
1. **暗号資産の税制** — 党・業界の提言と、成立済み税法・国税庁取扱いを区別
2. **DAO・NFT の法的整理** — 研究会・提言段階と成立法を区別
3. **ステーブルコイン** — 改正資金決済法上の電子決済手段と個別サービスを区別
4. **AML / Travel Rule** — [[exchanges/jp-vasp-aml-travel-rule-implementation|犯収法 + FATF Travel Rule 国内実装]]
5. **人材・スタートアップ支援** — 実施済み施策と提言中の制度を公式資料の日付付きで確認
