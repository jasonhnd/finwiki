...
- **CEX 戦略**: RWA は機関向け prime 証券仲介 の延長 → リテール CEX より institutional CEX 強み

## CEX × RWA 統合戦略

- **カストディ**: BUIDL / OUSG は Coinbase カストディ / Anchorage 受託多数
- **trading**: 機関 OTC のみ secondary market (リテール限定的)
- **決済**: USDC / USDT 経由 24/7 決済
- **税制 + 規制**: 米 SEC 監督 + Reg D / Reg S exemption + 機関適格投資家限定

## 国内 + アジア展開

- **Progmat** (三菱 UFJ 信託系) — 信託型 ST 国内最大 (~68% シェア)
- **DCJPY** + **JPYC** — RWA 決済補完候補
- **HK SFC** + **MAS DPT** が RWA 統合実験進行 (HKMA Project Ensemble 等)
