...
status: machine
fidelity: ok
title: "ベトナム暗号資産取引所ランドスケープ — SBV 規制曖昧 / ONUS / Remitano / グレー市場概観"
...
この項目は [[exchanges/INDEX|exchanges index]] の下位に位置づけられる。新興市場の同業比較・対照は [[exchanges/cex-coindcx-india|CoinDCX India]] / [[exchanges/cex-mercado-bitcoin-brazil|Mercado Bitcoin Brazil]]、より広いグローバル・ベンチマークは [[exchanges/global-cex-top10-comparison|global CEX top 10 comparison]]、規制境界の見方は [[exchanges/global-vasp-regulatory-comparison-matrix|グローバル VASP 規制比較]] とあわせて読む。
...
- 規制対応：
  ...
  - ベトナム国内では明示的 ライセンス 不要（VASP 制度なし）の運用
...
- [[exchanges/sg-mas-dpt-licensing-overview]] — シンガポール MAS（ONUS / Remitano の オフショア 拠点）
- [[exchanges/INDEX]] — 取引所ドメインインデックス
- [[exchanges/jp-foreign-exchange-bybit]] — オフショア CEX のアジア新興国展開比較
