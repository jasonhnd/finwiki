...
このエントリは [[exchanges/INDEX|exchanges index]] の配下に位置づけられる。ピア比較・対照の文脈では [[exchanges/global-dex-major-five-comparison|global dex major five comparison]]、より広いシステムおよび規制境界については [[exchanges/fsa-vasp-registration-system|FSA 暗号資産交換業登録制度 — 番号体系・財務局管轄・登録要件]] とあわせて読む。
