...
## 取扱可能銘柄リテール向けは SFC 厳格審査済の大型流動性トークン のみ — BTC, ETH, USDT, USDC 等に限定。機関向けは追加銘柄取扱可能だが、ステーブルコインは別途 [[fintech/hkma-stablecoin-licensing-overview]] の HKMA 監督下にあり、SFC VATP との並行ライセンス構造になる。
