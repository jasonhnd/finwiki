...
公式コーポレートサイトからの取扱一覧ページは取得不可のため、Wikipedia（二次源）掲載の銘柄リストを参照（取得日 2026-05-18）：BTC、ETH、ETC、BCH、LTC、MONA、LSK、XRP、BAT、XLM、XEM、XTZ、DOT、LINK、XYM、MATIC、MKR、ZPG、FLR、SHIB、PLT — 計21銘柄（変動の可能性あり）。公式確認が必要。

**特色**：BTC取引量で国内上位を継続（2016年上半期以来）。BTC/JPY の Lightning（高速取引） 専用板（Lightning Spot）あり。日本円建て現物に加え、レバレッジ取引（Lightning FX）も提供。
...
- 2016年上半期の国内ビットコイン取引量 第1位（bitFlyer公式発表、2016-08-15 GoodWay掲載）
...
| 2015-04 | chainFlyer（ブロックチェーン可視化ツール）リリース |
| 2016-08 | 国内ビットコイン取引量上半期 1位達成 |
| 2017-09-29 | 金融庁 暗号資産交換業者 登録完了（関東財務局 第00003号）|
| 2017-11 | bitFlyer USA BitLicense 取得・米国事業開始 |
| 2018-01-23 | bitFlyer EUROPE S.A. EU Payment Institution License 取得。日米欧3大陸ライセンス取得は世界初と公式発表 |
| 2018-06 | 金融庁より業務改善命令（内部管理体制の不備等・URL 削除済、Wikipedia 等で cross-check）|
| 2019-01 | 平子惠生 代表取締役就任（加納が退任）|
| 2019-05 | 株式会社 bitFlyer Blockchain 設立（ブロックチェーン技術子会社）|
| 2020-03 | 三根公博 代表取締役就任・経営陣刷新 |
| 2020-03 | 日米欧累計顧客数250万人突破 |
| 2021-03 | 林邦良 代表取締役就任 |
