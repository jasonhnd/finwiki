...
本項目は [[exchanges/INDEX|exchanges index]] 配下に位置する。比較・対照の文脈では [[exchanges/global-dex-major-five-comparison|global dex major five comparison]]、より広いシステム上・規制上の境界については [[exchanges/fsa-vasp-registration-system|FSA 暗号資産交換業登録制度 — 番号体系・財務局管轄・登録要件]] とあわせて読む。
...
- [[exchanges/global-perp-dex-five-comparison]] — perp 系 (CLOB / oracle / AMM) vs 本記事 現物 AMM
...
- [[systems/cross-chain-four-poles-overview]] — cross-chain 4 極 概要（AMM × bridge）
