...
- **決済 finality**: パブリックチェーン上 onchain settlement (Ethereum 12 confirmations 等)、JPYC EX 内では即時
...
- **メタプラネット (3350)** — JPYC シリーズ B 出資で BTC × SC 連携への布石 (発行体ではなく ecosystem 投資家)
...
| **登録番号例** | 関東財務局 第00099号 | (該当なし、信託業務として運営) | 銀行業免許 + 電代 92 号 (DCP) | 関東財務局 第00001号 (ECISP) | 関東財務局 第00773号 (JPYC v1) |
