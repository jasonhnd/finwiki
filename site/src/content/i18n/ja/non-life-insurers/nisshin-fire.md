...
このエントリは [[non-life-insurers/INDEX|non-life-insurers INDEX]] の下に位置する。同業 / 対比のコンテキストについては [[non-life-insurers/tokio-marine-nichido-fire|東京海上日動火災保険]] と、より広範な体系 / 規制境界については [[insurance/INDEX|insurance index]] と対照して読まれたい。
...
| グループ境界 | 東京海上グループの隣接性 |
| Wiki ロール | 専門 / グループ損害保険事業会社 |

## 2. オペレーティングモデル

日新火災は、東京海上グループの主要損保ブランドおよびダイレクトブランドとは異なる事業の面を持つ。SME / 地域 / 代理店チャネル、ニッチ商品、そしてグループブランドのセグメンテーションを見るとき、スタンドアロンのページが必要になる。

## 3. なぜこのページが重要か

- もう 1 つの東京海上グループ損保事業会社の境界を追加する。
- [[non-life-insurers/tokio-marine-nichido-fire]] および [[non-life-insurers/tokio-marine-direct]] を補完する。
- 登録に裏付けられた D5 専門損保のページ。
