...
status: machine
fidelity: ok
title: "日本の損保大手3社：再保険と災害リスクのオーバーレイ・マトリクス"
translated_at: 2026-06-02T14:01:20.922Z
---

# 日本の損保大手3社：再保険と災害リスクのオーバーレイ・マトリクス
...
日本の損保大手3社を財務諸表の要約（保険料、コンバインド・レシオ、ESR）だけで読むと、バランスシートの変動性を実際に動かす要因は見えない。その下には3つの構造的な問いがある。

1. **危険別の災害損失プロファイルはどうなっており、変動のどれだけが再保険に出され、どれだけが保有されているか。** 地震、台風、洪水の損失は、それぞれ異なるリターンピリオド形状を持つ。cat retention layer が高い場合、好調な引受年度には利益がより多く最終利益へ落ちるが、悪い年度にはより多くの資本を消耗する。
2. **海外事業は国内引受の変動性とどのように相互作用するか。** 各グループは異なる海外ミックスを構築している。Tokio Marine は最大の US specialty と London 市場プレゼンスを持ち、MS&AD は US、Asia、Lloyd's syndicate ルートを持ち、Sompo は US / Europe specialty フットプリントと Asia エクスポージャーを持つ。
3. **レガシーな政策保有株ポートフォリオはどのように縮減されており、それが ESR と資本還元に何をもたらすか。** 3グループはいずれも、戦後の系列・取引関係から継承した長いテールの株式ブックを抱える。これを減らすと ESR の市場リスク資本が下がり、自社株買い余力が生まれる一方、急ぎすぎると関係性と配当収入ラインを傷つける。

以下のオーバーレイ・マトリクスは、これらの軸を特定日現在の数値ではなくルーティングとして記録する。 具体的な災害損失額、ESR 比率、再保険保有、株式ポートフォリオ規模は毎年度変わるため、各グループ's の統合報告書 / 年次報告書および FSA 資料から取得すべきである。
...
資本還元は、配当と ESR に合わせた定期的な自社株買いの組み合わせである。政策保有株の縮減は進行中であり、資本政策上の反復的な論点である。
...
資本還元は、配当と ESR に合わせた機動的な自社株買いの組み合わせである。政策保有株の縮減は進行中である。改善対応の流れは近年、資本政策メッセージに影響する公開開示上の論点になっている。

## 災害危険、再保険、海外事業の重ね合わせ

3グループはいずれも、日本側では共通する再保険アーキテクチャと災害危険ミックスを持つ。ただし、各レイヤーの規模と形状は異なる。

- **地震（商業 / 信託不動産）** — 家計地震保険プール（[[insurance/earthquake-insurance-public-private-scheme|earthquake insurance public-private scheme]]）とは別である。Cat XL が主要な再保険プロテクションであり、最大級の単一イベント・シナリオが再保険プログラムの retention sizing を左右する。
- **台風 / 風災** — 年間頻度の高い損害ドライバーである。近年の Faxai（2019, ）と Hagibis（2019, ）およびその後の事象は、プログラム全体の再保険価格をリセットした。年間の災害予算の前提は、コンバインド・レシオ見通しに反映される。
- **洪水** — 気候変動との関連が指摘される発生頻度の上昇を伴う二次的危険である。主な緩和手段は Cat XL と再保険の復元条項である。
...
コンバインド・レシオ（損害 + 事業費 / 既経過保険料）は、引受収益性の主要指標である。大手3社では、任意自動車、火災（住宅および商業）、賠償責任、海上、傷害、その他商業種目といった種目別、および国内 / 海外の地域別に分解して読む。災害損失は、報告時には損害率への一行加算として現れ、中期計画では別個の「cat budget」仮定が開示される。

大手3社の ESR 感応度は次の要因で動く：

- **国内金利ショック** — 生命保険会社より小さいが、準備金の割引と債券ポートフォリオの時価評価を通じてなお存在する。
- **株式市場ショック** — 政策保有株ポートフォリオがあるため重要である。この感応度は、縮減が進むにつれて機械的に低下している。
- **為替ショック** — 海外利益、外貨建て準備金、外貨建て再保険回収額があるため重要である。
- **信用スプレッド拡大** — 債券ポートフォリオの時価評価と再保険カウンターパーティ・エクスポージャーに影響する。
- **災害ショック** — FSA の経済価値基準の下で災害モジュールの直接チャージが発生し、カウンターパーティの信用力に左右される再保険回収により緩和される。

制度レベルの分解は [[insurance/global-solvency-framework-comparison-matrix|the global solvency framework comparison matrix]]、指標定義は [[insurance/esr-economic-value-solvency|the ESR explainer]] を参照。

## 大手3社比較マトリクス

以下のマトリクスは、大手3社を差別化する軸を整理する。具体的な数値（災害予算、コンバインド・レシオ、ESR、株式ポートフォリオ規模）は時点依存であり、各グループの最新の統合報告書 / 年次報告書および FSA 資料で確認する必要がある。
...
| 国内災害予算のリセット | Faxai / Hagibis（2019）およびその後の事象後にリセット | Faxai / Hagibis（2019）およびその後の事象後にリセット | Faxai / Hagibis（2019）およびその後の事象後にリセット |

### 再保険プログラムの形状

| 軸 | Tokio Marine | MS&AD | Sompo |
|---|---|---|---|
| グループ内再々保険 | あり。海外子会社の災害 retro をグループへ戻す | あり。MSI / ADI と海外子会社の間 | あり。Sompo Japan と海外子会社の間 |
| 比例再保険（非災害ライン） | 選択したラインで利用 | 選択したラインで利用 | 選択したラインで利用 |
...
| 軸 | Tokio Marine | MS&AD | Sompo |
|---|---|---|---|
| 海外利益シェア | 3社中最大 | 重要だが Tokio Marine より小さい | 重要だが Tokio Marine より小さい |
| US specialty | Philadelphia / Pure / HCC プラットフォーム（M&A により取得） | US specialty プラットフォーム | Endurance / Sompo International の系譜 |
| London market プレゼンス | あり。意味のある Lloyd’s / London market プレゼンス | あり。MS Amlin の系譜による Lloyd’s syndicate ルート | 選択的な London / Europe specialty |
| アジア成長 | アジア損保と再保険のフットプリント | アジア損保フットプリント（Aioi / Nichido の系譜） | アジア損保フットプリント |
| Lloyd’s との関係 | Lloyd’s market への参加 | Lloyd’s syndicate への参加 | 選択的な Lloyd’s 参加 |
| 再保険エンティティ | Tokio Marine Re / specialty 子会社 | グループ再保険 | Sompo International / Endurance の系譜 |
| 外国再保険会社の日本市場 | [[insurance/foreign-reinsurer-japan-landscape|foreign-reinsurer Japan landscape]] を参照 | 同じ | 同じ |

### 株式保有と政策保有株ポートフォリオ

| 軸 | Tokio Marine | MS&AD | Sompo |
|---|---|---|---|
| 政策保有株の系譜 | 戦後の大規模な系列 / 顧客ブック | 戦後の大規模な系列 / 顧客ブック | 戦後の大規模な系列 / 顧客ブック |
| 縮減プログラム | 複数年の縮減プログラムと年次開示 | 複数年の縮減プログラムと年次開示 | 複数年の縮減プログラムと年次開示 |
| ESR 株式リスク資本への影響 | 縮減の進展に伴い機械的に低下 | 縮減の進展に伴い機械的に低下 | 縮減の進展に伴い機械的に低下 |
| 実現益パイプライン | 売却による定期的な実現益 | 売却による定期的な実現益 | 売却による定期的な実現益 |
| 関係性上の制約 | 売却は顧客 / パートナー関係を考慮して順序立てられる | 同じ制約 | 同じ制約 |

### 株主還元方針と ESR

| 軸 | Tokio Marine | MS&AD | Sompo |
|---|---|---|---|
| 主要資本指標 | ESR（FSA 経済価値制度） | ESR（FSA 経済価値制度） | ESR（FSA 経済価値制度） |
| ESR 目標 | 資本配分方針と結びつく開示レンジ | 資本配分方針と結びつく開示レンジ | 資本配分方針と結びつく開示レンジ |
| Dividend policy | 累進配当 | 累進配当 | 累進配当 |
| 自社株買い方針 | ESR に合わせた機動的な自社株買い。歴史的には3社中最も能動的。 | ESR に合わせた定期的な自社株買い | ESR に合わせた定期的な自社株買い |
| 劣後資本 | 持株会社レベルで利用 | 持株会社レベルで利用 | 持株会社レベルで利用 |
| IAIG / ICS オーバーレイ | [[insurance/japan-iaig-ics-mapping|Japan IAIG / ICS mapping]] を参照 | 同じルート | 同じルート |

### コンバインド・レシオ分解（概念）

| 種目 | Tokio Marine | MS&AD | Sompo |
|---|---|---|---|
| 任意自動車 | 保険料で最大の単一ライン。サイクル感応的。 | 最大の単一ライン。ADI の mobility ecosystem。 | 保険料で最大の単一ライン。 |
| 火災（住宅 / 商業） | 災害変動性に左右され、再保険回収額が重要 | 同じ | 同じ |
| 賠償責任（liability を含む） | 商業 / 法人ブック | 商業 / 法人ブック | 商業 / 法人ブック |
| 海上 | [[insurance/marine-insurance-and-pi-cover-market|marine / P&I cover market]] を参照 | 同じ | 同じ |
| 傷害 / 個人ライン | 安定的で変動性が低い | 安定的で変動性が低い | 安定的で変動性が低い |
| 海外コンバインド・レシオ | 別建てで報告され、US specialty / London サイクルを反映する | 別建てで報告 | 別建てで報告 |

### 概念レベルの ESR 感応度

| 感応度 | Tokio Marine | MS&AD | Sompo |
|---|---|---|---|
| 国内金利ショック | 生命保険より小さいが、準備金割引 / 債券 MTM を通じて存在 | 同じ | 同じ |
| Equity-market shock | 政策保有株の縮減に伴い低下 | 政策保有株の縮減に伴い低下 | 政策保有株の縮減に伴い低下 |
| 為替ショック | 海外利益ミックスのため3社中最大 | 重要 | 重要 |
| 信用スプレッド拡大 | 債券 MTM と再保険カウンターパーティ・エクスポージャー | 同じ | 同じ |
| 災害ショック | FSA 経済価値基準の下で直接の災害モジュール・チャージ | 同じ | 同じ |
| 再保険カウンターパーティ・リスク | グローバル再保険カウンターパーティ集合に分散 | 同じ | 同じ |

### 近年の M&A と戦略案件（概念）

| 軸 | Tokio Marine | MS&AD | Sompo |
|---|---|---|---|
| US specialty M&A の歴史 | Philadelphia、Pure、HCC プラットフォーム | US specialty プラットフォーム | Endurance / Sompo International |
| London / Lloyd’s M&A の歴史 | Kiln / specialty プラットフォーム | MS Amlin（Lloyd’s syndicate の系譜） | 選択的な specialty 案件 |
| Asia / EMEA deals | 継続的 | 継続的 | 継続的 |
| 売却 / 再編 | 継続的なポートフォリオ最適化 | 継続的なポートフォリオ最適化 | 継続的なポートフォリオ最適化に改善対応開示を加える |
| Mobility / digital 隣接領域 | Telematics / digital P&C 投資 | Toyota / mobility ecosystem | Digital P&C 投資 |

### 専門種目マッピング

| 専門種目 | Tokio Marine | MS&AD | Sompo |
|---|---|---|---|
| Marine / energy | 主要参加者。[[insurance/marine-insurance-and-pi-cover-market|marine / P&I cover market]] を参照 | 主要参加者 | 主要参加者 |
| Cyber | 成長中のブック。再保険市場に敏感 | 成長中のブック | 成長中のブック |
| Aviation | 選択的 | 選択的 | 選択的 |
| Trade credit / political risk | 選択的な specialty エクスポージャー | 選択的な specialty エクスポージャー | 選択的な specialty エクスポージャー |
| Construction / engineering | 国内および海外 | 国内および海外 | 国内および海外 |
| Surety | 選択的 | 選択的 | 選択的 |
| Personal accident | 安定的なブック | 安定的なブック | 安定的なブック |
| Agricultural（JA 関連） | 選択的 | 選択的（ADI の系譜） | 選択的 |
| Specialty alternatives | [[insurance/lloyds-japan-syndicate-operating-model|Lloyd's Japan syndicate model]], [[insurance/captive-insurance-japan-market|captive insurance market]] | 同じ | 同じ |
...
- **政策保有株の縮減。** 3社はいずれも複数年にわたり長期保有株式の縮減プログラムを進めており、ESR の市場リスク資本、配当収入ライン、自社株買い余力に影響する。

## 開示資料の読み方

各グループは関連データを似ているが同一ではない開示形式で公表している：

| 開示面 | Tokio Marine HD | MS&AD HD | Sompo HD |
|---|---|---|---|
| 統合報告書（年次） | あり | あり | あり |
| 中期経営計画 | あり（資本配分方針を含む） | あり（資本配分方針を含む） | あり（資本配分方針と改善対応文脈を含む） |
| ESR 開示 | 統合報告書と IR 資料に記載 | 統合報告書と IR 資料に記載 | 統合報告書と IR 資料に記載 |
| Cat budget開示 | 中期計画に記載 | 中期計画に記載 | 中期計画に記載 |
| 再保険プログラム開示 | 統合報告書では高水準の構造、専用の再保険開示では詳細 | 同じ | 同じ |
| 政策保有株の縮減計画 | プログラムと年次目標を開示 | プログラムと年次目標を開示 | プログラムと年次目標を開示 |
| 海外関連会社開示 | 地域 / ブランド別セグメント（US、Europe、Asia） | 地域 / ブランド別セグメント | 地域 / ブランド別セグメント（Sompo International） |
| 四半期財務補足資料 | 標準的な上場会社形式 | 標準的な上場会社形式 | 標準的な上場会社形式 |
| ALM / sensitivity開示 | 統合報告書に記載 | 統合報告書に記載 | 統合報告書に記載 |

勘定科目名は慎重に突き合わせる必要がある。「任意自動車」と「自賠責（CALI）」、「火災」を住宅 / 商業に分けるかどうか、「賠償責任」を一般賠償 / liability / E&O に細分するかどうか、「海外」を地域別に区分するかどうかは、3社でラベルと詳細が異なる。

## 判断での使い方

このオーバーレイは、損保大手3社をより広い市場ではなく相互に比較して読む場合に使う。マトリクスは、実務上の分析問いをいくつか浮かび上がらせる。

- **headline ESR の比較だけでは誤解を招く。** 同じ ESR の2グループでも、災害保有レイヤーや海外利益比率が異なれば、抱える変動性は異なる。headline に頼るのではなく、各グループの ESR 感応度開示を確認する。
- **災害予算の解釈には再保険プログラムが必要である。** 低い災害予算と高い再保険保有を組み合わせた場合は、低い災害予算と低い保有を組み合わせた場合とは構造的に異なる。
- **海外コンバインド・レシオは別サイクルである。** US specialty の soft / hard 市場と London casualty サイクルは、日本側の状況とは独立して動く。国内と海外を分けずにグループのコンバインド・レシオを読むと誤解を招く。
- **政策保有株の縮減には二重のシグナルがある。** 株式ブックの縮小は ESR 上の市場リスク資本を下げる（プラス）一方、配当収入の寄与も下げる（混在）。ペースと買い手側が重要である。
- **改善対応の文脈はメッセージに影響する。** 公開開示された改善対応の流れ、とくに近年の Sompo の流れは、中期計画メッセージ、規制当局との対話、資本政策ガイダンスに影響する。[[insurance/insurance-agency-and-brokerage-japan|the agency / brokerage Japan landscape]] と併せて読む。
- **MS&AD の二事業会社モデル。** グループレベルの数値は MSI と ADI を合算する。Tokio Marine & Nichido Fire または Sompo Japan との単一事業会社比較には、セグメントレベルで読む必要がある。
- **IAIG / ICS 報告。** 指定 IAIG には国内 ESR と並行してグループレベルの ICS 報告が適用される。[[insurance/japan-iaig-ics-mapping|Japan IAIG / ICS mapping]] と [[insurance/global-solvency-framework-comparison-matrix|the global solvency framework comparison matrix]] を参照。
...
- IAIS: Insurance Capital Standard活動 / topic page.
- General Insurance Association of Japan: industry overview.
- Tokio Marine Holdings: integrated / annual reports.
- MS&AD Insurance Group Holdings: integrated reports および開示 library.
