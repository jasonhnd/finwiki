...
|---|---|---|---|
| [[life-insurers/nippon-life|Nippon Life]] | 相互会社を中核とし、幅広いグループ事業を持つ | 規模、営業職員網、法人 / 団体保険、資産運用、海外展開 | 相互会社ガバナンス |
| [[life-insurers/dai-ichi-life|Dai-ichi Life]] | 株式会社 / 上場持株会社の参照例 | 株主向け開示、海外ポートフォリオ、資本政策、デジタル / グループ戦略 | 上場保険会社ガバナンス |
...
[[life-insurers/nippon-life|Nippon Life]] は相互会社型生命保険会社であり、大規模な国内生命保険、営業職員網、法人 / 団体保険、資産運用、海外保険、隣接する金融サービスの開示を持つ。

### 第一生命

[[life-insurers/dai-ichi-life|Dai-ichi Life]] は上場グループの参照例である。公開資料には、資本配分、市場評価、海外ポートフォリオ、株主との対話、契約者事業の開示が含まれる。名称とグループ構造の詳細は時点に依存する。

### 明治安田

[[life-insurers/meiji-yasuda|Meiji Yasuda]] は相互会社型生命保険会社であり、国内の関係性ベースの生命保険、営業職員・法人チャネル、長期保障、相互会社の剰余管理開示を持つ。
...
| 項目 | 公開情報での使い方 |
|---|---|
| 現在の法的名称とグループ形態 | エンティティ識別と法的形態の分類。 |
| チャネル構成 | 獲得コスト、継続率、販売行為リスクはチャネルごとに異なる。 |
| 商品構成 | 死亡、疾病、貯蓄、年金、外貨エクスポージャーは異なるリスクプロファイルを持つ。 |
| ESR / ソルベンシー開示 | 会社レベルの資本指標とソース日付。 |
| 海外戦略 | 海外買収は収益を分散しうるが、統合リスクと FX リスクを追加する。 |
| 契約者 / 株主ロジック | 相互会社と上場グループでは、最適化するステークホルダーのトレードオフが異なりうる。 |
...
- 生命保険協会：会員会社一覧。
- 日本生命：統合報告書。
- 第一生命ホールディングス：年次報告書 / 統合報告書。
- 明治安田：年次報告書。
- 住友生命：年次報告書。
- 金融庁：経済価値ベースのソルベンシー規制。
