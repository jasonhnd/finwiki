...
| Loyalty | [[payments/waon-prepaid-aeon|WAON]] 前払式 + WAON POINT | Connective currency across retail + finance, incl. some overseas markets |
...
全体像については [[payments/japan-consumer-credit-operator-comparison-matrix|consumer-credit 事業者 comparison matrix]] を参照のこと。イオンの特徴は、一つの上場持株の下に、**小売のアンカー**、**免許を受けた銀行**、**クロスボーダーの消費者金融** 事業を組み合わせている点である。
...
- [[payments/waon-prepaid-aeon|WAON 前払式]]
