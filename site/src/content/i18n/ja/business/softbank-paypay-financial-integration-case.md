...
| Loyalty | PayPay ポイント | ソフトバンク / Yahoo エコシステムと統合 —— [[loyalty/sb-yahoo-paypay-points-unified-ecosystem|points ecosystem]] 参照 |
...
| ポイントエンジン | ソフトバンク / Yahoo / PayPay にまたがる PayPay ポイントがユーザーを結びつける —— [[loyalty/sb-yahoo-paypay-points-unified-ecosystem|points ecosystem]] 参照 |
