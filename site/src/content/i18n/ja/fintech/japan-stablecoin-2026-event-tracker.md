...
この項目は [[fintech/INDEX|fintech index]] の配下にあります。規制枠組みは [[fintech/japan-stablecoin-regulatory-landscape|日本 SC 法制度の三層構造]]、分類体系は [[fintech/japan-epi-three-types-overview|EPI 三類型概要]]、競争環境は [[fintech/japan-epi-four-camps-comparison|EPI 四陣営比較]] とあわせて読んでください。主要発行体・流通体は [[JapanFG/jpyc|JPYC株式会社]]、[[JapanFG/progmat|株式会社Progmat]]、[[exchanges/jp-exchange-sbi-vc-trade|SBI VC Trade]] を参照。
