...
このエントリは [[fintech/INDEX|fintech index]] の配下に位置づけられる。比較・対照の文脈は [[fintech/three-circles-stablecoin-mra-framework|米 / 欧 / 日「三大円」stablecoin グローバル・コンプライアンス・アーキテクチャ（MRA 相互承認）]]、より広いシステム / 規制上の境界は [[fintech/japan-financial-regulation|日本金融規制 — トークン・暗号資産・決済に関する法体系]] と併せて読む。
