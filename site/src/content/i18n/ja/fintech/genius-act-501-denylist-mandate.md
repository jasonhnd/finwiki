...
status: machine
fidelity: ok
title: "GENIUS Act §501 チェーンレベル Denylist 合法化"
...
**地政学的含意**:法案により米国ステーブルコイン陣営(USDC / USD1 / PYUSD)と非米国ステーブルコイン(USDT グレールート / 各国主権ステーブルコイン / アルゴリズム・ステーブルコイン)は構造的対立を形成する。詳細は [[stablecoin-chain-sovereign-currency-divide]] を参照。
