...
translated_at: 2026-06-02T13:21:55.048Z
---
...
発行体の実装は、レイテンシ、分散性、コストのトレードオフが異なる**4つの実装パターン**へ収束している。
...
凍結・差押え残高は既存の **1099-DA 報告ストリーム**へ流れる（[[fintech/irs-1099-da|IRS 1099-DA]] と [[fintech/carf-1099da-end-of-crypto-anonymity|CARF + 1099-DA]] 参照）。差し押さえられた残高は元の保有者にとって**みなし処分**として扱われ、税務上の影響が生じ得る。IRS-OFAC-FinCEN 連携は、Q3 2025 から活動する省庁横断共同ワーキンググループを通じて運用化されている。

### 州規制当局との連携

発行体が GENIUS の二重トラックの下で州規制対象である場合、発行体の本拠州規制当局は同じ月次報告を受け取り、OCC および Federal Reserve と連携して連邦基準の充足を確認する。州規制当局は**追加的な消費者保護権限**を保持するが、§501  の最低基準を緩和することはできない。
