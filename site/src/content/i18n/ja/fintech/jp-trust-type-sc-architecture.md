...
この項目は [[fintech/INDEX|fintech index]] の配下に位置づけられる。比較対象として [[fintech/multi-megabank-consortium-governance|複数メガバンク・コンソーシアムのガバナンス —— 複数の megabank が fintech 基盤を共同保有する統治モデル]]、より広い制度境界として [[fintech/japan-financial-regulation|日本金融規制 — トークン・暗号資産・決済に関する法体系]] とあわせて読む。
...
出典注: [金融庁 資金決済制度等 WG 資料（2024-11-21、16 頁）](https://www.fsa.go.jp/singi/kessaiseido_wg/siryou/20241121/1.pdf)の発行主体・参入形態・資産保全・送金上限比較と、[2026 年施行規則の公布ページ](https://www.fsa.go.jp/news/r7/sonota/20260522/20260522.html)を使用した。後者は改正法・関連府令等が 2026-06-01 から施行・適用されたことを示す。
...
出典注: 法的地位に関する主張は、[金融庁 EPI 登録ページ](https://www.fsa.go.jp/common/shinsei/dendai/dentori.html)、e-Gov の現行 [資金決済法](https://elaws.e-gov.go.jp/document?lawid=421AC0000000059)および[信託法](https://elaws.e-gov.go.jp/document?lawid=418AC0000000108)、関連する発行者・受託者の開示で確認する必要がある。[2023 年 Progmat 共同発表](https://progmat.co.jp/press/pdf/press231106_01.pdf)は過去のプロジェクト資料であり、現在の発行や市場首位を証明するものではない。

## 応用

- 「信託会社発行」と「信託銀行発行」の規制差を確認する
- 裏付け資産、償還、倒産隔離、送金上限を別々の検証軸にする
- [[fintech/cross-border-sc-via-swift-api|越境 SC via SWIFT API]] の議論で、国内法上の発行資格と越境ネットワーク接続を混同しない
...
- [[fintech/cross-border-sc-via-swift-api|越境 SC via SWIFT API]]
- [[fintech/multi-megabank-consortium-governance|複数メガバンク・コンソーシアムのガバナンス]]
