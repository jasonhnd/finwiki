...
この項目は [[fintech/INDEX|fintech index]] の下に位置づけられる。法的フレームワークは [[fintech/mica-overview|MiCA 概観]]、token 分類は [[fintech/mica-emt-art-subcategories-deep-dive|MiCA EMT vs ART]]、「業務 + レジリエンス」の二軌アーキテクチャは [[fintech/dora-eu-digital-operational-resilience-overview|DORA 概観]] とあわせて読む。
