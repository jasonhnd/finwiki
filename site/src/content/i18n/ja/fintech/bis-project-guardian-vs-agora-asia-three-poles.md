...
status: machine
fidelity: ok
title: "アジア・トークン化インフラ三極"
translated_at: 2026-06-02T13:21:55.038Z
---
...
- BoJ は BIS Agorá 経由でソブリン・マネー・トークン化（JPY ホールセール CBDC）に参加 ^[extracted]
...
**互補関係**:
- Guardian で実験されたトークン化資産標準 → Ensemble のトークン化預金上で決済可能 → クロスボーダー時には [[fintech/mbridge-bis-multi-cbdc-overview|mBridge]] または Agorá ホールセール CBDC で出口
