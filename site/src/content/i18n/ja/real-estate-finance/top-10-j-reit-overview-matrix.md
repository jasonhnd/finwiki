...
translated_at: 2026-06-26T08:29:01.776Z
---
...
トラスティーの役割は、スポンサーのアイデンティティとは別個のカストディ / 資産管理機能である。同じ信託銀行が多くの異なるスポンサーグループのトラスティーになり得る。これは [[banking/trust-bank-custody-operating-comparison|trust bank カストディ operating comparison]] でカバーされるのと同じカストディ運営レイヤーのパターンである。
...
2. **資産クラス集中度対 分散** — 単一資産クラス J-REIT (オフィス、小売、物流) は、分散型 J-REIT (NMF、Orix JREIT) よりもシャープなセクターサイクルエクスポージャーを持つ。
