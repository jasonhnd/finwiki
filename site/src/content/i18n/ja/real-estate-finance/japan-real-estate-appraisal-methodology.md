...
公正価値報告のための評価を行う鑑定士は、当該不動産の経済的本人から独立していなければならない：
...
直接還元法は、安定化した NOI をキャップレートで除することによって不動産を評価する：
...
取引事例比較法は、比較可能な取引を参照することによって不動産を評価する：
...
原価法は、土地価格 + 改良物の減価償却済み再調達原価として不動産を評価する：
...
半期ごとの鑑定 NAV は、J-REIT にとっての二つの価値参照点のうちの一つである：
