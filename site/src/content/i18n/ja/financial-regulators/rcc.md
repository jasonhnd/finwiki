...
この項目は [[financial-regulators/INDEX|financial-regulators INDEX]]（そのドメイン経路）の下に位置する。これは規制当局ではなく **破綻処理／回収部門** である——機関としての親会社の境界としては 100% である親会社 [[financial-regulators/dic|預金保険機構 (Deposit Insurance Corporation)]] と、政策金融ビークルのピア／対比（公的特殊会社）としては [[financial-regulators/jbic|JBIC]] および [[financial-regulators/dbj|DBJ]] と、監督／銀行免許の境界としては [[financial-regulators/fsa|the FSA]] と併せて読むこと。
