...
この項目は、横断的な概観として [[megabanks/INDEX|megabanks INDEX]] の下に位置する。ライセンス階層のオーバーレイについては [[banking/japan-banking-license-tier-comparison-matrix]] と、ライセンススタックのカタログについては [[financial-licenses/INDEX|JapanFG legal-license INDEX]] と、上場 FG の投資可能ユニバースについては [[finance/japan-listed-financial-groups-investable-universe]] と、地方銀行統合の家系図については [[banking/japan-regional-bank-m-a-consolidation-family-tree-matrix]] と対にすること。
...
これらの機関は公的または準公的な性質を持ち、標準的な FIEA／銀行法の商業的枠組みではなく、特定の制定法の下で運営される。システムマップについては [[policy-finance/japan-policy-finance-system]] を参照。
...
地方銀行 FG（地銀 FG）は、典型的には二つ以上の県の銀行が単一の持株会社の下に連結されたものである。2010 年以降の統合パターンは、そうした FG を 20以上生み出してきた。完全な家系図については [[banking/japan-regional-bank-m-a-consolidation-family-tree-matrix]] を参照。
...
5. **信託銀行の分離** — 信託銀行業は歴史的に別個の信託銀行ライセンスの下で運営されてきており、SuMi トラストが最大の純粋信託グループである。[[banking/japan-trust-bank-vs-global-custodian-comparison-matrix]] を参照。
6. **公的金融の分離** — 郵政、協同組織中央、政策金融の機関は、特定の制定法の下で運営され、FIEA／銀行法の意味での商業的コングロマリットではない。[[policy-finance/japan-policy-finance-system]] を参照。
