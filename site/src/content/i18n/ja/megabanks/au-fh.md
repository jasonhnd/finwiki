...
### KPI 実績（KDDI 公式 IR・auじぶん銀行公式 PR ベース）

**au フィナンシャルホールディングス単体営業利益**^[extracted]
...
> エンティティ整理の注意：「auカブコム証券」は 2025-01-31 に MUFG へ売却され「三菱 UFJ eスマート証券」に改称。同日付で MUFG が保有していた auじぶん銀行株式は KDDI に移管。au-FH の証券事業は空白化状態（2026-05 時点で新規証券機能の再構築・提携の公式発表なし）。

### 重要年表（抜粋）^[extracted]

| 年月 | 事象 |
|---|---|
| 2008-06-17 | **じぶん銀行設立**（KDDI + 三菱東京 UFJ 銀行 50/50 合弁）― 邦初の本格モバイル特化ネット銀行 |
| 2010-12 | **au 損害保険開業**（KDDI + あいおいニッセイ同和損保合弁）|
| 2014-05 | **au ウォレット開始**（プリペイドカード、KDDI 系決済の起点）|
| 2017-09 | **KDDI フィナンシャルサービス**（au ウォレットカード発行体）法人化 |
| 2019-04-01 | **au フィナンシャルホールディングス発足**（KDDI の金融子会社統合）^[extracted] |
| 2019-04 | **au PAY 開始**（QR コード決済、au ウォレットブランド統一）|
| 2019-12 | KDDI が auカブコム証券に出資（旧カブドットコム証券 → 「auカブコム証券」改称）|
| 2020-05-21 | **じぶん銀行 → auじぶん銀行改称** |
...
| **2025-01-31** | **MUFG ↔ KDDI 子会社入れ替え**：MUFG が auじぶん銀行全株を auFH に売却、対価で旧 auカブコム証券（→ 三菱 UFJ eスマート証券）を MUFG が 100% 取得 ^[extracted] |
...
> **じぶん銀行入れ替え（2025-01-31）**：2008-06 KDDI 50% + 三菱東京 UFJ 銀行 50% 合弁で設立、17 年来の合弁関係を解消。同日付で MUFG が保有 50% を KDDI に売却し KDDI 100% 子会社化完了。対価で旧 auカブコム証券（au-FH 傘下）を MUFG が取得し「三菱 UFJ eスマート証券」へ。両社の金融戦略再編に伴うクロス取引で、KDDI は「銀行を中核に据え証券を手放す」選択。^[extracted]
...
- **三菱商事連携**（Lawson + Ponta）：2020 ポイント連携 → 2024 Lawson 共同経営で関係深化 ^[extracted]
...
- **直近政策論点**：
  ...
  - 2025〜 マイナンバーカード × 銀行口座連携（auじぶん銀行マイナ申込率 28%→86% 急伸）^[extracted]
