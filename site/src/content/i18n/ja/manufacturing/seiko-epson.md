...
このエントリは [[manufacturing/INDEX|manufacturing index]] の配下に位置する。隣接文脈には [[manufacturing/toyota-motor|Toyota Motor Corporation (トヨタ自動車)]]、より広い制度境界には [[INDEX|FinWiki index]] とあわせて読む。
