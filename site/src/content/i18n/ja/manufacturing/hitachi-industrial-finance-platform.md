...
status: machine
fidelity: ok
title: "日立グループ産業金融プラットフォーム (Hitachi Industrial Finance Platform)"
translated_at: 2026-06-02T16:33:58.489Z
---
# 日立グループ産業金融プラットフォーム (Hitachi Industrial Finance Platform)

## ウィキ上の位置づけ

この項目は [[manufacturing/INDEX|manufacturing index]] の下に位置する。産業金融の同業比較は [[manufacturing/toyota-motor|Toyota Motor]] と [[manufacturing/mitsubishi-heavy-export-finance|Mitsubishi Heavy export finance]]、旧キャプティブリース会社の歴史は [[JapanFG/hitachi-capital|旧 日立キャピタル]]、[[JapanFG/mitsubishi-hc-capital|三菱HCキャピタル]] は 2021 後の存続統合後法人、より広い制度・規制上の境界は [[JapanFG/INDEX|JapanFG index]] とあわせて読む。
...
日立製作所（6501, 親会社）
  ...
  └── コーポレート財務（Treasury & Group Finance）
        ...
        ├── 海外子会社の現地ベンダーファイナンス（Hitachi Energy 含む）
...
Hitachi Rail UK の **Class 800 / 802** や **Intercity Express Programme (IEP)** のような英国向け大型鉄道案件は、車両製造 + 30 年保守 + リースの一体取引である。リースを引き受ける SPV に英政府・年金ファンド・銀行団が出資する、典型的な「日本メーカー製造 × 英国インフラファイナンス」案件として知られる。
...
| 連結総資産 | 約 13 兆円規模 | 同上 |
| Hitachi Energy 売上 | 約 1.4 兆円規模 | セグメント開示 |
| Hitachi Rail 売上 | 約 0.7 兆円規模 | セグメント開示 |
| ネット D/E | 0.3 倍前後 | 同上 |
...
- **Lumada × 顧客金融**: ソリューション販売を「機器売り切り」から「データを通じた継続課金」へ移す。会計上は契約資産・契約負債（IFRS 15）として現れ、顧客に対しては利用量連動の請求になる。日立本体財務が繰延収益を抱える。
...
> [!info] 校正ステータス
> confidence: **高い**。Hitachi IR / Integrated Report・三菱HCキャピタル IR・EDINET をベースに公開情報で構成。FY2024 のセグメント別売上は概数で記載。Hitachi Rail UK / Hitachi Energy の個別案件金融組成の詳細は公開情報からは追跡に限界がある。
