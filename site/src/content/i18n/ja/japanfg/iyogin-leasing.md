...
> [!info] 検証状況
> 信頼度: **likely** (FG leasing-subsidiary anchor created 2026-05-25)。[[iyogin-hd]] page = 持株会社 holding strategy (2022-10 HD 化) を扱い、本ページは leasing-subsidiary operating boundary を扱う。設立年 (1974-09-26、旧称 伊豫銀総合リース) ・資本金 (8,000 万円) ・いよぎん HD 直接出資子会社化 (2022-10-03) はいよぎんリース公式会社概要 / 沿革で確認済 (出典下記)。海事クラスター取扱高比率は単体非開示 (公表値なし) のため本文では定性記述に留める。
