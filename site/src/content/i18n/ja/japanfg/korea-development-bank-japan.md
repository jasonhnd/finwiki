...
この項目は [[JapanFG/INDEX|JapanFG index]] の配下に置かれる。[[JapanFG/woori-bank-japan|Woori Bank Tokyo]] は同業・隣接項目との比較先であり、[[banking/INDEX|banking index]] は制度、登録、監督上の境界を確認するための参照先である。本文は公開情報に基づき、会社または制度項目の位置づけを日本語で整理する。
...
このページでは [[JapanFG/jbic]] を比較軸として、会社単位の公開情報と上位グループの説明を混同しないようにする。
