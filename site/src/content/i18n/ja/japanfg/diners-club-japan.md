...
本項目は [[JapanFG/INDEX|JapanFG index]] の配下に置く。[[JapanFG/jcb|JCB]] を同業・対比の文脈（両者とも 3者間型・プレミアム志向）として、[[payments/japan-card-issuer-acquirer-processor-split|Japan card issuer / acquirer / processor split]] をより広い制度・規制境界として併読する。
...
| グループ境界 | [[JapanFG/sumitomo-mitsui-trust|三井住友トラスト・グループ]] 系列 — 歴史的にシティバンクからの日本事業移管経緯 |
...
- [[JapanFG/smbc-card]] (グループ内別ブランド 発行会社・Vパスワード Olive 主軸)
