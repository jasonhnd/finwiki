...
この項目は [[JapanFG/INDEX|JapanFG index]] 配下に置かれる。[[JapanFG/freee|freee 株式会社 (freee K.K.)]] を同業・対照の文脈として、[[fintech/japan-stablecoin-regulatory-landscape|日本 Stablecoin 法制度の三層構造（JPYC・USDC・Project Pax）]] をより広い制度・規制境界として読む。
...
> [!info] 検証状況
> 信頼度: **概ね確からしい** (v1.0 Wikipedia + 公開 IR 校核 2026-05-19)。ユーザー数 (1500 万) / 連携行数 (1500 行) / MUFG JV 解消日 (2025-04-15) は公開情報ベース。財務数値・最新セグメント別売上は四半期 IR で要更新。創業者・辻庸介の経歴は公開取材記事に基づく。
