...
この項目は [[JapanFG/INDEX|JapanFG index]] の配下に位置する。比較・対照の文脈では [[JapanFG/shizuoka-bank|静岡銀行]]、より広い制度上・規制上の境界については [[banking/INDEX|banking index]] とあわせて読む。
...
- 清水銀行を誤ったグループ境界に結びつけていた従来の wiki 参照を修正する。
- 金融庁の正確な登録名に対応した清水銀行ページを整備する。
- 静岡県内の地方銀行間競争を銀行単位で説明するアンカーを提供する。
...
- FSA: bank license list, 地方銀行s, as of 2026-01-01.
- 清水銀行 公式会社概要。
