...
この項目は [[JapanFG/INDEX|JapanFG index]] 配下に置かれる。隣接文脈は [[banking/INDEX|banking index]]、より広い制度境界は [[JapanFG/legal-financial-licenses/INDEX|JapanFG index]] と合わせて読む。
...
- 金融庁掲載名に対応する宮崎太陽銀行のページを補完する。
- 宮崎県における第一地方銀行 / 第二地方銀行の比較ペアを完成させる。
- 再編と地域信用分析に使う九州の第二地方銀行アンカーを提供する。
