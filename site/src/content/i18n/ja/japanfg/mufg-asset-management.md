...
この項目は [[JapanFG/INDEX|JapanFG index]] 配下に置く。比較・対照の文脈では [[JapanFG/asset-management-one|アセットマネジメントOne]] を、より広い制度・規制上の境界では [[securities/INDEX|securities index]] を参照する。

## 要約

三菱UFJアセットマネジメントは [[JapanFG/mufg|MUFG]] の資産運用会社。金融庁の金融商品取引業者一覧では「三菱UFJアセットマネジメント株式会社」、関東財務局長（金商）第404号として掲載される。投資信託、投資一任、投資助言を扱う MUFG の運用会社。
...
| 親会社境界 | [[JapanFG/mufg|MUFG]] 100% の資産運用会社 |
