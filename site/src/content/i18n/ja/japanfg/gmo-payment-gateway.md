...
この項目は [[JapanFG/INDEX|JapanFG index]] の配下に位置づける。比較対象・対照軸として [[JapanFG/famima-digital-one|ファミマデジタルワン (FamiMa Digital One)]] を、より広い制度・規制上の境界として [[fintech/japan-stablecoin-regulatory-landscape|日本 Stablecoin 法制度の三層構造（JPYC・USDC・Project Pax）]] を併読する。
...
- **業態**: 決済代行業（登録制ではないが、加盟店契約・PCI DSS準拠が実質的な参入障壁）
- **規制論点**: 加盟店審査、不正利用対策、カード情報保護、資金決済法上の隣接サービスへの対応。
