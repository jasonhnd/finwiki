...
この項目は [[JapanFG/INDEX|JapanFG index]] の配下に位置づける。同業・比較対象の文脈は [[JapanFG/mufg|三菱 UFJ FG (MUFG)]] と照らし、より広い制度・規制上の境界は [[banking/INDEX|banking index]] を参照する。
...
| 金融機能補完 | 内国為替、国債・投信窓販等 | 会員労金の共同サービス基盤 |
| 事務集中 | 口座振替、財形貯蓄等 | 業務効率化 |
| システム運用 | R・ONE システム開発・運用 | IT 共通基盤 |
