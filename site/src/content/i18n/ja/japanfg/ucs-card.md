...
このエントリは [[JapanFG/INDEX|JapanFG index]] 配下に位置する。ピア比較・対比の文脈では [[JapanFG/life-card|ライフカード (Life Card)]]、より広い制度・規制境界では [[payments/INDEX|payments index]] と照らして読む。
...
- [[JapanFG/aeon-financial-service|AEON]]、[[JapanFG/seven-card-service|Seven]]、PPIH の小売金融モデルを、小売起点の発行会社ピアである [[JapanFG/epos-card|EPOS]] と並べて比較するのに有用である。
