...
この項目は [[JapanFG/INDEX|JapanFG index]] の配下に置く。比較・対照の文脈は [[JapanFG/mufg-nicos|三菱UFJニコス (Mitsubishi UFJ NICOS)]] と照合し、より広い制度・規制上の境界は [[payments/INDEX|payments index]] とあわせて読む。

## 要約

三井住友カードは [[JapanFG/smfg|SMFG]] のカード・信販・トランザクション事業の中核 operator。カード issuer だけでなく、加盟店向け決済、トランザクション、Olive / Vポイント周辺のキャッシュレス接点を束ねるため、[[payments/card-acquiring-japan-stack|card acquiring stack]] の代表ページとして独立させる。
...
- 同社は銀行口座、カード、ポイント、アプリ、加盟店受入ネットワークを接続する。
- SMFG の銀行バランスシート事業と、決済ネットワーク・信用販売事業を切り分ける境界ページとしても有用である。
