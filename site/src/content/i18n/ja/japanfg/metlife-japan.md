...
status: machine
fidelity: ok
title: "メットライフ生命保険 (MetLife Japan)"
...
この項目は [[JapanFG/INDEX|JapanFG index]] 配下に置かれる。[[JapanFG/prudential-japan|プルデンシャル・ジブラルタ・ファイナンシャル (Prudential Japan)]] は比較対象の文脈、[[insurance/INDEX|insurance index]] はより広い制度・規制境界の文脈として読む。
...
**親会社**：MetLife, Inc.（米デラウェア法人、NYSE 上場 MET、世界最大級の生保・年金グループ）^[extracted]
**設立**：1973-01（American Life Insurance Company 日本支店として開業）^[extracted]
**業態**：生命保険業（金融庁 内閣総理大臣免許）^[extracted]
**主要拠点**：東京本社（千代田区）+ 全国フィナンシャル・センター ^[extracted]
**チャネル**：
- フィナンシャル・アドバイザー（FA、専属営業職員）
- 代理店（来店型・乗合代理店）
- 銀行窓販（メガバンク・地銀・信託銀行と広範に提携）^[extracted]

### 親会社 MetLife, Inc.（米）参考スペック ^[extracted]

| 項目 | 値（2024 FY 10-K ベース）|
|---|---|
| 本社 | 米ニューヨーク州ニューヨーク市 |
| 設立 | 1868（Metropolitan Life Insurance Company として）|
| 上場 | 2000 NYSE: MET（持株会社化と同時）|
| 主要セグメント | U.S.（団体・個人）/ アジア / Latin America / EMEA / MetLife Holdings / コーポレートその他 |
...
- **Wikipedia: メットライフ生命保険**（https://ja.wikipedia.org/wiki/メットライフ生命保険, 2026-05-19 抽出）
- **Wikipedia: MetLife**（https://en.wikipedia.org/wiki/MetLife, 2026-05-19 抽出）
- **MetLife, Inc. Form 10-K**（2024 FY、SEC EDGAR）
- MetLife グローバル公式（https://www.metlife.com/）
- メットライフ生命 公式（https://www.metlife.co.jp/）
