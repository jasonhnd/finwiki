...
この項目は [[JapanFG/INDEX|JapanFG index]] の配下にある、物流を軸にした **BNPL** 商品として位置づける。[[JapanFG/bnpl-landscape|Japan BNPL landscape]] の制度メモ、[[JapanFG/net-protections-hd|Net Protections HD]] / [[JapanFG/paidy|Paidy]] の BNPL 比較群、規制上の問いについては [[payments/japan-bnpl-credit-purchase-boundary|Japan BNPL and credit-purchase boundary]] と併読する。[[payments/credit-purchase-card-operators-japan-index|METI credit-purchase registry]] は登録上のアンカーであり、[[payments/japan-payment-scheme-economics-matrix|Japan payment scheme economics matrix]] は加盟店経済において後払いがカード・コード決済レールとどう異なるかを示す。
...
| 項目 | 読み方 |
|---|---|
| 運営主体 | ヤマトクレジットファイナンス株式会社（ヤマト HD グループ） |
| 商品類型 | EC 後払い決済（請求書同梱型 + コンビニ / 銀行振込 / 電子マネー回収）|
...
- Yamato Credit Finance "クロネコ代金後払いサービス" 商品ページ: https://www.kuronekoyamato.co.jp/ytc/business/payment/atobarai/
- Yamato Credit Finance 決済サービス概要: https://www.kuronekoyamato.co.jp/ytc/business/payment/
