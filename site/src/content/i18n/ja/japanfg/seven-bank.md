...
fidelity: ok
title: "セブン銀行"
translated_at: 2026-06-02T15:14:17.096Z
---
...
この項目は [[JapanFG/INDEX|JapanFG index]] の配下に置く。比較・対照の文脈は [[JapanFG/lawson-bank|ローソン銀行 (Lawson Bank)]] と照合し、より広い制度・規制上の境界は [[banking/INDEX|banking index]] とあわせて読む。
...
> [!info] 検証状況
> 確度: **高め**（v1.1 Wikipedia + 公式 IR + 公開報道ベース、2026-05-19／持株比率は 2025-06 開示で更新）。ATM 設置台数（約 27,990 台、2025-03 末）・対応 12 言語は公式情報で確認。セブン&アイ HD の保有比率は 2025-06 の自己株式取得で約 46%→39.93% に低下し、セブン銀行は連結子会社から持分法適用会社へ移行（日経 2025-06-19 報道で確認）。提携金融機関数（約 600 行）は公開情報ベースの概数。具体的な業績数値（経常収益・純利益等）は本稿で取り上げず、別途公式 IR を参照のこと。
