...
この項目は [[JapanFG/INDEX|JapanFG index]] の配下に置く。比較・対照の文脈は [[JapanFG/gmo-epsilon|GMOイプシロン (GMO Epsilon)]] と照合し、より広い制度・規制上の境界は [[payments/INDEX|payments index]] とあわせて読む。
...
- PayPay の消費者向けウォレットを超えて、加盟店向け決済インフラを提供する。
- カード受入、オンラインチェックアウト、セキュリティ、加盟店管理を接続する。
- [[JapanFG/gmo-payment-gateway|GMO Payment Gateway]]、[[JapanFG/gmo-epsilon|GMO Epsilon]]、[[JapanFG/dg-financial-technology|DGFT]] と比較するうえで有用である。
