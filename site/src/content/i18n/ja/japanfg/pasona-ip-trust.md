...
パソナ知財信託は、[[JapanFG/INDEX|JapanFG]]配下の独立した信託会社ルートであり、[[JapanFG/trust-companies-japan-index|the Japan trust companies registry index]]から昇格した項目です。[[finance/japan-acquisition-finance|Japan acquisition finance]]、[[business/INDEX|business cases]]、[[banking/japan-trust-bank-custody-map|Japan trust-bank custody map]]と併せて参照する。
...
| セグメント | 知的財産信託会社 |
| 中核資産 | 産業財産権 / 知的財産権 |
| 公開サービス範囲 | 出願、権利維持、活用、IP管理支援 |
| グループ文脈 | 公開資料上のPasona group / Pasona Knowledge PartnerのIPサービス基盤 |
| 登録ルート | FSA信託会社一覧 |

これは銀行、証券会社、弁理士事務所のページではない。FinWiki上の境界は、信託された資産としてIPを扱う信託会社機能である。

## 事業役割マップ

| 機能 | FinWikiでの関連性 |
|---|---|
| IP信託 | 特許その他の産業財産権に関する信託ルート。 |
| 権利管理 | 出願、維持、利用に関する外部委託 / ガバナンス層。 |
...
2. サービス範囲と会社情報はパソナ知財信託の公開ページで確認する。
3. IP信託管理を、評価、融資、証券発行と区別する。
4. 金融または事業ページへは、公開された取引または政策論点がある場合に限ってリンクする。
