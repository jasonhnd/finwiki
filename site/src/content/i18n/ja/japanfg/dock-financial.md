...
> [!note] 命名 note
> このページは当初 "dock-financial" として作成依頼された 枠 だが、日本に「Dock Financial Group」という独立金融グループ法人は確認できないため、代替として **SoftBank グループの決済代行子会社「SB ペイメントサービス（SBPS）」** を充当。SoftBank グループ金融機能のオペレーティング・カンパニー・アンカーとして位置付ける。

## ウィキ上の位置づけ

この項目は [[JapanFG/INDEX|JapanFG index]] の下に置き、ソフトバンク株式会社（東証 PRIME 9434、コア通信事業）グループの **決済代行・金融サービス子会社 SB ペイメントサービス（SBPS）** の **事業会社アンカー** として扱う。[[JapanFG/paypay-fg|PayPay 金融グループ]] は SoftBank 系 payment / fintech クラスター内の兄弟会社、[[JapanFG/au-fh|au フィナンシャル HD]] は通信会社内包型金融グループの比較対象、[[JapanFG/ndfg|NTT ドコモ FG]] は通信系金融グループのピア、[[payments/INDEX|payments index]] は PSP / 加盟店決済サービス文脈、[[payments/cashless-jp-landscape|キャッシュレス日本ランドスケープ]] は制度上の位置付けとして併読する。
...
- [[payments/INDEX]] — payments 名前空間インデックス
- [[JapanFG/INDEX]] — JapanFG 名前空間インデックス
