...
この項目は [[JapanFG/INDEX|JapanFG index]] の配下に置く。比較・対照の文脈は [[JapanFG/citigroup-japan|シティグループ・ジャパン (Citigroup Japan)]] と照合し、より広い制度・規制上の境界は [[banking/INDEX|banking index]] とあわせて読む。
...
> [!info] 検証状況
> 確度: **高め**（v1.1 Wikipedia 日本語版 + 公式 IR ベースで 2026-05-19 更新）。重要史実（公的資金 1.96 兆円・2003-05 注入・2015-06 完済・2021-04 関西みらい完全子会社化・2024-04 KMFG 吸収合併）は Wikipedia 経由で公開情報ベース。FY2024 決算（2025-03 期）連結数値 IR 確認済み。次回見直しは FY2025（2026-03 期）決算発表後。
