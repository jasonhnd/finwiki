...
本項目は [[asset-managers/INDEX|asset-managers INDEX]]（そのドメインルート）の下に位置する。証券系列の 運用会社 のピア／対比としては [[asset-managers/nomura-asset-management|野村アセットマネジメント]] と併せて読み、投資運用業事業者に対する監督／登録の境界については [[financial-regulators/fsa|the FSA]] および [[securities/financial-instruments-business-operators-japan-index|FSA 金商業者 index]] と併せて読むこと。

## 要約大和アセットマネジメント株式会社は、金融商品取引法上の **投資運用業** 登録を持つ運用会社で、[[securities-firms/daiwa-sg|大和証券グループ]] の資産運用部門。FSA 金融商品取引業者一覧では「大和アセットマネジメント株式会社」、関東財務局長(金商)第352号として掲載される。公募投資信託・投資一任・ETF／インデックス商品を扱い、大和グループの fee ベースの運用機能を担う。
...
- 大和証券グループを 証券仲介 / IB だけで見ると見えにくい **運用会社としての ETF / インデックス / discretionary mandate** を切り出す。
