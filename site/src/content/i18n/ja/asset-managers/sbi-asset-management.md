...
fidelity: ok
title: "SBIアセットマネジメント"
translated_at: 2026-07-28T23:40:03.829Z
---
...
本項目は [[asset-managers/INDEX|asset-managers INDEX]]（そのドメインルート）の下に位置する。低コスト index / ETF の手数料競争における老舗ハウスの同業 / 対比については [[asset-managers/nomura-asset-management|野村アセットマネジメント]] と、投資運用業者に対する監督 / 登録の境界については [[financial-regulators/fsa|the FSA]] と [[securities/financial-instruments-business-operators-japan-index|FSA 金商業者 index]] と照らし合わせて読むこと。

## 要点

SBIアセットマネジメント株式会社は、金融商品取引法上の **投資運用業** 登録を持つ [[megabanks/sbi-hd|SBI グループ]] の運用会社。FSA 金融商品取引業者一覧では「SBIアセットマネジメント株式会社」、関東財務局長(金商)第311号として掲載される。SBI の低コスト公募投信・ETF / index fund、グループ販売導線を担う **online / low-cost house**。
...
- SBI の強みは customer funnel (販売会社) だが、**運用会社としての product manufacturing は別分析単位**。両者の役割を分離する。
- 低コスト index fund competition と NISA 拡充の交差点を確定する。
- 系列系大手 ([[asset-managers/nomura-asset-management|野村アセット]] / [[asset-managers/mufg-asset-management|三菱UFJ AM]]) に対する independent / online house の対比起点を提供する。
...
> [!info] 校核状態
> confidence: likely. 法人名・登録番号・SBI グループ系列は公開情報。具体的 AUM / ファンド本数 / 手数料率は記載しない。
