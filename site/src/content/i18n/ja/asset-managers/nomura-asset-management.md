...
この項目は [[asset-managers/INDEX|asset-managers INDEX]]（そのドメイン経路）の下に位置する。他の主要証券系運用会社のピア／対比としては [[asset-managers/daiwa-asset-management|大和アセットマネジメント]] と、投資運用業者に対する監督／登録の境界としては [[financial-regulators/fsa|the FSA]] および [[securities/financial-instruments-business-operators-japan-index|FSA 金商業者 index]] と併せて読むこと。
