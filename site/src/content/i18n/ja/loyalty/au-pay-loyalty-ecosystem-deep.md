...
au じぶん銀行は、預金残高と口座数で **[[banking/rakuten-bank|楽天銀行]]**、**PayPay 銀行**、**住信SBI ネット銀行**、**ソニー銀行** と並ぶ日本最大級のデジタル銀行に入ります。この「ネット銀行」ピアセットの中でも、au PAY、au PAY Card、Pontaポイント付与との統合により、単独のデジタル銀行商品ではなくロイヤルティエコシステムの構造的構成要素になっています。
