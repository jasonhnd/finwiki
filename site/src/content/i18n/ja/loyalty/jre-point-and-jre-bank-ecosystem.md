...
| **JRE銀行** | JR東日本ブランド×[[banking/rakuten-bank|楽天銀行]]BaaS（開設済み）2024-05-09) | 銀行預金残高の見越。長距離乗車券運賃割引特典 |
...
**JRE BANK** は **2024-05-09** に、**[[banking/rakuten-bank|楽天銀行]] BaaS** の下で運営される JR East ブランドの銀行口座として開設された。実際の銀行免許は楽天銀行が保有し、JR East はブランド、顧客接点、特典設計を提供する。主な特徴は以下のとおり。

| アイテム | 詳細 |
|---|---|
| オペレーター（ライセンス保有者） | [[banking/rakuten-bank|楽天銀行]] |
