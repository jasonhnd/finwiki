...
|---|---|---|---|
| Rakuten Point | Rakuten Group | EC + カード + 銀行 + 証券 + モバイルのフライホイール | [[JapanFG/rakuten-fg|Rakuten FG]]、Rakuten Card、Rakuten Bank、Rakuten Securities |
| V Point | T Point + V Point 統合後の CCCMK / SMBC Card 連合 | 共通ポイント + SMBC クレジットカードと Olive への隣接性。[[loyalty/v-point-smbc-ccc-case|V Point (SMBC × CCC) case]] で 2024-04-22 統合の詳細を、[[loyalty/point-liability-accounting-boundary|point liability accounting boundary]] で失効益 / IFRS 15 処理を参照 | [[JapanFG/smfg|SMFG]]、SMBC Card、小売パートナー |
| d Point | NTT docomo | 通信 ID + d払い + d Card + 予定される [[JapanFG/ndfg|NDFG]] 金融統合 | NTT docomo finance、d Card、d払い、銀行 / 証券 / 保険ルート |
| PayPay Point | PayPay / SoftBank / LY | コード決済の利用頻度とキャンペーン経済 | [[JapanFG/paypay-fg|PayPay FG]]、PayPay Card、PayPay Bank、PayPay Securities |
| WAON POINT | AEON | モール / スーパー / AEON Card / WAON の継続利用 | [[retail/aeon-group|Aeon Group]]、[[JapanFG/aeon-bank|Aeon Bank / AFS]] |
| nanaco point | Seven & i | コンビニ / スーパー / nanaco / Seven Card の継続利用 | [[retail/seven-and-i-hd|Seven & i]]、[[JapanFG/seven-bank|Seven Bank]] |
| Credit card points | JCB、SMBC、MUFG、Saison、AEON、Rakuten、PayPay Card | イシュアのロイヤルティとインターチェンジ防衛レイヤー | [[JapanFG/jcb|JCB]]、[[JapanFG/credit-saison|Credit Saison]] |
...
Rakuten Point は、最も分かりやすいフルエコシステムのループである。買い物でポイントが貯まり、カード利用でポイントが貯まり、ポイントは将来の買い物や携帯料金を補助でき、金融商品が同じアカウントグラフを補強する。このため、[[JapanFG/rakuten-fg|Rakuten FG]] は単なる金融セグメントではなく流通システムとして読むべきである。
...
d Point は [[JapanFG/ndfg|NDFG]] の仮説の中心にある。通信 ID がユーザーを決済、カード、銀行、証券、保険、サブスクリプション束へ誘導できるためである。未解決の問いは、NTT が分かりやすさを失わずに、ポイントを金融スーパーアプリへ変換できるかである。
...
| どのリテール銀行が日常利用の足場を持つか | WAON / nanaco と店舗トラフィックを通じた [[JapanFG/aeon-bank|Aeon Bank]] と [[JapanFG/seven-bank|Seven Bank]]。 |
| どの通信金融グループが最良のクロスセル基盤を持つか | d Point + d払い + d Card がきれいに統合されれば [[JapanFG/ndfg|NDFG]]。 |
| どの PSP が間接的に恩恵を受けるか | 加盟店が複数決済の受け入れとキャンペーンルーティングを必要とするため、[[JapanFG/gmo-payment-gateway|GMO Payment Gateway]] とその他 PSP。 |
| どの法務ページを確認すべきか | ポイントが現金類似または移転可能になる場合は [[JapanFG/legal-financial-licenses/INDEX|legal / financial licenses]]。 |
