...
| **EU AI 法 高リスク実装** | EU | 2026-2027 まで段階的導入 | トレーディング固有のユースケースが附属書 III に追加されるかどうか |
...
- **カストディ / 権限付与** — トレーディングエクスポージャーを制限する支出上限と失効については [[agent-economy/agent-custody-and-authorization-framework-2026|agent custody and authorization framework]]
