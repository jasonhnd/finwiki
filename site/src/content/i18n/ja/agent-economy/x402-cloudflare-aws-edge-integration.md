...
本項目は [[agent-economy/ai-agent-payment-protocols-overview|AI Agent 決済プロトコル全体図 · 7プロトコル俯瞰]] の下に位置する。同類・対照の文脈については [[agent-economy/x402-http-payment-overview|x402 · HTTP 402 を復活させた AI agent 決済プロトコル(総覧)]] を、より広いシステム・規制境界については [[payments/INDEX|payments index]] を併せて参照のこと。
