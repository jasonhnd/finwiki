...
translated_at: 2026-06-02T11:47:37.270Z
---
...
## メカニズム · validateUserOp ライフサイクル、エージェント側の読み方

単一のエージェント UserOp の間に SCW の内部で何が起こるかを丁寧に追う価値がある。なぜなら、そこにポリシー境界全体が実際に存在するからである。
