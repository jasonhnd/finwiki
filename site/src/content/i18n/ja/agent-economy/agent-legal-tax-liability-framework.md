...
**組込型ウォレットのプロバイダー**([[agent-economy/embedded-wallet-landscape-2026-consolidation|2026 ウォレット landscape]] 参照):Privy、Coinbase CDPなどは、規制当局に好意的なセルフカストディ設計([[agent-economy/embedded-wallet-network-effects-moat|network effects · §501 friendly]] 参照)の下で、引き続き非VASP / 非送金業者である。彼らの責任のエクスポージャーはテクノロジーに関するものであり、エージェントの取引判断に関するものではない。KYC義務は、顧客関係を保有する企業(デプロイヤー、または一部のフローでは [[agent-economy/coinbase-cdp-developer-platform|CDP / Privy parent]])にある。
...
- [[agent-economy/embedded-wallet-custody-bankruptcy-mechanics|Embedded ウォレットカストディ bankruptcy mechanics]]
