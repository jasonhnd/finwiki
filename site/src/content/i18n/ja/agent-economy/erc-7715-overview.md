...
本項目は [[agent-economy/ai-agent-payment-protocols-overview|AI Agent 決済プロトコル全体図 · 7プロトコル俯瞰]] の下に位置する。ピア / 対比の文脈については [[payments/INDEX|payments index]] と、より広いシステム / 規制の境界については [[systems/INDEX|systems index]] と照らし合わせて読まれたい。
