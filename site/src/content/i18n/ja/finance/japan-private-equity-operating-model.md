...
このページは [[finance/INDEX|finance domain]] の配下にある。バイアウトファンドの経路が公開買付け、買収デット、アドバイザリー、出口に接続する場合は [[finance/japan-acquisition-finance|Japan acquisition finance]]、[[finance/japan-mbo-and-squeeze-out-process|Japan MBO and squeeze-out process]]、[[finance/japan-tender-offer-process|Japan tender offer process]]、[[finance/japan-ib-league-table|Japan IB league table]] とあわせて読む。
...
| GP | 日本での位置づけ | 典型規模 |
|---|---|---|
| KKR Japan | 東京拠点、カーブアウト・非公開化・インフラ | 大型から上位ミッド |
| Bain Capital Japan | テクノロジー、ヘルスケア、消費財寄り | 大型から上位ミッド |
| Carlyle Japan | 日本バイアウト専用ヴィンテージ | ミッドから上位ミッド |
...
| 国内 GP | 特徴 |
|---|---|
| Advantage Partners | ミッドマーケット、事業承継、カーブアウト |
| J-STAR | 小型からミッドの事業承継 |
| Polaris Capital | 成長、事業承継 |
| Integral | ハンズオン運営、ターンアラウンド |
| JIC Capital | 政策関連の戦略投資 |

## ファンド構造と経済性

PE ファンドは LPS、Cayman LP、Delaware LP などで組成される。SPC レイヤーは [[finance/japan-ib-league-table|league tables]]、提出ルートは 4 を参照。投資期間は通常 6 -10 年、ファンド期間は [[finance/japan-acquisition-finance|Japan acquisition finance]]年 + 延長である。

古典的な [[finance/japan-tender-offer-process|tender offer process]] と 2 のモデルが基礎である。管理報酬は通常 20 -1.5%、キャリーは 2.0 %、ハードルは 20 % IRR、キャッチアップは 8  / 80、GP コミットメントは 20 -1% が目安である。

## 投資プロセス

| 段階 | 内容 | 公開情報 |
|---|---|---|
| オリジネーション | アドバイザー、銀行、仲介、独自発掘 | プレスリリース |
| 初期入札 | 非拘束の意向表明 | 非公開 |
| デューデリジェンス | 事業、財務、税務、法務、IT、ESG、運営 | 非公開 |
| 最終入札 | 価格、融資、SPA 条件 | 非公開 |
| 契約締結 | SPA と TOB 開始 | EDINET、TDnet |
| 規制承認 | JFTC、FEFTA、業法当局 | プレスリリース |
| クロージング | エクイティ注入、デット実行 | 決済発表 |
| スクイーズアウト | 会社法キャッシュアウト | 3  参照 |
| 上場廃止 | JPX 通知 | [[finance/japan-mbo-and-squeeze-out-process|MBO and squeeze-out]] 参照 |
...
- [[finance/japan-large-shareholding-disclosure|large shareholding disclosure]]
- [[finance/INDEX]]
...
- METI、FSA、JPX、各 GP 公開サイト、業界標準 LP 文書。
