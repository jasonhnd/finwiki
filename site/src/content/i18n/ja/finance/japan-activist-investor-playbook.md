...
1. コーポレートガバナンス報告書、有価証券報告書、TDnet、EDINET、株主総会招集通知、議決権行使結果など、公開会社の提出書類から始める。
2. 持分比率、保有目的、共同保有者ステータスを述べる前に、大量保有報告書と変更報告書を取得する。
3. ガバナンス・エンゲージメントと公開買付 / 支配権取引を分けて扱う。
4. 投資家が運用会社、実質保有者、アドバイザー、またはグループ会社のいずれとして行動しているかを確認する。
5. ポジション、提案、対象会社の対応、買付条件は急速に変わり得るため、正確な日付を使う。
