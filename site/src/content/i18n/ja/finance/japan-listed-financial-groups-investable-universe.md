...
translated_at: 2026-06-26T08:27:56.310Z
---
...
| Card / consumer finance | Listed card 発行会社 and consumer finance lenders. |
...
## Investable-Universe マトリクスのフィールド以下の各エンティティについて、マトリクスは次の public-surface フィールドを用いる:

| Field | What it captures |
|---|---|
| Ticker | TSE 4-digit 発行会社 code (primary listing). |
...
| Stewardship anchor | Whether the 発行会社 is a known stewardship / engagement target, routed via [[finance/japan-shareholder-proposal-and-agm-voting-route]]. |
...
| Pocket Card | 8519 | 小型 | Card 発行会社 | Strategic / parent stake significant | Mid yield class | TOPIX | Card-business profitability, parent-channel dependency, credit cycle. |
...
| Activist or large-shareholding target | Several regional FGs and consumer finance 発行会社 have been disclosed in large-shareholding filings; verify each filer / purpose against the EDINET record. |
| Convertible / equity-linked issuance | Used selectively by some consumer finance, leasing, and fintech 発行会社; never assume - check the most recent TDnet release. |
...
| Life insurance | NIRP legacy / rate sensitivity, equity-market sensitivity, FX, overseas life 引受. |
| Non-life insurance | NatCat cycle, overseas P&C 引受, FX, cross-holding unwind pace, governance / agency-channel event risk. |
...
| Fintech / crypto | Crypto-cycle dependency, regulatory perimeter, going-concern / disclosure event risk for smaller 発行会社. |
