...
以下の表は、エントリ出典インベントリの公開一次資料（oecd.org, berneunion.org）の範囲に限定して読む。^[source:oecd.org; berneunion.org]

| 項目 | 内容 |
|---|---|
| 正式名称 | Arrangement on Officially Supported Export Credits（公的輸出信用に関するアレンジメント） |
| フォーラム | OECD 貿易農業局／貿易委員会 — アレンジメント参加国ワーキンググループ |
| 法的地位 | 参加国間の紳士協定（政治的拘束力はあるが法的拘束力はない）。紛争解決手続ではなく、通知、コモンライン逸脱レビュー、ピア間の透明性を通じて履行される |
| 適用範囲 | 返済期間が **2 年以上** の公的輸出信用。2 年未満の短期貿易金融は対象外 |
| カバー対象 | **直接貸付**（例：JBIC OIL、US EXIM の直接貸付、K-EXIM）と **保険／保証**（例：NEXI、UKEF カバー、Coface、EDC、KfW IPEX、Bpifrance）の双方 |
| 参加国 | 11：日本、EU（27 加盟国）、米国、英国、カナダ、韓国、オーストラリア、ニュージーランド、ノルウェー、スイス、トルコ |
| 主な非参加国 | 中国（CDB、中国輸出入銀行、Sinosure）、ロシア、インド、ブラジル、サウジアラビア（Saudi EXIM を通じて ECA 活動を拡大中）、UAE — いずれも国家ファイナンスはアレンジメントの条件に拘束されない |
| 現行版 | 定期的に更新。現行の統合テキストとセクター了解は OECD ウェブサイトに、定期的な改訂日付スタンプとともに公表される |
| 通知レジーム | 参加国は対象となる取引を相互に（および OECD 事務局に）通知しなければならない。共通条件から逸脱する取引には通知と（場合により）コモンライン逸脱が必要となる |
...
| 国カテゴリー | 一般ルール上の最大返済テナー |
|---|---|
| カテゴリー I（高所得 OECD） | 最大 5 年（コモンラインの下で特定のケースは延長可能） |
| カテゴリー II（その他すべての国） | 最大 10 年 |

セクター了解は特定のセクターについてテナーを大幅に延長する。

以下の表は、エントリ出典インベントリの公開一次資料（oecd.org, berneunion.org）の範囲に限定して読む。^[source:oecd.org; berneunion.org]

| セクター了解 | セクタールール上の最大テナー |
|---|---|
| 船舶セクター了解（SSU） | 船舶について引渡しから最大 12 年 |
| 航空機セクター了解（ASU） | 大型民間航空機について最大 12 年 |
| 原子力発電セクター了解（NSU） | 原子力発電所輸出について最大 18 年 |
| 気候変動セクター了解（CCSU） | 再生可能エネルギー／水素／アンモニア／CCS／一部の鉄道メトロ／気候フレンドリーな水・貯蔵について最大 22 年 |
| 石炭火力発電セクター了解（CFSU） | 2021 年に厳格化 — 参加国間で新規の対策なし石炭火力発電輸出ファイナンスを事実上禁止 |
| 鉄道インフラ | 気候フレンドリー基準を満たすプロジェクトについて最大 14 年 |
...
| CRC | 国の例（例示。現行の OECD レビューにより変動） |
|---|---|
| 0 | 高所得 OECD（日本、米国、英国、ドイツ、フランス、カナダ、韓国、オーストラリア、シンガポール 等） |
| 1 | 低リスクの新興国（台湾、チェコ、UAE、サウジアラビア 等、時期により変動） |
| 2 | 各種の新興国（インドネシア、インド、マレーシア、メキシコ、ブラジル 等、時期により変動） |
| 3-4 | 中位の新興国（フィリピン、エジプト、トルコ、ベトナム 等、時期により変動） |
| 5 | より高リスクの新興国 |
| 6 | 債務持続可能性に重大な懸念がある高リスク国 |
| 7 | 差し迫った／現実のデフォルトリスクを伴う最高リスク国 |
...
| 年 | 出来事 |
|---|---|
| 1976 | OECD 加盟国間で公的輸出信用に関する当初のコンセンサスを設立 |
| 1978 | 「アレンジメント」に改称、正式な構造を採択 |
| 1983 | 最初の大規模改訂、基本的な規律を成文化 |
| 1992 | ヘルシンキ・パッケージ — タイドエイドの規律を追加 |
| 1997 | クネーペン・パッケージ — 保険料をカントリーリスクに連動させる MPR システムを初めて導入 |
| 1998 | 贈賄防止条項を統合 |
| 2007 | 環境デューデリジェンスに関するコモンアプローチを正式化 |
| 2008 | 船舶セクター了解を改訂 |
| 2009-04 | 世界金融危機に対応する東京行動声明 — アレンジメント枠組みの大規模な構造的レビュー |
| 2011 | 航空機セクター了解（ASU）を改訂 — リスクベース価格付けを大幅に精緻化 |
| 2012 | 気候変動セクター了解（CCSU）を設立 — 初の気候特化型テナー延長 |
| 2014 | コモンアプローチを改訂、環境デューデリジェンスを厳格化 |
| 2015 | 限定的な規律を伴う最初の石炭火力発電セクター了解（CFSU）を設立 |
| 2018-2020 | 気候ファイナンスの議論が激化、CFSU 厳格化の圧力が高まり、CCSU 拡大を準備 |
| 2021-09 | CFSU を大幅に厳格化 — 新規の対策なし石炭火力発電輸出ファイナンスを参加国間で事実上禁止 |
| 2022-02 | ロシアによるウクライナ侵攻 — アレンジメント参加国が制裁オーバーレイを実施、ロシア関連の輸出信用パイプラインを閉鎖 |
| 2023-04 | CCSU 2023 近代化 — テナー（多くのカテゴリーで最大 22 年）とカテゴリーのカバレッジ（水素、アンモニア、CCS、再生可能エネルギーの拡大、気候フレンドリーな水・鉄道メトロ）を大幅に拡大 |
| 2024 | 重要鉱物セクター了解の可能性に関する議論が継続 |
| 2024-2025 | 半導体、EV／バッテリー、水素／アンモニア、重要鉱物のサプライチェーンの文脈で中国対非アレンジメントの競争構図が激化、中国ファイナンスの非対称性に対処するためのアレンジメント近代化の呼びかけ |
| 2025 | CRC レビューサイクルが継続、ロシア／ウクライナ／ベラルーシの CRC は 7、ソブリンストレス事例（スリランカ、パキスタン、レバノン、アルゼンチン、エジプト）が CRC 調整を通じて反映される |
...
| KPI | 概算値 | 出典／留意 |
|---|---|---|
| 参加国 | 11（日本、ブロックとしての EU、米国、英国、カナダ、韓国、オーストラリア、ニュージーランド、ノルウェー、スイス、トルコ） | OECD |
| 代表される EU 加盟国 | 27（ブロックとして代表） | OECD |
| 有効なセクター了解 | 5（SSU、ASU、NSU、CCSU、CFSU） | OECD |
| カントリーリスク分類スケール | 0-7（8 段階） | OECD CRC |
| CRC レビュー頻度 | 年に数回 | OECD |
| CCSU 最大テナー | 適格カテゴリーについて最大 22 年 | OECD CCSU 2023 |
| 一般アレンジメント最大テナー（カテゴリー I 諸国） | 一般に 5 年 | OECD Arrangement |
| 一般アレンジメント最大テナー（カテゴリー II 諸国） | 一般に 10 年 | OECD Arrangement |
| 新規の対策なし石炭に対する CFSU 2021 の取扱い | 参加国間で事実上禁止 | OECD CFSU 2021 |
| ベルヌ・ユニオンのピア（別個だが関連するフォーラム） | 世界で約 80 の加盟 ECA／保険機関 | Berne Union |
