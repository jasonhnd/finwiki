...
このエントリは、[[policy-finance/INDEX|policy-finance index]] の **動作機構の詳細**として [[financial-regulators/dbj|株式会社日本政策投資銀行 (DBJ)]] の下にあります。 [[financial-regulators/dbj|JapanFG/dbj]] のオリジナル DBJ プロフィールは、企業構造、歴史、および高レベルの事業系統図に焦点を当てています。このエントリでは、特定投資業務フレームワークの**運営の仕組み**、**リスクマネー/メザニンファイナンスのルール**、**GX/DX投資基準**、**民間セクターとの共同投資パターン**、**危機対応融資制度**、**KPI/義務と[[financial-regulators/jfc|JFC]] / [[financial-regulators/jbic|JBIC]] / [[policy-finance/nexi|NEXI]]**の比較をさらに深く掘り下げています。機関間のオーバーレイについては [[policy-finance/japan-policy-finance-institution-mandate-matrix|Japan policy finance institution mandate matrix]]、JBIC オペレーション メカニクス パラレルについては [[policy-finance/jbic-overseas-investment-underwriting-process|JBIC overseas investment underwriting process]]、JFC オペレーション メカニクス パラレルについては [[policy-finance/jfc-sme-division-operating-model|JFC SME division operating model]]、システム全体のコンテキストについては [[policy-finance/japan-policy-finance-system|Japan policy finance system]] と読み替えてください。

## 要約

DBJ は、株式会社日本政策投資銀行法 (2007) に定められた**民間補完原則**の政策使命の下で、長期シニア融資、メザニン、エクイティ、アドバイザリーを 1 つのバランスシートで同時に組み合わせることができる、日本で唯一の政策金融機関である。中核となる運用層は **特定投資業務 (Special Investment Operations、SIO)** フレームワークで、2015 に当初約 ¥1.5tn の上限で創設され、その後の法改正による延長を通じて累計の授権投資枠は約 ¥3tn まで引き上げられた。SIO には、従来型の商業銀行が価格付けできない案件に対して、エクイティ、優先株式、劣後ローン、メザニンの形で**リスクマネー**を供給する明示的な権限がある。この枠組みは、**民間セクターの共同投資を呼び水として引き出す**こと (公的資金 1 円あたり通常 1x 以上の民間資金動員を目標とする) と、**期限付きの授権** (各延長はサンセット条項を伴う個別の立法行為) をルールとして運用される。現在の使命は、**GX (Green Transformation)**、**DX (Digital Transformation)**、**事業再生**、**危機対応業務**の 4 分野が中心である。[[financial-regulators/jfc|JFC]] (中小企業・個人・農林水産向け政策金融)、[[financial-regulators/jbic|JBIC]] (海外投資・輸出信用・資源安全保障)、[[policy-finance/nexi|NEXI]] (貿易・投資保険) と比べると、DBJ は長期案件でシニア、メザニン、エクイティを同一プロジェクト内で組み合わせられるため、日本の政策金融機関の中で最も柔軟なバランスシートを持つ。
...
| 次元 | DBJ | [[financial-regulators/jfc\|JFC]] | [[financial-regulators/jbic\|JBIC]] | [[policy-finance/nexi\|NEXI]] |
|---|---|---|---|---|
