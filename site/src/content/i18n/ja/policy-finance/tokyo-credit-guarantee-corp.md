...
東京信用保証協会 (東京信用保証協会) は、日本の 51 法人地域信用保証制度の東京都会員です。東京都の中小企業人口がどの都道府県の中でも最大であり、東京都政府の緊急プログラム（パンデミック、エネルギー危機、災害）がこの協会を通じて流れているため、保証残高、適格借入者数、政策プログラムの規模において、同協会は常に連合会内で最大の単独企業である。

[[policy-finance/INDEX|policy-finance index]] および [[policy-finance/japan-credit-guarantee-system|Japan credit guarantee system]] システム アンカーの標準的なローカル企業の例として、[[policy-finance/national-federation-credit-guarantee-corporations|Japan Federation of Credit Guarantee Corporations]] の下でこのページを使用します。
...
| 機能 | 重要な理由 |
|---|---|
| 中小企業銀行融資に対する信用保証 | 銀行、[[banking/shinkin-bank-registry-japan|shinkin banks]]、信用組合は、担保や取引履歴のない東京の中小企業に対して融資を行うことができます。 |
| 東京都の政策プログラム | 都の緊急融資制度（パンデミック救済、エネルギー価格ショック救済、地方創生）を運営。 |
| 代位と回収 | 保証先が破綻した場合に融資先金融機関に返済し、保証先からの回収を図る。 |
| 責任分担管理 | 標準システムに基づいて、企業と融資金融機関の間で残存リスクを分割します。特定の緊急プログラムの下では、100% のリスクが伴います。 |
| 官民中小企業アドバイザリー | 信用相談、経営改善指導、東京中小企業支援機関の紹介などを行っています。 |

## 3. 重要な理由

東京 CGC は、次の 3 つの構造的要因により、地域の信用保証システムにおいて最大の単一ノードです。
...
- プロジェクト ファイナンス ステート サポート ([[policy-finance/japan-project-finance-stack-diagram|project-finance stack]])。
