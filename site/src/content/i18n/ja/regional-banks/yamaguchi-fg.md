...
中国地方西部 + 北九州を地盤とする広域地銀グループ。2006-10-02に山口銀行が単独株式移転で持株会社化して発足し、その後 [[regional-banks/momiji-bank|もみじ銀行]]・[[regional-banks/kitakyushu-bank|北九州銀行]] を加えた **3 行体制**（山口銀 / もみじ銀 / 北九州銀）という、地銀単独 FG では珍しい構造を取る。**山陽・関門海峡経済圏（山口 + 広島 + 北九州）の広域連合 + 横浜銀行（コンコルディア）との域外協力提携 2 軸**。県境を越える地銀統合と「3 行 3 ブランド」モデルの代表例である。
