...
この項目は [[regional-banks/INDEX|regional-banks INDEX]] の下に位置づけられる。比較対象・対照関係は [[regional-banks/yokohama-bank|横浜銀行]]、より広い制度・規制上の境界は [[banking/INDEX|banking index]] とあわせて読む。
...
| グループ境界 | [[regional-banks/kiraboshi-fg]] の運営銀行 |
| 本拠市場 | 東京都・広域首都圏 |
| ウィキ上の役割 | 東京の地域銀行運営会社ページ |

## 2. 運営モデル

きらぼし銀行は、東京都内と首都圏を中心に、中小企業金融、個人預金、資産形成・証券仲介、事業承継、デジタル銀行との隣接領域を担う地域銀行。[[regional-banks/kiraboshi-fg]] ページは持株会社とグループ戦略を扱い、本ページは実際の銀行免許と支店・顧客接点を分けて扱う。東京・関東の地域銀行再編の文脈は [[banking/regional-bank-consolidation-pattern]] を参照。
