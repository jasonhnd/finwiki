...
この項目は [[regional-banks/INDEX|regional-banks INDEX]] 配下に置く。比較・対照の文脈では [[regional-banks/aichi-bank|あいち銀行]] を、より広い制度・規制上の境界では [[banking/INDEX|banking index]] を参照する。
...
|---|---|
| 法人名 | 株式会社名古屋銀行 |
| 免許ルート | 銀行法上の第二地方銀行。金融庁の銀行免許一覧に掲載 |
| グループ境界 | 独立系第二地方銀行 |
| 主な地盤 | 愛知県 / 名古屋市 |
| ウィキ上の役割 | 名古屋の第二地方銀行運営会社ページ |
...
- 金融庁上の正確な法人名である名古屋銀行のページ空白を埋める。
- 中京圏の重要な第二地方銀行に独立したアンカーを追加する。
- 他グループの類似名称を持つ歴史的な前身主体と、この銀行を切り分ける。
