...
| レンズ | 読み |
|---|---|
| グループルート | [[payment-firms/rakuten-fg]] / 楽天エコシステム。 |
| 免許レーン | 金融商品取引業者；FSA 登録一覧ルート。 |
...
- ポイント投資とロイヤルティ統合；
- デジタルファーストの NISA オンボーディング；
- 低手数料のオンライン証券競争。

リスクもまた流通に結びついている：オンライン証券競争は手数料を圧縮し、ポイント / カード報酬が獲得補助金として使われればエコシステムの恩恵は高コストになりうる。

## JapanFG との関連性

- 家計資産形成政策とフローについては [[securities/nisa-2024-flow]] に接続。
- 楽天ポイントを金融商品流通インフラとして分析する際は [[loyalty/japan-points-landscape]] に接続。
- FIEA / 自主規制ルーティングについては [[financial-licenses/INDEX]] と [[financial-regulators/jsda]] に接続。
...
- 楽天グループ / 楽天証券：16,  年 4 月 2024  口座マイルストーン・リリース。
- FSA：金融商品取引業者登録一覧。
- FSA：NISA 2024  特設サイト。
