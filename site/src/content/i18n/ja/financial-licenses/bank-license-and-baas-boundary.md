...
| ウォレット・前払式支払手段レイヤー | 資金移動 or 前払式 route where applicable | 登録 / filing route | 非銀行の決済残高、送金債権、前払残高、加盟店決済ルート。 |
...
## 銀行代理業ルート銀行代理業ルートは、許可を受けた仲介ルートである。FSA の監督資料では、銀行代理業務は預金、貸付、為替関連契約を含む銀行契約締結の代理または媒介として説明される。確認すべき公開情報は、所属銀行、銀行代理業者の法的主体、サービス規約、FSA の `銀行代理業者` 一覧である。
...
## 電子決済等代行業ルート電子決済等代行業ルートは、銀行法上の登録ルートである。銀行との間で口座情報または支払指図を媒介する、オープンバンキング / 銀行 API 型サービスを対象にする。公開情報での検証には、FSA の電子決済等代行業ページと `電子決済等代行業者` 登録簿を用いる。
...
| Is there a 資金移動 or 前払式 layer? | FSA `資金移動業者` list, FSA 前払式発行会社 list, and product terms. |
