...
[[payments/waon-prepaid-aeon|WAON]] と同様に、nanaco は [[payments/funds-transfer-vs-prepaid-boundary|Payment Services Act (資金決済法)]] 第 3 章のプリペイドの枠組みの下で **第三者型前払式支払手段** として登録されている。主要な規制上の帰結：
