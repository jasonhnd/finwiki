...
QUO Card は、[[payments/funds-transfer-vs-prepaid-boundary|資金決済法]] 第 3章に基づく **第三者型前払式支払手段** として登録されている。QUO Card フランチャイズは、資金決済法上の前払式支払手段枠組みの形成に影響した初期世代の紙型プリペイド商品の一つである。主な規制上の帰結は次のとおり。
...
- PayPay / au PAY / d払い のような [[payments/japan-code-payment-competitive-map|ウォレット-style code payments]] とは異なり、QUO Card Pay はチャージ / トップアップ機能を持たない **単回利用型ギフト** である。
...
- FSA, `daisan.xlsx` — third-party 前払式-instrument 発行会社 registration list.
