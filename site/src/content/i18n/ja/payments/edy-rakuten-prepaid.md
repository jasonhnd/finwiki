...
| グループの親 | [[card-issuers/rakuten-card\|Rakuten Card]]/ 楽天グループ |
...
| 成分 | 役割 |
|---|---|
| [[card-issuers/rakuten-card\|Rakuten Card]] | Edy ICが組み込まれたクレジットカードの共同ブランド。楽天カードからEdyへオートチャージ |
