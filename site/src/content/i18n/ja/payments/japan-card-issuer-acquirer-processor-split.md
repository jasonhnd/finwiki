...
このページは [[payments/card-acquiring-japan-stack|Japan card acquiring stack]]、[[payments/japan-card-security-authentication-controls|card security and authentication controls]]、[[payments/credit-purchase-card-operators-japan-index|credit purchase and card operator registry]]、[[payments/psp-merchant-settlement-risk|PSP settlement risk]]、[[payments/cashless-jp-landscape|cashless landscape]]、[[card-issuers/jcb|JCB]]、[[card-issuers/smbc-card|SMBC Card]]、[[card-issuers/mufg-nicos|MUFG NICOS]] とあわせて使う。
