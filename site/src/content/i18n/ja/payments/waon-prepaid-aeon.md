...
|---|---|
| ブランド所有者 | AEON Co Ltd |
| FSA 上の前払式支払手段発行者 | AEON CO Ltd と[[JapanFG/aeon-financial-service\|AEON Financial Service]]子会社が、FSA の `daisan.xlsx` 第三者型前払式支払手段発行者登録簿に掲載される |
| 決済 / 金融サービス | [[JapanFG/aeon-financial-service\|AEON Financial Service]] group |
| グループ銀行レール | [[JapanFG/aeon-bank\|AEON Bank]]（オートチャージ、ATM チャージ、口座連携） |
...
| 中間 — グループ連動 | グループ銀行 / カード連携のオートチャージ接点 | [[JapanFG/aeon-bank\|AEON Bank]] ATM、AEON Card 連携の提携店舗 |
...
内側ネットワークの規模、すなわち 20,000 を超える AEON Group 店舗が、コード決済（[[JapanFG/paypay|PayPay]]、[[JapanFG/au-payment|au PAY]]、楽天ペイ、d払い）が限界的な新規利用者成長を取り込む中でも、WAON の導入基盤上の地位を支えている。
...
2. **金融サービスのクロスセル** — WAON 利用は[[JapanFG/aeon-bank|AEON Bank]]口座開設、[[JapanFG/aeon-financial-service|AEON Financial Service]]カード発行、AEON Insurance 商品につながる。
...
2023以降の[[JapanFG/aeon-financial-service|AEON Financial Service]]によるグループ決済 / 銀行 / カード事業の統合は、WAON を単独のプリペイド商品ではなく、統合された小売金融サービススタックの消費者向けレイヤーとして位置づけ直した。
