...
本エントリは [[banking/INDEX|banking index]] の配下に、[[regional-banks/sony-bank|ソニー銀行 (Sony Bank) entity anchor]] のエンティティアンカーに対する事業プロファイルの補完として位置する。[[banking/japan-net-bank-competition-map|Japan net bank competition map]] のネット銀行セグメント図の中で、[[megabanks/sony-fg|Sony Financial Group]] の親グループ文脈とともに、また [[banking/rakuten-bank|Rakuten Bank]] · [[banking/paypay-bank|PayPay Bank]] · [[banking/au-jibun-bank|au Jibun Bank]] · [[regional-banks/ssnb|住信SBIネット銀行 / NEOBANK]] · [[banking/daiwa-next-bank|Daiwa Next Bank]] といったピアに対するエコシステム・証券隣接ポジショニングと照らして読まれたい。ライセンス境界については [[banking/japan-banking-license-tier-comparison-matrix|Japan banking license tier comparison matrix]] と [[financial-licenses/bank-license-and-baas-boundary|bank license / BaaS boundary]] を経由する。
...
```
Sony Group Corporation (TSE 6758, 最終親会社)
  └── Sony Financial Group (2020 に TOB により再連結化、2025-09-29に部分スピンオフで TSE プライムへ再上場、ソニーグループは約 20%を保有)
        ├── Sony Bank Incorporated (本ページの対象)
...
ソニー銀行の外貨預金商品は、より広範な [[banking/japan-net-bank-competition-map|net bank universe]] に対して同行の最も特徴的な機能である:
...
| デビットカード FX | **Sony Bank WALLET** は海外で外貨残高から直接支払う — スワイプ時の円→外貨レッグがない |
...
MoneyKit プラットフォームは 投信 (投資信託) を販売し、証券口座の隣接機能をサポートする。[[regional-banks/ssnb|SSNB]] の [[securities-firms/sbi-securities|SBI Securities]] への深い連携、あるいは [[banking/au-jibun-bank|au Jibun Bank]] の [[securities-firms/au-kabucom-securities|au Kabucom]] への連携と比べると、ソニー銀行の証券連携は相対的に薄い — しかし FX の強みが 外貨投信 の販売を補完する。

### カード・決済の隣接領域

| 商品 | 役割 |
|---|---|
| Sony Bank WALLET | マルチカレンシー・デビットカード + キャッシュカード。主力商品 |
| クレジットカード提携 | ソニー銀行は大規模な自社クレジットカードフランチャイズを運営するのではなく、外部のカード発行会社と提携する |
| ダイレクト決済 | 全銀システム経由でのソニー銀行の口座間振込 |
...
| マルチカレンシーの旅行 / 海外利用 | Sony Bank WALLET により首位 |
| 資産形成 / 投信 販売 | 堅実だが、SBI / SSNB エコシステムほど深くはない |
...
ソニー銀行の公開ディスクロージャー (「ディスクロージャー誌」シリーズおよび四半期決算) は、数兆円規模の預金基盤 — 2025-09-30時点の総預金 ¥4,536.9 億円 (円建て ¥3,800.6億円 + 外貨 ¥736.2億円) — に加え、増加する顧客数と相応の住宅ローン残高を示している。粒度の細かい時点 KPI (口座数、住宅ローン残高、ROE) は定期ディスクロージャーサイクルに属する。本ページは個々の数値をすべて追うのではなく、フランチャイズの形状を追跡する。
...
| 外貨業務 | FSA + 日銀統計の下での外国為替関連規則 | マルチカレンシー商品に適用される FX 開示および AML |
| 預金保険 | 預金保険機構 | 円預金は保護対象。外貨預金は明示的に対象外 |
| 証券商品販売 | 金融商品取引法 — 投信 販売向け | 標準的な適合性および開示義務 |
