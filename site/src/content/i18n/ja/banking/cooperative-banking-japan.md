...
協同組織機関は単なる小規模銀行ではない。そのガバナンスと事業ロジックは異なる：

- 会員 / 顧客の関係が機関設計の一部である。
- 業務区域と顧客適格性は通常の銀行より狭くなりうる。
- 全国的な法人銀行業務よりも、地域の中小企業・家計金融が重要である。
- 市場規律は上場銀行の規律より弱い場合があるため、ガバナンスと開示が監督上の重点項目となる。
- 中央機関と業界団体が、支援、モニタリング、システム、余剰資金管理にとって重要である。
...
- 協同組織金融は BaaS と同じではない。組み込み型バンキングについては [[banking/baas-japan-landscape]] を使用すること。
- 協同組織金融は自動的にリスクが低いわけではない。地域の借り手への集中とガバナンス上の制約がリスクを高めうる。
- すべての地域金融機関が協同組織機関であるわけではない。地方銀行は地域に拠点を持つ通常の銀行である。
