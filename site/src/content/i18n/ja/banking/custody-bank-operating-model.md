...
| Public AUC anchor | 受託信託財産総額 約 ¥696 兆円（受託信託財産 + 常任代理契約等に基づく預り資産; うち 信託財産 ¥476兆円）、2025-03-31時点 |
...
|---|---|---|---|
| **信託カストディ (Securities custody)** | 株式、JGB、社債、外国証券の保管; 振替登録; コーポレートアクション処理; 配当／利息受領; 税還付オペレーション | 年金プラン、アセットマネージャー、生保、日本のサブカストディアンを必要とする外国グローバルカストディアン | 自己勘定投資家ではない; 「信託口」名義人ラベルは記録管理上の構成物 |
...
| **資産管理サービス (Master custody)** | 機関投資家向けマスターカストディ、複数マンデート統合、運用指図処理 | 大規模な複数マンデート資産保有者 | スポンサーではない |
...
| Settlement (cash equity) | JASDEC + JSCC クリアリングによる DVP-X1 / DVP-X2 / DVP-X3 決済 |
| Settlement (JGB) | 日銀 JGB 振替制度への直接参加 |
| Settlement (corporate bond / CP) | 社債および CP について JASDEC 経由の振替 |
...
| Sub-custody for foreign assets | 非日本資産について [[foreign-financial-institutions/bny-mellon-japan|BNY Mellon]] / [[foreign-financial-institutions/state-street-japan|State Street]] / [[foreign-financial-institutions/jpmorgan-japan|JP Morgan]] / [[foreign-financial-institutions/citigroup-japan|Citi]] 経由でのリルーティング |
...
| Shareholder camp | SMTH 33.3% + みずほ FG 27.0% + りそな 16.7% + 第一生命 8.0% + 朝日 / 明治安田 / かんぽ / 富国 生保 | MUFG Trust + Nippon Life + Meiji Yasuda + Norinchukin |
...
|---|---|---|
| Custody / 投信受託 | コア機能（ユーティリティ規模） | 内製で運営 + 処理は CBJ / MTBJ にしばしば委託 |
...
| Pricing power on JP custody | 高（ユーティリティ規模） | 中（サブカストディプレミアム） |
| Pricing power on foreign custody | 低（グローバルへサブロール） | 高 |
...
| Securities custody fee | アセットクラスごとの AUC bps + チケットごとの決済手数料 | 公開非開示 |
...
|---|---|---|
| 銀行監督 | 銀行法 + 金融庁 監督指針 (信託兼営銀行 section) | 自己資本充実 + ガバナンス + IT リスク; CBJ は軽い与信ブックを運営しており、その結果 AUC に対して軽い自己資本比率となる |
| 信託業監督 | 信託業法 + 金融庁 監督指針 (信託業 section) | 信託勘定分別、受託者責任、利益相反コントロール |
