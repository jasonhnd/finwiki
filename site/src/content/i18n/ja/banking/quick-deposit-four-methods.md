...
このエントリは [[banking/INDEX|banking index]] の配下にある。ピア・対比の文脈については [[banking/regional-bank-consolidation-pattern|Regional bank consolidation pattern]] と、より広いシステム・規制境界については [[banking/cooperative-banking-japan|Cooperative banking in Japan]] と照らし合わせて読むこと。
