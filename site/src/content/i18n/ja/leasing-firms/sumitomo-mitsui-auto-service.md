...
| ウィキ上の役割 | **SMFG + 住友商事 のオート版 JV** ([[leasing-firms/smfl|SMFL]] の 姉妹会社)、日本最大級のオートリース・フリート管理プレーヤー |

### 「SMFL = 汎用 / SMAS = オート」の二本柱構造

| 会社 | 領域 |
|---|---|
| [[leasing-firms/smfl|SMFL]] | 一般機器・産業機器・不動産・環境・航空機・船舶・海外 |
...
| プレーヤー | 系列 |
|---|---|
| **オリックス自動車** | [[leasing-firms/orix-corp|オリックス]] 系 |
| **住友三井オートサービス (本ページ)** | [[megabanks/smfg|SMFG]] + 住友商事 |
...
- **直近政策論点**:
  - 2024〜 [[financial-regulators/boj-monetary-policy|日銀政策金利正常化]] → リース調達コスト上昇
...
- [[leasing-firms/smfl|SMFL]] (姉妹の汎用リース JV。同じ SMFG + 住友商事)
...
- [[asset-managers/mitsubishi-corp-asset-management|三菱商事系AM]] (商社系金融の比較対象)
...
- [[megabanks/smfg|SMFG]] (8316) 有価証券報告書 — 関係会社一覧
