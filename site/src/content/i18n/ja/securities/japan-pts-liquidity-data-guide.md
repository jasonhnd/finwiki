...
- [[JapanFG/sbi-securities|SBI Securities]] と [[JapanFG/rakuten-securities|Rakuten Securities]] は、SOR と PTS へのアクセスが小売価値提案の一部であるかどうかを尋ねるときに読むべき中心的なオンライン ブローカーです。
- アプリ/エコシステムの仲介により、ルートの複雑さを隠しながら UX を簡素化できるため、[[JapanFG/mufg-esmart-securities|MUFG eSmart Securities]] と [[JapanFG/paypay-securities|PayPay Securities]] は重要です。
- [[JapanFG/nomura-hd|Nomura]]、[[JapanFG/daiwa-sg|Daiwa Securities Group]]、[[JapanFG/smbc-nikko|SMBC Nikko]]、[[JapanFG/mizuho-securities|Mizuho Securities]]、および [[JapanFG/mufg-mums|MUMSS]] は、機関およびフルサービスの執行にとって重要ですが、ブローカーポリシーの証拠は依然として事業体ごとにチェックする必要があります。
