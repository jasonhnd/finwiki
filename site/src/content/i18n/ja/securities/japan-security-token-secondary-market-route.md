...
日本のセキュリティトークン流通市場の記録は、金融商品取引法上の登録、第一種金融商品取引業、PTS / 代替取引venue機能、トークンプラットフォーム基盤、証券会社による販売、カストディ / 記録管理、および発行体ディスクロージャーを結びつける。本ページは、公開開示されたセキュリティトークンの流通取引について、市場構造のルートを記録する。
...
| Settlement / custody | カストディ、移転、記録管理、受託者 / プラットフォームの役割 | 商品ディスクロージャー、信託 / カストディ資料、プラットフォーム規約。 |
...
| Field | Source route |
|---|---|
| Issuer / asset type | 商品ディスクロージャーおよび発行体資料。 |
...
| Settlement / custody structure | 商品資料、受託者 / カストディアン / プラットフォームのディスクロージャー。 |
...
| Custody / recordkeeping | 商品資料および受託者 / カストディアンのディスクロージャー。 |
