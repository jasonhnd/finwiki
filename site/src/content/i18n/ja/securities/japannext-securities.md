...
ジャパンネクスト証券は、独自の日本株取引システム「ジャパンネクストPTS」を運営しています。 公式サイトには、日本証券業協会に加入している登録金融商品取引業者及びPTS業者であると記載されている。

FinWiki にとって、ジャパンネクストは、[[securities/tokyo-stock-exchange|TSE]] 現金株式執行に対する主要なプライベートベニューのカウンターポイントです。
...
| 協会 | 日本証券業協会 |
| 会場 | ジャパンネクストPTS |
| 由来 | 2006 にSBIジャパンネクストとして設立。 PTS ライセンスは 2007 に承認されました。 |
...
|---|---|
| 昼間のPTS | 上場株式の代替執行場所。 |
| 夜のセッション | 通常の取引セッション以外の取引時間を提供します。 |
| 最高の執行 | SOR およびブローカーの注文ルーティング分析において重要です。 |
| HFT / 組織の流れ | プライベート会場の設計は、さまざまな流動性と待ち時間のインセンティブを生み出します。 |
