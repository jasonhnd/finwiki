...
translated_at: 2026-06-26T08:31:32.636Z
---
...
この項目は [[card-issuers/INDEX|card-発行会社 INDEX]]（そのドメイン経路）の下に位置する。メガバンク系列のピア／対比としては [[card-issuers/smbc-card|三井住友カード]] および [[card-issuers/jcb|JCB]] と、監督／システム境界としては [[financial-regulators/fsa|the FSA]] および [[payments/INDEX|payments]] と併せて読むこと。準拠するアクワイアリング法規は [[card-issuers/installment-sales-act-2020-amendment|割賦販売法 2020 改正]] である。

## 要点（TL;DR）

三菱UFJニコス株式会社 (Mitsubishi UFJ NICOS) は [[megabanks/mufg|MUFG]] グループのカード・信販 operating company。公式会社概要は **包括信用購入あっせん業者** 登録番号と **クレジットカード番号等取扱契約締結事業者**（card-number 加盟店契約）登録番号を明示しており、発行会社 / アクワイアラ / installment-credit の境界を読む上で重要。歴史的には複数のカードブランド・信販会社を統合してできた MUFG の retail / 加盟店 payment surface。
...
| アクワイアリング lane | クレジットカード番号等取扱契約締結事業者登録（加盟店契約・card-number 管理） |
...
## 2. オペレーティングモデル三菱UFJニコスは MUFG の retail / 加盟店 payment surface として、card issuing（発行）と 加盟店 acceptance（加盟店アクワイアリング）の両面を担う。割賦の中身は一括・分割払い (分割払い)・リボ (リボルビング)、加えてカードローン・加盟店サービスを展開する。日本のカードブランド・信販事業の歴史的な統合点であり、issuing と アクワイアリング を一社で抱える点が、ブランド・ライセンス三位一体型の [[card-issuers/jcb|JCB]] や SMFG ハブの [[card-issuers/smbc-card|三井住友カード]] との比較軸になる。
...
- 発行会社（割賦）と アクワイアラ（card-number 加盟店契約）の二系統登録が一社に同居する典型例として、[[payments/japan-card-issuer-acquirer-processor-split|発行会社 / アクワイアラ / processor split]] の具体 anchor になる。
- [[card-issuers/smbc-card|SMBC Card]]・[[card-issuers/jcb|JCB]] とともに megabank 系発行会社 の peer anchor を提供する。
...
- [[payments/japan-card-issuer-acquirer-processor-split|発行会社 / アクワイアラ / processor split]]
