---
title: "JA 共済連福島 (福島県本部 / Fukushima Prefectural Office of JA Kyosairen)"
aliases:
  - "JA-Kyosairen-Fukushima"
  - "JA共済連福島"
  - "全共連福島"
  - "福島県本部"
  - "Fukushima Prefectural Office JA Kyosairen"
...
confidence: likely
tags: [JapanFG, ja-group, kyosai, prefectural-federation, fukushima, tohoku, disaster-recovery, ja-kyosairen]
status: active
sources:
...
### 県共済連統合 (2000) の経緯 ^[extracted]

| 年代 | 事象 |
|---|---|
| 1951〜 | 47 都道府県別に「県共済農業協同組合連合会」設立 (法人格を持つ独立連合会) |
| 1960〜90 年代 | 47 県共済連 + 1 全共連の 2 段構造で運営 |
| **2000-04-01** | **県共済連 47 機関 → 全共連に統合**、各県本部に再編 ^[extracted] |
| 2000〜 | 全共連を全国本部、47 県組織を「県本部」とする一体運営化 |
| **2011-03-11** | **東日本大震災 + 福島第一原発事故** — 福島県本部の建更給付実務が大規模化 ^[extracted] |
| 2012〜 | 福島県内 JA + 県本部で復興期の組合員サービス継続 |
| 2020〜 | JA 共済アプリ・AI 査定の県本部展開 |
| 2024〜 | DX 推進 + 県本部の業務効率化 |

### 全共連 + 47 県本部の一体運営 ^[extracted]
...
| **組合員教育** | リスクマネジメント・共済利用教育 |
| **災害復興期対応** | 大規模災害時の集中査定 + 給付実務 |

### 2011 東日本大震災 + 原発事故での建更給付 ^[extracted]

- **2011-03-11 東日本大震災**: 福島県本部の管轄エリアで甚大な被害
  - 津波被害 (沿岸部) + 地震被害 (内陸部) + 福島第一原発事故 (避難区域)
- **建物更生共済 (建更)** = 火災 + 自然災害 + 死亡保障一体型 → 大規模給付
...
- **47 県本部の中で東北 6 県本部の一つ**
- 東北地区 (青森・岩手・宮城・秋田・山形・福島) で **2011 震災 + 原発事故** という特殊環境を経験
- 災害対応力 + 組合員密着サービスの **県本部モデル代表事例**
- 全共連内の **災害給付実務の知見集約地**

### 災害復興期の協同組合共済モデル

- 民間保険会社 (損保) との比較で、JA 共済連 = **「組合員相互扶助」**の理念に基づく給付
...
- **主管**: 農林水産省 (主) + 金融庁 (協力監督) + 福島県農林水産部 (県組合監督)
- **法的根拠**: 農業協同組合法 (共済事業条項) + 共済事業ガイドライン
- **直近政策論点**:
  - **災害復興期の建更給付モデル** の継続的進化
  - **AI 査定 + デジタル契約** の県本部展開
  - **食料安全保障計画 (2026〜)** での県本部 + 県内 JA の役割
  - **原発事故区域** の長期復興と組合員サービス継続

## Related

- [[non-life-insurers/ja-kyosairen]] — JA 共済連 全国本部 (本県本部の上位)
- [[cooperative-banks/ja-zenchu]] — JA 全中 (JA グループ代表)
- [[cooperative-banks/ja-zen-noh]] — JA 全農 (JA グループ経済事業)
- [[cooperative-banks/ja-shinnoren]] — JA 信連 (peer 県本部 / 信用事業)
- [[cooperative-banks/ja-bank-tokyo-shinren]] — JA バンク東京 信連 (peer prefectural anchor)
- [[cooperative-banks/norinchukin]] — 農林中央金庫 (JA Bank system の中央)
- [[regional-banks/fukushima-bank]] — 福島銀行 (福島県内 peer 銀行)
- [[non-life-insurers/kyoritsu-fire-marine]] — 共栄火災海上保険 (JA 共済連 74.20% 出資子会社)
- [[cooperative-banks/jf-shingyoren]] — JF 信漁連 (漁協系 peer)
