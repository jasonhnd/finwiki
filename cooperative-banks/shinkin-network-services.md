...
aliases:
  - "cooperative-banks/shinkin-network-services"
...
- **メガバンク（[[megabanks/mufg]]・[[megabanks/smfg]]・[[megabanks/mizuho-fg]]）**: 自社で勘定系・AML/CFT・モバイルバンキング基盤を保有・運営、IT 投資額は年間数千億円規模。
...
業界の 254 行が共通インフラに依存することは、SNS / 信金共同センターのシステム障害が業界全体に波及するリスクを意味する。これは銀行業界共通の課題（メガバンク [[megabanks/mizuho-fg|みずほ FG]] の繰り返されるシステム障害が示すように）だが、信用金庫の場合は「業界全体が同時停止する」可能性が構造的に内在する。
