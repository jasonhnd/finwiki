---
title: "信金中央金庫グループ証券機能 / 信金 AM (Shinkin securities + asset management lane)"
aliases:
  - "cooperative-banks/shinkin-shoken"
  - "shinkin-shoken"
  - "信金証券"
  - "Shinkin Securities lane"
  - "信金アセットマネジメント"
...
confidence: likely
tags: [JapanFG, shinkin, cooperative-banking, securities, asset-management, scb-group, infrastructure, operating-company]
status: active
sources:
  - "https://www.shinkin-central-bank.jp/"
  - "https://www.shinkin-am.co.jp/"
  - "https://www.shinkin.org/"
  - "https://www.fsa.go.jp/menkyo/menkyoj/shinkin.xlsx"
  - "https://www.fsa.go.jp/menkyo/menkyo.html"
---

# 信金中央金庫グループ証券機能 / 信金 AM (Shinkin securities + asset management lane)

> **Page scope note**: This entry was created under slug `shinkin-shoken` as a substitute for the originally requested `zenshinkyo-national-association` slug because the [[financial-regulators/zenshin-kyo|全国信用金庫協会 page]] already exists. This page covers a complementary and genuinely missing surface: the securities / asset-management arm of the shinkin central system, anchored by 信金 AM (Shinkin Asset Management) and the broader SCB-group securities function.
...
| Item | Notes |
|---|---|
| Anchor entity | 信金アセットマネジメント株式会社（Shinkin Asset Management Co., Ltd.） |
| Group route | 信金中央金庫グループ（SCB Group） |
| License route | 金融商品取引法（FIEA）下の投資運用業・第二種金融商品取引業（FSA 登録金商業者） |
| Wiki role | 信金中金グループの **証券・運用機能** anchor entry |
| Counterpart in JA system | [[cooperative-banks/norinchukin|農林中央金庫]] 系の [[cooperative-banks/nochu-securities|農中証券・農中バリューインベストメンツ]] |
| Counterpart in shinkumi system | 全信組連グループの運用機能（規模は限定的） |
...
- 信用金庫業界の**第四の中央インフラ層**（中央金庫本体 / 業界団体 / IT 共同 / 証券運用）の anchor entry。
