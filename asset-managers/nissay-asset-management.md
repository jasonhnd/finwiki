...
ニッセイアセットマネジメント (Nissay AM) は [[life-insurers/nippon-life|日本生命保険 (相互会社)]] の asset-management operating company。FSA 金融商品取引業者一覧では「ニッセイアセットマネジメント株式会社」、関東財務局長(金商)第369号として掲載される。**国内最大の生命保険会社** [[life-insurers/nippon-life|日本生命]] (総資産 80 兆円超、相互会社) の運用機能を担い、生保責任準備金運用 (約 75 兆円超規模) + 公募投信 + 年金運用を中核とする。**生保系運用会社カテゴリの最大手**で、メガバンク系 ([[asset-managers/mufg-asset-management|MUAM]] / [[asset-managers/asset-management-one|アセマネOne]]) や損保系 ([[asset-managers/tokio-marine-asset-management|東京海上 AM]]) とは異なる**生保責任準備金運用基盤の規模 + 相互会社親会社の独立性**が差別化軸。
...
| Parent boundary | [[life-insurers/nippon-life|日本生命保険 (相互会社)]] 100% asset-management 子会社 |
| 本社 | 東京都千代田区麹町 |
...
[[life-insurers/nippon-life|日本生命]] は国内最大の相互会社生命保険会社で、その運用機能を担う **Nissay AM** は独立分析単位として重要：

1. **生保系運用会社の最大手**：[[asset-managers/asset-management-one|アセマネOne]] (みずほ + 第一生命 JV) や [[asset-managers/tokio-marine-asset-management|東京海上 AM]] (損保) と並ぶが、生保単独 100% 出資で規模が突出
2. **低コスト・インデックス投信競争**：「ニッセイ外国株式インデックスファンド」等は信託報酬の業界最安値水準で、[[asset-managers/sbi-asset-management|SBI AM]] / [[asset-managers/mufg-asset-management|MUAM]] (eMAXIS Slim) 等と直接競合
