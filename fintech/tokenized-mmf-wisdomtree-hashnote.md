...
aliases: [tokenized-mmf-wisdomtree-hashnote, WTGXX, USYC, Hashnote USYC, WisdomTree WTGXX, tokenized short-duration product comparison]
domain: fintech
created: 2026-05-25
...
confidence: likely
tags: [fintech, tokenization, mmf, wisdomtree, hashnote, usyc, wtgxx, rwa, product-classification, comparison-matrix]
status: active
sources:
...
This entry sits under [[fintech/INDEX|fintech index]]. Read it with [[fintech/blackrock-buidl-tokenized-mmf-overview|BlackRock BUIDL]] and [[fintech/franklin-templeton-stablecoin-migration|Franklin BENJI]] / [[fintech/apollo-acred-private-credit-tokenization|Apollo ACRED]] for the broader tokenized-MMF and tokenized-RWA matrix, and with [[fintech/circular-reserve-asset-flywheel-overview|準備金相互ロックフライホイール]] for the systemic role tokenized MMF plays as stablecoin yield infrastructure. Product rankings require a stated date, scope and common measurement method; none is assigned here.
