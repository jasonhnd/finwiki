---
title: Argentina USDT Formalization · Post-Milei Reforms 2024-2026
...
status: active
sources:
  - https://www.argentina.gob.ar/normativa/nacional/resoluci%C3%B3n-994-2024-397598/texto
  - https://www.argentina.gob.ar/normativa/recurso/219405/texact-TituloXIV-CapIII/htm
  - https://www.argentina.gob.ar/node/420252
  - https://www.argentina.gob.ar/normativa/nacional/resoluci%C3%B3n-49-2024-397597/texto
  - https://www.cnv.gov.ar/SitioWeb/RegistrosPublicos/Psav
  - https://www.bcra.gob.ar/noticias/inicio-de-la-fase-3-del-programa-economico/
  - https://www.argentina.gob.ar/normativa/nacional/ley-27743-401268/texto
  - https://www.argentina.gob.ar/node/433376
  - https://www.argentina.gob.ar/node/462840
  - https://www.bcu.gub.uy/Comunicaciones/Paginas/Detalle-Noticia.aspx?noticia=527&title=El-BCU-aprueba-normativa-para-proveedores-de-servicios-de-activos-virtuales
  - https://www.bcp.gov.py/es/web/institucional/w/comunicado-sobre-activos-virtuales
---
...
| AML/KYC | UIF Resolution 49/2024 applies risk assessment, customer identification, monitoring and suspicious-transaction reporting duties; see also [[fintech/fatf-travel-rule-overview|FATF Travel Rule 概要]] |
...
Source note: entity status must be verified in the live [CNV PSAV registry](https://www.cnv.gov.ar/SitioWeb/RegistrosPublicos/Psav); the legal effect and limits of registration come from [Resolution 994/2024](https://www.argentina.gob.ar/normativa/nacional/resoluci%C3%B3n-994-2024-397598/texto) and the [current consolidated CNV rules](https://www.argentina.gob.ar/normativa/recurso/219405/texact-TituloXIV-CapIII/htm).
...
Source note: [Ley 27.743](https://www.argentina.gob.ar/normativa/nacional/ley-27743-401268/texto), the CNV [Resolution 1010 implementation notice](https://www.argentina.gob.ar/node/433376), and the ARCA [2025-04-21 programme update](https://www.argentina.gob.ar/node/462840). This is a source map, not individual tax advice.

### Uruguay

Uruguay enacted Ley 20.345 in September 2024, bringing virtual-asset service providers within the BCU's regulatory and supervisory perimeter. On 2026-07-22 the BCU announced implementing rules for those providers. Those official materials establish the regulatory sequence, but do **not** quantify a Buenos Aires-Colonia USDT corridor, attribute property purchases to USDT, or show a post-Milei direction of cross-border flows; those claims are therefore omitted. See the BCU's [institutional-law history](https://www.bcu.gub.uy/Acerca-de-BCU/Paginas/Proceso-Fundacional.aspx) and [2026 PSAV rules announcement](https://www.bcu.gub.uy/Comunicaciones/Paginas/Detalle-Noticia.aspx?noticia=527&title=El-BCU-aprueba-normativa-para-proveedores-de-servicios-de-activos-virtuales).

### Paraguay

The BCP's public materials warn that cryptoassets are not legal tender, highlight volatility and exchange/custody risks, and discuss a proposed virtual-asset law. They do not provide comparable flow data proving that an Argentina-Paraguay corridor is smaller than an Argentina-Uruguay corridor, that it is growing, or that named Argentine exchanges are entering Paraguay. This entry therefore records the regulatory position without a flow direction or market-entry claim. See the BCP's [2022 public warning](https://www.bcp.gov.py/es/web/institucional/w/comunicado-sobre-activos-virtuales) and its [December 2024 technical response on the proposed law](https://www.bcp.gov.py/documents/20117/0/P199.5383%2B2024%2BINFORME%2Bde_respuesta_HCD_Hector_Figueredo%2B10.12.2024.pdf/9dc4cd77-8dfe-d61b-9060-ffe55ce66ba6?t=1745931957345.pdf).
...
Argentina provides a bounded case study for [[fintech/em-market-crypto-dollarization-pattern|EM 暗号ドル化パターン]], but a regulatory event should not be treated as proof of a behavioural or market-volume outcome. The 2024-2025 record leaves the following research questions open:

1. **Does easing capital controls reduce USDT demand?** → Not established here. A credible answer requires a consistent, dated series separating exchange-rate, savings, payments and capital-control use cases.
2. **Does formalization (PSAV) reduce shadow-market USDT volume?** → Open empirical question. Registration makes supervised activity more observable, but this entry does not have a consistent official series proving a shift from informal to formal volume.
3. **Does the savings function persist?** → Open empirical question. Registration and macroeconomic stabilisation do not by themselves measure household USDT balances or motivations.
4. **Does the regional corridor function persist?** → Not established. The cited regulators publish rules and risk statements, not comparable Argentina-Uruguay-Paraguay USDT-flow series.
5. **Does Argentina become a template for other EMs?** → Analytical hypothesis only. The PSAV framework can be compared with other regimes, but legal and institutional portability must be assessed jurisdiction by jurisdiction.
...
- [CNV Resolution 994/2024 — original PSAV registry rules](https://www.argentina.gob.ar/normativa/nacional/resoluci%C3%B3n-994-2024-397598/texto)
- [CNV consolidated rules, Title XIV, Chapter III](https://www.argentina.gob.ar/normativa/recurso/219405/texact-TituloXIV-CapIII/htm)
- [CNV current PSAV registration procedure](https://www.argentina.gob.ar/node/420252)
- [CNV public PSAV registry](https://www.cnv.gov.ar/SitioWeb/RegistrosPublicos/Psav)
- [UIF Resolution 49/2024 — PSAV AML/CFT obligations](https://www.argentina.gob.ar/normativa/nacional/resoluci%C3%B3n-49-2024-397597/texto)
- [BCRA Phase 3 announcement, 2025-04-11](https://www.bcra.gob.ar/noticias/inicio-de-la-fase-3-del-programa-economico/)
- [BCRA foreign-exchange-market report, April 2025](https://www.bcra.gob.ar/publicaciones/informe-de-la-evolucion-del-mercado-de-cambios-y-balance-cambiario-abril-de-2025/)
- [Ley 27.743 — Medidas Fiscales Paliativas y Relevantes](https://www.argentina.gob.ar/normativa/nacional/ley-27743-401268/texto)
- [CNV Resolution 1010 asset-regularisation notice](https://www.argentina.gob.ar/node/433376)
- [ARCA asset-regularisation programme update, 2025-04-21](https://www.argentina.gob.ar/node/462840)
- [BCU 2026 PSAV rules announcement](https://www.bcu.gub.uy/Comunicaciones/Paginas/Detalle-Noticia.aspx?noticia=527&title=El-BCU-aprueba-normativa-para-proveedores-de-servicios-de-activos-virtuales)
- [BCP public warning on virtual assets](https://www.bcp.gov.py/es/web/institucional/w/comunicado-sobre-activos-virtuales)
- [BCP technical response on the proposed virtual-asset law, December 2024](https://www.bcp.gov.py/documents/20117/0/P199.5383%2B2024%2BINFORME%2Bde_respuesta_HCD_Hector_Figueredo%2B10.12.2024.pdf/9dc4cd77-8dfe-d61b-9060-ffe55ce66ba6?t=1745931957345.pdf)
