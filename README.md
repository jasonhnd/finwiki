...
| Link-audited entries | 1482 | `tools/wiki_link_audit.ts` が確認する public wiki entries |
| Unresolved link issues | 0 | body route / peer / system link audit と dead wikilink target audit の未解決 issue |
| Text volume | 約1107万字 | Markdown 全体の空白除外 UTF-8 文字数（約 11,073,198） |
...
| Link-audited entries | 1482 | Public wiki entries checked by `tools/wiki_link_audit.ts` |
| Unresolved link issues | 0 | Open body route / peer / system-link and dead wikilink-target audit issues |
| Text volume | ~11.07M chars | ~11,073,198 non-space UTF-8 characters across Markdown |
...
| Link-audited entries | 1482 | `tools/wiki_link_audit.ts` 覆盖的 public wiki entries |
| Unresolved link issues | 0 | body route / peer / system link audit 与 dead wikilink target audit 的未解决 issue |
| Text volume | 约1107万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 11,073,198） |
