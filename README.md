...
| Text volume | 約976万字 | Markdown 全体の空白除外 UTF-8 文字数（約 9,760,210） |
...
| Text volume | ~9.76M chars | ~9,760,210 non-space UTF-8 characters across Markdown |
...
| Text volume | 约976万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 9,760,210） |
