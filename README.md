...
| Text volume | 約1106万字 | Markdown 全体の空白除外 UTF-8 文字数（約 11,056,568） |
...
| Text volume | ~11.06M chars | ~11,056,568 non-space UTF-8 characters across Markdown |
...
| Text volume | 约1106万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 11,056,568） |
