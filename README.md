...
| Text volume | 約978万字 | Markdown 全体の空白除外 UTF-8 文字数（約 9,778,746） |
...
| Text volume | ~9.78M chars | ~9,778,746 non-space UTF-8 characters across Markdown |
...
| Text volume | 约978万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 9,778,746） |
