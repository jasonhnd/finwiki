...
| Text volume | 約974万字 | Markdown 全体の空白除外 UTF-8 文字数（約 9,739,839） |
...
| Text volume | ~9.74M chars | ~9,739,839 non-space UTF-8 characters across Markdown |
...
| Text volume | 约974万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 9,739,839） |
