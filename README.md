...
| Text volume | 約974万字 | Markdown 全体の空白除外 UTF-8 文字数（約 9,738,407） |
| Word-like tokens | 約154万 | English / CJK mixed corpus の近似 token count |
...
| Text volume | ~9.74M chars | ~9,738,407 non-space UTF-8 characters across Markdown |
| Word-like tokens | ~1.54M | Approximate English / CJK mixed-corpus token count |
...
| Text volume | 约974万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 9,738,407） |
| Word-like tokens | 约154万 | English / CJK mixed corpus 的近似 token count |
