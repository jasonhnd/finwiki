...
| Text volume | 約1093万字 | Markdown 全体の空白除外 UTF-8 文字数（約 10,934,253） |
...
| Text volume | ~10.93M chars | ~10,934,253 non-space UTF-8 characters across Markdown |
...
| Text volume | 约1093万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 10,934,253） |
