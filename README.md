...
| Text volume | 約1108万字 | Markdown 全体の空白除外 UTF-8 文字数（約 11,078,235） |
...
| Text volume | ~11.08M chars | ~11,078,235 non-space UTF-8 characters across Markdown |
...
| Text volume | 约1108万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 11,078,235） |
