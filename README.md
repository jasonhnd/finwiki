...
| Text volume | 約1107万字 | Markdown 全体の空白除外 UTF-8 文字数（約 11,074,119） |
...
| Text volume | ~11.07M chars | ~11,074,119 non-space UTF-8 characters across Markdown |
...
| Text volume | 约1107万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 11,074,119） |
