...
| Text volume | 約979万字 | Markdown 全体の空白除外 UTF-8 文字数（約 9,785,934） |
...
| Text volume | ~9.79M chars | ~9,785,934 non-space UTF-8 characters across Markdown |
...
| Text volume | 约979万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 9,785,934） |
