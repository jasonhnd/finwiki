...
| Text volume | 約1105万字 | Markdown 全体の空白除外 UTF-8 文字数（約 11,052,148） |
...
| Text volume | ~11.05M chars | ~11,052,148 non-space UTF-8 characters across Markdown |
...
| Text volume | 约1105万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 11,052,148） |
