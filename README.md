...
| Text volume | 約1043万字 | Markdown 全体の空白除外 UTF-8 文字数（約 10,427,096） |
| Word-like tokens | 約252万 | English / CJK mixed corpus の近似 token count |
...
| Text volume | ~10.43M chars | ~10,427,096 non-space UTF-8 characters across Markdown |
| Word-like tokens | ~2.52M | Approximate English / CJK mixed-corpus token count |
...
| Text volume | 约1043万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 10,427,096） |
| Word-like tokens | 约252万 | English / CJK mixed corpus 的近似 token count |
