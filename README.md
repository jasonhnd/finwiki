...
| Text volume | 約1112万字 | Markdown 全体の空白除外 UTF-8 文字数（約 11,118,605） |
...
| Text volume | ~11.12M chars | ~11,118,605 non-space UTF-8 characters across Markdown |
...
| Text volume | 约1112万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 11,118,605） |
