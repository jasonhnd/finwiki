...
| Text volume | 約975万字 | Markdown 全体の空白除外 UTF-8 文字数（約 9,751,152） |
...
| Text volume | ~9.75M chars | ~9,751,152 non-space UTF-8 characters across Markdown |
...
| Text volume | 约975万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 9,751,152） |
