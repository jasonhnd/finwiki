...
| Text volume | 約980万字 | Markdown 全体の空白除外 UTF-8 文字数（約 9,798,208） |
...
| Text volume | ~9.80M chars | ~9,798,208 non-space UTF-8 characters across Markdown |
...
| Text volume | 约980万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 9,798,208） |
