...
| Text volume | 約977万字 | Markdown 全体の空白除外 UTF-8 文字数（約 9,770,457） |
...
| Text volume | ~9.77M chars | ~9,770,457 non-space UTF-8 characters across Markdown |
...
| Text volume | 约977万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 9,770,457） |
