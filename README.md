...
| Text volume | 約1056万字 | Markdown 全体の空白除外 UTF-8 文字数（約 10,556,112） |
...
| Text volume | ~10.56M chars | ~10,556,112 non-space UTF-8 characters across Markdown |
...
| Text volume | 约1056万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 10,556,112） |
