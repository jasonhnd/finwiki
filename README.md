...
| Text volume | 約982万字 | Markdown 全体の空白除外 UTF-8 文字数（約 9,820,301） |
...
| Text volume | ~9.82M chars | ~9,820,301 non-space UTF-8 characters across Markdown |
...
| Text volume | 约982万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 9,820,301） |
