...
| Text volume | 約1052万字 | Markdown 全体の空白除外 UTF-8 文字数（約 10,518,515） |
...
| Text volume | ~10.52M chars | ~10,518,515 non-space UTF-8 characters across Markdown |
...
| Text volume | 约1052万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 10,518,515） |
