...
| Text volume | 約1109万字 | Markdown 全体の空白除外 UTF-8 文字数（約 11,087,767） |
...
| Text volume | ~11.09M chars | ~11,087,767 non-space UTF-8 characters across Markdown |
...
| Text volume | 约1109万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 11,087,767） |
