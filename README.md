...
| Text volume | 約1053万字 | Markdown 全体の空白除外 UTF-8 文字数（約 10,528,791） |
| Word-like tokens | 約166万 | English / CJK mixed corpus の近似 token count |
...
| Text volume | ~10.53M chars | ~10,528,791 non-space UTF-8 characters across Markdown |
| Word-like tokens | ~1.66M | Approximate English / CJK mixed-corpus token count |
...
| Text volume | 约1053万字 | 全库 Markdown 空白除外 UTF-8 字符数（约 10,528,791） |
| Word-like tokens | 约166万 | English / CJK mixed corpus 的近似 token count |
