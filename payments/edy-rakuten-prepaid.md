...
Rakuten Edy is registered as **第三者型前払式支払手段** under [[payments/funds-transfer-vs-prepaid-boundary|Payment Services Act (資金決済法)]] Chapter 3 because acceptance is at third-party merchants beyond Rakuten's own services. Key regulatory consequences:

- 楽天Edy株式会社 appears in [[payments/prepaid-payment-instrument-issuers-japan-index|FSA `daisan.xlsx`]] as registered third-party prepaid issuer.
- Half-yearly **unused-balance deposit** (供託) obligation with Legal Affairs Bureau.
