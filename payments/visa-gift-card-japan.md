...
- **[[payment-firms/kyash|Kyash]] Visa card** — wallet-and-prepaid-Visa-card hybrid issued by Kyash Inc.; serves a different use case (real-time wallet + Visa prepaid issuance) than Vプリカ (single-load gift / cardless purchase).
