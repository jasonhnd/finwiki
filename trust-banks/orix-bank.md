...
| License route | 銀行法の銀行免許（普通銀行）+ 兼営法に基づく信託業務の兼営。**信託専業の「信託銀行」ではない**点に注意 |
| Business shape | 投資用不動産ローン・ネット定期・カードローン中心の specialty / ネット系 bank |
| Current parent | [[leasing-firms/orix-corp|ORIX]]（株式譲渡公表済み） |
| Announced acquirer | [[securities-firms/daiwa-sg|大和証券グループ本社]] / [[regional-banks/daiwa-next-bank|大和ネクスト銀行]]（2026-04-27 公表、当局認可後に子会社化、将来は合併計画） |
| Watch item | 株式譲渡完了日、合併方針、銀行名 / グループ表示の変更 |
