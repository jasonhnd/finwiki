...
FinWiki 是一个公开金融知识 wiki，提供 Markdown corpus、Astro 人类站、双语 i18n、wikilink 图谱、AI discovery surface 和严格发布门禁。
...
| PRD-007 | Release transparency | 每次发布有按日文、英文排序的 README / CHANGELOG / release note，并在每种语言中记录范围、变更、验证、注意事项和后续。不添加中文阅读面。 |
...
- Maintainer journey: 读 docs -> 修改 corpus 或工具 -> 跑 release gate -> 更新日英发布文档 -> 提交推送。
