...
sources:
  ...
  - "https://www.jhf.go.jp/about/business/index.html"
  - "https://www.jhf.go.jp/files/300368739.pdf"
  - "https://www.mlit.go.jp/about/jhf_.html"
  - "https://www.mof.go.jp/"
...
| 業務委託 | Loan servicing, application processing, collection coordinated with private partner banks. | [[banking/regional-bank-consolidation-pattern|Regional banks]] and other partner financial institutions. |
...
The economic heart of JHF is the monthly **JHF MBS Trust** program — see [[structured-finance/jhf-mbs-mechanics]] for full plumbing. Flow:
...
The JHF MBS program is the **largest yen-denominated structured-paper program**, dwarfing private RMBS issuance in scale and benchmarking the yen RMBS curve. See [[structured-finance/jhf-mbs-vs-private-rmbs-spread]] for the spread economics.
...
- **Not a retail bank** — JHF does not take deposits, does not have branches in the bank sense, and is not part of the [[banking/INDEX|banking system]] in the deposit-taking-institution meaning.
- **Not the old GHLC page** — legacy history can be cited but routing for current housing-finance topics should use JHF, not GHLC.
- **Not SME credit guarantee** — SME guarantees belong to [[policy-finance/japan-credit-guarantee-system]] and [[policy-finance/national-federation-credit-guarantee-corporations]].
- **Not agriculture / fisheries credit** — those use [[policy-finance/agriculture-credit-guarantee-system]] and [[policy-finance/fisheries-credit-guarantee-system]].
...
- **YCC-era relevance erosion**: during NIRP / YCC, private variable-rate mortgages priced off ultra-low short rates dominated new origination, and Flat 35's long-tenor fixed-rate proposition lost relative appeal. Counterargument: even in low-rate eras, a subset of buyers value rate certainty over the full mortgage life, and Flat 35 retained a structural niche; the 2024–2026 rate normalization is restoring its relative appeal.
- **Privatization-debate residual**: critics argued the 2007 reform did not go far enough — JHF still operates as a public institution rather than being fully privatized; defenders argue housing-finance policy infrastructure is structurally a public good in Japan because no private-market structure would supply 35-year fixed-rate mortgages at scale.
- **MBS market dominance concern**: the dominance of JHF MBS in yen-denominated structured paper could be argued to crowd out private RMBS market development. Counterargument: private RMBS still exists for non-conforming credit segments; JHF MBS sets the benchmark curve.
- **Property-standard rigidity**: Flat 35's technical-standard eligibility (insulation, earthquake resistance) excludes some properties from eligibility, particularly older or non-conforming homes — which may not match all buyer preferences.

## Open questions

- What is the current Flat 35 vs private-variable-rate mortgage market-share split as BOJ normalizes rates through 2026?
- How will the 子育てプラス discount affect Flat 35 disbursement among target households?
- Will Flat 50 ever achieve meaningful scale, or remain a niche product?
- How does JHF's housing loan insurance product perform vs private mortgage insurance offerings?
- What is the long-run trajectory of JHF MBS issuance as Japan's housing-purchase volume declines with demographic decline?
