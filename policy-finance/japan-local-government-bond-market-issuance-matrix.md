...
aliases:
  - "Japan local-government bond market issuance matrix"
  - "Japan local bond issuance matrix"
  - "Japan municipal bond issuer comparison"
  - "prefecture vs designated-city vs municipality bond matrix"
  - "Tokyo-to-sai vs Osaka-fusai vs Aichi-kensai matrix"
  - "Japan 地方債 issuance matrix"
  - "公募地方債 vs 銀行等引受 vs JFM vs FILP matrix"
...
sources:
  ...
  - "https://www.chihousai.or.jp/02/10.php"
  - "https://www.mof.go.jp/filp/summary/filp_local/tihousaiseidonogaiyou.htm"
  - "https://www.soumu.go.jp/iken/zaisei/chihousai.html"
  - "https://www.soumu.go.jp/main_content/000760497.pdf"
  - "https://www.jfm.go.jp/"
  - "https://www.jfm.go.jp/about/outline.html"
  - "https://www.zaimu.metro.tokyo.lg.jp/kosai/index.html"
  - "https://www.pref.osaka.lg.jp/o110030/fissei/saimu/"
  - "https://www.pref.aichi.jp/soshiki/zaisei/0000076929.html"
  - "https://www.pref.kanagawa.jp/docs/tn3/cnt/f300054/"
  - "https://www.city.yokohama.lg.jp/city-info/zaisei/saimu/"
  - "https://www.city.osaka.lg.jp/zaisei/page/0000019527.html"
  - "https://www.city.nagoya.jp/zaisei/category/167-2-3-13-0-0-0-0-0-0.html"
---
...
Japan's local-government bond market is **not one issuer class**. It is layered across four issuer tiers — **47 prefectures (都道府県)**, **20 政令指定都市 (designated cities)**, **roughly 1,700 ordinary cities / towns / villages (市町村)**, and **special districts / public enterprise authorities** — with very different issuance scales, channel mixes, credit profiles, and JFM dependence. Tokyo Metropolis (都債) sits at the apex as the benchmark for the asset class and rarely uses [[policy-finance/japan-finance-organization-municipalities|JFM]]; mid-sized prefectures like Osaka, Aichi, and Kanagawa run material public-offering programs but also use joint-issuance and JFM; smaller prefectures rely heavily on [[policy-finance/japan-finance-organization-municipalities|JFM]] / FILP / bank-underwritten channels; most small municipalities are entirely outside public-offering markets. This matrix collects publicly-verifiable axes — issuer count, typical issue size, JFM reliance, FILP reliance, MIC (総務省) supervision role, secondary-market liquidity, yield-spread to JGB benchmarks, and foreign-investor participation — across the four tiers and against named benchmark issuers (Tokyo Metropolis, Osaka Prefecture, Aichi Prefecture, prefecture average, Yokohama City, Osaka City, Nagoya City, the joint-issuance pool, and the [[policy-finance/japan-finance-organization-municipalities|JFM]] bond complex).

## Wiki route

This entry sits under [[policy-finance/INDEX|policy-finance index]] as the issuer-type and credit-profile matrix paired with [[policy-finance/local-government-bond-market|Local government bond market]] (market-level entry), [[policy-finance/japan-finance-organization-municipalities|JFM]] (joint-funded public-credit institution), [[policy-finance/japan-local-bond-association|Japan Local Government Bond Association]] (industry-association anchor), and [[policy-finance/tokyo-metropolitan-bond|Tokyo Metropolitan Bond]] (benchmark-issuer case study). It complements the credit-guarantee public-credit lane at [[policy-finance/japan-credit-guarantee-system|Japan credit guarantee system]] / [[policy-finance/tokyo-credit-guarantee-corp|Tokyo Credit Guarantee Corp]] / [[policy-finance/osaka-credit-guarantee-corp|Osaka Credit Guarantee Corp]] (which sit on the SME-credit side rather than the local-bond side) and routes to the [[banking/INDEX|banking-domain]] entry on [[banking/regional-bank-consolidation-pattern|regional bank consolidation pattern]] (since regional banks hold material local-bond exposure), the [[money-market/INDEX|money-market index]] page [[money-market/jgb-repo-market-japan|JGB repo market]] (local bonds and JFM bonds serve as collateral), [[money-market/japan-money-market|Japan money market]], and the broader [[finance/INDEX|finance index]] route through [[finance/japan-listed-financial-groups-investable-universe|Japanese listed financial groups]] for institutional-holder context.
...
- **JFM dependence varies sharply.** Larger prefectures and designated cities use [[policy-finance/japan-finance-organization-municipalities|JFM]] modestly; smaller prefectures use it materially; most ordinary-city / town / village borrowers rely heavily on JFM and FILP for long-tenor lending.
...
- **Issuer category.** 都 (prefecture-equivalent special-administrative unit). One of only 47 prefecture-equivalent issuers but structurally distinct — see [[policy-finance/tokyo-metropolitan-bond|Tokyo Metropolitan Bond]] page for the dedicated treatment.
...
- **JFM reliance.** Low. Tokyo Metropolis has open market access and uses [[policy-finance/japan-finance-organization-municipalities|JFM]] proportionately less than smaller issuers.
...
- **JFM reliance.** Moderate. Large prefectures still draw on [[policy-finance/japan-finance-organization-municipalities|JFM]] lending for public-enterprise (water, sewerage, urban transit) and specific infrastructure lanes.
...
- **JFM reliance.** High to moderate. Smaller prefectures rely materially on [[policy-finance/japan-finance-organization-municipalities|JFM]] for long-tenor low-cost lending against local-government bond obligations.
...
- **JFM reliance.** Moderate — designated cities draw on [[policy-finance/japan-finance-organization-municipalities|JFM]] for urban-public-enterprise lending (water / sewerage / transit) but have direct public-offering access.
...
- **JFM reliance.** High to very high. Small municipalities rely heavily on [[policy-finance/japan-finance-organization-municipalities|JFM]] for long-tenor low-cost lending — this is JFM's structural reason for existence.
...
## Issuer Tier 6 — Special districts / public-enterprise authorities / [[policy-finance/japan-finance-organization-municipalities|JFM]]

- **Issuer category.** Includes (a) the joint local-government corporation [[policy-finance/japan-finance-organization-municipalities|JFM]] (地方公共団体金融機構), which is **not** a local government but the public-credit institution lending to local governments — JFM bonds are issued by JFM itself, not by any single local government; (b) the joint-issuance pool (共同発行市場公募地方債) where multiple local governments pool issuance under joint-and-several liability; (c) public-enterprise authorities for water / sewerage / transit / hospital / port operations.
- **JFM bonds.** Issued by the joint local-government corporation [[policy-finance/japan-finance-organization-municipalities|JFM]]; backed by the joint local-government support and statutory standing; **no explicit national-government guarantee**; market access AAA-equivalent.
- **Joint local-government bonds (共同発行市場公募地方債).** Multiple local governments pool issuance; jointly-and-severally liable; mechanism designed to give smaller issuers pooled-scale market access; coordinated by [[policy-finance/japan-local-bond-association|Japan Local Government Bond Association]].
...
Multiple local governments pool issuance under joint-and-several liability for scale, liquidity, and cost reduction. Coordinated by [[policy-finance/japan-local-bond-association|Japan Local Government Bond Association]]. Designed structurally for mid-sized prefectures and smaller designated cities that lack scale for cost-efficient standalone direct public offering. Issued in benchmark-size tranches; secondary-market liquidity good; spread to JGB modestly wider than top-tier named-issuer benchmarks.

### Channel 3 — Bank-underwritten / private placement (銀行等引受 / 私募債)

Direct bank lending or private-placement bonds underwritten primarily by [[banking/regional-bank-consolidation-pattern|regional banks]] and shinkin. Available to all issuer tiers but structurally important for mid- and small-prefecture issuers, ordinary cities, towns, villages. Pricing reflects bilateral negotiation; secondary-market liquidity essentially none. Investor base is the originating bank and a small set of relationship financial institutions.

### Channel 4 — [[policy-finance/japan-finance-organization-municipalities|JFM]] lending

The joint local-government corporation [[policy-finance/japan-finance-organization-municipalities|JFM]] lends against local-government obligations using funding raised by JFM's own bond issuance (JFM bonds in domestic and international markets). Structurally important for all tiers but especially for ordinary cities, towns, and villages that cannot tap public-offering markets efficiently. JFM's value proposition is **long tenor (20–30 years) + low cost + scale** — none of which any single small municipality can achieve standalone. The borrower-side pricing pass-through reflects JFM's own AAA-equivalent bond-market spread plus a thin spread for JFM's operating costs.
...
1. **Issuer type.** Tokyo Metropolis / 都道府県 / 政令指定都市 / 一般市町村 / joint issuance pool / [[policy-finance/japan-finance-organization-municipalities|JFM]] / public-enterprise — first axis controls almost every other field.
2. **Use of proceeds.** Infrastructure / public enterprise (water, sewerage, transit, hospital, port, gas, electricity) / refinancing / disaster recovery / other statutorily-permitted purposes. Local Finance Act constraint.
3. **Revenue base.** Local taxes + 地方交付税 (LAT) + national treasury disbursements + fees and charges. LAT status (不交付団体 vs receiving) is a critical credit lens.
4. **Fiscal-soundness indicators.** Real debt service ratio (実質公債費比率), future-burden ratio (将来負担比率), real-deficit ratio, consolidated real-deficit ratio, financial-capability index (財政力指数). Statutory thresholds trigger corrective regimes (財政健全化団体 / 財政再生団体).
5. **Market access.** Direct public-offering / joint-issuance / JFM-dependent / FILP-dependent / bank-underwritten-dependent. Channel mix determines effective funding cost and the role of public-credit institutions.
...
The investor-base concentration in domestic institutional holders, plus the demographic / tax-base structure of the Japanese local-government sector, means that local-bond market dynamics are closely coupled to BoJ monetary policy, JGB market dynamics, and [[money-market/japan-money-market|Japanese money market]] conditions — see [[money-market/jgb-repo-market-japan|JGB repo market]] for the collateral side.

## How to read this matrix

This matrix is a public-surface tool. It does not provide investment recommendations, does not estimate issuer-specific credit risk, and does not predict spread movements. It exists so that a [[policy-finance/local-government-bond-market|local government bond market]] reference can be classified consistently by issuer tier and channel before the deal / portfolio / investor question gets asked.

When reading any single local-government bond reference:

1. Start with the **issuer category** column — that determines almost every other field. Tokyo Metropolis is structurally different from a 不交付団体 perspective; designated cities are different from ordinary cities; JFM bonds are not local-government bonds at all.
2. Check the **LAT status** column. 不交付団体 vs LAT-receiving status affects credit logic.
3. Check the **JFM / FILP / bank-underwritten share** columns. Channel mix determines effective funding cost and the role of public-credit institutions.
4. Use the **MIC role** column to read whether 協議 (consultation) or 許可 (authorization) regime applies — the regime is tighter for fiscally-stressed issuers.
5. Check the **secondary-market liquidity** and **yield-spread** columns together. Liquidity dries up faster than spread widens for non-benchmark issuers under stress.
...
- **Not [[policy-finance/japan-finance-organization-municipalities|JFM]] bonds.** JFM bonds are issued by the joint local-government corporation, not by any local government. They form a separate public-credit asset class backed by joint local-government support and statutory standing, not by any single issuer's tax base.
...
- **Disaster-recovery bonds.** Specific disaster-recovery bonds issued after East Japan (2011), Kumamoto (2016), West Japan (2018), Noto (2024) carry distinctive program logic — typically supported by national-government supplementary budget programs through LAT mechanism and through [[policy-finance/japan-finance-organization-municipalities|JFM]] disaster-recovery lending lanes.
...
- **Implicit-support assumption is fragile.** Investors price local bonds as if 地方交付税 guarantees servicing; the legal reality is more nuanced and a stressed issuer is not automatically rescued. The statutory fiscal-soundness regime exists precisely because the assumption needs constraint.
- **Demographic divergence.** Tax-base erosion in shrinking-population municipalities can outpace fiscal-equalization support over long horizons; the credit profile of small municipalities is structurally exposed to depopulation that does not exist at the prefecture-aggregate level.
- **Public-private boundary.** Public-offering local bonds compete with private regional-bank lending for the same issuers; cheap [[policy-finance/japan-finance-organization-municipalities|JFM]] funding can dampen private-sector pricing competition at the local-government-finance lane.
- **Liquidity vs spread asymmetry.** Liquidity in non-benchmark named-issuer bonds can dry up sharply under stress while spread to JGB benchmarks widens modestly — the spread metric understates execution risk.
- **Yield-spread comparisons are indicative.** The spread ranges referenced in this matrix are stable-market orders of magnitude, not precise quotations, and shift materially with market regime, BoJ policy stance, and individual-issuer credit events. Always check current market data before any execution decision.

## Open questions

- How do public-offering local-bond spreads vs JGBs behave under monetary-tightening conditions and post-YCC normalization?
- What share of local-government total debt rests on [[policy-finance/japan-finance-organization-municipalities|JFM]] vs FILP vs market funding vs bank lending, and how is the mix evolving across issuer tiers?
- Will labelled (green / sustainability / SDG) local-government bonds grow into a structural lane, or remain a marginal subset of total issuance?
- How will disaster-recovery bonds (Tohoku 2011, Kumamoto 2016, Noto 2024 cohort) compare in pricing to ordinary refinancing bonds over their amortisation schedules?
- How will demographic decline pressure the small-municipality tier's reliance on JFM and FILP through the late 2020s and into the 2030s?
- Will foreign-investor participation expand beyond Tokyo Metropolitan Bond and JFM bonds into wider named-prefecture and designated-city issuance, or remain concentrated?
- How will the 不交付団体 set evolve over time — is Tokyo Metropolis structurally protected, or is its long-run demographic exposure greater than commonly assumed?
