...
confidence: likely
tags: [policy-finance, jfc, sme-finance, business-succession, startup-finance, safety-net, interest-subsidy]
status: active
sources:
  - "https://www.jfc.go.jp/n/finance/sme/"
  - "https://www.jfc.go.jp/n/findings/pdf/jfc2024.pdf"
  - "https://www.chusho.meti.go.jp/koukai/shingikai/"
  - "https://www.meti.go.jp/policy/jigyou_saisei/index.html"
  - "https://www.jfc.go.jp/n/finance/sme/m_keiei.html"
---
...
| Typical ticket | Tens of millions to several hundred million yen (上限 individual products go higher — e.g., 7.2 億円 普通貸付, 14.4 億円 for some 特別貸付 stacks) |
...
| **セーフティネット貸付** | 経営環境変化対応資金 (1 号) | Demand drop, sectoral shock | Standard SN tenor / ceiling | NEXI / megabank refinance |
| **セーフティネット貸付** | 金融環境変化対応資金 (2 号) | Bank-side credit contraction | SN tenor / ceiling | 信用保証協会 緊急保証 |
| **セーフティネット貸付** | 取引企業倒産対応資金 (3 号) | Chain-bankruptcy exposure | SN tenor / ceiling | 経営セーフティ共済 |
| **マル経融資** (国民生活事業) | 小規模事業者経営改善資金 | Working capital for small operators recommended by 商工会議所 / 商工会 | Up to 2,000 万円, 無担保無保証人 | Pure private microfinance gap |
| **共済関連** | 小規模企業共済 contract loans | Liquidity against accumulated 共済 reserves | Tied to 共済 balance | 中退共 / 退職金制度 |
| **共済関連** | 経営セーフティ共済 (倒産防止共済) loans | Liquidity against 共済 balance after chain-bankruptcy event | Tied to 共済 balance | 取引信用保険 |
...
| Crisis surge capacity | Very high via supplementary-budget 利子補給 | High (operates ゼロゼロ-style schemes in some episodes) | Significant via cooperative deposit funding | Very high via emergency-guarantee schemes | Limited absent policy backing |
...
- **Crisis loan tail risk.** The pandemic-era 実質無利子無担保 vintage matures and amortises through 2024–2027. Default rates on this vintage are a live policy-finance risk, and the JFC SME book absorbs a share of losses directly (rather than through a guarantee subrogation channel as the bank-side ゼロゼロ vintage does).
- **Crowding out vs filling the gap.** The 民間補完 doctrine is contested. Some 地銀 / 信金 voices have long complained that JFC SME prices below private rates on policy-overlaid products, taking the highest-quality risk and leaving private banks the rest. Defenders counter that without JFC, the relevant SME borrowers either go unfunded or are funded only after acute distress.
- **Subsidy delivery channel design.** Channeling cheap credit through 利子補給 keeps JFC's balance sheet clean but pushes contingent fiscal cost onto supplementary-budget appropriations, making the true policy cost less visible than if it were booked as a guarantee or grant.
- **Branch-network overlap with the 国民生活事業.** Two parallel branch networks for related SME borrowers is operationally expensive; periodic policy reviews have asked whether deeper integration of the SME and 国民生活 divisions would generate efficiency. Pushback has historically been strong from the predecessor-institution staff cultures.
- **Succession lever vs market.** JFC SME succession lending is one tool among several (private succession funds, M&A platforms, 引継ぎ支援センター matching); how much of the 2025 問題 demographic transition the public-finance lane actually absorbs versus the private market is open to debate.
