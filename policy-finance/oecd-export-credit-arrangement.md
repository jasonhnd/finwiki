...
sources:
  ...
  - "https://www.berneunion.org/Articles/Details/757"
---
...
This entry sits under [[policy-finance/INDEX|policy-finance index]] as the international rule-book that constrains Japan's official export credit and investment support stack. Read it against [[policy-finance/nexi|NEXI]] for the Japanese insurance institution constrained by Arrangement minimum premia / tenor caps; with [[policy-finance/nexi-export-credit-insurance-products|NEXI export-credit insurance products]] for product-side detail on Arrangement-compliant cover; with [[financial-regulators/jbic|国際協力銀行 (JBIC)]] for the Japanese direct lender constrained by Arrangement-compliant lending terms; with [[policy-finance/jbic-overseas-investment-underwriting-process|JBIC overseas-investment underwriting process]] for the lender-side flow operating within Arrangement ceilings; with [[policy-finance/jogmec|JOGMEC]] for upstream equity activity which sits **outside** Arrangement scope (equity is not export credit); with [[policy-finance/jogmec-equity-and-offtake-mechanics|JOGMEC equity and offtake mechanics]] for the upstream-finance leg that often precedes Arrangement-disciplined downstream financing; with [[policy-finance/jica|JICA]] for the ODA-grade lane that is explicitly **outside** Arrangement scope; with [[policy-finance/japan-policy-finance-system|Japan policy finance system]] for the wider toolkit; with [[policy-finance/japan-policy-finance-institution-mandate-matrix|Japan policy-finance institution mandate matrix]] for the nine-institution comparison; with [[policy-finance/japan-project-finance-stack-diagram|Japan project finance stack diagram]] for layered project-finance stack visualization; with [[policy-finance/japan-eximbank-history|Japan Eximbank history]] for the institutional history showing how Japan's ECA framework evolved alongside the Arrangement; and with [[trade/jetro-vs-nexi-vs-jbic-comparison|JETRO vs NEXI vs JBIC]] for the trade-promotion / insurance / financing three-pillar comparison.
...
| Legal status | Gentleman's Agreement among participants (politically binding, not legally binding); enforced through notification, common-line-derogation review, and peer transparency rather than dispute settlement |
