...
aliases:
  - "Aichi Credit Guarantee Corporation"
  - "Aichi Pref CGC"
  - "Aichi CGC"
  - "愛知県信用保証協会"
  - "愛知信用保証協会"
...
confidence: likely
tags: [policy-finance, credit-guarantee, prefecture-cgc, sme-finance, aichi]
status: active
sources:
...
| Dimension | Aichi CGC | [[policy-finance/tokyo-credit-guarantee-corp|Tokyo CGC]] | [[policy-finance/osaka-credit-guarantee-corp|Osaka CGC]] |
|---|---|---|---|
| Dominant industry mix | Automotive supply chain (Toyota-anchored) | Services / retail / finance / IT / hospitality | Manufacturing / wholesale / construction (Higashi-Osaka belt) |
| Concentration risk anchor | Single OEM concentration (Toyota family) | Diversified urban services | Diffuse mid-sized manufacturers |
| Megabank counterparty mix | MUFG dominance (legacy Tokai Bank roots) | All three megabank groups roughly comparable | SMFG dominance (Sumitomo Osaka roots) |
| Distinct product use | 経営革新保証 for EV-transition pivots | 創業保証 high in metropolitan startup belt | 事業承継保証 heavy in succession M&A |
| Crisis sensitivity | Toyota production cycles + global auto demand | Service / hospitality cycles | Manufacturing capex + global trade cycles |
