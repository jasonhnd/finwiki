...
aliases:
  ...
  - "JBIC OIL underwriting flow"
  - "JBIC overseas investment loan"
  - "JBIC 海外投融資"
  - "JBIC 特別業務勘定 underwriting"
  - "JBIC special operations underwriting"
  - "JBIC 審査プロセス"
...
sources:
  - "https://www.jbic.go.jp/en/efforts/economic/financial.html"
  - "https://www.jbic.go.jp/en/business-areas/finance/investment.html"
  - "https://www.jbic.go.jp/en/business-areas/finance/special_operations.html"
  - "https://www.jbic.go.jp/en/efforts/environment/guideline/"
...
- **Outbound Japanese M&A.** Mid-to-large Japanese cross-border acquisitions where a JBIC OIL slice complements a megabank syndicated acquisition tranche — connecting to the structure described in [[finance/japan-acquisition-finance|Japan acquisition finance]] but with the JBIC slice carrying a policy-aligned ticket.
...
- Country-risk classification using JBIC's internal country grading aligned with [[policy-finance/oecd-export-credit-arrangement|OECD Arrangement]] country-risk classification (Country Risk Classification 0–7).
...
- **Lenders' insurance broker** — bind structure including [[policy-finance/nexi|NEXI]] cover and any private political-risk insurance overlay.
...
For pure private outbound-acquisition syndicates without ECA involvement, the same megabanks run a different syndication geometry — described in [[finance/japan-acquisition-finance|Japan acquisition finance]]. The JBIC-anchored stack is structurally distinct from the pure-commercial stack despite using the same agent banks.
...
1. **Conditions-precedent (CP) management.** Final CP satisfaction prior to first drawdown, in coordination with the agent bank.
2. **Drawdown management.** Pro-rata drawdowns alongside NEXI-covered commercial tranches and sponsor equity; JBIC's drawdown discipline often aligns with construction-milestone certification by the lenders' technical advisor.
3. **Covenant monitoring.** Project DSCR, market-condition tests, sponsor-support obligations, environmental and social compliance per the JBIC Guidelines.
4. **Reliability test management.** At COD (commercial operation date), the project must pass lender-reliability testing before switching from sponsor-support undertakings to pure project cash-flow service.
5. **Restructuring management.** On stress (cost overrun, market downturn, force majeure events including security incidents), restructuring is coordinated across the common-terms creditor group, with NEXI claim handling in parallel where the commercial tranche is covered.
