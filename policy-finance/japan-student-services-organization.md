...
sources:
  ...
  - "https://www.jasso.go.jp/about/disclosure/index.html"
  - "https://www.studyinjapan.go.jp/en/about/outline.html"
  - "https://www.mext.go.jp/a_menu/koutou/shougakukin/index.htm"
  - "https://www.jasso.go.jp/shogakukin/about/shurui/index.html"
---
...
- **Does not**: set Japanese higher-education tuition or admission policy (that is MEXT directly + individual universities); lend to universities for capital projects (that is private-bank or 私立大学等経常費補助金 routes); operate international development education aid (that is [[policy-finance/jica|JICA]]); deliver Japanese-corporate education-related finance (that is private / JFC 教育一般貸付).
...
- [[policy-finance/jfc-kokumin-life-finance-division|JFC 国民生活事業]] — the JFC division that operates household-education loans (借入人 = parent / guardian); the closest operating-mechanics peer in the mainland JFC structure.
