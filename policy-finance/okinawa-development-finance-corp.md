...
sources:
  ...
  - "https://www.okinawakouko.go.jp/disclo/"
  - "https://www.cao.go.jp/okinawa/"
...
ODFC does not currently have a dedicated operating-mechanics sibling page in FinWiki (unlike JFC, which has [[policy-finance/jfc-sme-division-operating-model|JFC SME Division operating model]] and the AFF / Kokumin sister pages). The closest comparison anchors are:

- [[policy-finance/jfc-sme-division-operating-model|JFC SME Division]] — the operating model for the SME-lending lane that ODFC operates in its consolidated form for Okinawa.
- [[policy-finance/jfc-agriculture-forestry-fisheries-division|JFC AFF Division]] — the agriculture-forestry-fisheries lane.
- [[policy-finance/jfc-kokumin-life-finance-division|JFC 国民生活事業]] — the micro-business / household lane.
