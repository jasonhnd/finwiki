...
entity_edges:
  - relation: subsidiary_of
    target: non-life-insurers/tokio-marine
    evidence: official_profile
    source: https://www.tokiomarine-nichido.co.jp/
    as_of: 2026-06-22
    confidence: likely
  - relation: regulated_by
    target: financial-regulators/fsa
    evidence: official_registry
    source: https://www.fsa.go.jp/menkyo/menkyoj/songai.pdf
    as_of: 2026-06-22
    confidence: likely
sources:
...
This entry sits under [[non-life-insurers/INDEX|non-life-insurers INDEX]]. Read it against [[non-life-insurers/tokio-marine-direct|東京海上ダイレクト損害保険]] for peer / contrast context and [[insurance/INDEX|insurance index]] for the broader system / regulatory boundary.
...
東京海上日動 is the Japan non-life core of Tokio Marine group: auto, fire, liability, marine, commercial risk, accident, and specialty lines connect to agency distribution and corporate-risk relationships. The group page covers holding-company strategy; this page anchors the actual licensed insurer.
