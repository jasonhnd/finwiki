...
aliases: ["SOMPOダイレクト", "SOMPO Direct", "SOMPO Direct Insurance", "ＳＯＭＰＯダイレクト損害保険株式会社", "セゾン自動車火災"]
...
confidence: likely
tags: [JapanFG, insurance, non-life-insurance, direct-insurance, sompo, operating-company]
status: active
sources:
...
This entry sits under [[non-life-insurers/INDEX|non-life-insurers INDEX]]. Read it against [[non-life-insurers/sompo-japan-insurance|損害保険ジャパン]] for peer / contrast context and [[insurance/INDEX|insurance index]] for the broader system / regulatory boundary.
...
- Captures SOMPO's direct-channel non-life operating company.
- Complements the existing [[insurance/saison-automobile-fire]] concept page.
...
- SOMPOダイレクト official company profile.
