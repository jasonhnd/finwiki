...
Life-insurer groups can hold non-life entities to support employee benefits, group insurance, affinity products, and complementary protection products. 明治安田損保 is a useful example because the parent group's core identity remains mutual life insurance. 同様の life-group non-life arm として [[non-life-insurers/dai-ichi-ipet-insurance|第一アイペット損害保険]] (第一生命グループ) と比較できる。Capital / solvency framework comparison は [[insurance/global-solvency-framework-comparison-matrix]] を参照。
