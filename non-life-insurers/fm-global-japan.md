...
aliases:
  - "FM Global Japan"
  - "Factory Mutual Japan"
  - "FM Insurance Company Limited Japan Branch"
  - "FMグローバル"
  - "FMインシュアランス"
...
confidence: likely
tags: [JapanFG, insurance, non-life-insurance, foreign-insurer, industrial-property, mutual-insurer, public-source]
status: active
sources:
  - "FSA non-life insurer list: https://www.fsa.go.jp/menkyo/menkyoj/songai.xlsx"
  - "FM Global official: https://www.fmglobal.com/about-us/our-locations/japan"
  - "FM Global Annual Report (公開版)"
---
...
This entry sits under [[non-life-insurers/INDEX|non-life-insurers INDEX]]. Read it against [[non-life-insurers/lloyd-japan|Lloyd's Japan]] and [[non-life-insurers/chubb-insurance-japan|Chubb Insurance Japan]] for foreign-commercial-insurer peer context, and [[insurance/INDEX|insurance index]] for the broader Japan non-life market system / regulatory boundary.
...
- **Single-carrier capacity**: For very large property programs, FM Global typically writes 100% capacity rather than participating in subscription placements (contrasted with [[non-life-insurers/lloyd-japan|Lloyd's Japan]] syndicate placements).
...
This positions FM Global Japan as a niche but high-profile player alongside the domestic [[insurance/japan-nonlife-big-three|non-life big three]] for large industrial property risk, comparable internationally with mutuals discussed in [[insurance/mutual-vs-stock-life-insurer|mutual vs. stock insurer]]. Solvency framework differences across mutuals and stock companies are summarized in [[insurance/global-solvency-framework-comparison-matrix|global solvency framework comparison matrix]].
...
> [!info] 校核状态
> confidence: **likely** (FSA non-life insurer list + FM Global official Japan office page + public Annual Report based public information only, 2026-05-24 校核). Branch-level Japan financials are not separately publicly disclosed; group-level mutual financials are the primary public source. Sector concentration and earthquake accumulation are not granularly reported at the Japan branch level.
