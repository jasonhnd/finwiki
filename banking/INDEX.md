...
`banking/` contains **12 entries** about Japanese net banks, BaaS, quick deposit, cooperative banking, regional bank structure, and foreign-bank retreat patterns. P4 has now promoted the full banking domain: the net-bank / BaaS cluster plus [[banking/cooperative-banking-japan|cooperative banking]], [[banking/foreign-bank-japan-retreat|foreign-bank Japan retreat]], [[banking/post-megabank-positioning|post-megabank positioning]], and [[banking/regional-bank-consolidation-pattern|regional bank consolidation]].
