...
confidence: likely
tags: [banking, net-bank, rakuten, digital-bank]
status: active
sources:
...
- **Banking model**: 店舗前提ではなく、オンライン口座・デビット・口座振替・証券連携を主導線にするネット銀行。
- **Ecosystem hook**: 楽天証券との Money Bridge、楽天市場のポイント施策、楽天 Pay との口座連携が、預金獲得と日常利用を押し上げる。
