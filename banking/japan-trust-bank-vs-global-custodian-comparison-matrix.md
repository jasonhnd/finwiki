...
aliases:
  ...
  - "Japan custody comparison matrix"
  - "信託銀行 vs グローバルカストディアン matrix"
  - "trust bank vs global custodian Japan"
domain: "banking"
created: 2026-05-24
...
confidence: likely
tags: [banking, trust-bank, custody, global-custodian, asset-administration, securities-settlement, jasdec, jscc, comparison]
status: active
sources:
...
This page compares what can be verified about Japanese trust banks and global custodians operating in Japan. It does not rank pricing power, infer customer mandates, or assume market connectivity from a group brand. Legal-entity status comes from FSA registers; business scope from each entity's official materials; infrastructure participation from the current operator lists; and scale metrics from dated disclosures with the issuer's definitions preserved.
...
| Entity | Public category used here | Licence / legal-entity evidence | Business-scope evidence | Scale-data boundary |
|---|---|---|---|---|
| MUFG Trust | Full-service Japanese trust bank | Current FSA bank and trust-business registers | Official company / service pages | Use dated entity or MUFG disclosure; preserve metric definition |
| Mizuho Trust | Full-service Japanese trust bank | Current FSA bank and trust-business registers | Official company / service pages | Use dated entity or Mizuho FG disclosure |
| SMTB | Full-service Japanese trust bank | Current FSA bank and trust-business registers | Official company / service pages | Use dated entity or SMT Holdings disclosure |
| SMBC Trust | Japanese trust bank | Current FSA bank and trust-business registers | Official company / service pages | Use dated entity or group disclosure |
| Nomura Trust | Japanese trust bank | Current FSA bank and trust-business registers | Official company / service pages | Do not infer group-internal mandates |
| Norinchukin Trust | Japanese trust bank | Current FSA bank and trust-business registers | Official company / service pages | Do not infer JA-system mandates without a named source |
| MTBJ | Asset-administration specialist | Current FSA register and official profile | MTBJ business overview | Dated MTBJ disclosure; do not mix trust assets and other AUC definitions |
| CBJ | Asset-administration specialist | Current FSA register and official profile | CBJ business overview | Dated CBJ disclosure; preserve the disclosed perimeter |
| SBI Shinsei Trust | Japanese trust bank | Current FSA bank and trust-business registers | Official company / service pages | Use entity disclosure only |
| JSF Trust | Japanese trust bank | Current FSA bank and trust-business registers | Official company / service pages | Use entity disclosure only |

Sources: ^[FSA licensed-bank register, https://www.fsa.go.jp/menkyo/menkyoj/ginkou.xlsx; FSA trust-business financial-institution list, https://www.fsa.go.jp/menkyo/menkyoj/kenei.pdf; Trust Companies Association of Japan, https://www.shintaku-kyokai.or.jp/trust/trustbanks/; MTBJ and CBJ official pages listed in the frontmatter.]

## Comparison Matrix (global custodians in Japan)

| Group | Japan legal-entity check | Official service evidence | Parent metric | Japan-only boundary |
|---|---|---|---|---|
| BNY | FSA foreign-bank / bank / trust-business registers as applicable | BNY Japan official disclosure | Parent AUC/A from dated investor results | Parent total is not Japan-only AUC |
| State Street | FSA registers as applicable | State Street Japan official pages | Parent AUC/A from dated investor results | Parent total is not Japan-only AUC |
| JPMorgan | FSA registers as applicable | JPMorgan Securities Services official pages | Parent Securities Services AUC from dated results | Parent total is not Japan-only AUC |
| Citi | FSA foreign-bank and securities registers as applicable | Citi Securities Services official pages | Parent Securities Services AUC/A from dated results | Parent total is not Japan-only AUC |

Sources: ^[FSA registers; BNY, State Street, JPMorgan, and Citigroup official Japan / securities-services and investor-relations publications listed in the frontmatter.]

## Cross-camp matrix view

| Dimension | Japanese trust banks | Global custodians (Japan) |
|---|---|---|
| Legal entity | Verify each Japanese bank or trust bank | Verify each Japan branch, bank, trust bank, or securities company separately |
| Business scope | Entity official pages | Japan-entity and parent securities-services pages |
| Settlement participation | Current JASDEC / JSCC / BoJ participant data by legal entity | Same; do not infer from the parent group |
| AUC / AuA | Dated entity or group disclosure with definition | Parent metric must be labelled as parent-wide, not Japan-only |
| Customer / mandate | Named primary source required | Named primary source required |
| Fee or pricing power | Contract or disclosed tariff required | Contract or disclosed tariff required |
| Nominee row | Does not identify the underlying beneficiary by itself | Does not identify the underlying beneficiary by itself |

Sources: ^[FSA, JASDEC, JSCC, and BoJ official registers / system materials; official entity and investor-relations publications listed in the frontmatter.]

## Master Trust vs Custody Bank of Japan — 2020 統合の意味
...
|---|---|
| Market share or concentration | Same-perimeter market total and entity figures for the same date |
| Pricing power | Published tariff, contract evidence, or issuer disclosure expressly supporting the conclusion |
| Direct infrastructure access | Current participant list naming the relevant legal entity |
| Customer or mandate | Dated announcement, statutory filing, or customer disclosure naming the relationship |
| Cross-border routing | Entity service documentation or mandate-specific disclosure |
| Regulatory capital comparison | Same-basis regulatory disclosure for the relevant legal entities |

Sources: ^[Official entity, regulator, and infrastructure publications listed in this entry.]
...
2. Identify the exact legal entity and licence category in current FSA registers before describing its regulated role.
3. For global groups, distinguish the Japan branch, trust bank, securities company, and asset manager; do not combine their permissions.
4. Verify JASDEC, JSCC, BoJ, and ICSD connectivity from current participant or entity disclosures rather than group branding.
