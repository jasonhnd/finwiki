...
aliases:
  - "banking/sony-bank"
  - "Sony Bank operating profile"
  - "ソニー銀行 operating profile"
  - "Sony Bank Inc."
  - "MoneyKit"
domain: banking
created: 2026-05-25
...
| Ultimate parent | Sony Group Corporation (TSE 6758) — Sony FG was re-acquired in 2020 TOB; Sony FG IPO is a 2025–2026 stated direction ^[ambiguous] |
| HQ | Tokyo |
...
Sony Group Corporation (TSE 6758, ultimate parent)
  └── Sony Financial Group (re-consolidated 2020 via TOB; separate IPO direction 2025–2026) ^[ambiguous]
...
Sony FG was previously listed; in 2020 Sony Group launched a TOB and took Sony FG private. The 2025–2026 direction publicly contemplated by Sony Group involves re-listing Sony FG as a separate vehicle, which would re-introduce a public-market reference for Sony Bank's stake economics. ^[ambiguous] Until that re-listing closes, Sony Bank itself remains a non-listed bank operating company.
...
|---|---|
| Currency menu | 10+ foreign currencies (USD, EUR, GBP, AUD, NZD, CAD, CHF, HKD, SGD, ZAR, etc.) ^[ambiguous] |
...
Public Sony Bank disclosure (in the MoneyKit 「ディスクロージャー誌」 series) shows a multi-trillion-yen deposit base, growing customer count, and a meaningful mortgage book. Granular point-in-time KPIs (deposit balance, account count, mortgage outstanding, ROE) belong to the periodic disclosure cycle; this page tracks the shape of the franchise rather than running numbers. ^[ambiguous]
