---
title: "Japan net bank competition map"
aliases:
  - "Japan net bank competition"
  - "Japan digital bank competition map"
...
| Axis | What to collect | Why |
|---|---|---|
| Parent ecosystem | Commerce, payment, telecom, securities, trust bank, regional bank, or independent group | Explains customer acquisition and cross-sell cost. |
| Account scale | Date-stamped account count or customer base | Useful only if dated; account count can move quickly. |
| Deposit franchise | Deposit balance, salary account, settlement account, or promotional balance | Determines funding stability and primary-bank conversion. |
| Lending mix | Mortgage, card loan, personal loan, business loan, securities collateral, or no meaningful loan book | Drives ROA, credit risk, and capital use. |
...
[[banking/rakuten-bank|Rakuten Bank]], [[banking/paypay-bank|PayPay Bank]], and [[banking/au-jibun-bank|au Jibun Bank]] are ecosystem banks. Their public distribution surfaces include commerce, telecom, card, wallet, points, securities, and everyday payment behavior. Primary-account conversion fields include salary deposits, recurring payments, mortgages, cards, and high-frequency transfers.
...
1. Account-count metric and source date.
2. Parent-group, bank-only, account-only, or active-customer data category.
3. BaaS accounts and primary retail bank accounts where separately disclosed.
4. Deposit scale and lending profitability.
5. API / bank-agent category linked to [[banking/japan-baas-operating-models|BaaS operating models]] and [[payments/japan-bank-api-payment-agency-route|bank API payment agency route]].
6. Securities flows linked to [[securities/INDEX|securities index]] and quick-deposit routes.
...
- FSA: licensed bank list.
- Rakuten Group / Rakuten Bank public releases and bank disclosures.
- PayPay Bank company profile and PayPay ownership-related releases.
- au Jibun Bank performance / disclosure pages.
- SSNB company / NEOBANK pages.
- GMO Aozora Net Bank company pages.
- Sony Bank profile / disclosure pages.
- UI Bank company information.
