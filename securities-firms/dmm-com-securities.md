...
sources:
  ...
  - "https://kabu.dmm.com/company/"
  - "https://securities.dmm.com/service_policy/"
---
...
| FSA registration | 関東財務局長(金商)第1629号 |
| FIEA scope | 第一種・第二種 |
| Self-regulatory body | [[financial-regulators/jsda|JSDA]] / 金融先物取引業協会 |
| Core products | 株式 (DMM 株), 店頭FX (DMM FX), CFD |
| Namespace boundary | securities-firms page = securities / FX; exchanges page = crypto-asset operator |

## 2. Operating model

DMM.com証券は、DMM 株・DMM FX・CFD など retail trading services を提供する。FIEA operator としての registration と、crypto-asset operator としての registration が交差するため namespace 分離が重要。retail FX / CFD 市場では [[securities-firms/gmo-click-securities|GMOクリック証券]]・[[securities-firms/sbi-fx-trade|SBI FXトレード]]・[[securities-firms/traders-securities|トレイダーズ証券]]・[[securities-firms/saxo-bank-securities|サクソバンク証券]] などと比較対象になる。

## 3. Why this page matters

- 同じ法人が証券・FX・CFD・暗号資産周辺を横断するため、1 ページにまとめると規制論点が混ざる。securities-firms 側では FIEA / securities operator、exchanges 側では暗号資産交換業者として扱う。
