---
title: "[opinion] Japan CMBS and RMBS securitization market"
source_entry: real-estate-finance/japan-cmbs-rmbs-securitization.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — Japan CMBS and RMBS securitization market

> 出典エントリー: `real-estate-finance/japan-cmbs-rmbs-securitization.md`

## 推論 (from Historical arc)
...
## 推論 (from Rating-agency criteria for RMBS)
...
## 推論 (from Rating-agency criteria for CMBS)
