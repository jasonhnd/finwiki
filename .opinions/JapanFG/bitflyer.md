---
title: "[opinion] bitFlyer (株式会社ビットフライヤー / bitFlyer Holdings)"
source_entry: JapanFG/bitflyer.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — bitFlyer (株式会社ビットフライヤー / bitFlyer Holdings)

> 出典エントリー: `JapanFG/bitflyer.md`

## 推論 (from 主要取扱通貨（国内、年により変動）)
