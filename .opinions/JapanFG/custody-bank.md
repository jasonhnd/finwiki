---
title: "[opinion] 日本カストディ銀行 (CBJ)"
source_entry: JapanFG/custody-bank.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — 日本カストディ銀行 (CBJ)

> 出典エントリー: `JapanFG/custody-bank.md`
...
## 主観/非公開推測の移設（本文の ^[ambiguous] から）

- （統合シナジーより）統合に伴うシステム刷新は数年継続案件 — 具体時期は IR 非公開で、検証可能な出典なし
