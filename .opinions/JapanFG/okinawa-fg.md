...
- 「[[regional-banks/ryukyu-bank]] との均衡関係」: 県指定金融機関を隔年受託 = 両行とも県内 No.1 を独占できない構造的制約 ^[extracted]
...
- 「県内 3 行統合シナリオ」: [[regional-banks/okinawa-kaiho-bank|沖縄海邦銀行]]（No.3）の経営体力次第で県内再編論が浮上しうるが、現状は均衡維持 ^[ambiguous]
...
- [[regional-banks/okinawa-kaiho-bank|沖縄海邦銀行]]（No.3）との将来的再編シナリオは? 県内 3 行 → 2 行体制への移行可能性
- 本土地銀との広域連携（[[regional-banks/kyushu-fg]]・九州地区地銀との沖縄案件共同組成）の動きは?
