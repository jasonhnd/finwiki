---
title: "[opinion] みずほ FG (Mizuho FG)"
source_entry: JapanFG/mizuho-fg.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — みずほ FG (Mizuho FG)

> 出典エントリー: `JapanFG/mizuho-fg.md`
...
## 出所不明・誤認の主張（本文 ^[ambiguous] から分離）

- **「PayPay 銀行への戦略出資（みずほ参画）」**: 本文に「PayPay 銀行（旧ジャパンネット銀行）への戦略出資（SoftBank / Yahoo Japan 主導の中、みずほも資本参加）」とあったが、検証可能な公開情報では**みずほ証券の出資先は PayPay 銀行ではなく PayPay 証券（旧 One Tap BUY、約 24.8%）**であり、PayPay 銀行（SoftBank / LINEヤフー / PayPay 系）へのみずほの資本参加を裏付ける出典は確認できなかった。誤認の可能性が高いため隔離。本文は PayPay 証券への出資（確認済）に訂正済。出典: 日本経済新聞「PayPay証券を連結子会社に PayPay、出資比率75%へ」(2025-02), https://www.nikkei.com/article/DGXZQOUB102E20Q5A210C2000000/ ／ PayPay「Acquisition of Shares in PayPay Bank by PayPay Corporation」(2025-04-14), https://about.paypay.ne.jp/en/pr/20250414/01/
- **「サイバーエージェント関連合弁（CA Mobile 他）」**: 本文に合弁会社「CA Mobile」を挙げていたが、検証可能な事実はみずほ銀行・サイバーエージェント・フライウィールによる 2024-01-26 の**マーケティングプラットフォーム事業の戦略的業務提携**（合弁ではなく業務提携）であり、「CA Mobile」を当該みずほ協業の合弁会社とする裏付けは確認できなかった（CA Mobile は別個のサイバーエージェント系企業）。誤認の可能性が高いため隔離。本文は確認済の業務提携内容に訂正済。出典: 日本経済新聞「みずほ銀行が広告ビジネス、サイバーエージェントと提携」(2024-01), https://www.nikkei.com/article/DGXZQOUB256360V20C24A1000000/
