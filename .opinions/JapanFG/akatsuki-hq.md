---
title: "[opinion] あかつき本社 (Akatsuki Honsha)"
source_entry: JapanFG/akatsuki-hq.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — あかつき本社 (Akatsuki Honsha)

> 出典エントリー: `JapanFG/akatsuki-hq.md`
...
- 不動産・PE 等のノンコア事業比率調整 ^[ambiguous]
  - 「不動産・PE をノンコアとして比率調整する」という中計戦略の主張だが、出典で裏付けられない。むしろ公開セグメント情報では不動産関連事業が売上の約 72.4%・セグメント利益の約 63.2% を占める中核事業であり、当該期に高齢者施設開発等で拡大（増収増益）しており、「ノンコア縮小」という characterization と矛盾する。検証不能かつ反証される記述のため客観本文から分離。
