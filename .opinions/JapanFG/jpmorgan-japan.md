---
title: "[opinion] JP モルガン日本 (JPMorgan Japan)"
source_entry: JapanFG/jpmorgan-japan.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — JP モルガン日本 (JPMorgan Japan)

> 出典エントリー: `JapanFG/jpmorgan-japan.md`

## 推論 (from 2000 年合弁構想（実現せず）)

- **2000 年**：大和銀行（後 [[megabanks/ndfg]] りそな HD の前身の一つ）+ JP モルガン 合弁案検討 → 実現せず ^[inferred]

## 推論 (from 2014 年以降：国際 M&A アドバイザリー)
...
- 邦銀メガ（[[megabanks/mufg]] / [[megabanks/smfg]] / [[megabanks/mizuho-fg]]）の海外 IB 強化に対するカウンター戦略
