...
- 「1936-1945 戦時統合期: 一県一行政策下で宮城県内の銀行を吸収合併」— 具体的な合併先・時期を裏付ける公的出典を確認できず。Wikipedia が記載する沿革は 1932 の 3 行合併（七十七銀行・東北実業銀行・五城銀行）であり、戦時期の宮城県内銀行吸収という記述は出典未確認のため隔離。

## 未確認のブランディング記述（from 6. ブランディング・文化）

- 「コーポレートカラー: 地銀の中では伝統的な銀行カラー（紺・グリーン系）」— 一次出典による確認ができない主観的な色彩一般化のため隔離。
