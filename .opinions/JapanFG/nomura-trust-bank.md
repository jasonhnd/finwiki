---
title: "[opinion] 野村信託銀行 (Nomura Trust Bank)"
source_entry: JapanFG/nomura-trust-bank.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — 野村信託銀行 (Nomura Trust Bank)

> 出典エントリー: `JapanFG/nomura-trust-bank.md`
...
## 推論 (from 3. KPI 表（v1.0 公開ベース概算）^[inferred])

| 経常利益 | ¥数十億円規模 ^[inferred] | 信託フィー + 預貸スプレッド |
| 従業員数 | 数百名 ^[inferred] | 専門業務特化、店舗網最小限 |

## 推論 (from 4. 主要業務 — 証券グループ付随の信託機能)
