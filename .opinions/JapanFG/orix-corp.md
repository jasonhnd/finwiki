---
title: "[opinion] オリックス株式会社 (ORIX Corporation)"
source_entry: JapanFG/orix-corp.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — オリックス株式会社 (ORIX Corporation)

> 出典エントリー: `JapanFG/orix-corp.md`

## 推論 (from 1. 会社概要)

**機関設計**：指名委員会等設置会社（2003-06 移行、邦銀・大手金融で最早期の一社）^[inferred]

## 推論 (from 主要株主（2025-03-31 時点）^[extracted])

（メインバンク的安定株主は不在、純粋な機関投資家構成）^[inferred]

## 推論 (from 2. 事業セグメント・マップ（10 セグメント）)
