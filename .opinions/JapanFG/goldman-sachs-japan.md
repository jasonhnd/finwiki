---
title: "[opinion] ゴールドマン・サックス・ジャパン (Goldman Sachs Japan)"
source_entry: JapanFG/goldman-sachs-japan.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — ゴールドマン・サックス・ジャパン (Goldman Sachs Japan)

> 出典エントリー: `JapanFG/goldman-sachs-japan.md`
...
## 推論 (from 邦銀メガバンク系証券（IB リーグテーブル競合）)
...
- 日本企業 M&A 案件で邦銀系証券（[[megabanks/smfg]] / [[megabanks/mizuho-fg]] / 野村）と頻繁に共同主幹事 ^[inferred]
...
- 「リテール展開なし」観: モルガン・スタンレーが [[megabanks/mufg]] JV で日本リテール市場に間接的にアクセスする一方、GS は単独でホールセール特化 → 邦人富裕層・大衆富裕層市場機会の取り逃し ^[ambiguous]
...
- ソフトバンクグループの ARM Holdings 買収（2016、約 3.3 兆円、ファイナンシャル・アドバイザー）
- 日本企業の海外大型クロスボーダー M&A 案件で多数のアドバイザリー実績
- 日本企業のグローバル債券発行・サムライ債で主幹事多数

> 具体個別案件名は時期により公表 / 非公表が分かれるため、IR・Press Release 公開情報のみ参照。
