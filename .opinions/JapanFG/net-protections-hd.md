---
title: "[opinion] ネットプロテクションズHD (Net Protections HD)"
source_entry: JapanFG/net-protections-hd.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — ネットプロテクションズHD (Net Protections HD)

> 出典エントリー: `JapanFG/net-protections-hd.md`

## 推論 (from 1. 法人・ライセンス境界)

| 規制ルート | 主に **割賦販売法**（信用購入あっせん業）と債権譲渡前提の "後払い決済" 設計。METI Installment Sales Act registry に登録あり。FSA 監督下の資金移動業は採用していない。^[inferred] |

## 推論 (from 4. 規制・政策)

- **割賦販売法**: 信用購入あっせん業者として METI 監督下にあり、与信モデル・苦情処理・指定信用情報機関接続が継続論点。^[inferred]
- **2025〜 BNPL 規制議論**: 経産省 / 消費者庁の BNPL 過剰利用論点、AFTEE 進出先（台湾 / ベトナム）の地場 BNPL 規制動向も watch。^[inferred]
