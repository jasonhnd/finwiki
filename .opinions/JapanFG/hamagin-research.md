---
title: "[opinion] はまぎん総合研究所 (Hamagin Research Institute)"
source_entry: JapanFG/hamagin-research.md
type: opinion-quarantine
moved: 2026-05-29
note: 客観 wiki 本文から分離した主観的内容（推論 / Counterpoints / Open questions）。事実ではないため公開面・監査・計数から除外。将来の分析板块用に保留。
---

# 主観内容の隔離 — はまぎん総合研究所 (Hamagin Research Institute)

> 出典エントリー: `JapanFG/hamagin-research.md`
...
- 売上・従業員数・受託件数の最新規模は ([[regional-banks/concordia-fg]] セグメント情報で開示限定)
...
## 「関東 No.1 級」ランキング主張 — 出典なし (from TL;DR / KPI table / 強み)

> 地銀系シンクタンクとしては規模・知名度ともに上位 (関東 No.1 級) ^[ambiguous]
>
> 隔離理由: 「関東 No.1 級地銀系シンクタンク」という序列・優位性の主張は検証可能な一次資料・ランキング出典なし。Wikipedia「浜銀総合研究所」記事にも同種のランキング言明は存在しないことを確認 (2026-05-29 取得)。比較優位の定量的根拠を欠く主観的評価のため隔離。公式会社概要で確認できる事実 (設立 1988-07-21 / 資本金 1 億円 / 従業員 157 名 / 神奈川・首都圏地盤 / 横浜銀行グループ) は本文に保持。
