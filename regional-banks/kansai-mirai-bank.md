...
- **Supervision**: 銀行法のもとで金融庁 ([[financial-regulators/fsa|FSA]]) と近畿財務局が監督。自己資本比率規制（国内基準）等で健全性が規律される。
...
- **Consolidation context**: 関西の地銀再編・統合の一般文脈は [[banking/regional-bank-consolidation-pattern|regional-bank consolidation pattern]] を参照。
