...
sources:
  ...
  - "https://www.tomatobank.co.jp/about/summary.html"
  - "https://ja.wikipedia.org/wiki/トマト銀行"
---
...
This entry sits under [[regional-banks/INDEX|regional-banks INDEX]] (its domain route). Read it against [[regional-banks/chugoku-bank|中国銀行]] for the same-prefecture peer / contrast (Okayama first-regional bank vs second-regional bank), and against [[financial-regulators/fsa|the FSA]] plus [[banking/INDEX|banking]] for the supervisory / system boundary.
...
| Group boundary | Independent second-regional bank（独立系・岡山県唯一の第二地銀） |
| Lineage | 倉敷無尽 (1931) → 山陽相互銀行 → トマト銀行 (1989 普通銀行転換) |
| Home market | Okayama / Okayama City（岡山市本店） |
| Wiki role | Okayama second-regional-bank operating-company page |

## 2. Operating model

トマト銀行は、岡山県を中心に retail deposits, SME finance, local consumer banking, and regional relationship services を担う第二地方銀行。第一地銀の [[regional-banks/chugoku-bank|中国銀行]] が県内 primary regional bank anchor であるのに対し、トマト銀行は second-regional-bank exact-name anchor として整理する。隣県では [[regional-banks/tottori-bank|鳥取銀行]] や [[regional-banks/hiroshima-bank|広島銀行]] と中国地方 peer set を成す。Chugoku regional-bank consolidation context は [[banking/regional-bank-consolidation-pattern|地域銀行統合パターン]] を参照。
...
- Tomato Bank official company profile.
- トマト銀行 (Wikipedia): lineage 倉敷無尽 (1931) → 山陽相互銀行 → トマト銀行 (1989 ordinary-bank conversion); HQ Okayama City; Okayama's only second-regional bank.
