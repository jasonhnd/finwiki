...
sources:
  ...
  - "https://www.mof.go.jp/english/policy/jgbs/topics/index.html"
---
...
This entry sits under [[securities/INDEX|securities index]]. Read it against [[securities/japan-ipo-listing-disclosure-route|Japan IPO listing disclosure route]] for the structural / system / regulatory boundary and [[securities/japan-underwriting-market-structure|Japan underwriting market structure]] for peer / contrast context. This page records two large 2024-2025 listing cases used as case-study readings for the listing route.
...
- **Dividend-yield-focused retail demand**: utility-style infrastructure issuers attract dividend-yield-oriented domestic retail demand, often using [[securities/nisa-2024-flow|NISA growth quota]] allocations.
...
For 2024-2025 Growth-segment IPOs, the practical effect is that issuers must plan for post-listing market-cap maintenance, not just IPO-day pricing. Use [[securities/japan-ipo-listing-disclosure-route|listing disclosure route]] page for the structural rules.
...
For [[finance/japan-ib-league-table|IB league table]] purposes, confirm credited allocation against each issuer's registration statement and lead-manager announcement.

## Case Study Reading Method

For any FinWiki IPO case study:

1. Pin the issuer name, securities code, segment, listing approval date, and listing date from the JPX new-listings page.
2. Pull the securities-registration statement from EDINET for offering structure, lead-manager syndicate, and risk factors.
3. Read TDnet timely-disclosure announcements pre- and post-listing for governance and revisions.
4. Map the offering to one of the recurring structural types (privatization, carve-out, growth-tech IPO, founder-led IPO, etc.).
5. Verify any first-day pop or bookbuilding-range-revision figure against a primary or well-cited secondary source.
6. Avoid quoting specific yen figures unless the source citation is recorded.
