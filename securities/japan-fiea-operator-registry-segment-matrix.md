...
aliases:
  ...
  - "Japan FIBO registry segment matrix"
  - "金融商品取引業者 segment matrix"
  - "FIEA operator categories matrix"
  - "Type I II investment advisory segment matrix"
  - "FSA FIBO registry breakdown"
  - "日本 金商業者 segment matrix"
...
- **Investor protection asymmetry.** [[JapanFG/jiipf|JIPF]] coverage is structurally Type I; Type II / 投資助言・代理業 / 投資運用業 / Article 63 do not have the same protection floor. This asymmetry is one of the most important things for a retail investor to know about FIEA-segment classification.
