...
aliases:
  ...
  - "Japan large TOB MBO 2023-2026 comparison"
  - "Japan tender offer case matrix 2023-2026"
  - "公開買付け MBO 大型案件 2023-2026 マトリクス"
domain: securities
created: 2026-05-25
...
confidence: likely
tags: [securities, M&A, TOB, MBO, tender-offer, squeeze-out, fair-M&A, JFTC, special-committee, large-deal, 2023-2026, japan, matrix]
status: active
sources:
  - "https://www.fsa.go.jp/common/law/kaiji/20241001_guideline-tenderoffer.pdf"
  - "https://www.meti.go.jp/policy/economy/keiei_innovation/keieiryoku/fairma.html"
  - "https://www.jftc.go.jp/en/pressreleases/yearly-2024/index.html"
  - "https://www.jpx.co.jp/english/listing/disclosure/"
  - "https://global.toshiba/ww/ir.html"
  - "https://www.outsourcing.co.jp/en/ir/"
  - "https://www.sapporoholdings.jp/english/ir/"
  - "https://www.asahi-intecc.co.jp/en/ir/"
  - "https://www.yodogawasteel.co.jp/ir/"
  - "https://www.tokiomarinehd.com/en/ir/"
  - "https://www.itochu.co.jp/en/ir/"
  - "https://www.daiichisankyo.com/ir/"
---
...
Between 2023 and 2026 a sequence of large Japan TOB / MBO transactions (each over ¥100bn deal value, several over ¥1tn) repriced the **fair-M&A process expectations** for listed targets under [[finance/japan-tender-offer-process|Japan tender offer process]] and [[finance/japan-mbo-and-squeeze-out-process|Japan MBO and squeeze-out process]]. This matrix collects the major cases — Toshiba / JIP (2023, ~¥2tn), Outsourcing / Bain (2024), Sapporo Holdings (3D / activist-driven), Asahi Intec (special-situation), Yodogawa Steel, Tokio Marine subsidiary actions, Itochu / Descente follow-on, and the Daiichi Sankyo Espha-related restructuring — and compares them by target, acquirer, deal value, premium, offer mechanism, defense response, METI Fair M&A Guideline alignment, JFTC review path, special-committee role, and outcome. Use it as the public-source large-deal reference shelf for [[finance/japan-takeover-defense-poison-pill|takeover defense]] analysis and [[finance/japan-acquisition-finance|acquisition finance]] sizing.

## Wiki route

This page sits under [[securities/INDEX|securities index]] as the 2023-2026 large-deal TOB / MBO case-comparison surface. Peer securities pages: [[securities/japan-ipo-listing-disclosure-route|IPO listing disclosure route]] (TOB outcome ↔ post-deal re-IPO option), [[securities/japan-ipo-2024-2025-case-study-kioxia-tokyo-metro|Kioxia / Tokyo Metro IPO case]], [[securities/japan-margin-trading-and-securities-finance|margin trading]]. Process scaffolding: [[finance/japan-tender-offer-process|Japan tender offer process]], [[finance/japan-mbo-and-squeeze-out-process|Japan MBO and squeeze-out process]], [[finance/japan-takeover-defense-poison-pill|Japan takeover defense / poison pill]], [[finance/japan-large-shareholding-disclosure|Japan large shareholding disclosure]]. Process comparison: [[finance/japan-m-a-deal-process-comparison-matrix|Japan M&A deal process comparison matrix]]. Activist context: [[finance/japan-activist-investor-playbook|Japan activist investor playbook]], [[finance/japan-shareholder-proposal-and-agm-voting-route|Japan shareholder proposal AGM voting route]]. Financing context: [[finance/japan-acquisition-finance|Japan acquisition finance]], [[finance/japan-leveraged-buyout-economics|Japan LBO economics]], [[finance/japan-private-equity-fund-structure-matrix|Japan PE fund structure matrix]], [[finance/japan-private-equity-operating-model|Japan PE operating model]]. JFTC / antitrust: [[finance/jftc-merger-control-process|JFTC merger control process]]. Strategic restructuring overview: [[business/japan-listed-corp-strategic-restructuring-matrix|Japan listed corp strategic restructuring matrix]]. Cross-border M&A context: [[finance/cross-border-m-a-japan|cross-border M&A Japan]].
...
1. **METI Fair M&A Guidelines (2019 + 2023 amendments) bedded in across the cohort.** The fair-process expectations — special committee, fairness opinion, market check, MoM (majority-of-minority) consideration — moved from "good practice" to baseline expectation across this period. The cohort exposes how each deal fared against those expectations.
2. **Activist pressure intensified in Japan**, with multiple high-profile [[finance/japan-activist-investor-playbook|activist]] campaigns triggering or shaping TOB outcomes. Sapporo Holdings (3D), Outsourcing (pre-tender activist pressure), and other cases visibly carry an activist precursor.
3. **PE bidding capacity at scale matured.** Bain Capital, JIP, KKR, Carlyle, and other PE sponsors deployed multi-trillion-yen capacity into Japan TOB / MBO transactions in 2023-2026. The cohort documents the operational benchmark for [[finance/japan-acquisition-finance|acquisition finance]] at scale.
...
- **Toshiba ← Japan Industrial Partners (JIP) (2023)** — domestic PE-led TOB and squeeze-out resulting in delisting (~¥2tn). See [[corporate-strategy/toshiba-tob-squeeze-out-2023-2024-case|Toshiba TOB squeeze-out 2023-2024 case]].
...
| **Strategic / cross-border (foreign acquirer)** | Reference set across 2023-2026 includes multiple foreign-strategic cases | [[finance/cross-border-m-a-japan|Cross-border M&A]] dynamics apply; foreign-investment notifications add a regulatory step |
...
- **Active defense / [[finance/japan-takeover-defense-poison-pill|poison pill]]** — not central to the cohort above but the takeover-defense framework is the reference for hostile-tender scenarios.

### METI Fair M&A Guideline alignment

[[finance/japan-mbo-and-squeeze-out-process|Japan MBO and squeeze-out process]] documents the METI Fair Guideline expectations. The cohort largely aligns:
...
[[finance/jftc-merger-control-process|JFTC merger control process]] is invoked when the deal triggers notification thresholds:
...
- **Pattern**: Multi-bank LBO financing under [[finance/japan-acquisition-finance|Japan acquisition finance]]; full Fair Guideline process; squeeze-out and delisting.
- **Capital implications**: PE consortium structure with multiple LPs (often including strategic-corporate LPs, sovereign-wealth, and trust-bank-managed pools). See [[finance/japan-private-equity-fund-structure-matrix|Japan PE fund structure matrix]].

### Cluster 2 — Activist-driven (no tender, value reform pressure)

- **Anchor case**: Sapporo HD ← 3D Investment Partners.
- **Pattern**: Activist accumulates large minority position, engages management, files shareholder proposals via [[finance/japan-shareholder-proposal-and-agm-voting-route|AGM voting route]], proposes real-estate carve-out / capital return / strategy change.
...
1. Deal values cited are public-source approximations from press releases and tender offer statements at the time. Use the TOB filing on EDINET for the exact tender-amount disclosure.
2. Premium percentages depend on the reference price used (1-month average, 3-month average, undisturbed price). Different reports may quote different premium levels.
3. The Sapporo HD / 3D activism case is ongoing; outcome and any resulting transaction are pending.
4. The Asahi Intec, Yodogawa Steel, and Daiichi Sankyo Espha-related rows are included as reference cases to scaffold cluster reading. For full case detail, follow each company's IR page and EDINET filings.
5. JFTC review records are public via JFTC press releases; verify Phase I vs Phase II conclusion in JFTC published list.
6. Tokio Marine HD subsidiary actions span multiple announcements; the row aggregates the cluster rather than a single transaction.

## Research checklist

When using this matrix to analyse a new case:

1. Pull the TOB statement on EDINET and the target opinion.
2. Read the special-committee report and fairness opinion if disclosed.
3. Check [[finance/japan-tender-offer-process|tender offer process]] for the timing and amendment route.
4. Check [[finance/japan-mbo-and-squeeze-out-process|MBO and squeeze-out]] mechanics for the post-tender squeeze-out.
5. Check JFTC press releases for the merger-review path under [[finance/jftc-merger-control-process|JFTC merger control process]].
6. Check [[finance/japan-large-shareholding-disclosure|large shareholding disclosure]] for pre-TOB stake-building.
7. Use [[finance/japan-acquisition-finance|acquisition finance]] and [[finance/japan-leveraged-buyout-economics|LBO economics]] to size financing structure.
8. Cross-read with [[business/japan-listed-corp-strategic-restructuring-matrix|listed corp strategic restructuring matrix]] for vehicle taxonomy context.
