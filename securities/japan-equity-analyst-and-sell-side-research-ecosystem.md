...
aliases:
  ...
  - "Japan sell-side research"
  - "Japan equity analyst ecosystem"
  - "Japan research coverage map"
  - "Japan inducement rules research"
  - "Japan independent research"
  - "日本 セルサイドリサーチ"
...
sources:
  ...
  - "https://www.jpmorgan.com/jp/"
  - "https://www.bofa.com/ja-jp/content/japan-disclosures.html"
...
1. **Coverage equates to attention.** A name that no sell-side analyst covers gets less mindshare, often trades at a multiple discount, and faces structurally higher cost of capital. The Japanese long tail of TSE Standard / Growth Market names suffers from systematically thin coverage.
2. **Initiation and rating-change reports drive flow.** Initiations and target-price changes move stock prices; broker / IB economics depend on the credibility, breadth, and timeliness of this output.
3. **Corporate-access services are tied.** Roadshow management, conference hosting, and NDR (non-deal roadshow) booking are economically intertwined with research production at most large houses.
...
- The qualification is widely held inside [[securities/japan-asset-manager-landscape-matrix|domestic asset managers]] and broker / IB research teams.
...
1. **Research-banking conflict.** A research analyst issuing a rating on a stock whose issuer is an underwriting client. Mitigation: Chinese-wall procedures, pre-publication review controls, restricted-list management.
2. **Research-prime-brokerage / execution conflict.** Coverage intensity correlates with execution commission and prime-brokerage fee flow from the covered name's largest institutional holders. See [[securities/japan-prime-brokerage-and-institutional-financing|prime brokerage]] adjacency.
3. **Corporate-access conflict.** Allocation of issuer NDR / management-meeting access to favored institutional clients in a way that effectively functions as inducement.
4. **Issuer-relationship conflict.** Analysts who downgrade a covered name losing access to issuer management. The market-discipline response varies by house culture.
