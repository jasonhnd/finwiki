...
aliases:
  - "financial-regulators/fsa-inspection-bureau"
...
The Inspection Bureau (検査局) was the FSA's internal bureau responsible for on-site examination (検査) of licensed financial institutions until the July 2018 FSA reorganization, when its function was absorbed into the [[financial-regulators/fsa-supervision-bureau|監督局]] as an integrated supervision-and-examination lane. The reorganization aimed to merge the previously separate off-site supervision and on-site inspection streams into a single, more dialogue-based oversight model.
...
In July 2018 the FSA reorganized its bureau structure. The Inspection Bureau was abolished as a standalone bureau and its on-site examination function was integrated into the Supervision Bureau. The reform also created the Strategy Development and Management Bureau ([[financial-regulators/fsa-strategy-bureau|総合政策局]]) and retained the planning function under the Planning and Coordination Bureau ([[financial-regulators/fsa-planning-coordination-bureau|企画市場局]]).
...
- Citations after July 2018 should be redirected to [[financial-regulators/fsa-supervision-bureau|監督局]] for the operational function, with this page as a transition anchor.
...
- It distinguishes 検査局 (historical) from 公認会計士・監査審査会 ([[financial-regulators/cpaaob|CPAAOB]]), which is a separate FSA-affiliated body for audit-firm oversight and was not abolished.
