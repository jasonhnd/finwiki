...
aliases:
  - "financial-regulators/fsa-strategy-bureau"
  - "fsa-strategy-bureau"
  - "FSA Strategy Development and Management Bureau"
...
confidence: likely
tags: [JapanFG, regulator, internal-bureau, FSA, strategy, international, financial-education]
status: active
sources:
...
- Cross-bureau coordination across [[financial-regulators/fsa-supervision-bureau|監督局]] and [[financial-regulators/fsa-planning-coordination-bureau|企画市場局]] on issues that cut across supervision, rule-making, and policy.
- International financial policy: FSB, IOSCO, IAIS, FATF, OECD work, and bilateral / multilateral cooperation with foreign regulators. This is the FSA-side counterpart to the BoJ's [[financial-regulators/boj-international-dept|国際局]] (different institution, partially overlapping topics).
...
- **Other Japanese authorities**: METI on FinTech / digital industrial policy, MOF on international financial-policy and FX issues, the BoJ ([[financial-regulators/boj-international-dept|国際局]]) on Basel and CPMI work, and the inter-agency financial-education framework.
- **FSA internal**: cross-bureau working groups with [[financial-regulators/fsa-supervision-bureau|監督局]] and [[financial-regulators/fsa-planning-coordination-bureau|企画市場局]], plus liaison with affiliated bodies such as the Securities and Exchange Surveillance Commission and [[financial-regulators/cpaaob|CPAAOB]].
...
- It separates strategy / international policy (this bureau) from rule-making ([[financial-regulators/fsa-planning-coordination-bureau|企画市場局]]) and from supervision ([[financial-regulators/fsa-supervision-bureau|監督局]]) — three distinct lanes that JapanFG pages often need to disambiguate.
...
- [[financial-regulators/boj-international-dept|BoJ 国際局 (International Department)]]
