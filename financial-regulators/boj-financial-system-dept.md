...
aliases:
  - "financial-regulators/boj-financial-system-dept"
...
- Input into the Policy Board on financial-stability matters that may interact with monetary policy (the financial-stability remit complements but does not replace [[financial-regulators/boj-monetary-policy|monetary policy]] decisions).
...
- **Examined institutions**: banks, shinkin banks, foreign-bank branches, securities firms, and other entities holding BoJ current accounts. This includes most of the JapanFG bank universe — see [[megabanks/smfg|SMFG]], [[securities-firms/mufg-mums|MUFG / MUMS]], regional banks such as [[regional-banks/chiba-bank|Chiba Bank]] and [[regional-banks/77-bank|77 Bank]], and the shinkin segment captured in [[banking/shinkin-bank-registry-japan|shinkin bank registry]].
- **Other regulators**: the FSA (particularly [[financial-regulators/fsa-supervision-bureau|監督局]]), the Deposit Insurance Corporation of Japan, and foreign supervisors for cross-border banking groups.
- **Internal BoJ**: shared work with [[financial-regulators/boj-financial-markets-dept|金融市場局]] on counterparty-credit aspects of market operations, with [[financial-regulators/boj-payment-settlement-dept|決済機構局]] on settlement-risk surveillance, and with [[financial-regulators/boj-international-dept|国際局]] on cross-border prudential issues including BIS Basel coordination.
