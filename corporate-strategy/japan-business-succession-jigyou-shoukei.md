---
title: "事業承継 (jigyou shoukei) — Japan business-succession framework and 事業承継税制 inheritance / gift-tax deferral (法人版 / 個人版)"
aliases:
  - "japan-business-succession-jigyou-shoukei"
  - "事業承継"
  - "事業承継税制"
  - "jigyou shoukei zeisei"
  - "japan business succession tax"
  - "business succession deferral japan"
  - "経営承継円滑化法"
  - "特例承継計画"
...
This entry sits under [[corporate-strategy/INDEX|corporate-strategy INDEX]] and routes into [[finance/INDEX|finance INDEX]] for the deal-side overlay. It covers the **owner-transition** problem that sits behind much Japanese restructuring. Read it with [[corporate-strategy/japan-holding-company-conversion|holding-company conversion]] (a common pre-succession reorganization), [[corporate-strategy/japan-kaisha-bunkatsu-tax-regime|会社分割 tax regime]] for carving a business ahead of a handover, and [[finance/japan-mbo-and-squeeze-out-process|Japan MBO / squeeze-out process]] for the management-buyout route when no family or internal successor exists.
...
2. **親族外承継 / 役員・従業員承継 (internal non-family)** — to a manager or employee, often via a [[finance/japan-mbo-and-squeeze-out-process|management buyout (MBO)]].
...
- **持株会社化 ahead of succession** — interposing a holding company can concentrate voting control in the successor, separate operating risk, and reshape the share base before the transfer. The conversion mechanics are in [[corporate-strategy/japan-holding-company-conversion|holding-company conversion]]; the HoldCo can then be the vehicle whose shares pass under the 事業承継税制.
- **会社分割 to separate keep-vs-sell businesses** — split a multi-business company so the successor inherits the core while a non-core unit is sold or wound down. The split mechanics, including automatic employee transfer, are in [[corporate-strategy/japan-kaisha-bunkatsu-tax-regime|the 会社分割 tax regime]].
- **MBO when no family successor** — a manager / employee buys the company, typically with leverage; the structure and financing sit in [[finance/japan-mbo-and-squeeze-out-process|the MBO / squeeze-out process]] and [[finance/japan-leveraged-buyout-economics|leveraged-buyout economics]].
...
- **"No successor" is the real driver of Japan SME M&A**: the same demographic gap that powers the succession-tax regime also feeds third-party M&A volume, linking this entry to the deal pipeline in [[finance/INDEX|finance]] and the operating-company cases in [[business/japan-listed-corp-strategic-restructuring-matrix|the strategic-restructuring matrix]].
- **Policy finance is part of the toolkit**: public lenders and credit-guarantee bodies offer succession-specific finance for successors funding a buy-in — the institutions are catalogued in [[policy-finance/INDEX|policy-finance INDEX]].
...
- **Not a substitute for valuation discipline**: deferring tax does not fix an over-concentrated or poorly governed cap table; pairing succession with a [[corporate-strategy/japan-holding-company-conversion|HoldCo conversion]] or partial restructuring is common for good reason.
