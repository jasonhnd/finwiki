...
aliases:
  - "japan-group-tsusan-consolidated-tax-regime"
  - "グループ通算制度"
  - "group tsusan"
  - "japan group tax sharing"
  - "japan consolidated tax regime"
  - "連結納税制度"
  - "renketsu nozei"
  - "グループ法人税制"
  - "損益通算"
...
confidence: likely
tags: [corporate-strategy, tax, japan, group-taxation, holding-company, loss-offset]
status: active
sources:
  ...
  - "https://laws.e-gov.go.jp/document?lawid=340AC0000000034"
