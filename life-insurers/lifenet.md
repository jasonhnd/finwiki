---
title: ライフネット生命保険 (LifeNet Insurance)
...
sources:
  ...
  - "https://ir.lifenet-seimei.co.jp/en/ir/library.html"
...
> KDDI は 2015 年に出資参入し、au 経済圏 / au フィナンシャル HD [[megabanks/au-fh]] の生保ピースとして機能してきた。2026 年の会社開示では、capital alliance の扱いが見直されても business alliance は残るため、株主・提携関係を分けて読む。

### 創業者・経営陣（沿革）

| 役割 | 氏名 | 経歴 |
|---|---|---|
| 共同創業者・初代社長 | **出口治明**（でぐち はるあき）| 元日本生命（国際業務統括等） |
| 共同創業者・初代副社長 → 2 代社長 | **岩瀬大輔**（いわせ だいすけ）| 元 BCG（ボストン・コンサルティング）、東大法・Harvard MBA |
...
- **ネット完結**: 見積もり → 申込 → 健康診断書 / 告知 → 審査 → 引受 → 月払いクレカ / 口座振替
- **書類不要・対面不要**（電子申込）が原則
...
2. **コスト構造の軽量化**: 営業職員人件費・店舗賃料を持たない → 純保険料部分を厚くするモデル
3. **若年層 (20-30 代) 中心ターゲット**: 既存生保が手薄な「最初の保険」層を獲得
4. **デジタル UX**: スマホ完結・申込時間の最短化
5. **KDDI / au 経済圏連携** [[megabanks/au-fh]]: au 顧客基盤への送客、au PAY ポイント等の動線連携 ^[extracted]

### 沿革

| 年月 | 事象 |
|---|---|
| **2006-10** | **設立**（出口治明 + 岩瀬大輔 共同創業）^[extracted] |
| 2008-05-18 | **開業**（生命保険業免許取得、日本初の独立系ネット生保）^[extracted] |
| 2012-03-15 | **東証マザーズ上場**（戦後初のネット生保上場、証券コード 7157）^[extracted] |
...
| 競合 | 業態 | 差別化軸 |
|---|---|---|
| **アクサダイレクト生命** | 外資系ネット生保 | 自動車保険ブランド力 |
| **アフラック（ネット販売）** | がん保険大手の D2C 拡張 | がん / 医療領域強い |
| **SBI 生命** | SBI HD [[megabanks/sbi-hd]] 傘下 | SBI 証券・ネット銀との連携 |
| **メディケア生命** | 住友生命系・ネット販売 | 親会社ブランド |
| **楽天生命** | 楽天 G 傘下 | 楽天ポイント経済圏 |
| **PayPay ほけん**（少額短期）| ソフトバンク [[megabanks/paypay-fg]] | スーパーアプリ動線 |
...
## 3. #26 deepening: direct-life economics and listed insurer metrics

LifeNet の business model は、単に「保険をオンラインで売る」ではなく、営業職員・店舗コストを持たない direct-to-consumer insurer として、顧客獲得費、保有契約年換算保険料、insurance service results、IFRS17 上の CSM / comprehensive equity をどう積み上げるかで読む。2026 年の mid-term plan は FY2028 に comprehensive equity 2,000-2,400 億円を目標に置き、個人保険と GCL を別々の成長エンジンとして説明する。

規制・健全性の見方では、生命保険業免許と solvency margin ratio が基本である。2025-03 期の会社開示では consolidated solvency margin ratio が 1,722.2% とされ、2026-03 期の IR material では annualized premiums of policies-in-force、insurance service results、GCL contracts value を主要指標として並べる。従来の J-GAAP 保険料収入だけでなく、IFRS17 後の将来利益価値を含む指標で読まないと、ネット生保の成長・黒字化局面を過小評価しやすい。
...
- [[megabanks/au-fh]]（KDDI / au フィナンシャル HD、筆頭級戦略株主）
- [[megabanks/sbi-hd]]（SBI 生命の親会社、競合）
- [[megabanks/paypay-fg]]（PayPay ほけん、経済圏競合）
- [[megabanks/mufg]] · [[megabanks/smfg]] · [[megabanks/mizuho-fg]]（伝統的生保 vs ネット生保の対比）
...
> [!info] 検証状況
> confidence: **likely**（公式 IR / 株主情報 / mid-term plan で 2026-06-21 校核）。旧記述の東証 Growth / KDDI 約 28% は最新 IR と株主表に合わせ、東証 Prime、auFH 18.32% へ修正した。具体的な持分比率・最新財務数値は時点変動があるため、最新は同社 IR / 有価証券報告書を要参照。本ページは公開情報のみで構成、内部資料・非公開情報は引用していない。
