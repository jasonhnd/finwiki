...
confidence: likely
tags: [card-issuers, JapanFG, credit-card, prepaid, installment-credit]
status: active
sources:
...
| Item | Notes |
|---|---|
| Legal entity | ライフカード株式会社 / Life Card Co., Ltd. |
| Group | [[consumer-finance/aiful|アイフル (AIFUL) group]] のカード事業会社 |
| Card / credit lane | 割賦販売法上の包括信用購入あっせん（カード割賦・分割払い／リボ） |
| Prepaid lane | プリペイドカード（資金決済法上の前払式支払手段の枠組み） |
