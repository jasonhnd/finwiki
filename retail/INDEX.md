...
confidence: likely
tags: [retail, index, payments, loyalty, financial-services]
status: active
sources:
...
| likely | [[retail/lawson-kddi-retail-finance|Lawson + KDDI retail finance]] | CVS-finance case after 2024-02 KDDI + Mitsubishi 50/50 TOB: Lawson Bank + au PAY + Pontaポイント telco-anchored model |
| likely | [[retail/familymart-itochu-financial-integration|FamilyMart + Itochu financial integration]] | CVS-finance case under Itochu post-2020 take-private: FamiPay, FamiPay Card, Itochu Money distribution |

### Cross-case comparison

| Status | Page | Role |
|---|---|---|
| likely | [[retail/japan-retail-financial-distribution-wedge-matrix\|Japan retail financial-distribution wedge matrix]] | Canonical comparison. Matrix mapping the physical-retail wedge (SM / CVS / drugstore / EC / telco store) to bank / payment / point / card layers across AEON, Seven & i, Lawson, FamilyMart, Rakuten, PayPay, and telco-anchored ecosystems |
...
| Main risk | App complexity and competition from PayPay / Rakuten / telco points | Cashless adoption and dependence on ATM economics | Dependence on KDDI / au ecosystem direction | Thin own-finance stack; reliance on partners |
