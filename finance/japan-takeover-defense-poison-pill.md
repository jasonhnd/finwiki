---
title: "Japan takeover defense and poison pill"
aliases:
  - "japan-takeover-defense-poison-pill"
  - "Japan poison pill"
  - "Japan advance-warning takeover defense"
  - "事前警告型買収防衛策"
  - "Bull-Dog Sauce defense"
domain: "finance"
created: 2026-05-25
...
confidence: likely
tags: [finance, M&A, takeover-defense, poison-pill, TOB, Bull-Dog-Sauce, METI, FIEA, governance]
status: active
sources:
...
Japan takeover defense is a set of possible issuer responses that may interact with the [[finance/japan-tender-offer-process|FIEA tender-offer process]], the Companies Act, listing rules, and judicial review. A company may have a disclosed advance-warning response policy or may evaluate an event-specific response, but no mechanism or outcome should be assumed without the issuer filing and transaction facts. It belongs in [[finance/INDEX|finance]] alongside [[finance/japan-activist-investor-playbook|the activist playbook]] and [[finance/japan-mbo-and-squeeze-out-process|MBO / squeeze-out process]].

Read this page against [[finance/jftc-merger-control-process|JFTC merger control]], [[finance/cross-border-m-a-japan|cross-border M&A]], [[finance/japan-cross-shareholding-unwinding-economics|cross-shareholding unwinding]], [[finance/japan-shareholder-proposal-and-agm-voting-route|AGM voting route]], and the [[INDEX|FinWiki index]].

## Defense taxonomy

Source: the table is a route-level taxonomy based on METI's [Guidelines for Corporate Takeovers](https://www.meti.go.jp/english/press/2023/0831_001.html), Supreme Court case 2007 (Kyo) No. 30 (Bull-Dog Sauce), retrievable through the Courts' [official Supreme Court case search](https://www.courts.go.jp/hanrei/search2/index.html), and current issuer filings. Actual availability, approvals, triggers, and effects are plan-specific.
...
Source: every row in the table summarizes METI's [Guidelines for Corporate Takeovers](https://www.meti.go.jp/english/press/2023/0831_001.html); the guidelines are non-statutory and do not predetermine the legality of a transaction-specific response.
...
|---|---|---|
| 2007-08-07 | [Supreme Court case search](https://www.courts.go.jp/hanrei/search2/index.html): 2007 (Kyo) No. 30, Second Petty Bench, Minshu Vol. 61, No. 5, p. 2215 | The Bull-Dog Sauce judgment, factual record, shareholder vote, warrant allocation, and bidder treatment in that case. |
| 2023-08-31 | [METI Guidelines for Corporate Takeovers](https://www.meti.go.jp/english/press/2023/0831_001.html) | Current policy principles for acquisition proposals, board conduct, shareholder decision-making, and response measures. |
| Current issuer cycle | [JPX Code of Corporate Conduct](https://www.jpx.co.jp/english/equities/listing/code-of-conduct/index.html) and issuer filings | Listing-rule context and the issuer's disclosed policy; verify each issuer separately. |
...
1. **Filed trigger threshold**, acquisition-aggregation rule, and exact information-demand / waiting period
2. **Special-committee composition** — independence and ratio of independent directors
3. **Duration / sunset clause** and renewal or shareholder-approval route
4. **Allocation ratio and exercise terms** of any warrants
5. **Bidder compensation**, if any, and the stated legal / economic basis
6. **AGM voting result** and the board's disclosed reasons

## Research checklist

1. Pull TDnet / EDINET filings for the standing defense plan and AGM resolution.
2. Cross-check against the TSE corporate governance report and METI's 2023 Guidelines for Corporate Takeovers.
3. Map activist precedent against [[finance/japan-activist-investor-playbook|activist playbook]] tactics.
4. Read the controlling statutes and all relevant court decisions if a measure is litigated; treat Bull-Dog 2007 as an important case-specific precedent.
5. Cross-reference [[finance/japan-cross-shareholding-unwinding-economics|cross-shareholding unwind]] data only when dated issuer disclosures establish the holders and voting context.
