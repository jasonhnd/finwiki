...
aliases:
  ...
  - "Japan financials stock universe"
  - "JP listed financial groups reference universe"
  - "日本金融グループ上場ユニバース"
domain: finance
created: 2026-05-24
...
confidence: likely
tags: [finance, japan, listed-financials, megabank, insurance, securities, consumer-finance, leasing, fintech, reference-universe]
status: active
sources:
  ...
  - "https://www.fsa.go.jp/en/policy/stewardship/"
  - "https://www.fsa.go.jp/en/policy/corporategovernencereform/20240115.html"
---
...
Cross-holding unwind for insurers and megabanks shows up on the [[finance/japan-large-shareholding-disclosure]] surface when blocks move; activist or strategic positions in regional FGs and consumer finance issuers also surface there.
...
1. Open the issuer's TDnet recent-disclosure feed via [JPX TDnet](https://www.jpx.co.jp/equities/listing/disclosure/tdnet/index.html).
2. Pull the most recent securities report and extraordinary reports from [EDINET](https://disclosure.edinet-fsa.go.jp/).
3. Cross-check index inclusion (Nikkei 225 / TOPIX / TOPIX Core 30 / FTSE Russell) against the [JPX TOPIX methodology page](https://www.jpx.co.jp/markets/indices/topix/) and the relevant index provider.
4. Re-confirm the latest kessan tanshin and IR deck on the issuer's IR page.
5. For stewardship / engagement reading, cross-reference [[finance/japan-shareholder-proposal-and-agm-voting-route]] and [[finance/japan-activist-investor-playbook]].
6. For large-shareholding stakes, pull the EDINET 大量保有報告書 / 変更報告書 stack per [[finance/japan-large-shareholding-disclosure]].
