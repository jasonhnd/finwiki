...
aliases:
  - "Japan aircraft leasing financing"
  - "JOL Japan operating lease"
  - "JOLCO Japan operating lease with call option"
  - "Mitsubishi HC Capital aircraft"
  - "SMFL aircraft"
  - "Hong Kong Ireland aircraft SPV tax"
  - "structured-finance/aircraft-leasing-financing-japan-shosha"
...
confidence: likely
tags: [structured-finance, aircraft-leasing, jol, jolco, shosha, mhc, smfl, mizuho-lease, japan, hong-kong, ireland, spv]
status: active
sources:
  ...
  - "Sōgō shōsha IR (aircraft investment disclosures)"
---
