...
confidence: likely
tags: [structured-finance, rating-agency, jcr, ri, methodology, sdr, cash-flow-model, surveillance, japan]
status: active
sources:
  - "JCR structured-finance criteria — https://www.jcr.co.jp/en/"
  - "R&I structured-finance methodology — https://www.r-i.co.jp/en/"
  - "FSA designated rating agency — https://www.fsa.go.jp/en/"
...
| **Consumer-loan ABS** | Vintage curve by APR / loan-size bucket; 利息制限法 regulatory shock scenario; early-amortization trigger calibration | Monthly servicer report; quarterly rating review; semi-annual full review |
| **Credit-card receivable ABS** | Master-trust pool dynamics; 期間延長 conditional scenario; cross-series contagion stress | Monthly servicer report; quarterly rating review |
...
The criteria papers are published on each agency's website in Japanese and English; they're updated periodically (every 3–7 years for major methodology revisions).
...
- **"Sovereign-cap mechanical exception is unfair to JCR / R&I"** — JCR / R&I aren't bound by the country-ceiling; the question is whether this is methodologically sound or a structural advantage
