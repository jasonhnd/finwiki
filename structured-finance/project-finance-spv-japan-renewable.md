...
aliases:
  - "Japan renewable project finance"
  - "Japan solar SPV"
  - "Japan offshore wind project finance"
  - "Japan geothermal project finance"
  - "FIT-era SPV structure"
  - "PPA tenor Japan renewables"
...
confidence: likely
tags: [structured-finance, project-finance, renewable, solar, wind, geothermal, fit, ppa, japan]
status: active
sources:
  ...
  - "Sogo shosha IR — renewable equity disclosures"
---
...
- **Equity sponsors**: a mix of sōgō shōsha ([[financial-conglomerates/mitsubishi-corp|Mitsubishi Corp]], [[financial-conglomerates/mitsui-co|Mitsui]], [[financial-conglomerates/sumitomo-corp|Sumitomo Corp]]), IPP specialists, infrastructure funds, and (occasionally) institutional investors as LPs in fund-of-SPV structures
...
- **Sponsor consortium** typically including a sōgō shōsha, a Japanese utility, and a global offshore-wind developer (Ørsted-style international partner)
...
- **Equity sponsors**: utilities (e.g., Kyushu Electric, Hokkaido Electric), JOGMEC-supported developers, sōgō shōsha
