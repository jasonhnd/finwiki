...
- **進捗**: Wave 1(3 行)+ Wave 2(15 file: yucho/japan-post-bank/aeon-bank/gmo-payment-gateway/gmo-aozora-net/ndfg/jimoto-hd/gmo-financial-hd/au-fh/aeon-financial-service-detail/+ 信用組合 5)完了 = **18 file 済 / 約 128 file 残**。Wave 2 でも重大訂正多数(ゆうちょの日本郵政持株が 2025-03 に 50% 割れ、GMO あおぞらの株主比率が逆転記載[あおぞら 50% 出資 / 85.12% 議決権]、osaka-shogin は 2001 に近畿産業信組へ統合され消滅、jimoto-hd 殖産銀行の創業 1895→1914、GMO外貨改称、au-FH の Lifenet 出資 議決権 18.32% 等)。複数 wave で継続。サブエージェントが導入した `^[forecast]`(NDFG 等の設立前の前方視点、26 箇所)は別途整理予定。
