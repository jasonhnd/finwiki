...
aliases:
  ...
  - "Japan cap rate 2026"
  - "Tokyo prime office cap rate"
  - "Japan logistics cap rate"
  - "Japan residential cap rate"
  - "Osaka office cap rate"
  - "Japan cap rate floor"
  - "Japan real-estate yield compression"
...
confidence: likely
tags: [real-estate-finance, cap-rate, valuation, j-reit, foreign-buyer, post-nirp, normalization]
status: active
sources:
  - "https://www.ares.or.jp/en/"
  - "https://www.jrei.jp/"
  - "https://www.boj.or.jp/en/research/brp/fsr/index.htm"
  - "https://www.mlit.go.jp/totikensangyo/totikensangyo_fr2_000019.html"
...
All ranges above are class descriptors derived from [[real-estate-finance/INDEX|ARES J-REIT data]] and JREI Real Estate Investor Survey publication ranges. They go stale rapidly; re-confirm against the latest published survey before any decision use.
...
Net 2026 reading: cap-rate widening from NIRP-era trough has been modest, not aggressive, because the foreign-buyer underwriting floor and structural domestic risk-free anchor have both held. Read against [[real-estate-finance/j-reit-dividend-yield-vs-jgb-spread|J-REIT yield-spread analysis]] for the spread-driven version of the same logic.
...
This foreign-buyer logic explains why headline cap rates can remain compressed even as domestic rates normalise. The presence of foreign-GP deployment via [[real-estate-finance/real-estate-private-credit-japan|private credit]] and direct equity routes adds to bid-side depth. Foreign-ownership patterns in listed J-REIT vehicles also illustrate this dynamic per [[real-estate-finance/j-reit-foreign-investor-ownership]].
...
This decomposition is illustrative only; actual market-clearing cap rates reflect a much wider set of marginal-buyer underwriting frames. The exact 10Y JGB level is verifiable on [[money-market/japan-money-market]] and BoJ data pages.
...
This sensitivity is read against [[real-estate-finance/j-reit-market-overview]] for the listed J-REIT structure and [[real-estate-finance/japan-real-estate-appraisal-methodology|appraisal methodology]] for the lagging-appraisal effect that compounds with traded price-vs-NAV gaps.
