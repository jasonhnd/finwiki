...
sources:
  ...
  - "https://www.dbj.jp/en/ir/"
  - "https://www.tr.mufg.jp/english/ir/"
  - "https://www.smtb.jp/english/investors"
  - "https://www.mof.go.jp/english/policy/financial_system/index.html"
---
...
These ranges are class descriptors and rotate with the rate cycle, cap-rate environment per [[real-estate-finance/real-estate-cap-rate-compression-2026]], and competitive supply of private credit. Verify against current published GP fund documentation and broker / advisor commentary.
...
- TK / GK-TK / TMK structured deployment per [[real-estate-finance/jrei-foreign-investment-tax-treatment|tax treatment]];
...
Foreign-GP private-credit capacity grew materially as bank-side underwriting tightened post-pandemic and as foreign-buyer yen-funded carry attractiveness rose. Read foreign-equity-side dynamics at [[real-estate-finance/j-reit-foreign-investor-ownership]].
...
| Tax treatment | Interest expense at issuer (subject to thin-cap and TPS rules) | Distribution-treatment varies; see [[real-estate-finance/jrei-foreign-investment-tax-treatment]] |
...
| Japan life insurers | Allocates to mezz / preferred-equity programmes consistent with [[insurance/japan-life-insurance-alm-overview|ALM overview]]. |
...
Foreign-GP fund-raising into Japan-LP base is a meaningful component of recent private-credit growth and ties to [[finance/japan-private-equity-fund-structure-matrix]] for fund-structure detail.
