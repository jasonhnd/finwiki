---
title: "J-REIT top 20 detailed matrix"
aliases:
  - "j-reit-top-20-detailed-matrix"
  - "Top 20 J-REIT comparison matrix"
  - "J-REIT top 20 by market cap"
  - "J-REIT 上位20 比較"
  - "largest J-REIT detailed matrix"
  - "J-REIT sponsor LTV yield matrix"
  - "J-REIT 2026 league table"
  - "J-REIT NAV DPU trend 2024 2025"
  - "top 20 listed J-REIT detailed"
...
confidence: likely
tags: [real-estate-finance, j-reit, matrix, top-20, sponsor, asset-class, market-cap, ltv, dpu-yield, foreign-investor]
status: active
sources:
  ...
  - "https://www.nbf-m.com/nbf/en/"
  - "https://www.j-re.co.jp/english/"
  - "https://www.nre-mf.co.jp/english/"
  - "https://www.glpjreit.com/en/"
  - "https://www.prologis-reit.co.jp/english/"
  - "https://www.daiwa-office.co.jp/en/"
  - "https://www.naf-r.jp/english/"
  - "https://www.jlf-reit.com/english/"
  - "https://sekisuihouse-reit.co.jp/en/"
  - "https://www.orixjreit.com/en/"
  - "https://www.morihills-reit.co.jp/en/"
  - "https://www.mt-reit.jp/en/"
  - "https://www.iif-reit.com/en/"
  - "https://www.activia-reit.co.jp/en/"
  - "https://www.frontier-reit.co.jp/en/"
  - "https://www.pic-reit.co.jp/en/"
  - "https://www.kdo-reit.com/en/"
  - "https://www.hulic-reit.co.jp/en/"
  - "https://www.mflp-reit.co.jp/en/"
  - "https://www.aeon-jreit.co.jp/en/"
...
**Logistics J-REITs** and **AEON REIT** stand out for high single-tenant exposure: each facility is typically anchored by a single 3PL operator (logistics) or a single AEON Mall master tenant (AEON REIT). This is the structural inverse of the multi-tenant office model. See [[real-estate-finance/logistics-j-reit-vs-office-j-reit-asset-class-comparison|logistics J-REIT vs office J-REIT asset-class comparison]] for the tenant-structure tradeoff economics.

## 6. Foreign-sponsor vs domestic-sponsor split

Of the top 20, only **two J-REITs are foreign-sponsored** — both in logistics — versus **18 with domestic sponsors**. This is a structurally distinctive feature of the J-REIT industry compared with the US REIT industry, where the concept of an external sponsor is largely absent (US REITs are internally managed; see [[real-estate-finance/j-reit-vs-us-reit-governance-comparison|J-REIT vs US REIT governance comparison]]).
...
The 18 domestic-sponsored top-20 J-REITs are deeply tied to the Japan listed-developer landscape — see [[real-estate-finance/mitsui-fudosan-financing-model|Mitsui Fudosan]] and [[real-estate-finance/mitsubishi-estate-financing-model|Mitsubishi Estate]] as the two anchor developer entries for understanding the parent-side capital allocation that drives J-REIT pipeline flow.
...
The foreign-investor share of J-REIT trading volume — tracked via JPX trading-by-investor-type statistics ([[real-estate-finance/j-reit-foreign-investor-ownership|J-REIT foreign-investor ownership]]) — has historically been a leading indicator of relative-price performance, particularly between office-tilted and logistics-tilted names. The two foreign-sponsored logistics names (GLP, NPR) are especially sensitive to foreign-investor flow.

### Cap-rate compression and rate-normalization is the macro overlay

Reading the 2024-2025 NAV / DPU trend column without the macro overlay is misleading. The window has been characterized by the BoJ exit from negative-rate policy, gradual JGB yield-curve normalization, and a parallel global commercial-real-estate cap-rate widening cycle that has affected J-REITs more cyclically than the underlying property cash flows alone would predict. See [[real-estate-finance/real-estate-cap-rate-compression-2026|real estate cap-rate compression 2026]] for the macro cap-rate context, and [[real-estate-finance/j-reit-dividend-yield-vs-jgb-spread|J-REIT dividend yield vs JGB spread]] for the yield-spread context. The relative-performance dispersion across the top 20 in this window has tracked sector exposure (logistics vs office) and sponsor-quality bands more than absolute property-cash-flow growth.
...
- "Top 20" is a moving target: J-REIT mergers, new equity issuance, secondary offerings, and price movements regularly reshuffle the ranking. This matrix is a stable representative cut, not a fixed league table.
- A single J-REIT can re-enter or drop out of the top 20 across a year on price movement alone; do not anchor portfolio decisions on the matrix without live verification.
- Some smaller J-REITs that fall outside the top 20 (hotel REITs, healthcare REITs, infrastructure funds) may be more interesting on individual axes (DPU yield, sector growth, sponsor support) and should not be dismissed because they are not in the top 20.
- The sponsor-family lens is structural but does not predict execution: independent-sponsor J-REITs (Kenedix Office, Premier) can outperform on operational discipline and capital allocation despite the absence of a developer sponsor's pipeline-supply support.
- The 2024-2025 directional labels are qualitative; treat them as orientation only. Live IR data may diverge from the directional summary for a specific J-REIT within the cluster.
- The matrix uses "Mid-40% zone" as a shorthand LTV policy band — actual policy ceilings vary by J-REIT (some explicitly target 40-50%, some operate around 45-50%, some have 55% policy ceilings with lower target operating range). Read the IR for the precise band.

## Open questions

- **Sponsor-family consolidation**: does the Mitsui Fudosan-family cluster of J-REITs (NBF, Nippon Accommodations, Frontier, MFLP-REIT) head toward eventual sub-cluster mergers similar to the JMF consolidation pattern?
- **Foreign-sponsor strategic shifts**: how do GLP and Prologis sustain Japan-market priority versus other Asia-Pacific or US capex priorities — and what would unit-holders see if a foreign sponsor shifted capital elsewhere?
- **Office cap-rate path**: does office cap-rate revert post-rate-normalization, or does the logistics-office cap-rate convergence persist as a structural feature?
- **Activism / engagement**: do activist investor strategies extend from listed-developer parents (Mitsui Fudosan, Mitsubishi Estate as listed-corporate targets) into their J-REIT subsidiaries?
- **AEON REIT single-tenant evolution**: does AEON REIT's reliance on AEON Mall as master tenant face any restructuring as AEON Group reshapes its retail platform?
- **Mid-size office (Daiwa Office, Kenedix Office) resilience**: do mid-size office J-REITs face structurally tougher demand than flagship CBD office J-REITs as hybrid work persists?
