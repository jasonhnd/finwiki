...
aliases:
  - "export-finance-mechanism"
  - "export finance mechanism"
  - "buyer credit supplier credit"
  - "ECA-backed export finance"
  - "manufacturer export finance"
  - "輸出金融の仕組み"
  - "バイヤーズクレジット"
  - "サプライヤーズクレジット"
...
confidence: likely
tags: [manufacturing, export-finance, buyer-credit, supplier-credit, eca, jbic, nexi, oecd-arrangement, project-finance, mechanism, japan, global]
status: active
sources:
  - "https://www.oecd.org/en/topics/export-credits.html"
  - "https://legalinstruments.oecd.org/Instruments/instruments/OECD-LEGAL-5005"
...
| **Financing support (融資支援)** | 直接融資・リファイナンス・金利支援を提供 | [[JapanFG/jbic|JBIC]] (輸出金融・投資金融) |
...
海外の買い手 (政府/事業会社) が日本メーカーの資本財を発注
   ...
   │     + メガバンク ([[JapanFG/jbic|JBIC]] 協調融資にシンジケート参加)
   │
...
- [[JapanFG/jbic|JBIC (国際協力銀行)]] · [[policy-finance/nexi|NEXI (日本貿易保険)]] · [[policy-finance/oecd-export-credit-arrangement|OECD Arrangement]]
