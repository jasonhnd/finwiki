...
const DOMAIN_SYSTEM_CANDIDATES: Record<string, string[]> = {
  ...
  megabanks: ["megabanks/INDEX", "banking/INDEX", "JapanFG/INDEX"],
  "regional-banks": ["regional-banks/INDEX", "banking/INDEX", "JapanFG/INDEX"],
  "cooperative-banks": ["cooperative-banks/INDEX", "banking/INDEX", "JapanFG/INDEX"],
  "trust-banks": ["trust-banks/INDEX", "banking/INDEX", "securities/INDEX", "JapanFG/INDEX"],
  "life-insurers": ["life-insurers/INDEX", "insurance/INDEX", "non-life-insurers/INDEX", "JapanFG/INDEX"],
  "non-life-insurers": ["non-life-insurers/INDEX", "insurance/INDEX", "life-insurers/INDEX", "JapanFG/INDEX"],
  "securities-firms": ["securities-firms/INDEX", "securities/INDEX", "JapanFG/INDEX"],
  "asset-managers": ["asset-managers/INDEX", "securities/INDEX", "JapanFG/INDEX"],
  "payment-firms": ["payment-firms/INDEX", "payments/INDEX", "fintech/INDEX", "JapanFG/INDEX"],
  "card-issuers": ["card-issuers/INDEX", "payments/INDEX", "JapanFG/INDEX"],
  "leasing-firms": ["leasing-firms/INDEX", "manufacturer-finance/INDEX", "JapanFG/INDEX"],
  "consumer-finance": ["consumer-finance/INDEX", "payments/INDEX", "JapanFG/INDEX"],
  "trading-company-finance": ["trading-company-finance/INDEX", "corporate-strategy/INDEX", "JapanFG/INDEX"],
  "financial-conglomerates": ["financial-conglomerates/INDEX", "corporate-strategy/INDEX", "JapanFG/INDEX"],
  "foreign-financial-institutions": ["foreign-financial-institutions/INDEX", "banking/INDEX", "JapanFG/INDEX"],
  "financial-regulators": ["financial-regulators/INDEX", "policy-finance/INDEX", "JapanFG/INDEX"],
  "financial-licenses": ["financial-licenses/INDEX", "policy-finance/INDEX", "JapanFG/INDEX"],
  banking: [
    "banking/INDEX",
