...
So SPU is a customer-acquisition-cost mechanism aimed squarely at finance cross-sell: the point multiplier is the carrot that moves an EC shopper into [[JapanFG/rakuten-fg|Rakuten Card / Bank / Securities]]. Compared with the telco model in [[loyalty/d-point-au-kddi-docomo-telco-point-consolidation|the telco-point consolidation case]] — where the anchor is a mobile-line ID — Rakuten's anchor is the **commerce habit**, and finance is sold *off* it.
...
The licensing boundary itself is catalogued in [[JapanFG/legal-financial-licenses/INDEX|JapanFG legal / financial licenses]].

## Where Rakuten sits among the majors

| Operator | Anchor | Reward logic | Finance route |
|---|---|---|---|
| **Rakuten Point** | EC habit (楽天市場) | **SPU stacked multiplier** rises with ecosystem depth | [[JapanFG/rakuten-fg|Rakuten FG]] (card → bank → securities → mobile) |
| V Point | SMBC bank / card | Common-point breadth + Olive | [[JapanFG/smfg|SMFG]] / Olive |
| d Point | docomo mobile line | Telco-ID + rank | [[JapanFG/ndfg|NDFG]] |
| PayPay Point | Code-payment wallet | Campaign-led frequency | [[JapanFG/paypay-fg|PayPay FG]] |
...
- **The point is the acquisition channel for finance, not a marketing line.** SPU exists to move EC shoppers into [[JapanFG/rakuten-fg|Rakuten Card / Bank / Securities]] at a lower CPA than standalone finance marketing — that cross-sell base is the core of the 楽天経済圏 thesis.
