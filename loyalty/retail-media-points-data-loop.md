...
aliases:
  - "loyalty/retail-media-points-data-loop"
  - "retail-media-points-data-loop"
  - "リテールメディア ポイント データループ"
  - "ポイント 顧客ID データ経済"
  - "points retail media ID graph"
  - "loyalty data loop economics"
domain: "loyalty"
created: 2026-06-03
...
confidence: likely
tags: [loyalty, points, retail-media, data-marketing, id-graph, japan, finance, privacy]
status: active
sources:
