...
aliases:
  - "loyalty/point-program-unit-economics"
  - "point-program-unit-economics"
  - "ポイントプログラム ユニットエコノミクス"
  - "ポイント原資 ブレッカジ 経済"
  - "loyalty point unit economics"
  - "point funding float breakage CPA"
...
confidence: likely
tags: [loyalty, points, unit-economics, breakage, float, cpa, japan, finance]
status: active
sources:
